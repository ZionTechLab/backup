  ...
  return (
    <div className={className || 'mb-3'}>
      ...
      <div className="d-flex align-items-center gap-3">
        <div className={"image-preview d-flex align-items-center justify-content-center mb-2" + (preview ? ' has-preview' : '')}
          onClick={() => {
            if (preview) {
              setShowModal(true);
        ...
        <button
          type="button"
          className="btn btn-outline-secondary ms-2 image-upload-btn d-flex align-items-center justify-content-center"
