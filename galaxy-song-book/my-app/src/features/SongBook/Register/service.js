...
class RegisterService {
    constructor() {
        this.apiBase = config.apiBaseUrl + 'song-book';
    }
    ...
    async get(id) {
        const res = await axiosRequest(axios.get(`${this.apiBase}/get-song`, { params: { id } }));
        return res;
    }

    async getAll() {
        const res = await axiosRequest(axios.get(`${this.apiBase}/get-all-songs`));
        return res;
    }
