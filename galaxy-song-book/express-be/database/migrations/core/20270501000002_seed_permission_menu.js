// Adds the Permission Groups screen under the Settings menu group (id 340).
// Granted to Admin (role 1) only, since it manages access. Forward-only dev seed.

const ITEM = { id: 351, parentId: 340, route: '/settings/permission-groups', name: 'Permission Groups', icon: 'bi bi-shield-check' };
const GRANT_ROLES = [1];
