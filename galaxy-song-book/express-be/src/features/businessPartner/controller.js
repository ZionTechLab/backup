...
const BusinessPartnerModel = require('../../repository/BusinessPartnerModel');
...
exports.get = asyncHandler(async (req, res) => {
  const filters = Object.keys(req.query || {}).length ? req.query : (req.body || {});
  const data = await repo.get(filters);
...
exports.update = asyncHandler(async (req, res) => {
    ...
    const saved = await repo.update({ ...data, userId: req.userId });
