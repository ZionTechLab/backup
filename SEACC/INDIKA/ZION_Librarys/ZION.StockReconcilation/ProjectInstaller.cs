    ...
    public partial class ProjectInstaller : System.Configuration.Install.Installer
    {
        ...
        public ProjectInstaller()
        {
            try
            {
                ...
                string ServiceNAme = "SEACC Support - " ; //+ DateTime.Now.ToString("yyyyMMddhhmmss");
                this.ZionStockReconcilation.Description = "Provide auto alert, error support, and other support services";
