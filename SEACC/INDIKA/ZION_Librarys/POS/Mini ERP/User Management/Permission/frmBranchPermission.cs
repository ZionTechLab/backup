...
namespace Digiteq
{
    public partial class frmBranchPermission : Form
    {
        ...
        {
            //format Form
            clsFormatter.setFormatForm(this, "User Permission", 1,0);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //                            tbl_securityUserPermission oldRecord = tbl_securityUserPermission.Select(txtUserID.Tag.ToString(), int.Parse(sFormCode));
            //                            if (oldRecord != null)
            //                            {
            //                                tbl_securityUserPermission oldRecordNew = new tbl_securityUserPermission(txtUserID.Tag.ToString(),
            //                                   int.Parse(sFormCode), bAllowRead, bAllowWrite, bAllowDelete, bAllowApprovable, bAllowCheckable, bAllowUpdate);
            //                                oldRecordNew.Update();
            //                            }
            //                            else
            //                            {
        ...
        private void RefreshGrid_UserPermission(string sUserID)
        {
            ...
            //         sCategoryId = detail.FormCategory_ID;
            //         tbl_securityUserPermission permission = tbl_securityUserPermission.Select(sUserID, detail.Form_ID);
            //        if (permission != null)
            //        {
