...
namespace Digiteq
{
    public partial class frmDigiteqPannel : Form
    {
        ...
        //{
        //    frm_accUpdateOpeningBalances frm = new frm_accUpdateOpeningBalances();
        //    frm.MdiParent = this.MdiParent;
        //    frm.Show();
        //}
        ...
        private void btnAlert_Click(object sender, EventArgs e)
        {
            ...
            {
                clsAlerts_Email.createEmail_DONotInvoiced(enum_Alerts.SheduleAlert_DONoteInvoiced, "default");
            }
        }
