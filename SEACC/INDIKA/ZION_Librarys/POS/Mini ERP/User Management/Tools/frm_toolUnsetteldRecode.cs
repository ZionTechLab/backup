        ...
        private void btnLogon_Click(object sender, EventArgs e)
        {
            ...
            if (msgResult == DialogResult.Yes)
            {
                try
                {
                    ...
                    {
                        clsHelpMethods.RemoveSattlementsFrom_ReceiptID_OnlyCash(txtRecodeID.Text.Trim());
                    }
                    #endregion
                    ...
                    {
                        clsHelpMethods.RemoveSattlementsFrom_ReceiptID_CashAndCheque(txtRecodeID.Text.Trim());
                    }
                    #endregion
                    ...
                    {
                        clsHelpMethods.RemoveSattlementsFrom_ChequeID(txtRecodeID.Text.Trim());
                    }
                    #endregion
                    ...
                    {
                        clsHelpMethods.RemoveSattlementsFrom_InvoiceID(txtRecodeID.Text.Trim());
                    }
                    #endregion

                    if (rdoCreditNote.Checked)
                    {
                        clsHelpMethods.RemoveSattlementsFrom_CreditNoteID(txtRecodeID.Text.Trim());
                    }
