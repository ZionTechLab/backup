            ...
            else
            {
                try
                {
                    ...
                    if (path != "")
                    {
                        ...
                        connInfo.ServerName = clsSecurity.Server;
                        connInfo.DatabaseName = clsSecurity.Database;
                        connInfo.UserID = clsSecurity.UserName;
                        connInfo.Password = clsSecurity.Password;
