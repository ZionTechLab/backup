...
namespace Digiteq
{
    public partial class frm_mtrItemCategory_Sub : MettroForm
    {
        #region Variables
        ...
        #region Form Load
        public frm_mtrItemCategory_Sub()
        {
                        ...
                        try
                        {
                            ...
                            if (txtSubCategoryID.TextLength > 0)
                            {
                                if (IsUpdate)  //update records
                                {
                                    ...
                                    {
                                        //Country Header
                                        tbl_zItemCategory_Sub detail = new   tbl_zItemCategory_Sub(txtSubCategoryID.Text.Trim(), txtCategoryID.Tag.ToString(), txtSubCategoryName.Text.Trim(), "");
                                        detail.Update();
            ...
            try
            {
                if (sID.Length > 0)
                {
                    ...
                    if (detail != null)
                    {
                        ...
                        txtCategoryID.Text = clsGenaralName.getName_ItemCategory(detail.ItemCategory_ID);
                    }
                }
            }
            catch (Exception ex)
        ...
        private void txtItemSubCategory_KeyDown(object sender, KeyEventArgs e)
        {
