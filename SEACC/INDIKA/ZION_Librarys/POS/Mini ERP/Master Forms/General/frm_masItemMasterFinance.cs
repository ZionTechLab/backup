...
namespace Digiteq
{
    public partial class frm_masItemMasterFinance : MettroForm
    {
        ...
        private void Refresh_Searchlabel()
        {
            ...
            //    chkItemSubCategory1.Text = "Category No";
            //    chkPartNo.Text = "Serial No";
            //    chkRefNo.Text = "Referance No";
            //    lblCustomerName.Text = "Customer Name";
            //    label2.Text = "Branch Name";
            //    chkItemCode.Text = "Design Code";
            //}
            //else
            // {
            chkItemName.Text = "Item Name";
        ...
        private void RefreshGrid()
        {
            try
            {
                ...
                if (txtCustomer.Tag == null)
                {
                    ...
                    DataTable dtResulTable = (DBHandling.ExecQuery(sQuary).Tables[0]);
                    dtAllRecodes.Merge(dtResulTable);
                }
                else
                {
