...
namespace Digiteq
{
    public partial class frm_accPaymentVoucher : SEACC_Form
    {
                                ...
                                if (!oldRecord.IsChecked || (oldRecord.IsChecked && clsSecurity.PermissionToApproved(clsSecurity.UserIDLoged, iFormID)))
                                {
                                        ...
                                        (oldRecord.CashAmount > 0))
                                    {
                                        if (clsValidate.CheckValidity_TransactionCodeLength(txtPaymentVoucherID.Text))
                                        {
                                            ...
                                            clsHelpMethods.RemoveAPNSattlementsFrom_PaymentVoucherID(
                                            ...
                                            clsHelpMethods.AutoSettledAPN_WithCheque_PV(txtPaymentVoucherID.Text);
                    ...
                    else
                    {
                        ...
                        if (clsValidate.CheckValidity_TransactionCodeLength(txtPaymentVoucherID.Text)) //(txtPaymentVoucherID.Text.Length > 0)
                        {
                            ...
                            tbl_accPaymentVoucher detail = new tbl_accPaymentVoucher(txtPaymentVoucherID.Text.Trim(), dtpVoucherDate.Value, txtRemarks.Text.Trim(), txtNarration.Text.Trim(), txtPayee.Text.Trim(), "default", "default", txtOtherCreditor.Tag.ToString(),
                                ...
                                clsSecurity.FinancialYearID, txtCurrencyID.Tag.ToString().Trim(), decimal.Parse(txtCurrencyRate.Text.Trim()), clsHelpMethods.getSavePrice(decimal.Parse(txtCashAmount.Text.Trim()), txtCurrencyRate),
                                clsHelpMethods.getSavePrice(decimal.Parse(txtChequeAmount.Text.Trim()), txtCurrencyRate), GetPVAmount(), clsSecurity.UserIDLoged, clsSecurity.UserIDLoged, "default", "default", clsSecurity.UserIDLoged,
                            ...
                            saveDone = true;
                            clsAlerts_Email.createEmail_PV(txtPaymentVoucherID.Text.ToString(), enum_Alerts.PaymentVoucherCreated);
                        }
                        //else
                                    ...
                                    if (!detail.IsDeleted)
                                    {
                                        ...
                                        if (msgResult == DialogResult.Yes)
                                        {
                                            ...
                                            if (bstatus)
                                            {
                                                ...
                                                clsHelpMethods.RemoveAPNSattlementsFrom_PaymentVoucherID(detail.PaymentVoucher_ID);
                                                #endregion
                                                ...
                                                clsAlerts_Email.createEmail_PV(txtPaymentVoucherID.Text.ToString(), enum_Alerts.PaymentVoucherCanceled);
                                                ClearFileds();
                                            }
                                            else
            ...
            try
            {
                if (sID.Length > 0)
                {
                    ...
                    if (detail != null)
                    {
                        ...
                        txtChequeAmount.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.ChequeAmount, dExRate));
                        txtCashAmount.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.CashAmount, dExRate));
                        ...
                        foreach (tbl_accPaymentVoucher_Detail oPVD in tbl_accPaymentVoucher_Detail.SelectAllByPaymentVoucher_ID(sID))
                        {
                            ...
                            if (oPVD.AccountPayableNote_ID != "default")
                            {
                                ...
                                if (oAPN != null)
                                {
                                    ...
                                    dgvAPN["APNAmount", iRow].Value = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(oPVD.SettleAmount, dExRate));
                                }
                            }
                        ...
                        if (oPV_POs.Count > 0)
                        {
                            foreach (tbl_accPaymentVoucher_PO oPV_PO in oPV_POs)
                            {
                                if (oPV_PO != null)
                                {
                                    ...
                                    dgvPO["Amount", iRowPO].Value = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(oPV_PO.Amount, dExRate));
                                }
                            }
                        }
                        ...
                        //clsHelpMethods.SetProcessFlowAPN(detail.AccountPayableNote_ID, txtFlow2Quotation);
                    }
                }
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                if (detail != null)
                {
                    if (CheckCurrencyRate(detail.Currency_ID, detail.CurrencyRate))
                    {
                        ...
                        dgvAPN["APNAmount", iRow].Value = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.GrandTotal - detail.SettledAmount, dExRate));
        ...
        private void FillDetailByPO(string sID)
        {
            try
            {
                ...
                if (detail != null)
                {
                    ...
                    dgvPO["Amount", iRow].Value = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.GrandTotal - detail.SeattleAmount, dExRate));
                    #endregion
            ...
            try
            {
                ...
                if (detail != null)
                {
                    if (CheckCurrencyRate(detail.Currency_ID, detail.CurrencyRate))
                    {
                        ...
                        dgvAPN["APNAmount", iRow].Value = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.TotalAmount - detail.SeattleAmount, dExRate));
                        #endregion
                ...
                foreach (tbl_accChequeRegister Cdetail in Cdetails)
                {
                    if (Cdetail != null && !Cdetail.IsDeleted)
                    {
                        ...
                        if (oAcc != null)
                        {
                            ...
                            txtChequeAmount.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(chequeTotal, dExRate));
            ...
            try
            {
                ...
                if (txtPaymentVoucherID.Text.Trim().Length > 0 && txtPaymentVoucherID.Text.Trim() != "<Auto Generate>")
                {
                    ...
                    if (bPermissinOkToPrint)
                    {
                        ...
                        if (PV != null)
                        {
                            ...
                            if (bApprovalDone && bCheckingDone)
                            {
                                ...
                                if (bOkToPrint && bApprovalDone)
                                {
                                    ...
                                    #region View
                                    //if (clsConfig.sSoftwareModel.Trim() == SoftwareModel_Sales.idealWheels.ToString() || clsConfig.bActivate_paymentVoucherNotePrintingwithAccountCode)
                                    //{
                                    //    #region Data Set
                                    //    if (clsConfig.bisDataSetActive_PaymentVoucherNotePrinting)
                                    //    {
                                    ...
                                    //                string sBank = "", sAccNo = "", sCostCenter1_Name = "", sCostCenter2_Name = "";

                                    //                #region Get Cost Center Detail
                                    //                tbl_zAccCostCenter1 oCost1 = tbl_zAccCostCenter1.Select(oPv.CostCenter1_ID);
                                    //                if (oCost1 != null && oCost1.CostCenter1_ID != "default")
                                    //                    sCostCenter1_Name = oCost1.CostCenter1Name;

                                    //                tbl_zAccCostCenter2 oCost2 = tbl_zAccCostCenter2.Select(oPv.CostCenter2_ID);
                                    //                if (oCost2 != null && oCost2.CostCenter2_ID != "default")
                                    //                    sCostCenter2_Name = oCost2.CostCenter2Name;
                                    //                #endregion

                                    //                #region Header Section
                                    //                foreach (tbl_accChequeRegister ocheque in tbl_accChequeRegister.SelectAllByPaymentVoucher_ID(oPv.PaymentVoucher_ID))
                                    //                {
                                    //                    tbl_genCompanyAccount oAcc = tbl_genCompanyAccount.Select(ocheque.CompanyAccount_ID);
                                    //                    if (oAcc != null)
                                    //                    {
                                    //                        tbl_zBank oBank = tbl_zBank.Select(oAcc.Bank_ID);
                                    //                        if (ocheque != null && oAcc.Bank_ID != "default")
                                    //                            sBank = oBank.BankName;
                                    //                        sAccNo = oAcc.AccountNumber;

                                    //                        glb_dts_accPaymentVoucher.dt_accPaymentVoucher.Adddt_accPaymentVoucherRow(oPv.PaymentVoucher_ID, oPv.PaymentVoucherDate, oPv.Payee,
                                    //                            clsGenaralName.getSupplierAddressRegister(oPv.Supplier_ID), oPv.TotalAmount, clsGenaralName.getName_Customer(oPv.Customer_ID), "", "",
                                    //                            sCostCenter1_Name, sCostCenter2_Name, oPv.DatePrinted, oPv.Employee_ID, sBank, sAccNo, ocheque.ChequeRegister_ID, ocheque.ChequeNumber, ocheque.DateCheque,
                                    //                            oPv.ChequeAmount, oPv.CashAmount, oPv.IsDeleted, oPv.Narration, oPv.Remark, isDuplicate, clsCommon.CurrencyToWord(oPv.TotalAmount), oPv.Currency_ID);
                                    //                    }
                                    //                }
                                    //                #endregion

                                    //                #region Detail Section
                                    //                foreach (tbl_accPaymentVoucher_SubTotal oPVDetail in tbl_accPaymentVoucher_SubTotal.SelectAllByPaymentVoucher_ID(oPv.PaymentVoucher_ID))
                                    //                {
                                    //                    if (oPVDetail.IsCredit)
                                    //                        continue;

                                    //                    string sGlName = "";
                                    //                    tbl_accGLMaster oGlMaster = tbl_accGLMaster.Select(oPVDetail.Gl_ID);
                                    //                    if (oGlMaster != null && oGlMaster.Gl_ID != "default")
                                    //                        sGlName = oGlMaster.GlName;
                                    //                    glb_dts_accPaymentVoucher.dt_accPaymentVoucherDetail.Adddt_accPaymentVoucherDetailRow(oPVDetail.PaymentVoucher_ID, oPVDetail.Gl_ID, sGlName, "", clsGenaralName.getName_Employee(oPVDetail.Employee_ID), clsGenaralName.getName_CostCenter1(oPVDetail.CostCenter1_ID), clsGenaralName.getName_CostCenter2(oPVDetail.CostCenter2_ID), oPVDetail.Amount, oPVDetail.IsCredit, oPVDetail.Remarks);
                                    //                }
                                    //                #endregion
                                    ...
                                    //                string sRptPath = clsHelpMethods.GetReportPath(clsAutocode.getReportID(enum_ReportName.NP_PaymentVoucher));
                                    //                if (sRptPath != null)
                                    //                    print(sRptPath, " Payment Voucher ", glb_dts_accPaymentVoucher, bIsDraft, oUserData, sDuplicate, clsAutocode.getReportID(enum_ReportName.NP_PaymentVoucher));
                                    //                else
                                    //                    print("\\Reports\\ACC\\NotePrinting\\rpt_accPaymentVoucher_common_DataSet.rpt", " Payment Voucher ", glb_dts_accPaymentVoucher, bIsDraft, oUserData, sDuplicate, clsAutocode.getReportID(enum_ReportName.NP_PaymentVoucher));
                                    //            }
                                    //            catch (Exception ex)
                                    //            {
                                    //                SEACCException.Show(ex);
                                    ...
                                    //    else
                                    //    {
                                    //        string s_Path = "", sReportTitle = "PAYMENT VOUCHER", sFormula = "";
                                    //        if (txtPaymentVoucherID.TextLength > 0)
                                    //            sFormula = " {vw_rpt_accPaymentVocherOriNew.paymentVoucher_ID} =  '" + txtPaymentVoucherID.Text.Trim() + "'";
                                    //        ReportDocument RD = new ReportDocument();
                                    //        s_Path = Application.StartupPath.Replace("\\bin\\Debug", "");

                                    //        if (clsConfig.sSoftwareModel.Trim() == SoftwareModel_Sales.idealWheels.ToString())
                                    //            s_Path += "\\Reports\\ACC\\NotePrinting\\rpt_accPaymentVoucher.rpt";
                                    //        else
                                    //            s_Path += "\\Reports\\ACC\\NotePrinting\\rpt_accPaymentVoucher_common.rpt";
                                    ...
                                    //        try
                                    //        {
                                    //            RD.DataDefinition.FormulaFields["CreatedUserID"].Text = clsCommon.fncsetstring(sCreateUserID);
                                    //            RD.DataDefinition.FormulaFields["CheckedUserID"].Text = clsCommon.fncsetstring(sCheckedUserID);
                                    //            RD.DataDefinition.FormulaFields["ApprovedUserID"].Text = clsCommon.fncsetstring(sApprovedUserID);
                                    //        }
                                    //        catch { }
                                    ...
                                    //        //  List<tbl_accChequeRegister> list = tbl_accChequeRegister.SelectAllByPaymentVoucher_ID(txtPaymentVoucherID.Text.Trim());
                                    //        foreach (tbl_accChequeRegister aCheque in tbl_accChequeRegister.SelectAllByPaymentVoucher_ID(txtPaymentVoucherID.Text.Trim()))
                                    //        {
                                    //            tbl_genCompanyAccount oAcc = tbl_genCompanyAccount.Select(aCheque.CompanyAccount_ID);
                                    //            if (oAcc != null)
                                    //            {
                                    //                RD.DataDefinition.FormulaFields["Date"].Text = clsCommon.fncsetstring(aCheque.DateCheque.ToString("dd/MM/yyyy"));
                                    //                RD.DataDefinition.FormulaFields["Bank"].Text = clsCommon.fncsetstring(clsGenaralName.getName_Bank(oAcc.Bank_ID));
                                    //                RD.DataDefinition.FormulaFields["ChequeNumber"].Text = clsCommon.fncsetstring(aCheque.ChequeNumber.ToString());
                                    //                RD.DataDefinition.FormulaFields["ChequeAmount"].Text = clsCommon.fncsetstring(clsFormatter.FormatToCurrecyWithThousendSep(decimal.Parse(aCheque.ChequeAmount.ToString())));
                                    //                break;
                                    //            }
                                    //        }
                                    ...
                                    //  else
                                    {
                                        try
                                        {
                                            ...
                                            foreach (tbl_accPaymentVoucher_Detail detail in tbl_accPaymentVoucher_Detail.SelectAllByPaymentVoucher_ID(PV.PaymentVoucher_ID).Where(p => p.AccountPayableNote_ID != "default"))
                                            {
                                                ...
                                                {
                                                    glb_dts_accPaymentVoucher.dt_accPaymentVoucherAllocation.Adddt_accPaymentVoucherAllocationRow(PV.PaymentVoucher_ID, apn.AccountPayableNote_ID, apn.BillDate, clsHelpMethods.getDisplayPrice(detail.SettleAmount, txtCurrencyRate), detail.Narration);
                                            ...
                                            string sGetRptPath = clsHelpMethods.GetReportPath(clsAutocode.getReportID(enum_ReportName.NP_PaymentVoucher));
                                            string s_Path = "";
                        ...
                        clsAlerts_Email.createEmail_PV(txtPaymentVoucherID.Text.ToString(), enum_Alerts.PaymentVoucherPrinted);
                    }
                }
                else
        ...
        private bool CheckValidity_EmptyFields()
        {
            ...
            try
            {
                ...
                if (decimal.Parse(txtCashAmount.Text) != 0)
                {
                    ...
                    if (dAmount != clsHelpMethods.getSavePrice(decimal.Parse(txtCashAmount.Text), txtCurrencyRate))
                    {
                ...
                if (decimal.Parse(txtChequeAmount.Text) != 0)
                {
                    ...
                    if (dAmount != clsHelpMethods.getSavePrice(decimal.Parse(txtChequeAmount.Text), txtCurrencyRate))
                    {
        ...
        private decimal GetPVAmount()
        {
            decimal value = 0;
            if (clsCommon.isCurrency(txtChequeAmount.Text.Trim()) && decimal.Parse(txtChequeAmount.Text.ToString()) > 0)
                value = clsHelpMethods.getSavePrice(decimal.Parse(txtChequeAmount.Text.Trim()), txtCurrencyRate);
            else if (clsCommon.isCurrency(txtCashAmount.Text.Trim()) && decimal.Parse(txtCashAmount.Text.ToString()) > 0)
                value = clsHelpMethods.getSavePrice(decimal.Parse(txtCashAmount.Text.Trim()), txtCurrencyRate);
            return value;
        }
        #endregion
        ...
        private void print(string path, string sReportTitle, DataSet ojbDataSet, bool bIsDraft, InclsUserDetail oUser, string sDuplicate, string sReportID, bool bHasAPNDetails)
        {
            try
            {
                if (path != "" && path != null)
                {
                    ...
                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("HideAPNSummery", bHasAPNDetails ? "" : "Hide", true,false);

                    //isData set Actived
                    if (oUser != null)
                    {
                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CreateUserName", oUser.sCreateUser, true,false);
                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CheckUserName", oUser.sCheckedUser, true,false);
                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("ApproveUserName", oUser.sApprovedUser, true,false);
                    }
