                            ...
                            if (oGRN != null)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (clsValidate.CheckValidity_TransactionCodeLength(txtFixedAssetD.Text))// if (txtFixedAssetD.Text.Length > 0)
                                    {
                                        ...
                                        decimal dWeightedAverageCostPrice = 0;
                                        clsHelpMethods.UpdateStoreStock(iFormID, detail.AssetTransferNote_ID, detailATN.AssetTransferNoteDate, lblItemID.Text, "0", oGRN.Store_ID, 1, 0, 0, false, false, false, ref dWeightedAverageCostPrice);
                                        clsHelpMethods.UpdateStoreStock(iFormID, detail.AssetTransferNote_ID, detailATN.AssetTransferNoteDate, lblItemID.Text, "0", clsConfig.sFixedAsset_MainStore, 1, 0, 0, false, true, false, ref dWeightedAverageCostPrice);
                                ...
                                if (!detail.IsDeleted)
                                {
                                    if (CheckValidity_UpdateATN(detail.FixedAsset_Code))
                                    {
                                        ...
                                        if (msgResult == DialogResult.Yes)
                                        {
                                            ...
                                            //{
                                            //    clsHelpMethods.UpdateStoreStock(iFormID, detail.AssetTransferNote_ID, detail.AssetTransferNoteDate, oUpdatedRecore.Item_ID, "0", txtDepFrom.Tag.ToString(), 1, 0, 0, true, false, false);
                                            //    clsHelpMethods.UpdateStoreStock(iFormID, detail.AssetTransferNote_ID, detail.AssetTransferNoteDate, oUpdatedRecore.Item_ID, "0", txtDepTo.Tag.ToString(), 1, 0, 0, true, true, false);
                                            //}
                                            #endregion
