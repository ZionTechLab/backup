                                ...
                                foreach (DataGridViewRow row in dgvDetail.Rows)
                                {
                                    try
                                    {
                                        ...
                                        if (sItemCode.Length > 0)
                                        {
                                            ...
                                            decimal dWeightedAverageCostPrice = 0;
                                            clsHelpMethods.UpdateStoreStock(iFormID, detail.AssetTransferNote_ID, detail.AssetTransferNoteDate, sItemCode, "0",txtDepFrom.Tag.ToString(), 1, 0, 0, false, false, false, ref dWeightedAverageCostPrice);
                                            clsHelpMethods.UpdateStoreStock(iFormID, detail.AssetTransferNote_ID, detail.AssetTransferNoteDate, sItemCode, "0",txtDepTo.Tag.ToString(), 1, 0, 0, false, true, false, ref dWeightedAverageCostPrice);
                                        ...
                                        if (CheckValidity_Dependencies())
                                        {
                                            ...
                                            if (msgResult == DialogResult.Yes)
                                            {
                                                ...
                                                foreach (tbl_scsAssetsTransferNote_Detail oUpdatedRecore in tbl_scsAssetsTransferNote_Detail.SelectAllByAssetsTransferNote_ID(txtTransferCode.Text.Trim()))
                                                {
                                                    ...
                                                    clsHelpMethods.UpdateStoreStock(iFormID, detail.AssetTransferNote_ID, detail.AssetTransferNoteDate, oUpdatedRecore.Item_ID, "0", txtDepFrom.Tag.ToString(), 1, 0, 0, true, false, false, ref dWeightedAverageCostPrice);
                                                    clsHelpMethods.UpdateStoreStock(iFormID, detail.AssetTransferNote_ID, detail.AssetTransferNoteDate, oUpdatedRecore.Item_ID, "0", txtDepTo.Tag.ToString(), 1, 0, 0, true, true, false, ref dWeightedAverageCostPrice);
