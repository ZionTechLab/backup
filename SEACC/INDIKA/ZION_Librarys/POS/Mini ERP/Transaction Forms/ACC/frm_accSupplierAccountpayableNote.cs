    ...
    public partial class frm_accSupplierAccountpayableNote : SEACC_Form
    {
        ...
        private void Refresh_PostingEntys()
        {
            ...
            if (uC_Supplier.Supplier_ID != null && uC_Supplier.Supplier_ID != "")
            {
                ...
                decimal dAmount_VAT = clsHelpMethods.getSavePrice(uC_TotalCalc1.VatAmount, uC_ExchangeRate1.ExchangeRate);
                decimal dAmount_NBT = clsHelpMethods.getSavePrice(uC_TotalCalc1.NbtAmount, uC_ExchangeRate1.ExchangeRate);
                decimal dAmount_GrandTotal = clsHelpMethods.getSavePrice(uC_TotalCalc1.GrandTotal, uC_ExchangeRate1.ExchangeRate);
                ...
                foreach (DataRow row in newDt.Rows)
                {
                    ...
                    decimal sUnsettledAmount = clsHelpMethods.getSavePrice(clsValidate.ValidateRowValue(row, "AllocatedAmount", (decimal)0), uC_ExchangeRate1.ExchangeRate);
