                ...
                if (ValidateSave())
                {
                    ...
                    else
                    {
                        ...
                        if (clsValidate.CheckValidity_TransactionCodeLength(txtAPNID.Text)) //if (txtAPNID.Text.Trim().Length > 0)
                        {
                            ...
                            if (txtGRNNo.Text.Trim() != "" && txtGRNNo.Text.Trim() != "default")
                                clsProcessMethods.SetSettle_GRN_From_APN(txtGRNNo.Tag.ToString().Trim(), clsHelpMethods.getDisplayPrice(uC_TotalCalc1.GrandTotal, uC_ExchangeRate1.ExchangeRate));
        ...
        private bool CheckValiditySettleAmmount()
        {
            ...
            try
            {
                ...
                if (txtGRNNo.Tag != null && txtGRNNo.Tag.ToString().Trim().Length > 0 && txtGRNNo.Tag.ToString().Trim() != "default")
                    bSettoffOk = clsProcessMethods.Check_ARNTotal_With_GRNTotal(txtGRNNo.Text.ToString().Trim(), clsHelpMethods.getDisplayPrice(uC_TotalCalc1.GrandTotal - dOldGrandTotal, uC_ExchangeRate1.ExchangeRate));//dSettleAmount - dOldGrandTotal is it OK            
                else
                    bSettoffOk = true;
                        ...
                        if (oAPN != null)
                        {
                            ...
                            if (oSup != null && oAPN_SubTotals != null)
                            {
                                ...
                                if (bApprovalDone && bCheckingDone)
                                {
                                    ...
                                    sCreateUser = "[ " + clsGenaralName.getName_User(oAPN.CreateUser_ID) + " ] [ " + clsFormatter.FormatDate_SL2(oAPN.DateCreate) + " ]";
                                    if (oAPN.CheckedUser_ID != "default")
                                        sCheckedUser = "[ " + clsGenaralName.getName_User(oAPN.CheckedUser_ID) + " ] [ " + clsFormatter.FormatDate_SL2(oAPN.DateChecked) + " ]";
                                    if (oAPN.ApprovedUser_ID != "default")
                                        sApprovedUser = "[ " + clsGenaralName.getName_User(oAPN.ApprovedUser_ID) + " ] [ " + clsFormatter.FormatDate_SL2(oAPN.DateApproved) + " ]";

                                    string s_Path = "", sReportTitle = "";
                                    sReportTitle = clsHelpMethods.GetReportDisplayName(clsAutocode.getReportID(enum_ReportName.NP_AccountPayableNote));
                                    ...
                                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("HideGRNSummery", bIsAllocatedGRN ? "" : "Hide", true,false);
