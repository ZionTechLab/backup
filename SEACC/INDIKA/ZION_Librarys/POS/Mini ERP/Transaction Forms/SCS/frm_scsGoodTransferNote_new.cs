...
namespace Digiteq
{
    public partial class frm_scsGoodTransferNote_new : SEACC_Form
    {
                                    ...
                                    !oldRecord.IsDeleted && clsValidate.CheckPrintingValidity(oldRecord.PrintCount))
                                {
                                    if (clsValidate.CheckValidity_TransactionCodeLength(txtGTNID.Text))
                                    {
                                                ...
                                                txtGTNID.Text.Trim()))
                                        {
                                            ...
                                            clsHelpMethods.UpdateStoreStock(iFormID, detail.GoodTransferNote_ID,
                                        ...
                                        foreach (DataGridViewRow row in dgvDetail.Rows)
                                        {
                                            try
                                            {
                                                ...
                                                if (sItemCode.Length > 0)
                                                {
                                                    ...
                                                    //  clsHelpMethods.UpdateOrInsertStoreStock(true, true, sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2, sJobCode, txtStoreFrom.Tag.ToString(), dQuantity, dWeight, 0, 0, false, false, true);
                                                    //   clsHelpMethods.UpdateOrInsertStoreStock(true, true, sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2, sJobCode, txtStoreTo.Tag.ToString(), dQuantity, dWeight, 0, 0, false, true, true);
                                        ...
                                        foreach (tbl_scsGoodTransferNote_Detail oUpdatedRecord in tbl_scsGoodTransferNote_Detail.SelectAllByGoodTransferNote_ID(txtGTNID.Text.Trim()))
                                        {
                                            ...
                                            // clsHelpMethods.UpdateFifo_Stock(iFormID, detail.GoodTransferNote_ID, detail.GoodTransferNoteDate, detail.StoreID_From, oUpdatedRecord.Item_Code, oUpdatedRecord.ItemSerialNo, oUpdatedRecord.Qty, oUpdatedRecord.UnitPrice, false);
                                            //   clsHelpMethods.UpdateFifo_Stock(iFormID, detail.GoodTransferNote_ID, detail.GoodTransferNoteDate, detail.StoreID_To, oUpdatedRecord.Item_Code, oUpdatedRecord.ItemSerialNo, oUpdatedRecord.Qty, oUpdatedRecord.UnitPrice, true);
                                        }
                                        #endregion
                                ...
                                foreach (DataGridViewRow row in dgvDetail.Rows)
                                {
                                    try
                                    {
                                        ...
                                        if (sItemCode.Length > 0)
                                        {
                                            ...
                                            clsHelpMethods.UpdateStoreStock(iFormID, detail.GoodTransferNote_ID, detail.GoodTransferNoteDate, sItemCode, "0", txtStoreFrom.Tag.ToString(), dQuantity, dWeight, dTotalAmount, false, false, false, ref dWeightedAverageCostPrice);
                                            clsHelpMethods.UpdateStoreStock(iFormID, detail.GoodTransferNote_ID, detail.GoodTransferNoteDate, sItemCode, "0", txtStoreTo.Tag.ToString(), dQuantity, dWeight, dTotalAmount, false, true, false, ref dWeightedAverageCostPrice);
                                            
                                            //   clsHelpMethods.UpdateFifo_Stock(iFormID, detail.GoodTransferNote_ID, detail.GoodTransferNoteDate, txtStoreFrom.Tag.ToString(), items.Item_Code, items.ItemSerialNo, items.Qty, items.UnitPrice, false);
                                            //     clsHelpMethods.UpdateFifo_Stock(iFormID, detail.GoodTransferNote_ID, detail.GoodTransferNoteDate, txtStoreTo.Tag.ToString(), items.Item_Code, items.ItemSerialNo, items.Qty, items.UnitPrice, true);
                                                ...
                                                if (msgResult == DialogResult.Yes)
                                                {
                                                    ...
                                                    foreach (tbl_scsGoodTransferNote_Detail Olddetail in Olddetails)
                                                    {
                                                        if (Olddetail.Item_Code != null)
                                                        {
                                                            ...
                                                            clsHelpMethods.UpdateStoreStock(iFormID, detail.GoodTransferNote_ID, detail.GoodTransferNoteDate, Olddetail.Item_Code, "0", txtStoreFrom.Tag.ToString(), Olddetail.Qty, Olddetail.Weight, Olddetail.TatalAmount, true, false, false, ref dWeightedAverageCostPrice);
                                                            clsHelpMethods.UpdateStoreStock(iFormID, detail.GoodTransferNote_ID, detail.GoodTransferNoteDate, Olddetail.Item_Code, "0", txtStoreTo.Tag.ToString(), Olddetail.Qty, Olddetail.Weight, Olddetail.TatalAmount, true, true, false, ref dWeightedAverageCostPrice);
            ...
            try
            {
                ...
                if (oGTN != null)
                {
                    foreach (tbl_scsGoodTransferNote_Detail detail in tbl_scsGoodTransferNote_Detail.SelectAllByGoodTransferNote_ID(sGTNID))
                    {
                        ...
                        clsHelpMethods.Fill_StockDatagrid_GTN(dgvDetail, iRow, detail.Line_No, detail.Item_Code, detail.Uom, oGTN.Job_ID, "", "", "",
                            oGTN.StoreID_To, "", "", "",
        ...
        private void RefreshGridByItem_ID(string sItem_ID)
        {
            try
            {
                ...
                if (detail != null)
                {
                    ...
                    //    clsHelpMethods.Fill_StockDatagridItemGem(dgvDetail, iRow, detail.Item_ID, detail.Uom_ID, "default", "default", "default", "default",
                    ...
                    //else
                    {
                        ...
                        clsHelpMethods.Fill_StockDatagrid_GTN(dgvDetail, iRow, maxLineNo + 1, detail.Item_ID, detail.Uom_ID, "default", "default", "default", "default",
        ...
        //                clsHelpMethods.AssignSingleStockItemDetail(ref sItemCode, ref sSubCategoryID1, ref sSubCategoryID2, ref sSerialNo1, ref sSerialNo2);
        //        }
            ...
            try
            {
                ...
                foreach (DataRow row in dt_ItemGrouped.Rows)
                {
                    ...
                    if (!clsHelpMethods.IsNonInventoryItem(sItemCode))
                    {
                        ...
                        {
                            if ((clsConfig.bStockValidateQty_GTN || clsConfig.bStockValidateWeight_GTN) && !clsHelpMethods.IsNonInventoryItem(sItemCode) && (clsConfig.sSoftwareModel.Trim() != SoftwareModel_Sales.akt.ToString()))
                            {
                    ...
                    else if (e.KeyCode == Keys.F5)
                    {
                        ...
                        if (frm.lstclsTmpMultipleSelectedItems.Count > 0)
                        {
                            foreach (clsTmpMultipleSelectedItems oItem in frm.lstclsTmpMultipleSelectedItems)
                            {
                                ...
                                var maxLineNo = dgvDetail.Rows.Cast<DataGridViewRow>().Max(r => Convert.ToInt32(r.Cells["LineNo"].Value));
                                clsHelpMethods.Fill_StockDatagrid_GTN(dgvDetail, iRow, maxLineNo + 1, oItem.sItemID, oItem.sUOMID, "default", "default", "default", "default", txtStoreTo.Tag.ToString(), "default", "default", "default", "default", sNoteID, oItem.dQty, oItem.dWeight, oItem.sItemSubCategoryID, oItem.sItemSubCategoryID2, oItem.sItemSerialNo, oItem.sItemSerialNo2, "N", oItem.dUnitPrice, oItem.dTotalAmount);
                            }
                        }
                    }
                        ...
                        if (bPermissinOkToPrint)
                        {
                            ...
                            if (oGTN != null && oGTN.GoodTransferNote_ID != "default")
                            {
                                ...
                                if (bApprovalDone && bCheckingDone)
                                {
                                    ...
                                    #region Print Report
                                    string s_Path = clsHelpMethods.GetReportPath(clsAutocode.getReportID(enum_ReportName.NP_GoodsTransferNote));
                                    if (s_Path != null)
                                    {
