...
namespace Digiteq
{
    public partial class frm_scsStoreGoodReceiveNote : SEACC_Form
    {
        ...
        private void frmCustomerOrder_Load(object sender, EventArgs e)
        {
            ...
            //clsFormatter.setFormatForm(this, clsHelpMethods.getFormName(iFormID), 4, iFormID);
                                                                    ...
                                                                    if (clsValidate.CheckValidity_TransactionCodeLength(txtGoodreceivedNoteID.Text))
                                                                    {
                                                                        ...
                                                                        foreach (DataGridViewRow row in dgvDetail.Rows)
                                                                        {
                                                                            try
                                                                            {
                                                                                ...
                                                                                if (sItemCode.Length > 0)
                                                                                {
                                                                                    ...
                                                                                    //Update Store Stock                                                           
                                                                                    //clsHelpMethods.UpdateOrInsertStoreStock(clsConfig.bStockValidateQty_iGRN, clsConfig.bStockValidateWeight_iGRN, sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2,
                                                                                    ...
                                                                                    txtGoodreceivedNoteID.Text.Trim()))
                                                                        {
                                                                            ...
                                                                            clsHelpMethods.UpdateStoreStock(
                                                                                ...
                                                                                false, ref dWeightedAverageCostPrice);
                                                                            //    clsHelpMethods.UpdateFifo_Stock(iFormID, detail.StoreGoodReceiveNote_ID, detail.StoreGoodReceiveNoteDate, txtStoreID.Tag.ToString(), oUpdatedRecord.Item_ID, oUpdatedRecord.ItemSerialNo, oUpdatedRecord.Qty, oUpdatedRecord.UnitPrice, true);
                                                                        }
                                                            ...
                                                            foreach (DataGridViewRow row in dgvDetail.Rows)
                                                            {
                                                                try
                                                                {
                                                                    ...
                                                                    if (sItemCode.Length > 0)
                                                                    {
                                                                        ...
                                                                        #region Update Store Stock
                                                                        decimal dWeightedAverageCostPrice = 0;
                                                                        clsHelpMethods.UpdateStoreStock(iFormID, detail.StoreGoodReceiveNote_ID, detail.StoreGoodReceiveNoteDate, sItemCode, "0", txtLocationID.Tag.ToString(), dQuantity, dWeight, items.TotalAmount, false, true, false, ref dWeightedAverageCostPrice);
                                                                        //    clsHelpMethods.UpdateFifo_Stock(iFormID, detail.StoreGoodReceiveNote_ID, detail.StoreGoodReceiveNoteDate, detail.ToStore_ID, items.Item_ID, items.ItemSerialNo, items.Qty, items.UnitPrice, true);
        ...
        private void Print(bool bIsDraft)
        {
            try
            {
                ...
                if (txtGoodreceivedNoteID.Text.Trim().Length > 0 && txtGoodreceivedNoteID.Text.Trim() != "<Auto Generate>")
                {
                    ...
                    //            clsHelpMethods.GetLocationNameAndID_FromDeptSecStore(oGRN.FromDepartment_ID, oGRN.FromSection_ID, oGRN.FromStore_ID, ref sFromLocationID, ref sFromLocationName);
                    ...
                    try
                    {
                        ...
                        if (bPermissinOkToPrint)
                        {
                            ...
                            string sGetRptPath = clsHelpMethods.GetReportPath(clsAutocode.getReportID(enum_ReportName.NP_iGrn));
                            string sGetRptDisplayName = clsHelpMethods.GetReportDisplayName(clsAutocode.getReportID(enum_ReportName.NP_iGrn));
                            string s_Path = "";
                            ...
                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CreateUserName", sCreateUserAndDate, true, false);
                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CheckUserName", sCheckedUserAndDate, true, false);
                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("ApproveUserName", sApprovedUserAndDate, true, false);
                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("ModelRemark", sModelRemark, true, false);
                            ...
                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("isDel", oGRN.IsDeleted ? "CANCELLED" : "", true, false);
                            ...
                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("ReportTitle", sGetRptDisplayName, true, false);
                            ...
                            if (bIsDraft)
                            {
                                if (!clsConfig.isVisibleCompanyInfoInDraftPrint)
                                {
                                    ...
                                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("BisRegNo", "", true, false);
                                    ...
                                    if (!detail.IsLocked)
                                    {
                                        if (!detail.IsDeleted)
                                        {
                                            ...
                                            if (msgResult == DialogResult.Yes)
                                            {
                                                ...
                                                {
                                                    decimal dWeightedAverageCostPrice = 0;
                                                    //clsHelpMethods.UpdateStoreStock(GRNdetail.Item_ID, txtStoreID.Tag.ToString(), GRNdetail.Qty, GRNdetail.Weight, true, true);
                                                    //  clsHelpMethods_Local.RollBackFifo_Stock(iFormID, GRNdetail.StoreGoodReceiveNote_ID);
                                                    clsHelpMethods.UpdateStoreStock(iFormID, GRNdetail.StoreGoodReceiveNote_ID, detail.StoreGoodReceiveNoteDate, GRNdetail.Item_ID, "0", txtStoreID.Tag.ToString(), GRNdetail.Qty, GRNdetail.Weight, GRNdetail.TotalAmount, true, true, false, ref dWeightedAverageCostPrice);
