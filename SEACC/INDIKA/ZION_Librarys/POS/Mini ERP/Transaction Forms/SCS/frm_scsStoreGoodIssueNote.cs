...
namespace Digiteq
{
    public partial class frm_scsStoreGoodIssueNote : SEACC_Form
    {
        ...
        private void frmCustomerOrder_Load(object sender, EventArgs e)
        {
            ...
            if (glbSRNo.Length > 0)
            {
                txtISRID.Text = glbSRNo;
                FillDetailsFromSR(txtISRID.Text.Trim());
            }
        }
        #endregion
                                                                        ...
                                                                        if (!oldRecord.IsChecked || (oldRecord.IsChecked && clsSecurity.PermissionToApproved(clsSecurity.UserIDLoged, iFormID)))
                                                                        {
                                                                            if (clsValidate.CheckValidity_TransactionCodeLength(txtGoodIssueNoteID.Text))
                                                                            {
                                                                                ...
                                                                                foreach (tbl_scsStoreGoodIssueNote_Detail oUpdatedRecord in tbl_scsStoreGoodIssueNote_Detail.SelectAllByStoreGoodIssueNote_ID(txtGoodIssueNoteID.Text.Trim()))
                                                                                {
                                                                                    ...
                                                                                    clsHelpMethods.UpdateStoreStock(iFormID, oUpdatedRecord.StoreGoodIssueNote_ID, oldRecord.StoreGoodIssueNoteDate, oUpdatedRecord.Item_ID, "0", txtLocationID.Tag.ToString(), oUpdatedRecord.Qty,
                                                                                            oUpdatedRecord.Weight, oUpdatedRecord.TotalAmount, true, false, false, ref dWeightedAverageCostPrice);
                                                                                ...
                                                                                foreach (tbl_scsStoreGoodIssueNote_Detail oldGINDetail in oldGINDetails)
                                                                                {
                                                                                    ...
                                                                                    string sSrnID = clsHelpMethods.GetSelectAreaNoteID(oldGINDetail.ToSelectArea_ID, oldGINDetail.DepartmentReqositionNote_ID, oldGINDetail                                                                                                    .SectionRequisitionNote_ID, oldGINDetail.StoreRequisitionNote_ID); if (sSrnID.Trim().Length > 0 &&sSrnID.Trim().ToLower() != "default")
                                                                                    {
                                                                                        if (clsAutocode.getSelectAreaCode(SelectArea.Department) == oldGINDetail.ToSelectArea_ID)
                                                                                        {
                                                                                            foreach (tbl_scsDepartmentReqositionNote_Detail SR in tbl_scsDepartmentReqositionNote_Detail.SelectAllByDepartmentReqositionNote_ID(sSrnID).Where(p =>p.Item_ID == oldGINDetail.Item_ID && p.Line_No==oldGINDetail.Line_No))
                                                                                            {
                                                                                                SR.QtySettle -= oldGINDetail.Qty;
                                                                                                SR.WeightSettle -= oldGINDetail.Weight;
                                                                                                SR.Update(); clsProcessMethods.SetSettle_DepartmentSR(sSrnID);
                                                                                            }
                                                                                        }
                                                                                        else if (clsAutocode.getSelectAreaCode(SelectArea.Section) == oldGINDetail.ToSelectArea_ID)
                                                                                        {
                                                                                            foreach (tbl_scsSectionReqositionNote_Detail SR in tbl_scsSectionReqositionNote_Detail.SelectAllBySectionReqositionNote_ID(sSrnID).Where(p => p.Item_ID == oldGINDetail.Item_ID && p.Line_No == oldGINDetail.Line_No))
                                                                                            {
                                                                                                SR.QtySettle -= oldGINDetail.Qty;
                                                                                                SR.WeightSettle -= oldGINDetail.Weight;
                                                                                                SR.Update();
                                                                                        ...
                                                                                        else if (clsAutocode.getSelectAreaCode(SelectArea.Store) == oldGINDetail.ToSelectArea_ID)
                                                                                        {
                                                                                            foreach (tbl_scsStoreReqositionNote_Detail SR in tbl_scsStoreReqositionNote_Detail.SelectAllByStoreRecositionNote_ID(sSrnID).Where(p => p.Item_ID == oldGINDetail.Item_ID && p.Line_No == oldGINDetail.Line_No))
                                                                                            {
                                                                                                SR.QtySettle -= oldGINDetail.Qty;
                                                                                                SR.WeightSettle -= oldGINDetail.Weight;
                                                                                                SR.Update();
                                                                                ...
                                                                                foreach (DataGridViewRow row in dgvDetail.Rows)
                                                                                {
                                                                                    ...
                                                                                    string sItemCode = "", sUom = "default", sJobCode = "", sSelectArea_ID = "", sDepartment_ID = "", sSection_ID = "", sStore_ID = "",
                                                                                    sDepartmentNote_ID = "", sSectionNote_ID = "", sStoreNote_ID = "", sItemSubCategoryID1 = "", sItemSubCategoryID2 = "", sItemSerialNo1 = "", sItemSerialNo2 = "", sRemarks = "";
                                                                                    ...
                                                                                    {
                                                                                        tbl_scsStoreGoodIssueNote_Detail items = new tbl_scsStoreGoodIssueNote_Detail(iLineNo, txtGoodIssueNoteID.Text.Trim(), sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2, sJobCode, txtLocationID.Tag
                                                                                                            .ToString(), sSelectArea_ID, sDepartment_ID, sSection_ID, sStore_ID, sDepartmentNote_ID, sSectionNote_ID, sStoreNote_ID,
                                                                                        ...
                                                                                        //Update Store Stock                                                           
                                                                                        //clsHelpMethods.UpdateOrInsertStoreStock(clsConfig.bStockValidateQty_iGIN, clsConfig.bStockValidateWeight_iGIN, sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2,
                                                                                        //   sJobCode, txtLocationID.Tag.ToString(), dQuantity, dWeight, 0, 0, false, false, true);

                                                                                        #region Update SR Status

                                                                                        string sSrnID = clsHelpMethods.GetSelectAreaNoteID(sSelectArea_ID,
                                                                                                    sDepartmentNote_ID, sSectionNote_ID,
                                                                                                    sStoreNote_ID);
                                                                                        ...
                                                                                        tbl_scsInventoryTxnDetail oInventoryDetail = new tbl_scsInventoryTxnDetail(iFormID, iLineNo, 0, txtGoodIssueNoteID.Text.Trim(), dtpGINDate.Value, "", "", "", "", "default", "default", txtStoreID.Tag.ToString(),
                                                                                ...
                                                                                tbl_scsStoreGoodIssueNote detail = new tbl_scsStoreGoodIssueNote(txtGoodIssueNoteID.Text.Trim(), dtpGINDate.Value, txtRemark.Text.Trim(), txtJobID.Tag.ToString(), txtLocationID.Tag.ToString(), getSelectAriaID(), getToDepartment(), getToSection(), getToStore(), getDepartmentSRN(), getSectionSRN(), getStoreSRN(), txtOrderRefNo.Tag.ToString(), oldRecord.CreateUser_ID, clsSecurity.UserIDLoged, oldRecord.CheckedUser_ID,
                                                                                        oldRecord.ApprovedUser_ID, oldRecord.DeletedUser_ID, oldRecord.PrintedUser_ID, oldRecord.CreateTerminal_ID, clsSecurity.TerminalID, oldRecord.DeletedTerminal_ID, oldRecord.PrintedTerminal_ID, oldRecord.DateCreate, clsSecurity.getServerDateTime(), oldRecord.DateChecked, oldRecord.DateApproved, oldRecord.DateDeleted, oldRecord.DatePrinted, oldRecord.IsChecked, oldRecord.IsApproved, oldRecord.IsFinished,
                                                                                        oldRecord.IsDeleted, oldRecord.IsLocked, oldRecord.PrintCount, oldRecord.IsSeattled, ((ComboBoxItem)cmbItemPrice.SelectedItem).Value, oldRecord.CompanyID, oldRecord.CompanyBranch_ID);
                                                                                detail.Update();
                                                                                ...
                                                                                {
                                                                                    decimal dWeightedAverageCostPrice = 0;
                                                                                    clsHelpMethods.UpdateStoreStock(iFormID, detail.StoreGoodIssueNote_ID, detail.StoreGoodIssueNoteDate, oUpdatedRecord.Item_ID, "0", txtLocationID.Tag.ToString(),
                                                                                ...
                                                                                tbl_scsInventoryTxnHeader oHeader = new tbl_scsInventoryTxnHeader(iFormID, 0, txtGoodIssueNoteID.Text.Trim(), dtpGINDate.Value, txtRemark.Text.Trim(),
                                                                                        "default", "default", "default", -1, 0, "", "", "", "", false, clsSecurity.UserIDLoged);
                                                                    ...
                                                                    foreach (DataGridViewRow row in dgvDetail.Rows)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            if (sItemCode.Length > 0)
                                                                            {
                                                                                ...
                                                                                decimal dWeightedAverageCostPrice = 0;
                                                                                clsHelpMethods.UpdateStoreStock(iFormID, detail.StoreGoodIssueNote_ID, detail.StoreGoodIssueNoteDate, sItemCode, "0", txtLocationID.Tag.ToString(), dQuantity, dWeight, dTotalAmount, false, false, false, ref dWeightedAverageCostPrice);
                                                                                ...
                                                                                if (sSrnID.Trim().Length > 0 && sSrnID.Trim().ToLower() != "default")
                                                                                {
                                                                                    ...
                                                                                    {
                                                                                        foreach (tbl_scsDepartmentReqositionNote_Detail SR in tbl_scsDepartmentReqositionNote_Detail.SelectAllByDepartmentReqositionNote_ID(sSrnID).Where(p => p.Item_ID == sItemCode && p.Line_No == iLineNo))
                                                                                            if (SR != null)
                                                                                            {
                                                                                    ...
                                                                                    {
                                                                                        foreach (tbl_scsSectionReqositionNote_Detail SR in tbl_scsSectionReqositionNote_Detail.SelectAllBySectionReqositionNote_ID(sSrnID).Where(p => p.Item_ID == sItemCode && p.Line_No == iLineNo))
                                                                                        {
                                                                                            SR.QtySettle += dQuantity;
                                                                                            SR.WeightSettle += dWeight;
                                                                                            SR.Update();
                                                                                    ...
                                                                                    {
                                                                                        foreach (tbl_scsStoreReqositionNote_Detail SR in tbl_scsStoreReqositionNote_Detail.SelectAllByStoreRecositionNote_ID(sSrnID).Where(p => p.Item_ID == sItemCode && p.Line_No== iLineNo))
                                                                                        {
                                                                                            SR.QtySettle += dQuantity;
                                                                                            SR.WeightSettle += dWeight;
                                                                                            SR.Update();
                                                                                ...
                                                                                tbl_scsInventoryTxnDetail oInventoryDetail = new tbl_scsInventoryTxnDetail(iFormID, iLineNo, 0, txtGoodIssueNoteID.Text.Trim(), dtpGINDate.Value,
                                                                                                            "", "", "", "", "default", "default", txtStoreID.Tag.ToString(), sItemCode, clsGenaralName.getName_ItemUOMID(sItemCode), 0, dQuantity, dUnitPrice, 0, false);
                                                                                oListInventory.Add(oInventoryDetail);
                                                                                #endregion
                                                                            }
                                                                        }
        ...
        private void frm_scsStoreGoodIssueNote_SF_cancelButton_Click(object sender, EventArgs e)
        {
            try
            {
                                        ...
                                        if (!detail.IsDeleted)
                                        {
                                            if (!detail.IsSeattled)
                                            {
                                                ...
                                                if (msgResult == DialogResult.Yes)
                                                {
                                                    ...
                                                    foreach (tbl_scsStoreGoodIssueNote_Detail oGINdetail in tbl_scsStoreGoodIssueNote_Detail.SelectAllByStoreGoodIssueNote_ID(detail.StoreGoodIssueNote_ID))
                                                    {
                                                        #region Update Store Stock
                                                        decimal dWeightedAverageCostPrice = 0;
                                                        clsHelpMethods.UpdateStoreStock(iFormID, detail.StoreGoodIssueNote_ID, detail.StoreGoodIssueNoteDate, oGINdetail.Item_ID, "0", txtLocationID.Tag.ToString(), oGINdetail.Qty, oGINdetail.Weight, oGINdetail.TotalAmount, true, false, false, ref dWeightedAverageCostPrice);
                                                        oGINdetail.WeightedAvgCost = clsProcessMethods.GetItemWeightedAvarageCostPrice(oGINdetail.Item_ID);
                                                        oGINdetail.Update();
                                                        #endregion

                                                        foreach (tbl_scsStoreReqositionNote_Detail oStoreSR in tbl_scsStoreReqositionNote_Detail.SelectAllByStoreRecositionNote_ID(oGINdetail.StoreRequisitionNote_ID).Where(p => p.Item_ID == oGINdetail.Item_ID))
                                                        {
                                                            oStoreSR.QtySettle = oStoreSR.QtySettle - oGINdetail.Qty;
                                                            oStoreSR.WeightSettle = oStoreSR.WeightSettle - oGINdetail.Weight;
                                                            oStoreSR.Update();
                                                            clsProcessMethods.SetSettle_StoreSR(oGINdetail.StoreRequisitionNote_ID);
                                                        }

                                                        foreach (tbl_scsSectionReqositionNote_Detail oSectionSR in tbl_scsSectionReqositionNote_Detail.SelectAllBySectionReqositionNote_ID(oGINdetail.SectionRequisitionNote_ID).Where(p => p.Item_ID == oGINdetail.Item_ID))
                                                        {
                                                            oSectionSR.QtySettle = oSectionSR.QtySettle - oGINdetail.Qty;
                                                            oSectionSR.WeightSettle = oSectionSR.WeightSettle - oGINdetail.Weight;
                                                            oSectionSR.Update();
                                                            clsProcessMethods.SetSettle_SectionSR(oGINdetail.SectionRequisitionNote_ID);
                                                        }

                                                        foreach (tbl_scsDepartmentReqositionNote_Detail oDepartmentSR in tbl_scsDepartmentReqositionNote_Detail.SelectAllByDepartmentReqositionNote_ID(oGINdetail.DepartmentReqositionNote_ID))
                                                        {
                                                            oDepartmentSR.QtySettle = oDepartmentSR.QtySettle - oGINdetail.Qty;
                                                            oDepartmentSR.WeightSettle = oDepartmentSR.WeightSettle - oGINdetail.Weight;
                                                            oDepartmentSR.Update();
                                                            clsProcessMethods.SetSettle_DepartmentSR(oGINdetail.DepartmentReqositionNote_ID);
                                                        }
                                                    }
                                                    #endregion
        ...
        {
            if (txtISRID.Text.Trim().Length > 0)
                FillDetailsFromSR(txtISRID.Text.Trim());
        ...
        private void clearItamAndJobNew()
        {
            txtItemID.Tag = null;
            txtJobID.Clear();
            txtJobID.Tag = null;
        ...
        private void clearLocationFieldsNew()
        {
            txtDepartmentID.Tag = null;
            txtSectionID.Tag = null;
            txtStoreID.Tag = null;
            ...
            try
            {
                if (sID.Length > 0)
                {
                    ...
                    if (detail != null)
                    {
                        ...
                        txtISRID.Tag = detail.StoreRequisitionNote_ID;
                        ...
                        if (detail.DepartmentReqositionNote_ID != "default")
                        {
                            txtISRID.Text = clsCommon.GetForeignKeyValue(detail.DepartmentReqositionNote_ID);
                            txtISRID.Tag = clsCommon.GetForeignKeyValue(detail.DepartmentReqositionNote_ID);
                        }
                        else if (detail.SectionRequisitionNote_ID != "default")
                        {
                            txtISRID.Text = clsCommon.GetForeignKeyValue(detail.SectionRequisitionNote_ID);
                            txtISRID.Tag = clsCommon.GetForeignKeyValue(detail.SectionRequisitionNote_ID);
                        }
                        else if (detail.StoreRequisitionNote_ID != "default")
                        {
                            txtISRID.Text = clsCommon.GetForeignKeyValue(detail.StoreRequisitionNote_ID);
                            txtISRID.Tag = clsCommon.GetForeignKeyValue(detail.StoreRequisitionNote_ID);
                        }
        ...
        {
            tbl_scsDepartmentReqositionNote oSR_Department = tbl_scsDepartmentReqositionNote.Select(txtISRID.Text.Trim());
            ...
            tbl_scsSectionReqositionNote oSR_Section = tbl_scsSectionReqositionNote.Select(txtISRID.Text.Trim());
            if (oSR_Section != null)
            {
            ...
            tbl_scsStoreReqositionNote oSR_Store = tbl_scsStoreReqositionNote.Select(txtISRID.Text.Trim());
            if (oSR_Store != null)
            {
        ...
        private void FillDetailsTextBoxes(string sDepartmentID, string sSectionID, string sStoreID, string sLocationID, string sRequisitionID, string sIssueRefID, string sItemPriceCategory)
        {
            ...
            txtISRID.Text = sRequisitionID;
            txtISRID.Tag = sRequisitionID;
        ...
        private void RefreshGrid(string sGINID)
        {
            try
            {
                ...
                foreach (tbl_scsStoreGoodIssueNote_Detail detail in details)
                {
                    ...
                    string sNoteID = clsHelpMethods.GetSelectAreaNoteID(detail.ToSelectArea_ID, detail.DepartmentReqositionNote_ID, detail.SectionRequisitionNote_ID, detail.StoreRequisitionNote_ID);
                    ...
                    clsHelpMethods.Fill_StockDatagrid(dgvDetail, iRow, detail.Line_No, detail.Item_ID, detail.Uom_ID, detail.Job_ID, detail.ToSelectArea_ID, detail.ToDepartment_ID, detail.ToSection_ID,
                       ...
                       detail.ItemSerialNo2, "O", detail.UnitPrice, detail.TotalAmount, detail.Remark, 0);
            ...
            try
            {
                ...
                foreach (tbl_pmsPrePlan PrePlan in PrePlans)
                {
                    ...
                    foreach (tbl_pmsPrePlan_SectionPath_InputItem input in inputs)
                    {
                        ...
                        if (item != null)
                        {
                            clsHelpMethods.Fill_StockDatagrid(dgvDetail, iRow, input.Line_No, item.Item_ID, item.Uom_ID, sJob_ID, getSelectAriaID(), getToDepartment(), getToSection(),
        ...
        private void RefreshGridBySectionSRN_ID(string sGIN_ID)
        {
            try
            {
                ...
                foreach (tbl_scsSectionReqositionNote_Detail detail in details)
                {
                    ...
                    clsHelpMethods.Fill_StockDatagrid(dgvDetail, iRow, detail.Line_No, detail.Item_ID, detail.Uom_ID, detail.Job_ID, getSelectAriaID(), getToDepartment(),
            ...
            try
            {
                ...
                foreach (tbl_scsStoreReqositionNote_Detail detail in details)
                {
                    ...
                    if (dQty > 0 || dWeight > 0)//didnot display zero qty item
                    {
                        ...
                        clsHelpMethods.Fill_StockDatagrid(dgvDetail, iRow, detail.Line_No, detail.Item_ID, detail.Uom_ID, detail.Job_ID, detail.ToSelectArea_ID, detail.ToDepartment_ID,
        ...
        private void RefreshGridByItem_ID(string sItem_ID)
        {
            try
            {
                ...
                if (detail != null && oItemF != null)
                {
                    ...
                    clsHelpMethods.Fill_StockDatagrid(dgvDetail, iRow, maxLineNo + 1, detail.Item_ID, detail.Uom_ID, sJobID, getSelectAriaID(), getToDepartment(), getToSection(),
        ...
        private bool CheckStockValidity()
        {
            ...
            foreach (DataRow row in dt_ItemGrouped.Rows)
            {
                ...
                if (!clsHelpMethods.IsNonInventoryItem(sItemCode))
                {
                    ...
                    {
                        if ((clsConfig.bStockValidateQty_iGIN || clsConfig.bStockValidateWeight_iGIN) && !clsHelpMethods.IsNonInventoryItem(sItemCode) && (clsConfig.sSoftwareModel.Trim() != SoftwareModel_Sales.akt.ToString()))
                        {
                ...
                if (bStatus == true)
                {
                    //if (txtLocationID.Tag != null && !IsUpdate)
                    //{
                    //    if (!clsValidate.CheckValidity_StockQty(txtLocationID.Tag.ToString(), sItemCode, clsGenaralName.getName_Item(sItemCode), dtpGINDate.Value.Date, dQty, 0))
                    //    {
                    //        bStatus = false;
                    //        break;
                    //    }
        ...
        private void ValidateEmptyForeignKey()
        {
            ...
            clsCommon.ValidateForeignKey(ref txtISRID);
        }
        #endregion
        ...
        {
            clsSearch.Search_TransactionDepartmentStoreReqositionNote_Use(ref txtISRID, txtDepartmentID.Tag.ToString());
        }

        private void Search_SectionStoreReqositionNote()
        {
            clsSearch.Search_TransactionSectionStoreReqositionNote_Use(ref txtISRID, txtSectionID.Tag.ToString());
        }

        private void Search_StoreGoodReqositionNote()
        {
           clsSearch.Search_TransactionStoreReqositionNote(ref txtISRID, false, false, txtStoreID.Tag.ToString());
            if (txtISRID.Text.Trim().Length > 0)
                ...
                else if (e.KeyCode == Keys.F5)
                {
                    ...
                    if (frm.lstclsTmpMultipleSelectedItems.Count > 0)
                    {
                        foreach (clsTmpMultipleSelectedItems oItem in frm.lstclsTmpMultipleSelectedItems)
                        {
                            ...
                            string sToLocation = clsHelpMethods.getToLocationName(txtDepartmentID, txtSectionID, txtStoreID);
                            string sNoteID = "N/A";
                            decimal dFlowStockQty = clsHelpMethods.GetFlowStock_Qty(dtpGINDate.Value.Date, oItem.sItemID, txtLocationID.Tag.ToString());

                            clsHelpMethods.Fill_StockDatagrid(dgvDetail, iRow, dgvDetail.Rows.Count, oItem.sItemID, oItem.sUOMID, txtJobID.Text.Trim(), getSelectAriaID(),
        ...
        private void setEnableItems(bool Val)
        {
            ...
            clsCommon.SetEnableDisable_ForeignKeyTextboxOptional(txtISRID, Val);
        ...
        {
            string rtn = "";
            if (txtDepartmentID.Tag != null && txtDepartmentID.Tag.ToString() != "default" && txtISRID.Tag != null)
                rtn = txtISRID.Tag.ToString();
            else
                rtn = "default";
            return rtn;
        }
        ...
        {
            string rtn = "";
            if (txtSectionID.Tag != null && txtSectionID.Tag.ToString() != "default" && txtISRID.Tag != null)
                rtn = txtISRID.Tag.ToString();
            else
                rtn = "default";
            return rtn;
        ...
        {
            string rtn = "";
            if (txtStoreID.Tag != null && txtStoreID.Tag.ToString() != "default" && txtISRID.Tag != null)
                rtn = txtISRID.Tag.ToString();
            else
                rtn = "default";
            return rtn;
                ...
                if (txtGoodIssueNoteID.Text.Trim().Length > 0 && txtGoodIssueNoteID.Text.Trim() != "<Auto Generate>")
                {
                    if (clsConfig.bDataSetActive_iGIN)
                    {
                        ...
                        try
                        {
                            ...
                            if (clsHelpMethods.GetReportPath(clsAutocode.getReportID(enum_ReportName.NP_GoodsIssuedNote), ref sReportTitle_Main, ref sReportTitle_Sub, ref sReportPath))
                            {
                                Cursor = Cursors.WaitCursor;
                                ...
                                if (bPermissinOkToPrint)
                                {
                                    ...
                                    if (oIGIN != null && oIGIN.StoreGoodIssueNote_ID != "default")
                                    {
                                        ...
                                        clsHelpMethods.getLocationNameAndID_FromDeptSecStore(oIGIN.ToDepartment_ID, oIGIN.ToDepartment_ID, oIGIN.ToStore_ID, ref sFromLocationID, ref sFromLocationName);
                                        ...
                                        string sReqositionNote_ID = " - ";

                                        if (oIGIN.DepartmentReqositionNote_ID != "default")
                                        {
                                            sReqositionNote_ID = oIGIN.DepartmentReqositionNote_ID;

                                            tbl_scsDepartmentReqositionNote oDept = tbl_scsDepartmentReqositionNote.Select(sReqositionNote_ID);
                                            if (oDept != null)
                                                dtStoreRequisitionDate = oDept.DepartmentReqositionNoteDate;
                                        }
                                        else if (oIGIN.SectionRequisitionNote_ID != "default")
                                        {
                                            sReqositionNote_ID = oIGIN.SectionRequisitionNote_ID;

                                            tbl_scsSectionReqositionNote oSec = tbl_scsSectionReqositionNote.Select(sReqositionNote_ID);
                                            if (oSec != null)
                                                dtStoreRequisitionDate = oSec.SectionReqositionNoteDate;
                                        }
                                        else if (oIGIN.StoreRequisitionNote_ID != "default")
                                        {
                                            sReqositionNote_ID = oIGIN.StoreRequisitionNote_ID;

                                            tbl_scsStoreReqositionNote oStore = tbl_scsStoreReqositionNote.Select(sReqositionNote_ID);
                                            if (oStore != null)
                                        ...
                                        glb_dtsStoreGoodsIssueNote.dt_scsStoreGoodsIssueNote.Adddt_scsStoreGoodsIssueNoteRow(oIGIN.StoreGoodIssueNote_ID, oIGIN.FromStore_ID, oIGIN.Remark, oIGIN.IsDeleted,
                                            oIGIN.StoreGoodIssueNoteDate, oIGIN.DateCreate, sFromLocationID, sFromLocationName, oIGIN.FromStore_ID, clsGenaralName.getName_Store(oIGIN.FromStore_ID), sReqositionNote_ID, dtStoreRequisitionDate);
                                        ...
                                        foreach (tbl_scsStoreGoodIssueNote_Detail detail in tbl_scsStoreGoodIssueNote_Detail.SelectAllByStoreGoodIssueNote_ID(oIGIN.StoreGoodIssueNote_ID))
                                        {
                                            ...
                                            if (oItem != null)
                                            {
                                                ...
                                                clsHelpMethods.getLocationNameAndID_FromDeptSecStore(detail.ToDepartment_ID, detail.ToSection_ID, detail.ToStore_ID, ref sFromLocationID, ref sFromLocationName);
                                    ...
                                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("isDel", oIGIN.IsDeleted ? "CANCELLED" : "", true, false);
                                    ...
                                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CreateUser", sCreateUserCel, true, false);
                                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CheckUser", sCheckedUserCel, true, false);
                                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("ApprovedUser", sApprovedUserCel, true, false);
                                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("ApprovedDate", sApprovedDate, true, false);
                                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CreateDate", sCreatedate, true, false);
                                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CheckedDate", sChequeDate, true, false);
                                    #endregion
