    ...
    public partial class frm_sasCustomerOrderManuallySettleTool : MettroForm
    {
        ...
        private void Refreshgrid()
        {
            try
            {
                ...
                foreach (tbl_sasCustomerOrder detail in details.OrderBy(p=>p.CustomerOrderDate))
                {
                    dt.Rows.Add(
                        iRow,
                        detail.CustomerOrder_ID, 
                        clsGenaralName.getName_Customer(detail.Customer_ID),
                        detail.CustomerOrderDate,
                        clsFormatter.FormatDate_Short(detail.CustomerOrderDate),
     ...
     //      dt     .DefaultView.Sort = "Date_1 ASC";
