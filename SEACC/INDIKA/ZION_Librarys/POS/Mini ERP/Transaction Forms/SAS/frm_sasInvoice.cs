...
namespace Digiteq
{
    public partial class frm_sasInvoice : SEACC_Form
    {
        ...
        Font Font_Title = new Font("Courier New", 16, FontStyle.Bold);
        Font Font_Header = new Font("Courier New", 10, FontStyle.Bold);
        Font Font_Detail = new Font("Courier New", 12, FontStyle.Regular);
        Font Font_Number = new Font("Times New Roman", 12, FontStyle.Bold);
        //  string s_UnderLine = "----------------------------------------";
        int i_Yvalue = 0;
        string glb_sInvoiceNo;
                                        ...
                                        if (clsValidate.CheckValidity_TransactionCodeLength(txtInvoiceID.Text))
                                        {
                                            ...
                                            tbl_sasInvoice detail = new tbl_sasInvoice(txtInvoiceID.Text.Trim(),
                                                ...
                                                clsHelpMethods.getSavePrice(
                                                    ...
                                                    txtCurrencyRate),
                                                clsHelpMethods.getSavePrice(decimal.Parse(lblNBT.Tag.ToString()),
                                                    txtCurrencyRate),
                                                clsHelpMethods.getSavePrice(decimal.Parse(lblVAT.Tag.ToString()),
                                                    txtCurrencyRate),
                                                clsHelpMethods.getSavePrice(decimal.Parse(lblSVAT.Tag.ToString()),
                                                    txtCurrencyRate),
                                                clsHelpMethods.getSavePrice(
                        ...
                        if (clsValidate.CheckValidity_TransactionCodeLength(txtInvoiceID.Text)) //if (txtInvoiceID.TextLength > 0 && txtInvoiceID.Text.Trim() != "<Auto Generate>")
                        {
                            ...
                            if (oInvoice == null)
                            {
                                ...
                                tbl_sasInvoice detail = new tbl_sasInvoice(txtInvoiceID.Text.Trim(), "default", dtpInvoiceDate.Value, txtRemark.Text.Trim(),
                                                        ...
                                                        decimal.Parse(txtPercentageVat.Text.Trim()), decimal.Parse(txtPercentageOtherTax.Text.Trim()), clsHelpMethods.getSavePrice(decimal.Parse(txtSubTotal.Tag.ToString()), txtCurrencyRate),
                                                        clsHelpMethods.getSavePrice(decimal.Parse(txtDiscount.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(txtDisc1.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(txtDisc2.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(txtDisc3.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(txtNBT.Tag.ToString()), txtCurrencyRate),
                                                        clsHelpMethods.getSavePrice(decimal.Parse(txtVat.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(txtOtherTax.Tag.ToString()), txtCurrencyRate),
                                                        clsHelpMethods.getSavePrice(decimal.Parse(txtGrandTotal.Text.Trim()), txtCurrencyRate), decimal.Parse(txtSubTotal_Rec.Text.Trim()), decimal.Parse(txtGrandTotal_Rec.Text.Trim()), clsSecurity.UserIDLoged, clsSecurity.UserIDLoged,
                                                        ...
                                                        bIsTaxReversedInvoice, decimal.Parse(lblPercentageNBT.Text.Trim()), decimal.Parse(lblPercentageVAT.Text.Trim()), decimal.Parse(lblPercentageSVAT.Text.Trim()), clsHelpMethods.getSavePrice(decimal.Parse(lblTaxExcludingValue.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(lblNBT.Tag.ToString()), txtCurrencyRate),
                                                        clsHelpMethods.getSavePrice(decimal.Parse(lblVAT.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(lblSVAT.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(lblGrandTotal.Tag.ToString()), txtCurrencyRate), decimal.Parse(txtAdvanceReceived.Text), int.Parse(lblRoute.Tag.ToString()));
                                detail.Insert();
                                #endregion
                                ...
                                {
                                    //Email
                                    clsAlerts_Email.createEmail_Invoice(txtInvoiceID.Text.Trim(), enum_Alerts.InvoiceCreated);
                                    if (bIsOverriddenInvoice_30Days_CrExeed)
                                        clsAlerts_Email.createEmail_Warning_Alert_Exceeded_Credit_Days(txtInvoiceID.Text.Trim(), 30, enum_Alerts.Invoice_CreaditDaysExeedAlert);
                                    if (bIsOverriddenInvoice_60Days_CrExeed)
                                        clsAlerts_Email.createEmail_Warning_Alert_Exceeded_Credit_Days(txtInvoiceID.Text.Trim(), 60, enum_Alerts.Invoice_CreaditDaysExeedAlert);
                                        ...
                                        if (detail.SeattleAmount == 0)
                                        {
                                            if (!detail.IsDeleted)
                                            {
                                                ...
                                                if (msgResult == DialogResult.Yes)
                                                {
                                                    ...
                                                    //Remove Settlements Amounts
                                                    clsHelpMethods.RemoveSattlementsFrom_InvoiceID(detail.Invoice_ID);
                                                    ...
                                                    clsAlerts_Email.createEmail_Invoice(txtInvoiceID.Text.Trim(), enum_Alerts.InvoiceCanceled);
                ...
                if (txtDeliveryOrder.Tag != null && txtDeliveryOrder.Tag.ToString().Length > 0)
                {
                    ...
                    if (detail != null)
                    {
                        ...
                        if (oNoteType != null)
                        {
                            ...
                            //if (oNoteType.IsPostingEnable_VAT)
                            //{
                            //    if ((FormName)iFormID != FormName.Invoice_TAXReverced)
                            //    {
                            //        chkVat.Enabled = true;
                        ...
                        //if (oNoteType != null)
                        //{
                        //    if (oNoteType.IsPostingEnable_NBT)
                        //    {
                        //        if ((FormName)iFormID != FormName.Invoice_TAXReverced)
                        //        {
                        //            chkNBT.Enabled = true;
            ...
            try
            {
                ...
                foreach (tbl_sasCustomerOrder_Detail detail in tbl_sasCustomerOrder_Detail.SelectAllByCustomerOrder_ID(sCustomerOrderID).OrderBy(p => p.Line_No))
                {
                    ...
                    if (item != null)
                    {
                        ...
                        Fill_Datagrid(iRow, detail.Line_No, detail.Item_ID, "default", detail.CustomerOrder_ID, detail.Quotation_ID, clsHelpMethods.GetProductionJobIDByCustomerOrderID(detail.CustomerOrder_ID),
            ...
            try
            {
                ...
                if (detail != null)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        Fill_Datagrid(iRow, iRow, detail.Item_ID, "default", "default", "default", detail.ProductionJob_ID, detail.Uom_ID, dUnitPrice, 0,
                            false, 0, 0, item.Width, dAmount, item.Height, item.Thickness, item.Gusset, detail.Weight, detail.Qty, "default", "default", "0", "0", item.Description, bHasSettledBefore, dExRate);
                ...
                if (sID.Length > 0)
                {
                    ...
                    if (detail != null)
                    {
                        ...
                        if (detail.DiscountTotal1 > 0)
                        {
                            ...
                            txtDisc1.Tag = clsHelpMethods.getDisplayPrice(detail.DiscountTotal1, detail.CurrencyRate);
                            txtDisc1.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.DiscountTotal1, detail.CurrencyRate));
                        ...
                        if (detail.DiscountTotal2 > 0)
                        {
                            ...
                            txtDisc2.Tag = clsHelpMethods.getDisplayPrice(detail.DiscountTotal2, detail.CurrencyRate);
                            txtDisc2.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.DiscountTotal2, detail.CurrencyRate));
                        ...
                        if (detail.DiscountTotal3 > 0)
                        {
                            ...
                            txtDisc3.Tag = clsHelpMethods.getDisplayPrice(detail.DiscountTotal3, detail.CurrencyRate);
                            txtDisc3.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.DiscountTotal3, detail.CurrencyRate));
                        ...
                        lblTaxExcludingValue.Tag = clsHelpMethods.getDisplayPrice(detail.SubTotal_EX, detail.CurrencyRate);
                        lblTaxExcludingValue.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.SubTotal_EX, detail.CurrencyRate));
                        lblNBT.Tag = clsHelpMethods.getDisplayPrice(detail.NbtTotal_EX, detail.CurrencyRate);
                        lblNBT.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.NbtTotal_EX, detail.CurrencyRate));
                        lblVAT.Tag = clsHelpMethods.getDisplayPrice(detail.VatTotal_EX, detail.CurrencyRate);
                        lblVAT.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.VatTotal_EX, detail.CurrencyRate));
                        lblSVAT.Tag = clsHelpMethods.getDisplayPrice(detail.OtherTaxTotal_EX, detail.CurrencyRate);
                        lblSVAT.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.OtherTaxTotal_EX, detail.CurrencyRate));
                        lblGrandTotal.Text = clsFormatter.FormatToCurrecyWithThousendSep(clsHelpMethods.getDisplayPrice(detail.GrandTotal_EX, detail.CurrencyRate));
                        lblGrandTotal.Tag = clsHelpMethods.getDisplayPrice(detail.GrandTotal_EX, detail.CurrencyRate);
        ...
        {
            //if (chkNBT2.Checked && chkVAT2.Enabled)
            //    chkVAT2.Checked = true;
            ...
            try
            {
                ...
                if (txtInvoiceID.TextLength > 0 && txtInvoiceID.Text != "<Auto Generate>")
                {
                    ...
                    if (Detail != null)
                    {
                        ...
                        s_Path = clsHelpMethods.GetReportPath(sReportID);
                            ...
                            if (bCreditLimitOK) //Condition
                            {
                                if (bApprovalDone && bCheckingDone)
                                {
                                    ...
                                    if (oCustomer != null)
                                    {
                                        ...
                                        #region Invoice Detail
                                        decimal dTotall = 0;
                                        List<tbl_sasInvoice_Detail> oOrderDetails = tbl_sasInvoice_Detail.SelectAllByInvoice_ID(Detail.Invoice_ID);
                                        foreach (tbl_sasInvoice_Detail Detail1 in oOrderDetails.OrderBy(p => p.Line_No))
                                        {
                                            ...
                                            if (oUom != null && oItmaster != null)
                                            {
                                                ...
                                                if (Detail.IsWeightCalculation)
                                                {
                                                    dUnitPrice = clsHelpMethods.getDisplayPrice(Detail1.WeightPrice, Detail.CurrencyRate);
                                                    dQTY = Detail1.Weight;
                                                }
                                                else
                                                {
                                                    dUnitPrice = clsHelpMethods.getDisplayPrice(Detail1.UnitPrice, Detail.CurrencyRate);
                                                    dQTY = Detail1.Qty;
                                                }
                                                ...
                                                glb_dtsSasInvoice.dt_sasInvoice_Detail.Adddt_sasInvoice_DetailRow(Detail1.Invoice_ID, Detail1.Item_ID,
                                                    clsGenaralName.getName_Brand(oItmaster.Brand_ID), dUnitPrice, dQTY, oItmaster.ItemName, Detail1.Remark, oUom.UomCode, count, "", Detail1.DiscountPresentage, clsHelpMethods.getDisplayPrice(Detail1.DiscountAmount, Detail.CurrencyRate), clsHelpMethods.getDisplayPrice(Detail1.TatalAmount, Detail.CurrencyRate), Detail1.BIsFreeItem, clsHelpMethods.getDisplayPrice(Detail1.DiscountAmount, Detail.CurrencyRate) * dQTY, clsHelpMethods.GetPLU(oCustomer.Customer_ID, oItmaster.Item_ID));
                                            }
                                        }
                                        ...
                                        if (!Detail.IsTaxExcludedInvoice)
                                        {
                                            dNbtAmout = clsHelpMethods.getDisplayPrice(Detail.NbtTotal, Detail.CurrencyRate);
                                            dvatAmount = clsHelpMethods.getDisplayPrice(Detail.VatTotal, Detail.CurrencyRate);
                                            dSvatAmount = clsHelpMethods.getDisplayPrice(Detail.OtherTaxTotal, Detail.CurrencyRate);
                                            dGrandToatal = clsHelpMethods.getDisplayPrice(Detail.GrandTotal, Detail.CurrencyRate);
                                            dnbtPresentage = clsHelpMethods.getDisplayPrice(Detail.NbtPercentage, Detail.CurrencyRate);
                                            dVatPreasentage = clsHelpMethods.getDisplayPrice(Detail.VatPercentage, Detail.CurrencyRate);
                                            dSvatPresentage = clsHelpMethods.getDisplayPrice(Detail.OtherTaxPercentage, Detail.CurrencyRate);
                                        }
                                        else
                                        {
                                            dNbtAmout = clsHelpMethods.getDisplayPrice(Detail.NbtTotal_EX, Detail.CurrencyRate);
                                            dvatAmount = clsHelpMethods.getDisplayPrice(Detail.VatTotal_EX, Detail.CurrencyRate);
                                            dSvatAmount = clsHelpMethods.getDisplayPrice(Detail.OtherTaxTotal_EX, Detail.CurrencyRate);
                                            dSvatAmount = clsHelpMethods.getDisplayPrice(Detail.OtherTaxTotal_EX, Detail.CurrencyRate);
                                            dGrandToatal = clsHelpMethods.getDisplayPrice(Detail.GrandTotal_EX, Detail.CurrencyRate);
                                            dnbtPresentage = clsHelpMethods.getDisplayPrice(Detail.NbtPercentage_EX, Detail.CurrencyRate);
                                            dVatPreasentage = clsHelpMethods.getDisplayPrice(Detail.VatPercentage_EX, Detail.CurrencyRate);
                                            dSvatPresentage = clsHelpMethods.getDisplayPrice(Detail.OtherTaxPercentage_EX, Detail.CurrencyRate);
                                        }
                                        ...
                                        sStoreID, sStoreName, sSalesmanName, sSalesmanContact, "", "", Detail.IsDeleted, (iDoCount == 1) ? sDeliveryOrders : "", sInvoiceType, clsHelpMethods.getDisplayPrice(Detail.SubTotal, Detail.CurrencyRate),
                                            clsHelpMethods.getDisplayPrice(Detail.DiscountPercentage, Detail.CurrencyRate), clsHelpMethods.getDisplayPrice(Detail.DiscountTotal, Detail.CurrencyRate), clsHelpMethods.getDisplayPrice(Detail.SubTotal_EX, Detail.CurrencyRate),
                                            dnbtPresentage, dNbtAmout, dVatPreasentage, dvatAmount, dSvatPresentage, dSvatAmount, dGrandToatal, sCOID, clsHelpMethods.GetCustomerPurchaseOrderID(Detail.OrderRefNo_ID), sOrderNum,
                                            Detail.IsSVatInvoice ? oCustomer.SvatRegistrationNo : oCustomer.VatRegistrationNo, oCustomer.SvatRegistrationNo, oCustomer.NbtRegistrationNo, sTaxType, Detail.IsWeightCalculation, dtmDoDate,
                                                clsHelpMethods.getDisplayPrice(Detail.DiscountPercentage1, Detail.CurrencyRate), clsHelpMethods.getDisplayPrice(Detail.DiscountPercentage2, Detail.CurrencyRate),
                                                clsHelpMethods.getDisplayPrice(Detail.DiscountPercentage3, Detail.CurrencyRate), clsHelpMethods.getDisplayPrice(Detail.DiscountTotal1, Detail.CurrencyRate), clsHelpMethods.getDisplayPrice(Detail.DiscountTotal2, Detail.CurrencyRate),
                                                clsHelpMethods.getDisplayPrice(Detail.DiscountTotal3, Detail.CurrencyRate), sPoNO, Detail.TatalAmountInWord, sPoDate, sPaymentMethod, Detail.IsSVatInvoice,
                                        ...
                                        #region Parameters
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("TotalOutstanding", clsFormatter.FormatDecimalPlaces_Price(dTotalOutstanding), true,false);
                                        ...
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("DeliveryOrder2", iDoCount == 1 ? "" : sDeliveryOrders, true,false);
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("PurchaseOrderNo", sPoNO, true,false);
                                        ...
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CompanyNBT", clsCommon.getCompanyNBT(), true,false);
                                        ...
                                        try
                                        {
                                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("AmountInWord", clsCommon.CurrencyToWord(decimal.Parse(dTotall.ToString())), true,false);
                                        }
                                        catch (Exception ex)
                                        {

                                        }
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("PriceCategory", clsFill.GetItemPriceName(Detail.ItemPriceCategory), true,false);
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("BisRegNo", clsCommon.getCompanyBusinessRegisterNo(), true,false);
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("OurVATNo", clsCommon.getCompanyVAT(), true,false);
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("ReportTitle", sTaxType + " INVOICE", true,false);
                                        ...
                                        try
                                        {
                                            foreach (tbl_zDiscount oDiscounts in tbl_zDiscount.SelectAll())
                                            {
                                                ...
                                                {
                                                    case "D001":
                                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("Discount1", oDiscounts.DiscountName, true,false);
                                                        break;
                                                    case "D002":
                                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("Discount2", oDiscounts.DiscountName, true,false);
                                                        break;
                                                    case "D003":
                                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("Discount3", oDiscounts.DiscountName, true,false);
                                                        break;
                                                    default:
                                                        break;
                                                }
                                        ...
                                        if (bIsDraft)
                                        {
                                            if (!clsConfig.isVisibleCompanyInfoInDraftPrint)
                                            {
                                                ...
                                                glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CompanyVAT", "", true,false);
                                                glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CompanySVAT", "", true,false);
                                                glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CompanyEmail", "", true,false);
                                                glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CompanyNBT", "", true,false);
                                                glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CompanyWebSite", "", true,false);
                                            }
                                        }
                    ...
                    clsAlerts_Email.createEmail_Invoice(txtInvoiceID.Text.Trim(), enum_Alerts.InvoicePrinted);
                }
                else
        ...
        private void frm_sasInvoice_FormClosing(object sender, FormClosingEventArgs e)
        {
            Attachments.Close();
        }
