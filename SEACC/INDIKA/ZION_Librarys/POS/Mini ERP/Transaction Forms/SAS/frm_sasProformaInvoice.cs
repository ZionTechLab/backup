...
namespace Digiteq
{
    public partial class frm_sasProformaInvoice : SEACC_Form
    {
                                     ...
                                     clsSecurity.PermissionToApproved(clsSecurity.UserIDLoged, iFormID)))
                                {
                                    if (clsValidate.CheckValidity_TransactionCodeLength(txtProformaInvoiceID.Text))
                                    {
                                        ...
                                        tbl_sasProformaInvoice detail = new tbl_sasProformaInvoice(
                                            ...
                                            clsHelpMethods.isTaxActiveNote(txtOtherTax), "default", txtCustomerPO_No.Text);
                                        detail.Update();
                    ...
                    else  //insert records
                    {
                        ...
                        if (clsValidate.CheckValidity_TransactionCodeLength(txtProformaInvoiceID.Text)) //if (txtProformaInvoiceID.TextLength > 0)
                        {
                            ...
                            tbl_sasProformaInvoice detail = new tbl_sasProformaInvoice(txtProformaInvoiceID.Text.Trim(), dtpInvoiceDate.Value, txtRemark.Text.Trim(),
                                                    ...
                                                    false, bIsLocked, false, !chkUnitPricing.Checked, 0, false, chkReverseCalculation.Checked, chkFreeOrder.Checked, clsHelpMethods.isTaxActiveNote(txtVat), clsHelpMethods.isTaxActiveNote(txtOtherTax), "default", txtCustomerPO_No.Text);
                            detail.Insert();
                            #endregion
        ...
        private void frm_sasProformaInvoice_SF_printButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Approve the Proforma Invoice Before Print", clsFormatter.GetMessageCaption(), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        #endregion
            ...
            try
            {
                ...
                foreach (tbl_sasCustomerOrder_Detail detail in details)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        Fill_Datagrid(iRow, detail.Line_No, detail.Item_ID, detail.Quotation_ID, clsHelpMethods.GetProductionJobIDByCustomerOrderID(detail.CustomerOrder_ID),
            ...
            try
            {
                if (sID.Length > 0)
                {
                    ...
                    if (detail != null)
                    {
                        ...
                        CusDataGirdViewFormatForCalucation(dgvDetail, !chkUnitPricing.Checked);
                        glbOrderRefNo = detail.OrderRefNo_ID;
                        txtCustomerPO_No.Text = detail.CustomerPO_No;
