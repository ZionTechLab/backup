...
namespace Digiteq
{
    public partial class frm_sasInvoice2 : SEACC_Form
    {
                        ...
                        if (clsValidate.CheckValidity_TransactionCodeLength(txtInvoiceID.Text))
                        {
                            ...
                            if (oInvoice == null)
                            {
                                ...
                                tbl_sasInvoice detail = new tbl_sasInvoice(txtInvoiceID.Text.Trim(), sFormConfigCode, dtpInvoiceDate.Value, txtRemark.Text.Trim(), txtAddress.Text.Trim(), txtAmountInWord.Text.Trim(), txtCustomerID.Tag.ToString(), txtQuotationID.Tag.ToString(), txtCustomerOrderID.Tag.ToString(), txtDeliveryOrder.Tag.ToString(),
                                                        ...
                                                        decimal.Parse(txtPercentageNBT.Text.Trim()), decimal.Parse(txtPercentageVat.Text.Trim()), decimal.Parse(txtPercentageOtherTax.Text.Trim()), clsHelpMethods.getSavePrice(decimal.Parse(txtSubTotal.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(txtDiscount.Tag.ToString()), txtCurrencyRate),
                                                        clsHelpMethods.getSavePrice(decimal.Parse(txtDisc1.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(txtDisc2.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(txtDisc3.Tag.ToString()), txtCurrencyRate),
                                                        clsHelpMethods.getSavePrice(decimal.Parse(txtNBT.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(txtVat.Tag.ToString()), txtCurrencyRate), clsHelpMethods.getSavePrice(decimal.Parse(txtOtherTax.Tag.ToString()), txtCurrencyRate),
                                                        clsHelpMethods.getSavePrice(decimal.Parse(txtGrandTotal.Text.Trim()), txtCurrencyRate), 0, 0, clsSecurity.UserIDLoged, clsSecurity.UserIDLoged, "default", "default", clsSecurity.UserIDLoged, clsSecurity.UserIDLoged, clsSecurity.TerminalID, clsSecurity.TerminalID,
                        ...
                        if (clsHelpMethods.GetReportPath(sReportID, ref sReportTitle_Main, ref sReportTitle_Sub, ref sReportPath))
                        {
                            ...
                            if (oInvoice != null)
                            {
                                ...
                                if (!isDraftPrint)
                                {
                                    ...
                                    decimal dCreditBalance = clsHelpMethods.GetCustomerCreditBalance(txtCustomerID.Tag.ToString());
                                ...
                                if (bApprovalDone && bCheckingDone && bCreditLimitOK && bPermissinOkToPrintOriginal)
                                {
                                    ...
                                    if (oCustomer != null)
                                    {
                                        ...
                                        decimal dSubTotal = clsHelpMethods.getDisplayPrice(oInvoice.SubTotal, oInvoice.CurrencyRate);
                                        dDiscountTotal = clsHelpMethods.getDisplayPrice(dDiscountTotal, oInvoice.CurrencyRate);
                                        decimal dNbtAmout = clsHelpMethods.getDisplayPrice(oInvoice.NbtTotal, oInvoice.CurrencyRate);
                                        decimal dvatAmount = clsHelpMethods.getDisplayPrice(oInvoice.VatTotal, oInvoice.CurrencyRate);
                                        decimal dSvatAmount = clsHelpMethods.getDisplayPrice(oInvoice.OtherTaxTotal, oInvoice.CurrencyRate);
                                        decimal dGrandToatal = clsHelpMethods.getDisplayPrice(oInvoice.GrandTotal, oInvoice.CurrencyRate);
                                        ...
                                        glb_dtsSasInvoice.dt_sasInvoice.Adddt_sasInvoiceRow(oInvoice.Invoice_ID, oInvoice.InvoiceDate, oInvoice.Customer_ID, oCustomer.CustomerName, oCustomer.AddressRegister,
                                            oCustomer.Telephone, sBranchId, "", "", "", sSalesmanName, "", sDeliveryAddress, sDeliveryTel, oInvoice.IsDeleted,
                                                ...
                                                oInvoice.OtherTaxPercentage, dSvatAmount, dGrandToatal, oInvoice.CustomerOrder_ID, clsHelpMethods.GetCustomerPurchaseOrderID(oInvoice.OrderRefNo_ID), "",
                                                ...
                                                clsHelpMethods.getDisplayPrice(oInvoice.DiscountPercentage1, oInvoice.CurrencyRate), clsHelpMethods.getDisplayPrice(oInvoice.DiscountPercentage2,
                                                oInvoice.CurrencyRate), clsHelpMethods.getDisplayPrice(oInvoice.DiscountPercentage3, oInvoice.CurrencyRate), clsHelpMethods.getDisplayPrice(oInvoice.DiscountTotal1, oInvoice.CurrencyRate),
                                                clsHelpMethods.getDisplayPrice(oInvoice.DiscountTotal2, oInvoice.CurrencyRate), clsHelpMethods.getDisplayPrice(oInvoice.DiscountTotal3, oInvoice.CurrencyRate), sPoNO, oInvoice.TatalAmountInWord, "", "",
                                        ...
                                        #region Invoice Detail
                                        decimal dInvoiceSubTotal = clsHelpMethods.getDisplayPrice(oInvoice.SubTotal, oInvoice.CurrencyRate);
                                        foreach (tbl_sasInvoice_Detail Detail1 in tbl_sasInvoice_Detail.SelectAllByInvoice_ID(oInvoice.Invoice_ID).OrderBy(p => p.Line_No))
                                        {
                                            ...
                                            {
                                                decimal dAmount = clsHelpMethods.getDisplayPrice(Detail1.TatalAmount, oInvoice.CurrencyRate);
                                                ...
                                                oItmaster.Brand_ID, dUnitPrice, Detail1.Qty, oItmaster.ItemName, Detail1.Remark, oUom.UomCode, 0, "", Detail1.DiscountPresentage, dLineDiscount, dAmount, Detail1.BIsFreeItem, clsHelpMethods.getDisplayPrice(Detail1.DiscountAmount, oInvoice.CurrencyRate) * Detail1.Qty, clsHelpMethods.GetPLU(oCustomer.Customer_ID, oItmaster.Item_ID));
                                            }
                                        }
                                        #endregion
                                        ...
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("IsDraft", isDraftPrint ? "DRAFT" : "", true, false);
                                        ...
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CONumber", sCOID, true, false);
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("DONumber", sDOID, true, false);
                                        #endregion
        ...
        private void CusDataGridViewFormat()
        {
            ...
            //clsHelpMethods.FormatGrid_Sales(dgr_delivaryOrder);
            ...
            try
            {
                ...
                foreach (tbl_sasInvoice_Detail detail in tbl_sasInvoice_Detail.SelectAllByInvoice_ID(sInvoiceID).OrderBy(p => p.Line_No))
                {
                    ...
                    if (item != null)
                    {
                        ...
                        decimal dUnitPrice = clsHelpMethods.getDisplayPrice(detail.UnitPrice, dExRate);
                        decimal dWeightPrice = clsHelpMethods.getDisplayPrice(detail.WeightPrice, dExRate);
                        decimal dDiscountAmount = clsHelpMethods.getDisplayPrice(detail.DiscountAmount, dExRate);
                        decimal dGrossTotal = clsHelpMethods.getDisplayPrice(detail.TatalAmount, dExRate);


                        Fill_Datagrid(iRow, detail.Line_No, detail.Item_ID, detail.DeliveryOrder_ID, detail.CustomerOrder_ID, detail.Quotation_ID, detail.Job_ID, clsCommon.GetForeignKeyValue(detail.Uom_ID),
                           dUnitPrice, dWeightPrice,
                             detail.BIsFreeItem, detail.DiscountPresentage, dDiscountAmount, dGrossTotal, item.Width, item.Height, item.Thickness, item.Gusset, detail.Weight, detail.Qty, detail.ItemSubCategory_ID, detail.ItemSubCategory2_ID, detail.ItemSerialNo, detail.ItemSerialNo2, detail.Remark, bHasSettledBefore, dExRate);
                    }
                }
            }
            catch (Exception ex)
                ...
                if (oCo != null && oCo.CustomerOrder_ID != "default")
                {
                    foreach (tbl_sasCustomerOrder_Detail detail in tbl_sasCustomerOrder_Detail.SelectAllByCustomerOrder_ID(sCustomerOrderID).OrderBy(p => p.Line_No))
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            decimal dUnitPrice = clsHelpMethods.getDisplayPrice(detail.UnitPrice, oCo.CurrencyRate);
                            decimal dWeightPrice = clsHelpMethods.getDisplayPrice(detail.WeightPrice, oCo.CurrencyRate);
                            decimal dDiscountAmount = clsHelpMethods.getDisplayPrice(detail.DiscountAmount, oCo.CurrencyRate);
                            decimal dGrossTotal = clsHelpMethods.getDisplayPrice(detail.TatalAmount, oCo.CurrencyRate);
                            ...
                            Fill_Datagrid(iRow, detail.Line_No, detail.Item_ID, "default", detail.CustomerOrder_ID, detail.Quotation_ID, clsHelpMethods.GetProductionJobIDByCustomerOrderID(detail.CustomerOrder_ID),
                                item.Uom_ID, dUnitPrice, dWeightPrice, detail.BIsFreeItem, detail.DiscountPresentage,
                               dDiscountAmount, dGrossTotal, item.Width, item.Height, item.Thickness, item.Gusset, (detail.Weight - detail.WeightSettle_Invoice), (detail.Qty - detail.QtySettle_Invoice),
        ...
        private void RefreshGridByQuotationID(string sQuotaion)
        {
            ...
            {
                int iRow;
                tbl_sasQuotation oQuot = tbl_sasQuotation.Select(sQuotaion);
                if (oQuot != null && oQuot.Quotation_ID != "default")
                {
                    //dgvDetail.Rows.Clear();
                    ...
                    foreach (tbl_sasQuotation_Detail detail in details)
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            decimal dUnitPrice = clsHelpMethods.getDisplayPrice(detail.UnitPrice, oQuot.CurrencyRate);
                            decimal dWeightPrice = clsHelpMethods.getDisplayPrice(detail.WeightPrice, oQuot.CurrencyRate);
                            decimal dDiscountAmount = clsHelpMethods.getDisplayPrice(detail.DiscountAmount, oQuot.CurrencyRate);
                            decimal dGrossTotal = clsHelpMethods.getDisplayPrice(detail.TatalAmount, oQuot.CurrencyRate);

                            Fill_Datagrid(iRow, iRow, detail.Item_ID, "default", "default", detail.Quotation_ID, "default",
                                detail.Uom_ID, dUnitPrice, dWeightPrice, false, 0, 0, dGrossTotal, item.Width, item.Height, item.Thickness, item.Gusset, dWeight, dQty,
                                detail.ItemSubCategory_ID, detail.ItemSubCategory2_ID, detail.ItemSerialNo, detail.ItemSerialNo2, detail.Remark, bHasSettledBefore, dExRate);
                        }
                    }
                }
                ...
                if (oDo != null && oDo.DeliveryOrder_ID != "default")
                {
                    foreach (tbl_sasDeliveryOrder_Detail detail in tbl_sasDeliveryOrder_Detail.SelectAllByDeliveryOrder_ID(sDeliveryOrder).OrderBy(p => p.Line_No))
                    {
                        ...
                        if (oItem != null)
                        {
                            ...
                            decimal dUnitPrice = clsHelpMethods.getDisplayPrice(detail.UnitPrice, oDo.CurrencyRate);
                            decimal dWeightPrice = clsHelpMethods.getDisplayPrice(detail.WeightPrice, oDo.CurrencyRate);
                            decimal dDiscountAmount = clsHelpMethods.getDisplayPrice(detail.DiscountAmount, oDo.CurrencyRate);
                            decimal dGrossTotal = clsHelpMethods.getDisplayPrice(detail.TatalAmount, oDo.CurrencyRate);

                            Fill_Datagrid(iRow, detail.Line_No, detail.Item_ID, detail.DeliveryOrder_ID, detail.CustomerOrder_ID, detail.Quotation_ID, detail.Job_ID, oItem.Uom_ID,
                                dUnitPrice, dWeightPrice, detail.BIsFreeItem,
                                 detail.DiscountPresentage,
                              dDiscountAmount,
                                 dGrossTotal, oItem.Width, oItem.Height, oItem.Thickness, oItem.Gusset, (detail.Weight - detail.WeightSettle - detail.WeightReturned), (detail.Qty - detail.QtySettle - detail.QtyReturned),
                                detail.ItemSubCategory_ID, detail.ItemSubCategory2_ID, detail.ItemSerialNo, detail.ItemSerialNo2, detail.Remark, bHasSettledBefore, dExRate);
                        }
                    }
                }
