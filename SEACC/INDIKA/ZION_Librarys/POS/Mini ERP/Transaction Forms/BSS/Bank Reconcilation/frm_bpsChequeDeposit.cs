    ...
    public partial class frm_bpsChequeDeposit : SEACC_Form
    {
        ...
        private void RefreshGridAllForChequeDeposit()
        {
            try
            {
                ...
                dtChequeDeposit.Merge(DBHandling.ExecQuery("exec sp_PReg_ChequesToBeDeposit '" + clsSecurity.CompanyID + "','" + ((ComboBoxItem)cmbComBranch.SelectedItem).Value + "'").Tables[0]);
        ...
        private bool CheckSelectedChequeCount(DataGridView dgv)
        {
            ...
            foreach (DataGridViewRow row in dgv.Rows)
            {
                ...
                else if (dgv.Name == dgvDetail.Name && dgv["Select", row.Index].Value != null)
                {
