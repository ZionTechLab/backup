                                                            ...
                                                            if (register != null)
                                                            {
                                                                ...
                                                                else if (sStatusID == clsAutocode.getChequeStatusID(ChequeStatus.Returned_NR_C) || sStatusID == clsAutocode.getChequeStatusID(ChequeStatus.Returned_NR_O) || sStatusID == clsAutocode.getChequeStatusID(ChequeStatus.Returned_R))
                                                                {
                                                                    ...
                                                                    tbl_sasInvoice objInvoice = new tbl_sasInvoice(sDebitNoteID, "default", dtpReconciliationDateIN.Value, "Returned Cheque / Deibt Note",
                                                                         "", clsCommon.CurrencyToWord(register.Amount), register.Customer_ID, "default", "default", "default", "default", clsHelpMethods.getEmployeeIDFromReceiptID(register.Receipt_ID), register.OrderRefNo_ID, register.ChequeRegister_ID,
...
//private void btnPrintRecon_Click(object sender, EventArgs e)
//{
//    try
//    {
//        if (txtReconciliationIDIN.TextLength > 0 && txtReconciliationIDIN.Text != "<Auto Generate>")
//        {
//            Cursor = Cursors.WaitCursor;
//            string s_Path = "", sHeaderTitle = "Cheque Management Note Print", sReportTitle = "Cheque Reconciliation Note", sFormula = "";
//            if (txtReconciliationIDIN.TextLength > 0)
//                sFormula = "{vw_rpt_bpsChequeReconciliation.reconciliation_ID} =  '" + txtReconciliationIDIN.Text.Trim() + "'";

//            ReportDocument RD = new ReportDocument();
//            s_Path = Application.StartupPath.Replace("\\bin\\Debug", "");
//            s_Path += "\\reports\\rpt_bpsChequeReconciliation.rpt";
...
//        }
//        else
//            MessageBox.Show("Please Select the Reconciliation Code To Print the Reconciliation Note", clsFormatter.GetMessageCaption(), MessageBoxButtons.OK, MessageBoxIcon.Error);
//    }
//    catch (Exception ex)
//    {
//        clsValidate.WriteErrorLog("", iFormID,ex);
...
//private void btnPrintReIssue_Click(object sender, EventArgs e)
//{
//    try
//    {
//        if (txtReIssueID.TextLength > 0 && txtReIssueID.Text != "<Auto Generate>")
//        {
//            Cursor = Cursors.WaitCursor;
//            string s_Path = "", sHeaderTitle = "Cheque Management Note Print", sReportTitle = "Cheque ReIssue Note", sFormula = "";
//            if (txtReIssueID.TextLength > 0)
//                sFormula = "{vw_rpt_bpsChequeReIssue.reIssue_ID} =  '" + txtReIssueID.Text.Trim() + "'";

//            ReportDocument RD = new ReportDocument();
//            s_Path = Application.StartupPath.Replace("\\bin\\Debug", "");
//            s_Path += "\\reports\\rpt_bpsChequeReIssue.rpt";
...
//        }
//        else
//            MessageBox.Show("Please Select the ReIssue Code To Print the ReIssue Note", clsFormatter.GetMessageCaption(), MessageBoxButtons.OK, MessageBoxIcon.Error);
//    }
//    catch (Exception ex)
//    {
//        clsValidate.WriteErrorLog("", iFormID,ex);
