...
namespace SEACC_POS.Reports.NotePrint {
    ...
    public class rpt_pos_billA4_MLED : ReportClass {
        
        public rpt_pos_billA4_MLED() {
        }
        
        public override string ResourceName {
            get {
                return "rpt_pos_bill(A4)_MLED.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SEACC_POS.Reports.NotePrint.rpt_pos_bill(A4)_MLED.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedrpt_pos_billA4_MLED : Component, ICachedReport {
        
        public Cachedrpt_pos_billA4_MLED() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rpt_pos_billA4_MLED rpt = new rpt_pos_billA4_MLED();
            rpt.Site = this.Site;
            return rpt;
        }
