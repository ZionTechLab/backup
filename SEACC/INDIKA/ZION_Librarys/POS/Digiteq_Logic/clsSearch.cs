...
namespace Digiteq
{
    public class clsSearch
    {
        ...
        public static void passValue_User(bool bExceptDigiteq)
        {
            ...
            frmSearchMaster.i_ColumnWidth = new int[] { 100, 250 };
            string sCondition = "user_ID != 'default' and isBlocked = 0 and user_ID != 'AutoGenerated'";
            if (bExceptDigiteq)
        ...
        #region Security Form Category
        public static void Search_SecurityFormMaster(ref TextBox txtBox)
        {
            Form frmhelpsearch = new frmSearchMaster();
            frmSearchMaster.s_TableName = "tbl_securityFormMaster";
            frmSearchMaster.s_Columns = " form_ID [Form Code], formName [Form Name] ";
            frmSearchMaster.i_ColumnWidth = new int[] { 100, 250 };
            frmSearchMaster.e_ColomnAlignment = new enum_GridFormat[] { enum_GridFormat.TextValue, enum_GridFormat.TextValue };

            frmSearchMaster.s_Criteria = "isEnable = 1";
            frmhelpsearch.ShowDialog();
        ...
        public static void Search_TransactionPurchaseReqositionNote_Use(ref TextBox txtBox)
        {
            ...
            sCondition += "AND tbl_scsPurchaseRequisition.IsApproved='true' ";
        ...
        #region Financial ID
        //public static void passValue_FinancialID(TextBox txtBox)
        //{
        //    //passing values
        //    Form frmhelpsearch = new frmSearchMaster();
        //    frmSearchMaster.s_TableName = " tbl_accFinancialYearMaster ";
        //    frmSearchMaster.s_Columns = " financialYear_ID [Financial Year], financialYearName Title, statusID Status ";
        //    frmSearchMaster.i_ColumnWidth = new int[] { 100, 200, 50 };
        //    frmSearchMaster.e_ColomnAlignment = new enum_GridFormat[] { enum_GridFormat.TextValue, enum_GridFormat.TextValue, enum_GridFormat.TextValue };

        //    frmSearchMaster.s_Criteria = "financialYear_ID != 'default'";
        //    frmhelpsearch.ShowDialog();
        ...
        public static void Search_MasterCustomerAll(ref TextBox txtBox, bool bShowInActiveCustomers)
        {
            List<string> lstParameeters = new List<string>();
            lstParameeters.Add(clsSecurity.BranchID);
            ...
            frmSearch RowDataSearch = new frmSearch(lstParameeters);
            List<string> lstResult = RowDataSearch.Show(Search.Customer_All);
            if (RowDataSearch.DialogResult == DialogResult.OK)
            {
                txtBox.Tag = lstResult[0];
                txtBox.Text = lstResult[1];
        ...
        public static void Search_SalesExecutive(ref TextBox txtBox)
        {
            frmSearch RowDataSearch = new frmSearch();
            List<string> lstResult = RowDataSearch.Show(Search.SalesExecutive);
            if (RowDataSearch.DialogResult == DialogResult.OK)
            {
                txtBox.Tag = lstResult[0];
                txtBox.Text = lstResult[1];
        ...
        //public static void Search_TransactionItemMaster(ref TextBox txtBox)
        //{
        //    List<string> lstParameeters = new List<string>();
        //    lstParameeters.Add(clsSecurity.BranchID);
        ...
        //public static void Search_ItemMaster(ref TextBox txtBox, bool bIsDeleteOk)
        //{
        //    List<string> lstParameeters = new List<string>();
        //    frmSearch RowDataSearch = null;
        ...
        //    if (!bIsDeleteOk)
        //        //lstParameeters.Add("false");
        //        lstParameeters.Add("0");
        //    else
        //        lstParameeters.Add("");

        //    RowDataSearch = new frmSearch(lstParameeters);
        //    List<string> lstResult = RowDataSearch.Show(Search.ItemMasterInactive);
        //    if (RowDataSearch.DialogResult == DialogResult.OK)
        //    {
        //        txtBox.Tag = lstResult[0];
        //        txtBox.Text = lstResult[1];
        ...
        public static void Search_TransactionDeliveryOrder_Direct(ref TextBox txtBox, bool ShowSettled)
        {
            try
            {
                List<string> lstParameeters = new List<string>();
