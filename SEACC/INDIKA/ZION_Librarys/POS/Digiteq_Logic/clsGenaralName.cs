...
namespace Digiteq_Logic
{
    public class clsGenaralName
    {
        ...
        #region Report Item Ins Level1
        public static string getName_ReportInsItemLevel1(string ID)
        {
            string valueName = "";
            tbl_rbInsReportItem_Level_1 detail = tbl_rbInsReportItem_Level_1.Select(ID);
            if (detail != null)
                valueName = detail.ReportItem_level1Name;
            return valueName;
        }
        ...
        #region Report Ins Item Level2
        public static string getName_ReportInsItemLevel2(string ID)
        {
            string valueName = "";
            tbl_rbInsReportItem_Level_2 detail = tbl_rbInsReportItem_Level_2.Select(ID);
            if (detail != null)
                valueName = detail.ReportItem_level2Name;
            return valueName;
        }
        ...
        #region Report Ins Item
        public static string getName_ReportInsItem(string ID)
        {
            string valueName = "";
            tbl_rbInsReportItem detail = tbl_rbInsReportItem.Select(ID);
            if (detail != null)
                valueName = detail.ReportItemName;
            return valueName;
        }
