...
namespace Digiteq_Logic
{
    public class clsDB
    {
        ...
        public static void OpenConnectionTransaction()
        {
            gSqlCon = DBHandling.GetConnection();
            gSqlCon.Open();
        }

        public static void BeginTransaction()
        {
            gSqlTran = gSqlCon.BeginTransaction();
        }
        ...
        public static void CloseConnectionTransaction()
        {
            gSqlCon.Close();
        }
        ...
        public static bool ExecNonQuery(string sQuery)
        {
            SqlConnection Sqlcon = DBHandling.GetConnection();
            SqlCommand Sqlcmd = new SqlCommand();
        ...
        public static bool ExecNonQuerywithTran(ref SqlConnection sqlCon, ref SqlTransaction sqlTran, string sQuery)
        {
            //SqlConnection Sqlcon = DBHandling.GetConnection();
            SqlCommand Sqlcmd = new SqlCommand();
