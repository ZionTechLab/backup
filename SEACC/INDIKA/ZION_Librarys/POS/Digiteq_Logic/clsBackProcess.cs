    ...
    public class clsBackProcess
    {
        ...
        public static void AutoAssignConfigValue()
        {
            foreach (tbl_securityConfigValue detail in tbl_securityConfigValue.SelectAll())
            {
                ...
                else if (detail.ValueID == 655)
                    clsConfig.sClient_ID = detail.ConfigValue.Trim();
                else if (detail.ValueID == 656)
                    clsConfig.sClientScreat = detail.ConfigValue.Trim();
                else if (detail.ValueID == 657)
                    clsConfig.sBaseURL = detail.ConfigValue.Trim();
                else if (detail.ValueID == 658)
                    clsConfig.sPosMerchantURL = detail.ConfigValue.Trim();
            }
        }
        #endregion
            ...
            foreach (tbl_securityStockValidate oStock in tbl_securityStockValidate.SelectAllByCompanyBranch_ID(clsSecurity.BranchID))
            {
                switch (oStock.Form_ID)
                {
                    ...
                    case 16:// Split Note
                        ...
                        #region TO Be delete
                        //case 95://   Stock Validate Qty_Invoice
                        //    clsConfig.bStockValidateQty_Invoice = detail.ConfigValue;
                        //    break;
                        //case 96://   Stock Validate Weight_Invoice
                        //    clsConfig.bStockValidateWeight_Invoice = detail.ConfigValue;
                        //    break;
                        //case 97://   Stock Validate Qty_Inquiry
                        //    clsConfig.bStockValidateQty_Inquiry = detail.ConfigValue;
                        //    break;
                        //case 98://   Stock Validate Weight_Inquiry
                        //    clsConfig.bStockValidateWeight_Inquiry = detail.ConfigValue;
                        //    break;
                        //case 99://   Stock Validate Qty_SalesJob
                        //    clsConfig.bStockValidateQty_SalesJob = detail.ConfigValue;
                        //    break;
                        //case 100://   Stock Validate Weight_SalesJob
                        //    clsConfig.bStockValidateWeight_SalesJob = detail.ConfigValue;
                        //    break;


                        //case 101://   Stock Validate Qty_Quotation
                        //    clsConfig.bStockValidateQty_Quotation = detail.ConfigValue;
                        //    break;
                        //case 102://   Stock Validate Weight_Quotation
                        //    clsConfig.bStockValidateWeight_Quotation = detail.ConfigValue;
                        //    break;


                        //case 103://   Stock Validate Qty_CustomerOrder
                        //    clsConfig.bStockValidateQty_CustomerOrder = detail.ConfigValue;
                        //    break;
                        //case 104://   Stock Validate Weight_CustomerOrder
                        //    clsConfig.bStockValidateWeight_CustomerOrder = detail.ConfigValue;
                        //    break;


                        //case 105://   Stock Validate Qty_ProforemaInvoice
                        //    clsConfig.bStockValidateQty_ProforemaInvoice = detail.ConfigValue;
                        //    break;
                        //case 106://   Stock Validate Weight_ProforemaInvoice
                        //    clsConfig.bStockValidateWeight_ProforemaInvoice = detail.ConfigValue;
                        //    break;
                        //case 107://   Stock Validate Qty_DeliveryOrder
                        //    clsConfig.bStockValidateQty_DeliveryOrder = detail.ConfigValue;
                        //    break;
                        //case 108://   Stock Validate Weight_DeliveryOrder
                        //    clsConfig.bStockValidateWeight_DeliveryOrder = detail.ConfigValue;
                        //    break;
                        //case 109://   Stock Validate Qty_iGIN
                        //    clsConfig.bStockValidateQty_iGIN = detail.ConfigValue;
                        //    break;
                        //case 110://   Stock Validate Weight_iGIN
                        //    clsConfig.bStockValidateWeight_iGIN = detail.ConfigValue;
                        //    break;
                        //case 111://   Stock Validate Qty_iGRN
                        //    clsConfig.bStockValidateQty_iGRN = detail.ConfigValue;
                        //    break;
                        //case 112://   Stock Validate Weight_iGRN
                        //    clsConfig.bStockValidateWeight_iGRN = detail.ConfigValue;
                        //    break;

                        //case 113://   Stock Validate Qty_iSR
                        //    clsConfig.bStockValidateQty_iSR = detail.ConfigValue;
                        //    break;
                        //case 114://   Stock Validate Weight_iSR
                        //    clsConfig.bStockValidateWeight_iSR = detail.ConfigValue;
                        //    break;


                        //case 132://   Stock Validate Qty_eGIN
                        //    clsConfig.bStockValidateQty_eGIN = detail.ConfigValue;
                        //    break;
                        //case 133://   Stock Validate Weight_eGIN
                        //    clsConfig.bStockValidateWeight_eGIN = detail.ConfigValue;
                        //    break;
                        ...
                        //case 140://   Stock Validate Qty_DIN
                        //    clsConfig.bStockValidateQty_DIN = detail.ConfigValue;
                        //    break;
                        //case 141://   Stock Validate Weight_DIN
                        //    clsConfig.bStockValidateWeight_DIN = detail.ConfigValue;
                        //    break;

                        //case 142://   Stock Validate Qty_PRN
                        //    clsConfig.bStockValidateQty_PRN = detail.ConfigValue;
                        //    break;
                        //case 143://   Stock Validate Weight_PRN
                        //    clsConfig.bStockValidateWeight_PRN = detail.ConfigValue;
                        //    break;




                        //case 271://   Stock Validate Qty_GTN
                        //    clsConfig.bStockValidateQty_GTN = detail.ConfigValue;
                        //    break;
                        //case 272://   Stock Validate Weight_GTN
                        //    clsConfig.bStockValidateWeight_GTN = detail.ConfigValue;
                        //    break; 
                        #endregion
                }
            }
        ...
        public static void AutoAssignCompanyValue()
        {
            ...
            if (com != null)
            {
                ...
                {
                    clsSecurity.CompanyName = "Test Company";
                    clsSecurity.CompanyAddress1 = " - ";
                    clsSecurity.CompanyAddress2 = " - ";
                    if (com.Telephone1.Length > 0)
                        clsSecurity.CompanyAddress2 = "Tel : -";
                    if (com.Telephone2.Length > 0)
                        clsSecurity.CompanyAddress2 += " | ";
                    if (com.Fax.Length > 0)
                        clsSecurity.CompanyAddress2 += " FAX : - ";
                }
