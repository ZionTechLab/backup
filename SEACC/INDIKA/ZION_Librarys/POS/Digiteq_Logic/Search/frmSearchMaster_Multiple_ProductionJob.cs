...
namespace Digiteq
{
    public partial class frmSearchMaster_Multiple_ProductionJob : Form
    {
      ...
      //  DateTime glbCheckedDate = clsSecurity.getServerDateTime();
        ...
        public frmSearchMaster_Multiple_ProductionJob()
        {
            InitializeComponent();
        }
        ...
        private void RefreshGrid()
        {
            try
            {
                ...
                foreach (tbl_pmsProductionJobRegister detail in tbl_pmsProductionJobRegister.SelectAll().Where(p => p.ProductionJob_ID != "default" && !p.IsDeleted))
                {
                    string sStatus = detail.IsJobClosed ? "Job Closed" : "New"; 
                    dtAllRecodes.Rows.Add(false, detail.ProductionJob_ID, clsGenaralName.getName_Customer(detail.Customer_ID), sStatus);
                }
        ...
        private void CreateDataTable()
        {
            ...
            dtAllRecodes.Columns.Add("CategoryStatus", typeof(string));
            ...
            dtSelectedRecords.Columns.Add("CategoryStatus", typeof(string));
        }
        #endregion
