...
namespace SEACC_Report.Excel_DataTable
{
    ...
    {        
        ...
        public cls_sasPendingOrders_DTO(DateTime _CODate, string _CO_No, string _CustomerName, string _Branch, string _CustomerType, string _CustomerCategory,
            string _SalesRep, string _ItemCode, string _ItemDescription, decimal _COQty, decimal _DOQty, decimal _BalQty, decimal _SellingPrice, 
            decimal _DiscountPercentage, decimal _DiscountAmount, DateTime _DeliveryDate, decimal _NetPrice, decimal _PendingTotal)
        {            
            CODate = _CODate;
            CONo = _CO_No;
