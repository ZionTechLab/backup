	...
	public sealed class tbl_scsStoreGoodReceiveNote {
		...
		private static tbl_scsStoreGoodReceiveNote Maketbl_scsStoreGoodReceiveNote(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(27) == false) {
				tbl_scsStoreGoodReceiveNote.ItemPriceCategory = dataReader.GetString(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_scsStoreGoodReceiveNote.CompanyID = dataReader.GetString(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_scsStoreGoodReceiveNote.CompanyBranch_ID = dataReader.GetString(29);
			}
