...
namespace DataTire {
	public sealed class tbl_bpsReceipt {
        ...
        public static void DeleteAllByCustomer_ID(string customer_ID)
        {
            ...
            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_bpsReceiptDeleteAllByCustomer_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
        ...
        public static void DeleteAllByCompanyID(string companyID)
        {
            ...
            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_bpsReceiptDeleteAllByCompanyID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
        ...
        public static void DeleteAllByInvoice_ID(string invoice_ID)
        {
            ...
            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_bpsReceiptDeleteAllByInvoice_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
        ...
        public static void DeleteAllByCompanyBranch_ID(string companyBranch_ID)
        {
            ...
            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_bpsReceiptDeleteAllByCompanyBranch_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
        ...
        /// Selects all records from the tbl_bpsReceipt table by a foreign key.
        /// </summary>
        public static List<tbl_bpsReceipt> SelectAllByCompanyID(string companyID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_bpsReceiptSelectAllByCompanyID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
