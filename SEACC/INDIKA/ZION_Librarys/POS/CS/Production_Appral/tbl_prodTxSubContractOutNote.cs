...
namespace DataTire {
	public sealed class tbl_prodTxSubContractOutNote {
		#region Fields
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_prodTxSubContractOutNote table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_prodTxSubContractOutNote table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_prodTxSubContractOutNote table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static void DeleteAllByRelease_Dept_ID(string release_Dept_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDeleteAllByRelease_Dept_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByApprovedUser_ID(string approvedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDeleteAllByApprovedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCanceldUser_ID(string canceldUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDeleteAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCreateUser_ID(string createUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDeleteAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCheckedUser_ID(string checkedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDeleteAllByCheckedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByModifiedUser_ID(string modifiedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDeleteAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCompanyBranchID(string companyBranchID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDeleteAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCompanyID(string companyID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDeleteAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByRelease_Section_ID(string release_Section_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDeleteAllByRelease_Section_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllBySupplier_ID(string supplier_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteDeleteAllBySupplier_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_prodTxSubContractOutNote table.
		/// </summary>
		public static tbl_prodTxSubContractOutNote Select(string subOut_ID_Incoming){

			tbl_prodTxSubContractOutNote tbl_prodTxSubContractOutNoteins = new tbl_prodTxSubContractOutNote();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_prodTxSubContractOutNoteins = Maketbl_prodTxSubContractOutNote(dataReader);
				} else {
					tbl_prodTxSubContractOutNoteins = null;
				}
			}
			scon.Close();
			return tbl_prodTxSubContractOutNoteins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prodTxSubContractOutNote table.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_prodTxSubContractOutNote> tbl_prodTxSubContractOutNoteList = new List<tbl_prodTxSubContractOutNote>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_prodTxSubContractOutNote tbl_prodTxSubContractOutNote = Maketbl_prodTxSubContractOutNote(dataReader);
					tbl_prodTxSubContractOutNoteList.Add(tbl_prodTxSubContractOutNote);
				}
			}
			scon.Close();
			return tbl_prodTxSubContractOutNoteList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAllByRelease_Dept_ID(string release_Dept_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAllByRelease_Dept_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAllByApprovedUser_ID(string approvedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAllByApprovedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAllByCanceldUser_ID(string canceldUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAllByCreateUser_ID(string createUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAllByCheckedUser_ID(string checkedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAllByCheckedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAllByModifiedUser_ID(string modifiedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAllByCompanyBranchID(string companyBranchID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAllByCompanyID(string companyID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAllByRelease_Section_ID(string release_Section_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAllByRelease_Section_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxSubContractOutNote table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxSubContractOutNote> SelectAllBySupplier_ID(string supplier_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxSubContractOutNoteSelectAllBySupplier_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_prodTxSubContractOutNote class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_prodTxSubContractOutNote Maketbl_prodTxSubContractOutNote(SqlDataReader dataReader) {
			tbl_prodTxSubContractOutNote tbl_prodTxSubContractOutNote = new tbl_prodTxSubContractOutNote();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_prodTxSubContractOutNote.SubOut_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_prodTxSubContractOutNote.SubOut_Date = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_prodTxSubContractOutNote.Release_Dept_ID = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_prodTxSubContractOutNote.Release_Section_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_prodTxSubContractOutNote.Supplier_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_prodTxSubContractOutNote.Remark = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_prodTxSubContractOutNote.IsChecked = dataReader.GetBoolean(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_prodTxSubContractOutNote.IsApproved = dataReader.GetBoolean(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_prodTxSubContractOutNote.IsCanceled = dataReader.GetBoolean(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_prodTxSubContractOutNote.CreateUser_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_prodTxSubContractOutNote.ModifiedUser_ID = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_prodTxSubContractOutNote.CheckedUser_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_prodTxSubContractOutNote.ApprovedUser_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_prodTxSubContractOutNote.CanceldUser_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_prodTxSubContractOutNote.DateCreate = dataReader.GetDateTime(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_prodTxSubContractOutNote.DateModified = dataReader.GetDateTime(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_prodTxSubContractOutNote.DateChecked = dataReader.GetDateTime(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_prodTxSubContractOutNote.DateApproved = dataReader.GetDateTime(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_prodTxSubContractOutNote.DateCanceled = dataReader.GetDateTime(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_prodTxSubContractOutNote.CreateUserTerminal_ID = dataReader.GetString(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_prodTxSubContractOutNote.ModifiedUserTerminal_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_prodTxSubContractOutNote.CheckedUserTerminal_ID = dataReader.GetString(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_prodTxSubContractOutNote.ApprovedUserTerminal_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_prodTxSubContractOutNote.CanceledUserTerminal_ID = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_prodTxSubContractOutNote.CompanyID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_prodTxSubContractOutNote.CompanyBranchID = dataReader.GetString(25);
			}

			return tbl_prodTxSubContractOutNote;
		}
		/// <summary>
		/// This makes tbl_prodTxSubContractOutNote datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_prodTxSubContractOutNote object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_prodTxSubContractOutNote  tbl_prodTxSubContractOutNote   )
		{
		...
		/// <summary>
		/// This fills tbl_prodTxSubContractOutNote datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_prodTxSubContractOutNote object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_prodTxSubContractOutNote user) {
