...
namespace DataTire
{
	public sealed class tbl_securityConfigForms {
		...
		/// Initializes a new instance of the tbl_securityConfigForms class.
		/// </summary>
		public tbl_securityConfigForms(string configForm_ID, int counter, string configName, int length, string prefix1, string seperator1, string prefix2, string seperator2, bool isAutoGenerate, int serialType, string documentCode, string txnCode) {
		...
		/// <summary>
		/// Gets or sets the SerialType value.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the TxnCode value.
		/// </summary>
		...
		public void Insert() {
			...
			scom.Parameters.Add("@serialType", SqlDbType.Int,4);
			scom.Parameters.Add("@documentCode", SqlDbType.VarChar,4);
			scom.Parameters.Add("@txnCode", SqlDbType.VarChar,4);
			...
			scom.Parameters["@serialType"].Value = serialType;
			scom.Parameters["@documentCode"].Value = documentCode;
			scom.Parameters["@txnCode"].Value = txnCode;
		...
		private static tbl_securityConfigForms Maketbl_securityConfigForms(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(9) == false) {
				tbl_securityConfigForms.SerialType = dataReader.GetInt32(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_securityConfigForms.DocumentCode = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_securityConfigForms.TxnCode = dataReader.GetString(11);
			}
		...
		DataTable dt = new DataTable();
			...
			DataColumn col_serialType = new DataColumn("serialType" , typeof(int));
			DataColumn col_documentCode = new DataColumn("documentCode" , typeof(string));
			DataColumn col_txnCode = new DataColumn("txnCode" , typeof(string));
		dt.Columns.AddRange(new DataColumn[] { col_configForm_ID,col_counter,col_configName,col_length,col_prefix1,col_seperator1,col_prefix2,col_seperator2,col_isAutoGenerate,col_serialType,col_documentCode,col_txnCode,});		return dt;
		}
		/// <summary>
		...
		DataRow drow = dt.NewRow();
			...
			drow["serialType"] = user.serialType;
			drow["documentCode"] = user.documentCode;
			drow["txnCode"] = user.txnCode;
		dt.Rows.Add(drow);
		}
		#endregion
	}
