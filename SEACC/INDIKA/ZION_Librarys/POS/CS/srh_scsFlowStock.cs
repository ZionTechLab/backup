...
namespace DataTire
{
    public sealed class srh_scsFlowStock
    {
        ...
        /// </summary>
        public static List<srh_scsFlowStock> Select(DateTime toDate, string item_ID,string isDeleted, string companyBranch_ID,bool showServiseItems)
        {
            ...
            scom.Parameters.Add("@ShowServisitems", SqlDbType.VarChar);
            scom.Parameters["@ShowServisitems"].Value = showServiseItems;
