...
namespace DataTire {
	public sealed class tbl_genItemMaster {
		...
		/// Selects all records from the tbl_genItemMaster table by a foreign key.
		/// </summary>
		public static void DeleteAllByTag1_ID(string tag1_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterDeleteAllByTag1_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		/// Selects all records from the tbl_genItemMaster table by a foreign key.
		/// </summary>
		public static void DeleteAllByTag2_ID(string tag2_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterDeleteAllByTag2_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		/// Selects all records from the tbl_genItemMaster table by a foreign key.
		/// </summary>
		public static void DeleteAllByRoleType_ID(string roleType_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterDeleteAllByRoleType_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByUom_ID(string uom_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterDeleteAllByUom_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByMeasureType_ID(string measureType_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterDeleteAllByMeasureType_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItemCategorySub_ID(string itemCategorySub_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterDeleteAllByItemCategorySub_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		/// Selects all records from the tbl_genItemMaster table by a foreign key.
		/// </summary>
		public static List<tbl_genItemMaster> SelectAllByTag1_ID(string tag1_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterSelectAllByTag1_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
        ...
        public static List<tbl_genItemMaster> SelectAllByCompanyBranch_ID(string companyBranch_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_genItemMasterSelectAllByCompanyBranch_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
		...
		/// Selects all records from the tbl_genItemMaster table by a foreign key.
		/// </summary>
		public static List<tbl_genItemMaster> SelectAllByTag2_ID(string tag2_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterSelectAllByTag2_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genItemMaster table by a foreign key.
		/// </summary>
		public static List<tbl_genItemMaster> SelectAllByRoleType_ID(string roleType_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterSelectAllByRoleType_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genItemMaster table by a foreign key.
		/// </summary>
		public static List<tbl_genItemMaster> SelectAllByUom_ID(string uom_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterSelectAllByUom_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genItemMaster table by a foreign key.
		/// </summary>
		public static List<tbl_genItemMaster> SelectAllByMeasureType_ID(string measureType_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterSelectAllByMeasureType_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genItemMaster table by a foreign key.
		/// </summary>
		public static List<tbl_genItemMaster> SelectAllByItemCategorySub_ID(string itemCategorySub_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMasterSelectAllByItemCategorySub_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
