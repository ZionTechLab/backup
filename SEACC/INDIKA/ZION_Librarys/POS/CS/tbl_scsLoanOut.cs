...
namespace DataTire {
	public sealed class tbl_scsLoanOut {
		#region Fields
		private string loanOut_ID;
		private DateTime loanOutDate;
		...
		/// <summary>
		/// Gets or sets the LoanOutDate value.
		/// </summary>
		public DateTime LoanOutDate {
			get { return loanOutDate; }
			set { loanOutDate = value; }
		}
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_scsLoanOut table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutInsert", scon);
			scom.CommandType = CommandType.StoredProcedure;
 
 
			scom.Parameters.Add("@loanOut_ID", SqlDbType.VarChar,20);
			scom.Parameters.Add("@loanOutDate", SqlDbType.DateTime,8);
			...
			scom.Parameters["@loanOutDate"].Value = loanOutDate;
		...
		/// <summary>
		/// Updates a record in the tbl_scsLoanOut table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_scsLoanOut table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_scsLoanOut table by a foreign key.
		/// </summary>
		public static void DeleteAllBySupplier_ID(string supplier_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutDeleteAllBySupplier_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByIssuedRefNo_ID(string issuedRefNo_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutDeleteAllByIssuedRefNo_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCustomer_ID(string customer_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutDeleteAllByCustomer_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_scsLoanOut table.
		/// </summary>
		public static tbl_scsLoanOut Select(string loanOut_ID_Incoming){

			tbl_scsLoanOut tbl_scsLoanOutins = new tbl_scsLoanOut();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_scsLoanOutins = Maketbl_scsLoanOut(dataReader);
				} else {
					tbl_scsLoanOutins = null;
				}
			}
			scon.Close();
			return tbl_scsLoanOutins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsLoanOut table.
		/// </summary>
		public static List<tbl_scsLoanOut> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_scsLoanOut> tbl_scsLoanOutList = new List<tbl_scsLoanOut>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_scsLoanOut tbl_scsLoanOut = Maketbl_scsLoanOut(dataReader);
					tbl_scsLoanOutList.Add(tbl_scsLoanOut);
				}
			}
			scon.Close();
			return tbl_scsLoanOutList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsLoanOut table by a foreign key.
		/// </summary>
		public static List<tbl_scsLoanOut> SelectAllBySupplier_ID(string supplier_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutSelectAllBySupplier_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsLoanOut table by a foreign key.
		/// </summary>
		public static List<tbl_scsLoanOut> SelectAllByIssuedRefNo_ID(string issuedRefNo_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutSelectAllByIssuedRefNo_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsLoanOut table by a foreign key.
		/// </summary>
		public static List<tbl_scsLoanOut> SelectAllByCustomer_ID(string customer_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanOutSelectAllByCustomer_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_scsLoanOut class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_scsLoanOut Maketbl_scsLoanOut(SqlDataReader dataReader) {
			tbl_scsLoanOut tbl_scsLoanOut = new tbl_scsLoanOut();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_scsLoanOut.LoanOut_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_scsLoanOut.LoanOutDate = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_scsLoanOut.Remark = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_scsLoanOut.ReceiverName = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_scsLoanOut.IssuedRefNo_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_scsLoanOut.Store_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_scsLoanOut.Supplier_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_scsLoanOut.Customer_ID = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_scsLoanOut.TotalUnitPrice = dataReader.GetDecimal(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_scsLoanOut.TotalWeightPrice = dataReader.GetDecimal(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_scsLoanOut.TotalQty = dataReader.GetDecimal(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_scsLoanOut.TotalWeight = dataReader.GetDecimal(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_scsLoanOut.CreateUser_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_scsLoanOut.ModifiedUser_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_scsLoanOut.CheckedUser_ID = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_scsLoanOut.ApprovedUser_ID = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_scsLoanOut.DeletedUser_ID = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_scsLoanOut.PrintedUser_ID = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_scsLoanOut.CreateTerminal_ID = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_scsLoanOut.ModifiedTerminal_ID = dataReader.GetString(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_scsLoanOut.DeletedTerminal_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_scsLoanOut.PrintedTerminal_ID = dataReader.GetString(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_scsLoanOut.DateCreate = dataReader.GetDateTime(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_scsLoanOut.DateModified = dataReader.GetDateTime(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_scsLoanOut.DateChecked = dataReader.GetDateTime(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_scsLoanOut.DateApproved = dataReader.GetDateTime(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_scsLoanOut.DateDeleted = dataReader.GetDateTime(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_scsLoanOut.DatePrinted = dataReader.GetDateTime(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_scsLoanOut.IsChecked = dataReader.GetBoolean(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_scsLoanOut.IsApproved = dataReader.GetBoolean(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_scsLoanOut.IsFinished = dataReader.GetBoolean(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_scsLoanOut.IsDeleted = dataReader.GetBoolean(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_scsLoanOut.IsLocked = dataReader.GetBoolean(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_scsLoanOut.IsSeattled = dataReader.GetBoolean(33);
			}
			if (dataReader.IsDBNull(34) == false) {
				tbl_scsLoanOut.SeattleAmount = dataReader.GetDecimal(34);
			}
			if (dataReader.IsDBNull(35) == false) {
				tbl_scsLoanOut.PrintCount = dataReader.GetInt32(35);
			}
			if (dataReader.IsDBNull(36) == false) {
				tbl_scsLoanOut.IsForSupplier = dataReader.GetBoolean(36);
			}
			if (dataReader.IsDBNull(37) == false) {
				tbl_scsLoanOut.IsForOther = dataReader.GetBoolean(37);
			}
			if (dataReader.IsDBNull(38) == false) {
				tbl_scsLoanOut.IsForCustomer = dataReader.GetBoolean(38);
			}
			if (dataReader.IsDBNull(39) == false) {
				tbl_scsLoanOut.IsWeightCalculation = dataReader.GetBoolean(39);
			}
			if (dataReader.IsDBNull(40) == false) {
				tbl_scsLoanOut.IsFirstDocument = dataReader.GetBoolean(40);
			}
			if (dataReader.IsDBNull(41) == false) {
				tbl_scsLoanOut.CompanyID = dataReader.GetString(41);
			}
			if (dataReader.IsDBNull(42) == false) {
				tbl_scsLoanOut.CompanyBranch_ID = dataReader.GetString(42);
			}

			return tbl_scsLoanOut;
		}
		/// <summary>
		/// This makes tbl_scsLoanOut datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_scsLoanOut object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_scsLoanOut  tbl_scsLoanOut   )
		{
		DataTable dt = new DataTable();
		
			DataColumn col_loanOut_ID = new DataColumn("loanOut_ID" , typeof(string));
			DataColumn col_loanOutDate = new DataColumn("loanOutDate" , typeof(DateTime));
