...
namespace DataTire {
	public sealed class tbl_pmsWorkInProgress {
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_pmsWorkInProgress class.
		/// </summary>
		public tbl_pmsWorkInProgress() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_pmsWorkInProgress class.
		/// </summary>
		public tbl_pmsWorkInProgress(string workInProgress_ID, DateTime workInProgressDate, string remark, string productionJob_ID, string createUser_ID, string modifiedUser_ID, string checkedUser_ID, string approvedUser_ID, DateTime dateCreate, DateTime dateModified, DateTime dateChecked, DateTime dateApproved, bool isChecked, bool isApproved, bool isFinished, bool isDeleted, bool isLocked, bool isNewJob, bool isJobWorkInProgress, bool isJobClosedAuto, bool isJobClosed, DateTime dateJobClosed, string jobClosedUser_ID, bool isJobSuspended, DateTime dateJobSuspended, string jobSuspendedUser_ID) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_pmsWorkInProgress table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgressInsert", scon);
			...
			scom.Parameters.Add("@remark", SqlDbType.VarChar,-1);
		...
		/// <summary>
		/// Updates a record in the tbl_pmsWorkInProgress table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgressUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_pmsWorkInProgress table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgressDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_pmsWorkInProgress table by a foreign key.
		/// </summary>
		public static void DeleteAllByProductionJob_ID(string productionJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgressDeleteAllByProductionJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_pmsWorkInProgress table.
		/// </summary>
		public static tbl_pmsWorkInProgress Select(string workInProgress_ID_Incoming){

			tbl_pmsWorkInProgress tbl_pmsWorkInProgressins = new tbl_pmsWorkInProgress();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgressSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_pmsWorkInProgressins = Maketbl_pmsWorkInProgress(dataReader);
				} else {
					tbl_pmsWorkInProgressins = null;
				}
			}
			scon.Close();
			return tbl_pmsWorkInProgressins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_pmsWorkInProgress table.
		/// </summary>
		public static List<tbl_pmsWorkInProgress> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgressSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_pmsWorkInProgress> tbl_pmsWorkInProgressList = new List<tbl_pmsWorkInProgress>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_pmsWorkInProgress tbl_pmsWorkInProgress = Maketbl_pmsWorkInProgress(dataReader);
					tbl_pmsWorkInProgressList.Add(tbl_pmsWorkInProgress);
				}
			}
			scon.Close();
			return tbl_pmsWorkInProgressList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_pmsWorkInProgress table by a foreign key.
		/// </summary>
		public static List<tbl_pmsWorkInProgress> SelectAllByProductionJob_ID(string productionJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgressSelectAllByProductionJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_pmsWorkInProgress class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_pmsWorkInProgress Maketbl_pmsWorkInProgress(SqlDataReader dataReader) {
			tbl_pmsWorkInProgress tbl_pmsWorkInProgress = new tbl_pmsWorkInProgress();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_pmsWorkInProgress.WorkInProgress_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_pmsWorkInProgress.WorkInProgressDate = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_pmsWorkInProgress.Remark = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_pmsWorkInProgress.ProductionJob_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_pmsWorkInProgress.CreateUser_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_pmsWorkInProgress.ModifiedUser_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_pmsWorkInProgress.CheckedUser_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_pmsWorkInProgress.ApprovedUser_ID = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_pmsWorkInProgress.DateCreate = dataReader.GetDateTime(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_pmsWorkInProgress.DateModified = dataReader.GetDateTime(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_pmsWorkInProgress.DateChecked = dataReader.GetDateTime(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_pmsWorkInProgress.DateApproved = dataReader.GetDateTime(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_pmsWorkInProgress.IsChecked = dataReader.GetBoolean(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_pmsWorkInProgress.IsApproved = dataReader.GetBoolean(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_pmsWorkInProgress.IsFinished = dataReader.GetBoolean(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_pmsWorkInProgress.IsDeleted = dataReader.GetBoolean(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_pmsWorkInProgress.IsLocked = dataReader.GetBoolean(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_pmsWorkInProgress.IsNewJob = dataReader.GetBoolean(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_pmsWorkInProgress.IsJobWorkInProgress = dataReader.GetBoolean(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_pmsWorkInProgress.IsJobClosedAuto = dataReader.GetBoolean(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_pmsWorkInProgress.IsJobClosed = dataReader.GetBoolean(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_pmsWorkInProgress.DateJobClosed = dataReader.GetDateTime(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_pmsWorkInProgress.JobClosedUser_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_pmsWorkInProgress.IsJobSuspended = dataReader.GetBoolean(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_pmsWorkInProgress.DateJobSuspended = dataReader.GetDateTime(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_pmsWorkInProgress.JobSuspendedUser_ID = dataReader.GetString(25);
			}

			return tbl_pmsWorkInProgress;
		}
		/// <summary>
		/// This makes tbl_pmsWorkInProgress datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_pmsWorkInProgress object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_pmsWorkInProgress  tbl_pmsWorkInProgress   )
		{
		...
		/// <summary>
		/// This fills tbl_pmsWorkInProgress datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_pmsWorkInProgress object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_pmsWorkInProgress user) {
