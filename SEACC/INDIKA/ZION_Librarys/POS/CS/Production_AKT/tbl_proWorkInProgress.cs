...
namespace DataTire {
	public sealed class tbl_proWorkInProgress {
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_proWorkInProgress class.
		/// </summary>
		public tbl_proWorkInProgress() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_proWorkInProgress class.
		/// </summary>
		public tbl_proWorkInProgress(string productionJob_ID, string workInProgress_ID, DateTime workInProgressDate, string remark, string createUser_ID, string modifiedUser_ID, string checkedUser_ID, string approvedUser_ID, string deletedUser_ID, string printedUser_ID, string createTerminal_ID, string modifiedTerminal_ID, string deletedTerminal_ID, string printedTerminal_ID, DateTime dateCreate, DateTime dateModified, DateTime dateChecked, DateTime dateApproved, DateTime dateDeleted, DateTime datePrinted, bool isChecked, bool isApproved, bool isFinished, bool isDeleted, bool isLocked) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_proWorkInProgress table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_proWorkInProgressInsert", scon);
			...
			scom.Parameters.Add("@printedTerminal_ID", SqlDbType.VarChar,20);
		...
		/// <summary>
		/// Updates a record in the tbl_proWorkInProgress table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_proWorkInProgressUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_proWorkInProgress table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_proWorkInProgressDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_proWorkInProgress table by a foreign key.
		/// </summary>
		public static void DeleteAllByProductionJob_ID(string productionJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_proWorkInProgressDeleteAllByProductionJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_proWorkInProgress table.
		/// </summary>
		public static tbl_proWorkInProgress Select(string workInProgress_ID_Incoming){

			tbl_proWorkInProgress tbl_proWorkInProgressins = new tbl_proWorkInProgress();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_proWorkInProgressSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_proWorkInProgressins = Maketbl_proWorkInProgress(dataReader);
				} else {
					tbl_proWorkInProgressins = null;
				}
			}
			scon.Close();
			return tbl_proWorkInProgressins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_proWorkInProgress table.
		/// </summary>
		public static List<tbl_proWorkInProgress> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_proWorkInProgressSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_proWorkInProgress> tbl_proWorkInProgressList = new List<tbl_proWorkInProgress>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_proWorkInProgress tbl_proWorkInProgress = Maketbl_proWorkInProgress(dataReader);
					tbl_proWorkInProgressList.Add(tbl_proWorkInProgress);
				}
			}
			scon.Close();
			return tbl_proWorkInProgressList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_proWorkInProgress table by a foreign key.
		/// </summary>
		public static List<tbl_proWorkInProgress> SelectAllByProductionJob_ID(string productionJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_proWorkInProgressSelectAllByProductionJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_proWorkInProgress class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_proWorkInProgress Maketbl_proWorkInProgress(SqlDataReader dataReader) {
			tbl_proWorkInProgress tbl_proWorkInProgress = new tbl_proWorkInProgress();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_proWorkInProgress.ProductionJob_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_proWorkInProgress.WorkInProgress_ID = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_proWorkInProgress.WorkInProgressDate = dataReader.GetDateTime(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_proWorkInProgress.Remark = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_proWorkInProgress.CreateUser_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_proWorkInProgress.ModifiedUser_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_proWorkInProgress.CheckedUser_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_proWorkInProgress.ApprovedUser_ID = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_proWorkInProgress.DeletedUser_ID = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_proWorkInProgress.PrintedUser_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_proWorkInProgress.CreateTerminal_ID = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_proWorkInProgress.ModifiedTerminal_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_proWorkInProgress.DeletedTerminal_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_proWorkInProgress.PrintedTerminal_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_proWorkInProgress.DateCreate = dataReader.GetDateTime(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_proWorkInProgress.DateModified = dataReader.GetDateTime(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_proWorkInProgress.DateChecked = dataReader.GetDateTime(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_proWorkInProgress.DateApproved = dataReader.GetDateTime(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_proWorkInProgress.DateDeleted = dataReader.GetDateTime(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_proWorkInProgress.DatePrinted = dataReader.GetDateTime(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_proWorkInProgress.IsChecked = dataReader.GetBoolean(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_proWorkInProgress.IsApproved = dataReader.GetBoolean(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_proWorkInProgress.IsFinished = dataReader.GetBoolean(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_proWorkInProgress.IsDeleted = dataReader.GetBoolean(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_proWorkInProgress.IsLocked = dataReader.GetBoolean(24);
			}

			return tbl_proWorkInProgress;
		}
		/// <summary>
		/// This makes tbl_proWorkInProgress datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_proWorkInProgress object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_proWorkInProgress  tbl_proWorkInProgress   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_productionJob_ID,col_workInProgress_ID,col_workInProgressDate,col_remark,col_createUser_ID,col_modifiedUser_ID,col_checkedUser_ID,col_approvedUser_ID,col_deletedUser_ID,col_printedUser_ID,col_createTerminal_ID,col_modifiedTerminal_ID,col_deletedTerminal_ID,col_printedTerminal_ID,col_dateCreate,col_dateModified,col_dateChecked,col_dateApproved,col_dateDeleted,col_datePrinted,col_isChecked,col_isApproved,col_isFinished,col_isDeleted,col_isLocked,});		return dt;
		}
		/// <summary>
		/// This fills tbl_proWorkInProgress datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_proWorkInProgress object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_proWorkInProgress user) {
