	...
	public sealed class tbl_pcbMasAccount {
		...
		private static tbl_pcbMasAccount Maketbl_pcbMasAccount(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(8) == false) {
				tbl_pcbMasAccount.Counter = dataReader.GetInt32(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_pcbMasAccount.IsCanceled = dataReader.GetBoolean(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_pcbMasAccount.CreateUser_ID = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_pcbMasAccount.ModifiedUser_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_pcbMasAccount.CanceldUser_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_pcbMasAccount.DateCreate = dataReader.GetDateTime(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_pcbMasAccount.DateModified = dataReader.GetDateTime(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_pcbMasAccount.DateCanceled = dataReader.GetDateTime(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_pcbMasAccount.CreateUserTerminal_ID = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_pcbMasAccount.ModifiedUserTerminal_ID = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_pcbMasAccount.CanceledUserTerminal_ID = dataReader.GetString(18);
			}
		...
		dt.Columns.AddRange(new DataColumn[] { col_pcbAccount_ID,col_pcbAccountName,col_assignedUser_ID,col_currency_ID,col_floatAmount,col_remarks,col_gl_ID,col_prefix,col_counter,col_isCanceled,col_createUser_ID,col_modifiedUser_ID,col_canceldUser_ID,col_dateCreate,col_dateModified,col_dateCanceled,col_createUserTerminal_ID,col_modifiedUserTerminal_ID,col_canceledUserTerminal_ID,});		return dt;
		}
		/// <summary>
