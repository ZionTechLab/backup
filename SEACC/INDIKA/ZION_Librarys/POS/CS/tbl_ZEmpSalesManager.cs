...
namespace DataTire {
	public sealed class tbl_ZEmpSalesManager {
		...
		/// Initializes a new instance of the tbl_ZEmpSalesManager class.
		/// </summary>
		public tbl_ZEmpSalesManager(string salesManager_ID, string salesManagerName, bool isDelete) {
		...
		private static tbl_ZEmpSalesManager Maketbl_ZEmpSalesManager(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(2) == false) {
				tbl_ZEmpSalesManager.IsDelete = dataReader.GetBoolean(2);
			}
		...
		dt.Columns.AddRange(new DataColumn[] { col_salesManager_ID,col_salesManagerName,col_isDelete,});		return dt;
		}
		/// <summary>
