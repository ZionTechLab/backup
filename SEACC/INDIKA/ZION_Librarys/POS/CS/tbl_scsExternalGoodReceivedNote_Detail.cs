...
namespace DataTire {
	public sealed class tbl_scsExternalGoodReceivedNote_Detail {
		#region Fields
		private int line_No;
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_scsExternalGoodReceivedNote_Detail class.
		/// </summary>
		public tbl_scsExternalGoodReceivedNote_Detail() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_scsExternalGoodReceivedNote_Detail class.
		/// </summary>
		public tbl_scsExternalGoodReceivedNote_Detail(int line_No, string externalGoodReceivedNote_ID, string item_ID, string purchaseOrder_ID, string purchaseReturnedNote_ID, string itemSubCategory_ID, string itemSubCategory2_ID, string itemSerialNo, string itemSerialNo2, decimal qty, decimal qtySettle, decimal weight, decimal weightSettle, decimal warranty, string batchNo, decimal kiloPrice, decimal unitPrice, decimal unitDiscount, decimal totalDiscount, decimal tatalAmount, string remark, bool bHasBreakDown, decimal weightedAvgCost) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_scsExternalGoodReceivedNote_Detail table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_scsExternalGoodReceivedNote_Detail table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_scsExternalGoodReceivedNote_Detail table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_scsExternalGoodReceivedNote_Detail table by a foreign key.
		/// </summary>
		public static void DeleteAllByPurchaseOrder_ID(string purchaseOrder_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailDeleteAllByPurchaseOrder_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByExternalGoodReceivedNote_ID(string externalGoodReceivedNote_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailDeleteAllByExternalGoodReceivedNote_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByItemSubCategory_ID(string itemSubCategory_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailDeleteAllByItemSubCategory_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByItem_ID(string item_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailDeleteAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByItemSubCategory2_ID(string itemSubCategory2_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailDeleteAllByItemSubCategory2_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_scsExternalGoodReceivedNote_Detail table.
		/// </summary>
		public static tbl_scsExternalGoodReceivedNote_Detail Select(int line_No_Incoming, string externalGoodReceivedNote_ID_Incoming, string item_ID_Incoming, string itemSubCategory_ID_Incoming, string itemSubCategory2_ID_Incoming, string itemSerialNo_Incoming, string itemSerialNo2_Incoming){

			tbl_scsExternalGoodReceivedNote_Detail tbl_scsExternalGoodReceivedNote_Detailins = new tbl_scsExternalGoodReceivedNote_Detail();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_scsExternalGoodReceivedNote_Detailins = Maketbl_scsExternalGoodReceivedNote_Detail(dataReader);
				} else {
					tbl_scsExternalGoodReceivedNote_Detailins = null;
				}
			}
			scon.Close();
			return tbl_scsExternalGoodReceivedNote_Detailins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsExternalGoodReceivedNote_Detail table.
		/// </summary>
		public static List<tbl_scsExternalGoodReceivedNote_Detail> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_scsExternalGoodReceivedNote_Detail> tbl_scsExternalGoodReceivedNote_DetailList = new List<tbl_scsExternalGoodReceivedNote_Detail>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_scsExternalGoodReceivedNote_Detail tbl_scsExternalGoodReceivedNote_Detail = Maketbl_scsExternalGoodReceivedNote_Detail(dataReader);
					tbl_scsExternalGoodReceivedNote_DetailList.Add(tbl_scsExternalGoodReceivedNote_Detail);
				}
			}
			scon.Close();
			return tbl_scsExternalGoodReceivedNote_DetailList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsExternalGoodReceivedNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsExternalGoodReceivedNote_Detail> SelectAllByPurchaseOrder_ID(string purchaseOrder_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailSelectAllByPurchaseOrder_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsExternalGoodReceivedNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsExternalGoodReceivedNote_Detail> SelectAllByExternalGoodReceivedNote_ID(string externalGoodReceivedNote_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailSelectAllByExternalGoodReceivedNote_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsExternalGoodReceivedNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsExternalGoodReceivedNote_Detail> SelectAllByItemSubCategory_ID(string itemSubCategory_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailSelectAllByItemSubCategory_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsExternalGoodReceivedNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsExternalGoodReceivedNote_Detail> SelectAllByItem_ID(string item_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailSelectAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsExternalGoodReceivedNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsExternalGoodReceivedNote_Detail> SelectAllByItemSubCategory2_ID(string itemSubCategory2_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsExternalGoodReceivedNote_DetailSelectAllByItemSubCategory2_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_scsExternalGoodReceivedNote_Detail class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_scsExternalGoodReceivedNote_Detail Maketbl_scsExternalGoodReceivedNote_Detail(SqlDataReader dataReader) {
			tbl_scsExternalGoodReceivedNote_Detail tbl_scsExternalGoodReceivedNote_Detail = new tbl_scsExternalGoodReceivedNote_Detail();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.Line_No = dataReader.GetInt32(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.ExternalGoodReceivedNote_ID = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.Item_ID = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.PurchaseOrder_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.PurchaseReturnedNote_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.ItemSubCategory_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.ItemSubCategory2_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.ItemSerialNo = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.ItemSerialNo2 = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.Qty = dataReader.GetDecimal(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.QtySettle = dataReader.GetDecimal(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.Weight = dataReader.GetDecimal(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.WeightSettle = dataReader.GetDecimal(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.Warranty = dataReader.GetDecimal(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.BatchNo = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.KiloPrice = dataReader.GetDecimal(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.UnitPrice = dataReader.GetDecimal(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.UnitDiscount = dataReader.GetDecimal(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.TotalDiscount = dataReader.GetDecimal(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.TatalAmount = dataReader.GetDecimal(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.Remark = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.BHasBreakDown = dataReader.GetBoolean(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_scsExternalGoodReceivedNote_Detail.WeightedAvgCost = dataReader.GetDecimal(22);
			}

			return tbl_scsExternalGoodReceivedNote_Detail;
		}
		/// <summary>
		/// This makes tbl_scsExternalGoodReceivedNote_Detail datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_scsExternalGoodReceivedNote_Detail object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_scsExternalGoodReceivedNote_Detail  tbl_scsExternalGoodReceivedNote_Detail   )
		{
