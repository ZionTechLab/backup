...
namespace DataTire {
	public sealed class tbl_prod_polyTxJobCard_Labour {
		#region Fields
		private int line_No;
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_prod_polyTxJobCard_Labour class.
		/// </summary>
		public tbl_prod_polyTxJobCard_Labour() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_prod_polyTxJobCard_Labour class.
		/// </summary>
		public tbl_prod_polyTxJobCard_Labour(int line_No, string prodJob_ID, string prodSection_ID, string prodActivity_ID, decimal shifts_Day, decimal shiftMinutes_Day, decimal labours_Day, decimal labourRatePerHour_Day, decimal shifts_Night, decimal shiftMinutes_Night, decimal labours_Night, decimal labourRatePerHour_Night, decimal ohRatePerHour, decimal otherCostRatePerHour, decimal prodMinutes, decimal costTotal) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_prod_polyTxJobCard_Labour table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_prod_polyTxJobCard_Labour table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_prod_polyTxJobCard_Labour table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_prod_polyTxJobCard_Labour table by a foreign key.
		/// </summary>
		public static void DeleteAllByProdJob_ID(string prodJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourDeleteAllByProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByProdSection_ID(string prodSection_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourDeleteAllByProdSection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByProdActivity_ID(string prodActivity_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourDeleteAllByProdActivity_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_prod_polyTxJobCard_Labour table.
		/// </summary>
		public static tbl_prod_polyTxJobCard_Labour Select(int line_No_Incoming, string prodJob_ID_Incoming){

			tbl_prod_polyTxJobCard_Labour tbl_prod_polyTxJobCard_Labourins = new tbl_prod_polyTxJobCard_Labour();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_prod_polyTxJobCard_Labourins = Maketbl_prod_polyTxJobCard_Labour(dataReader);
				} else {
					tbl_prod_polyTxJobCard_Labourins = null;
				}
			}
			scon.Close();
			return tbl_prod_polyTxJobCard_Labourins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_polyTxJobCard_Labour table.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard_Labour> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_prod_polyTxJobCard_Labour> tbl_prod_polyTxJobCard_LabourList = new List<tbl_prod_polyTxJobCard_Labour>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_prod_polyTxJobCard_Labour tbl_prod_polyTxJobCard_Labour = Maketbl_prod_polyTxJobCard_Labour(dataReader);
					tbl_prod_polyTxJobCard_LabourList.Add(tbl_prod_polyTxJobCard_Labour);
				}
			}
			scon.Close();
			return tbl_prod_polyTxJobCard_LabourList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_polyTxJobCard_Labour table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard_Labour> SelectAllByProdJob_ID(string prodJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourSelectAllByProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard_Labour table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard_Labour> SelectAllByProdSection_ID(string prodSection_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourSelectAllByProdSection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard_Labour table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard_Labour> SelectAllByProdActivity_ID(string prodActivity_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCard_LabourSelectAllByProdActivity_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_prod_polyTxJobCard_Labour class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_prod_polyTxJobCard_Labour Maketbl_prod_polyTxJobCard_Labour(SqlDataReader dataReader) {
			tbl_prod_polyTxJobCard_Labour tbl_prod_polyTxJobCard_Labour = new tbl_prod_polyTxJobCard_Labour();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_prod_polyTxJobCard_Labour.Line_No = dataReader.GetInt32(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_prod_polyTxJobCard_Labour.ProdJob_ID = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_prod_polyTxJobCard_Labour.ProdSection_ID = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_prod_polyTxJobCard_Labour.ProdActivity_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_prod_polyTxJobCard_Labour.Shifts_Day = dataReader.GetDecimal(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_prod_polyTxJobCard_Labour.ShiftMinutes_Day = dataReader.GetDecimal(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_prod_polyTxJobCard_Labour.Labours_Day = dataReader.GetDecimal(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_prod_polyTxJobCard_Labour.LabourRatePerHour_Day = dataReader.GetDecimal(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_prod_polyTxJobCard_Labour.Shifts_Night = dataReader.GetDecimal(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_prod_polyTxJobCard_Labour.ShiftMinutes_Night = dataReader.GetDecimal(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_prod_polyTxJobCard_Labour.Labours_Night = dataReader.GetDecimal(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_prod_polyTxJobCard_Labour.LabourRatePerHour_Night = dataReader.GetDecimal(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_prod_polyTxJobCard_Labour.OhRatePerHour = dataReader.GetDecimal(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_prod_polyTxJobCard_Labour.OtherCostRatePerHour = dataReader.GetDecimal(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_prod_polyTxJobCard_Labour.ProdMinutes = dataReader.GetDecimal(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_prod_polyTxJobCard_Labour.CostTotal = dataReader.GetDecimal(15);
			}

			return tbl_prod_polyTxJobCard_Labour;
		}
		/// <summary>
		/// This makes tbl_prod_polyTxJobCard_Labour datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_prod_polyTxJobCard_Labour object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_prod_polyTxJobCard_Labour  tbl_prod_polyTxJobCard_Labour   )
		{
		...
		/// <summary>
		/// This fills tbl_prod_polyTxJobCard_Labour datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_prod_polyTxJobCard_Labour object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_prod_polyTxJobCard_Labour user) {
