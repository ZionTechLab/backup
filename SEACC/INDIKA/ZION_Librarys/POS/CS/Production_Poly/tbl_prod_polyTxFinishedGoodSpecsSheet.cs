...
namespace DataTire {
	public sealed class tbl_prod_polyTxFinishedGoodSpecsSheet {
		#region Fields
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_prod_polyTxFinishedGoodSpecsSheet table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_prod_polyTxFinishedGoodSpecsSheet table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_prod_polyTxFinishedGoodSpecsSheet table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static void DeleteAllByApprovedUser_ID(string approvedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByApprovedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByTag3_ID(string tag3_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByTag3_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_ID_Template(string item_ID_Template) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByItem_ID_Template", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_ID_FG(string item_ID_FG) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByItem_ID_FG", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCompanyID(string companyID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByTag4_ID(string tag4_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByTag4_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCheckedUser_ID(string checkedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByCheckedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByColour_ID(string colour_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByColour_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCustomer_ID(string customer_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByCustomer_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCanceldUser_ID(string canceldUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCreateUser_ID(string createUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCompanyBranchID(string companyBranchID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByModifiedUser_ID(string modifiedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetDeleteAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_prod_polyTxFinishedGoodSpecsSheet table.
		/// </summary>
		public static tbl_prod_polyTxFinishedGoodSpecsSheet Select(string item_ID_FG_Incoming){

			tbl_prod_polyTxFinishedGoodSpecsSheet tbl_prod_polyTxFinishedGoodSpecsSheetins = new tbl_prod_polyTxFinishedGoodSpecsSheet();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_prod_polyTxFinishedGoodSpecsSheetins = Maketbl_prod_polyTxFinishedGoodSpecsSheet(dataReader);
				} else {
					tbl_prod_polyTxFinishedGoodSpecsSheetins = null;
				}
			}
			scon.Close();
			return tbl_prod_polyTxFinishedGoodSpecsSheetins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_prod_polyTxFinishedGoodSpecsSheet> tbl_prod_polyTxFinishedGoodSpecsSheetList = new List<tbl_prod_polyTxFinishedGoodSpecsSheet>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_prod_polyTxFinishedGoodSpecsSheet tbl_prod_polyTxFinishedGoodSpecsSheet = Maketbl_prod_polyTxFinishedGoodSpecsSheet(dataReader);
					tbl_prod_polyTxFinishedGoodSpecsSheetList.Add(tbl_prod_polyTxFinishedGoodSpecsSheet);
				}
			}
			scon.Close();
			return tbl_prod_polyTxFinishedGoodSpecsSheetList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByApprovedUser_ID(string approvedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByApprovedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByTag3_ID(string tag3_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByTag3_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByItem_ID_Template(string item_ID_Template) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByItem_ID_Template", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByItem_ID_FG(string item_ID_FG) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByItem_ID_FG", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByCompanyID(string companyID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByTag4_ID(string tag4_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByTag4_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByCheckedUser_ID(string checkedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByCheckedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByColour_ID(string colour_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByColour_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByCustomer_ID(string customer_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByCustomer_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByCanceldUser_ID(string canceldUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByCreateUser_ID(string createUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByCompanyBranchID(string companyBranchID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxFinishedGoodSpecsSheet> SelectAllByModifiedUser_ID(string modifiedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxFinishedGoodSpecsSheetSelectAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_prod_polyTxFinishedGoodSpecsSheet class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_prod_polyTxFinishedGoodSpecsSheet Maketbl_prod_polyTxFinishedGoodSpecsSheet(SqlDataReader dataReader) {
			tbl_prod_polyTxFinishedGoodSpecsSheet tbl_prod_polyTxFinishedGoodSpecsSheet = new tbl_prod_polyTxFinishedGoodSpecsSheet();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Item_ID_FG = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Item_ID_Template = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Industry_ID = dataReader.GetInt32(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Customer_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Instruction_Sales = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Instruction_Prod = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Instruction_Accounts = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Instruction_Stores = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Instruction_Supplier = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Uom_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Uom_ID_Weight = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Tag3_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Tag4_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Colour_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.MeltingPoint = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.ChemFormula = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.Density = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.IsChecked = dataReader.GetBoolean(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.IsApproved = dataReader.GetBoolean(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.IsCanceled = dataReader.GetBoolean(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.CreateUser_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.ModifiedUser_ID = dataReader.GetString(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.CheckedUser_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.ApprovedUser_ID = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.CanceldUser_ID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.DateCreate = dataReader.GetDateTime(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.DateModified = dataReader.GetDateTime(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.DateChecked = dataReader.GetDateTime(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.DateApproved = dataReader.GetDateTime(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.DateCanceled = dataReader.GetDateTime(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.CreateUserTerminal_ID = dataReader.GetString(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.ModifiedUserTerminal_ID = dataReader.GetString(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.CheckedUserTerminal_ID = dataReader.GetString(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.ApprovedUserTerminal_ID = dataReader.GetString(33);
			}
			if (dataReader.IsDBNull(34) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.CanceledUserTerminal_ID = dataReader.GetString(34);
			}
			if (dataReader.IsDBNull(35) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.CompanyID = dataReader.GetString(35);
			}
			if (dataReader.IsDBNull(36) == false) {
				tbl_prod_polyTxFinishedGoodSpecsSheet.CompanyBranchID = dataReader.GetString(36);
			}

			return tbl_prod_polyTxFinishedGoodSpecsSheet;
		}
		/// <summary>
		/// This makes tbl_prod_polyTxFinishedGoodSpecsSheet datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_prod_polyTxFinishedGoodSpecsSheet object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_prod_polyTxFinishedGoodSpecsSheet  tbl_prod_polyTxFinishedGoodSpecsSheet   )
		{
		...
		/// <summary>
		/// This fills tbl_prod_polyTxFinishedGoodSpecsSheet datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_prod_polyTxFinishedGoodSpecsSheet object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_prod_polyTxFinishedGoodSpecsSheet user) {
