...
namespace DataTire {
	public sealed class tbl_scsPurchaseOrder_Detail {
		#region Fields
		private int line_No;
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_scsPurchaseOrder_Detail class.
		/// </summary>
		public tbl_scsPurchaseOrder_Detail() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_scsPurchaseOrder_Detail class.
		/// </summary>
		public tbl_scsPurchaseOrder_Detail(int line_No, string purchaseOrder_ID, string item_ID, string itemSubCategory_ID, string itemSubCategory2_ID, string itemSerialNo, string itemSerialNo2, decimal qty, decimal qtySettle, decimal weight, decimal weightSettle, decimal meters, decimal kiloPrice, decimal unitPrice, decimal unitDiscount, decimal totalDiscount, decimal tatalAmount, string remark) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_scsPurchaseOrder_Detail table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_scsPurchaseOrder_Detail table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_scsPurchaseOrder_Detail table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_scsPurchaseOrder_Detail table by a foreign key.
		/// </summary>
		public static void DeleteAllByPurchaseOrder_ID(string purchaseOrder_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailDeleteAllByPurchaseOrder_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByItemSubCategory_ID(string itemSubCategory_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailDeleteAllByItemSubCategory_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByItem_ID(string item_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailDeleteAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByItemSubCategory2_ID(string itemSubCategory2_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailDeleteAllByItemSubCategory2_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_scsPurchaseOrder_Detail table.
		/// </summary>
		public static tbl_scsPurchaseOrder_Detail Select(int line_No_Incoming, string purchaseOrder_ID_Incoming, string item_ID_Incoming, string itemSubCategory_ID_Incoming, string itemSubCategory2_ID_Incoming, string itemSerialNo_Incoming, string itemSerialNo2_Incoming){

			tbl_scsPurchaseOrder_Detail tbl_scsPurchaseOrder_Detailins = new tbl_scsPurchaseOrder_Detail();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_scsPurchaseOrder_Detailins = Maketbl_scsPurchaseOrder_Detail(dataReader);
				} else {
					tbl_scsPurchaseOrder_Detailins = null;
				}
			}
			scon.Close();
			return tbl_scsPurchaseOrder_Detailins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsPurchaseOrder_Detail table.
		/// </summary>
		public static List<tbl_scsPurchaseOrder_Detail> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_scsPurchaseOrder_Detail> tbl_scsPurchaseOrder_DetailList = new List<tbl_scsPurchaseOrder_Detail>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_scsPurchaseOrder_Detail tbl_scsPurchaseOrder_Detail = Maketbl_scsPurchaseOrder_Detail(dataReader);
					tbl_scsPurchaseOrder_DetailList.Add(tbl_scsPurchaseOrder_Detail);
				}
			}
			scon.Close();
			return tbl_scsPurchaseOrder_DetailList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsPurchaseOrder_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsPurchaseOrder_Detail> SelectAllByPurchaseOrder_ID(string purchaseOrder_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailSelectAllByPurchaseOrder_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsPurchaseOrder_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsPurchaseOrder_Detail> SelectAllByItemSubCategory_ID(string itemSubCategory_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailSelectAllByItemSubCategory_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsPurchaseOrder_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsPurchaseOrder_Detail> SelectAllByItem_ID(string item_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailSelectAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsPurchaseOrder_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsPurchaseOrder_Detail> SelectAllByItemSubCategory2_ID(string itemSubCategory2_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsPurchaseOrder_DetailSelectAllByItemSubCategory2_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_scsPurchaseOrder_Detail class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_scsPurchaseOrder_Detail Maketbl_scsPurchaseOrder_Detail(SqlDataReader dataReader) {
			tbl_scsPurchaseOrder_Detail tbl_scsPurchaseOrder_Detail = new tbl_scsPurchaseOrder_Detail();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_scsPurchaseOrder_Detail.Line_No = dataReader.GetInt32(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_scsPurchaseOrder_Detail.PurchaseOrder_ID = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_scsPurchaseOrder_Detail.Item_ID = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_scsPurchaseOrder_Detail.ItemSubCategory_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_scsPurchaseOrder_Detail.ItemSubCategory2_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_scsPurchaseOrder_Detail.ItemSerialNo = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_scsPurchaseOrder_Detail.ItemSerialNo2 = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_scsPurchaseOrder_Detail.Qty = dataReader.GetDecimal(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_scsPurchaseOrder_Detail.QtySettle = dataReader.GetDecimal(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_scsPurchaseOrder_Detail.Weight = dataReader.GetDecimal(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_scsPurchaseOrder_Detail.WeightSettle = dataReader.GetDecimal(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_scsPurchaseOrder_Detail.Meters = dataReader.GetDecimal(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_scsPurchaseOrder_Detail.KiloPrice = dataReader.GetDecimal(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_scsPurchaseOrder_Detail.UnitPrice = dataReader.GetDecimal(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_scsPurchaseOrder_Detail.UnitDiscount = dataReader.GetDecimal(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_scsPurchaseOrder_Detail.TotalDiscount = dataReader.GetDecimal(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_scsPurchaseOrder_Detail.TatalAmount = dataReader.GetDecimal(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_scsPurchaseOrder_Detail.Remark = dataReader.GetString(17);
			}

			return tbl_scsPurchaseOrder_Detail;
		}
		/// <summary>
		/// This makes tbl_scsPurchaseOrder_Detail datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_scsPurchaseOrder_Detail object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_scsPurchaseOrder_Detail  tbl_scsPurchaseOrder_Detail   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_line_No,col_purchaseOrder_ID,col_item_ID,col_itemSubCategory_ID,col_itemSubCategory2_ID,col_itemSerialNo,col_itemSerialNo2,col_qty,col_qtySettle,col_weight,col_weightSettle,col_meters,col_kiloPrice,col_unitPrice,col_unitDiscount,col_totalDiscount,col_tatalAmount,col_remark,});		return dt;
		}
		/// <summary>
		/// This fills tbl_scsPurchaseOrder_Detail datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_scsPurchaseOrder_Detail object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_scsPurchaseOrder_Detail user) {
