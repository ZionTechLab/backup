...
namespace Digiteq_Logic
{
    public class clsSecurity
    {
        ...
        public static string CompanyEPFNo;
        ...
        public static bool AutoAssignCompanyValue()
        {
            ...
            try
            {
                ...
                if (com != null)
                {
                    CompanyName = decryptPassword(com.CompanyName);
                    //clsSecurity.CompanyName = (com.CompanyName);
                    CompanyAddress1 = decryptPassword(com.Address);
                    //clsSecurity.CompanyAddress1 = (com.Address);
                    CompanyAddress2 = "";
                    if (com.Telephone1.Length > 0)
                        CompanyAddress2 = "Tel:" + com.Telephone1;
                    if (com.Telephone2.Length > 0)
                        CompanyAddress2 += "," + com.Telephone2;
                    if (com.Fax.Length > 0)
                        CompanyAddress2 += "," + " FAX:" + com.Fax;
        ...
        public static DateTime GetSystemExpireDate()
        {
            ...
            if (oCompany != null && oCompany.ProductKey != null)
            {
                ...
                dtmExpire = clsValidation.Validate_DateTime(sDate);
            }
            return dtmExpire;
        }
