...
namespace DataTire {
	public sealed class tbl_hrMasLeaveTypes {
		...
		/// <summary>
		/// Gets or sets the IsDaysLimit value.
		/// </summary>
		public bool IsDaysLimit {
			get { return isDaysLimit; }
			set { isDaysLimit = value; }
		}
		...
		public void Insert() {
			...
			scom.Parameters.Add("@isDaysLimit", SqlDbType.Bit,1);
			...
			scom.Parameters["@isDaysLimit"].Value = isDaysLimit;
		...
		private static tbl_hrMasLeaveTypes Maketbl_hrMasLeaveTypes(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(5) == false) {
				tbl_hrMasLeaveTypes.IsDaysLimit = dataReader.GetBoolean(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_hrMasLeaveTypes.Std_NoOfDays = dataReader.GetInt32(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_hrMasLeaveTypes.IsCanceled = dataReader.GetBoolean(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_hrMasLeaveTypes.UserID_Created = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_hrMasLeaveTypes.UserID_Modified = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_hrMasLeaveTypes.UserID_Canceled = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_hrMasLeaveTypes.TerminalID_Created = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_hrMasLeaveTypes.TerminalID_Modified = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_hrMasLeaveTypes.TerminalID_Canceled = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_hrMasLeaveTypes.Date_Created = dataReader.GetDateTime(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_hrMasLeaveTypes.Date_Modified = dataReader.GetDateTime(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_hrMasLeaveTypes.Date_Canceled = dataReader.GetDateTime(16);
			}
		...
		DataTable dt = new DataTable();
			...
			DataColumn col_isDaysLimit = new DataColumn("isDaysLimit" , typeof(bool));
		...
		DataRow drow = dt.NewRow();
			...
			drow["isDaysLimit"] = user.isDaysLimit;
