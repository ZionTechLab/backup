...
namespace DataTire {
	public sealed class tbl_genMasReligion {
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_genMasReligion class.
		/// </summary>
		public tbl_genMasReligion() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_genMasReligion class.
		/// </summary>
		public tbl_genMasReligion(string religion_ID, string religion, bool isCanceled, string userID_Created, string userID_Modified, string userID_Canceled, string terminalID_Created, string terminalID_Modified, string terminalID_Canceled, DateTime date_Created, DateTime date_Modified, DateTime date_Canceled) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_genMasReligion table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasReligionInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_genMasReligion table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasReligionUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_genMasReligion table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasReligionDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects a single record from the tbl_genMasReligion table.
		/// </summary>
		public static tbl_genMasReligion Select(string religion_ID_Incoming){

			tbl_genMasReligion tbl_genMasReligionins = new tbl_genMasReligion();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasReligionSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
			scom.Parameters.Add("@religion_ID", SqlDbType.VarChar,8);
			scom.Parameters["@religion_ID"].Value = religion_ID_Incoming;
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_genMasReligionins = Maketbl_genMasReligion(dataReader);
				} else {
					tbl_genMasReligionins = null;
				}
			}
			scon.Close();
			return tbl_genMasReligionins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_genMasReligion table.
		/// </summary>
		public static List<tbl_genMasReligion> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasReligionSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_genMasReligion> tbl_genMasReligionList = new List<tbl_genMasReligion>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_genMasReligion tbl_genMasReligion = Maketbl_genMasReligion(dataReader);
					tbl_genMasReligionList.Add(tbl_genMasReligion);
				}
			}
			scon.Close();
			return tbl_genMasReligionList;
		}
		
		/// <summary>
		/// Creates a new instance of the tbl_genMasReligion class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_genMasReligion Maketbl_genMasReligion(SqlDataReader dataReader) {
			tbl_genMasReligion tbl_genMasReligion = new tbl_genMasReligion();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_genMasReligion.Religion_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_genMasReligion.Religion = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_genMasReligion.IsCanceled = dataReader.GetBoolean(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_genMasReligion.UserID_Created = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_genMasReligion.UserID_Modified = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_genMasReligion.UserID_Canceled = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_genMasReligion.TerminalID_Created = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_genMasReligion.TerminalID_Modified = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_genMasReligion.TerminalID_Canceled = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_genMasReligion.Date_Created = dataReader.GetDateTime(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_genMasReligion.Date_Modified = dataReader.GetDateTime(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_genMasReligion.Date_Canceled = dataReader.GetDateTime(11);
			}

			return tbl_genMasReligion;
		}
		/// <summary>
		/// This makes tbl_genMasReligion datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_genMasReligion object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_genMasReligion  tbl_genMasReligion   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_religion_ID,col_religion,col_isCanceled,col_userID_Created,col_userID_Modified,col_userID_Canceled,col_terminalID_Created,col_terminalID_Modified,col_terminalID_Canceled,col_date_Created,col_date_Modified,col_date_Canceled,});		return dt;
		}
		/// <summary>
		/// This fills tbl_genMasReligion datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_genMasReligion object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_genMasReligion user) {
