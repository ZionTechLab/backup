...
namespace DataTire {
	public sealed class tbl_hrPeriod_Year {
		...
		/// Initializes a new instance of the tbl_hrPeriod_Year class.
		/// </summary>
		public tbl_hrPeriod_Year(string company_ID, string companyBranch_ID, int year_ID, string year_Name, DateTime year_startDate, DateTime year_endDate, int status, bool isCanceled, string userID_Created, string userID_Modified, string userID_Canceled, string terminalID_Created, string terminalID_Modified, string terminalID_Canceled, DateTime date_Created, DateTime date_Modified, DateTime date_Canceled) {
		...
		/// </summary>
		public static tbl_hrPeriod_Year Select(string company_ID_Incoming, string companyBranch_ID_Incoming, int year_ID_Incoming){
		...
		private static tbl_hrPeriod_Year Maketbl_hrPeriod_Year(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(2) == false) {
				tbl_hrPeriod_Year.Year_ID = dataReader.GetInt32(2);
			}
