...
namespace DataTire {
	public sealed class tbl_tasHolidayType {
		#region Fields
		private string holydayType_ID;
		private string holydayType_Name;
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_tasHolidayType class.
		/// </summary>
		public tbl_tasHolidayType() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_tasHolidayType class.
		/// </summary>
		public tbl_tasHolidayType(string holydayType_ID, string holydayType_Name, bool isCanceled, string userID_Created, string userID_Modified, string userID_Canceled, string terminalID_Created, string terminalID_Modified, string terminalID_Canceled, DateTime date_Created, DateTime date_Modified, DateTime date_Canceled) {
			this.holydayType_ID = holydayType_ID;
			this.holydayType_Name = holydayType_Name;
		...
		/// <summary>
		/// Gets or sets the HolydayType_Name value.
		/// </summary>
		public string HolydayType_Name {
			get { return holydayType_Name; }
			set { holydayType_Name = value; }
		}
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_tasHolidayType table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_tasHolidayTypeInsert", scon);
			scom.CommandType = CommandType.StoredProcedure;
 
 
			scom.Parameters.Add("@holydayType_ID", SqlDbType.VarChar,8);
			scom.Parameters.Add("@holydayType_Name", SqlDbType.VarChar,500);
			...
			scom.Parameters["@holydayType_Name"].Value = holydayType_Name;
		...
		/// <summary>
		/// Updates a record in the tbl_tasHolidayType table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_tasHolidayTypeUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_tasHolidayType table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_tasHolidayTypeDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects a single record from the tbl_tasHolidayType table.
		/// </summary>
		public static tbl_tasHolidayType Select(string holydayType_ID_Incoming){

			tbl_tasHolidayType tbl_tasHolidayTypeins = new tbl_tasHolidayType();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_tasHolidayTypeSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
			scom.Parameters.Add("@holydayType_ID", SqlDbType.VarChar,8);
			scom.Parameters["@holydayType_ID"].Value = holydayType_ID_Incoming;
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_tasHolidayTypeins = Maketbl_tasHolidayType(dataReader);
				} else {
					tbl_tasHolidayTypeins = null;
				}
			}
			scon.Close();
			return tbl_tasHolidayTypeins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_tasHolidayType table.
		/// </summary>
		public static List<tbl_tasHolidayType> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_tasHolidayTypeSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_tasHolidayType> tbl_tasHolidayTypeList = new List<tbl_tasHolidayType>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_tasHolidayType tbl_tasHolidayType = Maketbl_tasHolidayType(dataReader);
					tbl_tasHolidayTypeList.Add(tbl_tasHolidayType);
				}
			}
			scon.Close();
			return tbl_tasHolidayTypeList;
		}
		
		/// <summary>
		/// Creates a new instance of the tbl_tasHolidayType class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_tasHolidayType Maketbl_tasHolidayType(SqlDataReader dataReader) {
			tbl_tasHolidayType tbl_tasHolidayType = new tbl_tasHolidayType();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_tasHolidayType.HolydayType_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_tasHolidayType.HolydayType_Name = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_tasHolidayType.IsCanceled = dataReader.GetBoolean(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_tasHolidayType.UserID_Created = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_tasHolidayType.UserID_Modified = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_tasHolidayType.UserID_Canceled = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_tasHolidayType.TerminalID_Created = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_tasHolidayType.TerminalID_Modified = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_tasHolidayType.TerminalID_Canceled = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_tasHolidayType.Date_Created = dataReader.GetDateTime(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_tasHolidayType.Date_Modified = dataReader.GetDateTime(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_tasHolidayType.Date_Canceled = dataReader.GetDateTime(11);
			}

			return tbl_tasHolidayType;
		}
		/// <summary>
		/// This makes tbl_tasHolidayType datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_tasHolidayType object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_tasHolidayType  tbl_tasHolidayType   )
		{
		DataTable dt = new DataTable();
		
			DataColumn col_holydayType_ID = new DataColumn("holydayType_ID" , typeof(string));
			DataColumn col_holydayType_Name = new DataColumn("holydayType_Name" , typeof(string));
		...
		dt.Columns.AddRange(new DataColumn[] { col_holydayType_ID,col_holydayType_Name,col_isCanceled,col_userID_Created,col_userID_Modified,col_userID_Canceled,col_terminalID_Created,col_terminalID_Modified,col_terminalID_Canceled,col_date_Created,col_date_Modified,col_date_Canceled,});		return dt;
		}
		/// <summary>
		/// This fills tbl_tasHolidayType datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_tasHolidayType object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_tasHolidayType user) {
		DataRow drow = dt.NewRow();
		
			drow["holydayType_ID"] = user.holydayType_ID;
			drow["holydayType_Name"] = user.holydayType_Name;
