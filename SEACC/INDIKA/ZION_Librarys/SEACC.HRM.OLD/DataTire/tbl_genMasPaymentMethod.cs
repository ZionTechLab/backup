...
namespace DataTire {
	public sealed class tbl_genMasPaymentMethod {
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_genMasPaymentMethod class.
		/// </summary>
		public tbl_genMasPaymentMethod() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_genMasPaymentMethod class.
		/// </summary>
		public tbl_genMasPaymentMethod(string paymentMethod_ID, string paymentMethodName, bool isCanceled, string userID_Created, string userID_Modified, string userID_Canceled, string terminalID_Created, string terminalID_Modified, string terminalID_Canceled, DateTime date_Created, DateTime date_Modified, DateTime date_Canceled) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_genMasPaymentMethod table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasPaymentMethodInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_genMasPaymentMethod table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasPaymentMethodUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_genMasPaymentMethod table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasPaymentMethodDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects a single record from the tbl_genMasPaymentMethod table.
		/// </summary>
		public static tbl_genMasPaymentMethod Select(string paymentMethod_ID_Incoming){

			tbl_genMasPaymentMethod tbl_genMasPaymentMethodins = new tbl_genMasPaymentMethod();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasPaymentMethodSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_genMasPaymentMethodins = Maketbl_genMasPaymentMethod(dataReader);
				} else {
					tbl_genMasPaymentMethodins = null;
				}
			}
			scon.Close();
			return tbl_genMasPaymentMethodins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_genMasPaymentMethod table.
		/// </summary>
		public static List<tbl_genMasPaymentMethod> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasPaymentMethodSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_genMasPaymentMethod> tbl_genMasPaymentMethodList = new List<tbl_genMasPaymentMethod>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_genMasPaymentMethod tbl_genMasPaymentMethod = Maketbl_genMasPaymentMethod(dataReader);
					tbl_genMasPaymentMethodList.Add(tbl_genMasPaymentMethod);
				}
			}
			scon.Close();
			return tbl_genMasPaymentMethodList;
		}
		
		/// <summary>
		/// Creates a new instance of the tbl_genMasPaymentMethod class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_genMasPaymentMethod Maketbl_genMasPaymentMethod(SqlDataReader dataReader) {
			tbl_genMasPaymentMethod tbl_genMasPaymentMethod = new tbl_genMasPaymentMethod();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_genMasPaymentMethod.PaymentMethod_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_genMasPaymentMethod.PaymentMethodName = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_genMasPaymentMethod.IsCanceled = dataReader.GetBoolean(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_genMasPaymentMethod.UserID_Created = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_genMasPaymentMethod.UserID_Modified = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_genMasPaymentMethod.UserID_Canceled = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_genMasPaymentMethod.TerminalID_Created = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_genMasPaymentMethod.TerminalID_Modified = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_genMasPaymentMethod.TerminalID_Canceled = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_genMasPaymentMethod.Date_Created = dataReader.GetDateTime(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_genMasPaymentMethod.Date_Modified = dataReader.GetDateTime(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_genMasPaymentMethod.Date_Canceled = dataReader.GetDateTime(11);
			}

			return tbl_genMasPaymentMethod;
		}
		/// <summary>
		/// This makes tbl_genMasPaymentMethod datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_genMasPaymentMethod object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_genMasPaymentMethod  tbl_genMasPaymentMethod   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_paymentMethod_ID,col_paymentMethodName,col_isCanceled,col_userID_Created,col_userID_Modified,col_userID_Canceled,col_terminalID_Created,col_terminalID_Modified,col_terminalID_Canceled,col_date_Created,col_date_Modified,col_date_Canceled,});		return dt;
		}
		/// <summary>
		/// This fills tbl_genMasPaymentMethod datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_genMasPaymentMethod object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_genMasPaymentMethod user) {
