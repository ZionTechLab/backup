...
namespace DataTire {
	public sealed class tbl_genSection_Stock {
		#region Fields
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_genSection_Stock table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_genSection_Stock table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_genSection_Stock table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_genSection_Stock table by a foreign key.
		/// </summary>
		public static void DeleteAllByItem_ID(string item_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockDeleteAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByJob_ID(string job_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockDeleteAllByJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllBySection_ID(string section_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockDeleteAllBySection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_genSection_Stock table.
		/// </summary>
		public static tbl_genSection_Stock Select(string section_ID_Incoming, string item_ID_Incoming, string job_ID_Incoming, string itemSubCategory_ID_Incoming, string itemSubCategory2_ID_Incoming, string itemSerialNo_Incoming, string itemSerialNo2_Incoming){

			tbl_genSection_Stock tbl_genSection_Stockins = new tbl_genSection_Stock();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_genSection_Stockins = Maketbl_genSection_Stock(dataReader);
				} else {
					tbl_genSection_Stockins = null;
				}
			}
			scon.Close();
			return tbl_genSection_Stockins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_genSection_Stock table.
		/// </summary>
		public static List<tbl_genSection_Stock> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_genSection_Stock> tbl_genSection_StockList = new List<tbl_genSection_Stock>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_genSection_Stock tbl_genSection_Stock = Maketbl_genSection_Stock(dataReader);
					tbl_genSection_StockList.Add(tbl_genSection_Stock);
				}
			}
			scon.Close();
			return tbl_genSection_StockList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_genSection_Stock table by a foreign key.
		/// </summary>
		public static List<tbl_genSection_Stock> SelectAllByItem_ID(string item_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockSelectAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genSection_Stock table by a foreign key.
		/// </summary>
		public static List<tbl_genSection_Stock> SelectAllByJob_ID(string job_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockSelectAllByJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genSection_Stock table by a foreign key.
		/// </summary>
		public static List<tbl_genSection_Stock> SelectAllBySection_ID(string section_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genSection_StockSelectAllBySection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_genSection_Stock class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_genSection_Stock Maketbl_genSection_Stock(SqlDataReader dataReader) {
			tbl_genSection_Stock tbl_genSection_Stock = new tbl_genSection_Stock();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_genSection_Stock.Section_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_genSection_Stock.Item_ID = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_genSection_Stock.Job_ID = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_genSection_Stock.ItemSubCategory_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_genSection_Stock.ItemSubCategory2_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_genSection_Stock.ItemSerialNo = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_genSection_Stock.ItemSerialNo2 = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_genSection_Stock.Qty = dataReader.GetDecimal(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_genSection_Stock.AvailableQty = dataReader.GetDecimal(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_genSection_Stock.Weight = dataReader.GetDecimal(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_genSection_Stock.AvailableWeight = dataReader.GetDecimal(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_genSection_Stock.Meter = dataReader.GetDecimal(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_genSection_Stock.AvailableMeter = dataReader.GetDecimal(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_genSection_Stock.WasteageWeight = dataReader.GetDecimal(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_genSection_Stock.DamageWeight = dataReader.GetDecimal(14);
			}

			return tbl_genSection_Stock;
		}
		/// <summary>
		/// This makes tbl_genSection_Stock datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_genSection_Stock object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_genSection_Stock  tbl_genSection_Stock   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_section_ID,col_item_ID,col_job_ID,col_itemSubCategory_ID,col_itemSubCategory2_ID,col_itemSerialNo,col_itemSerialNo2,col_qty,col_availableQty,col_weight,col_availableWeight,col_meter,col_availableMeter,col_wasteageWeight,col_damageWeight,});		return dt;
		}
		/// <summary>
		/// This fills tbl_genSection_Stock datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_genSection_Stock object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_genSection_Stock user) {
