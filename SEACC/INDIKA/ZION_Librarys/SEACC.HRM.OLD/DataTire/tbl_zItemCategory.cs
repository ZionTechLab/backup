...
namespace DataTire {
	public sealed class tbl_zItemCategory {
		...
		/// Initializes a new instance of the tbl_zItemCategory class.
		/// </summary>
		public tbl_zItemCategory(string itemCategory_ID, string categoryName, string itemType_ID, string prefrix, bool isItemSubCategoryEnabled, bool isItemSubCategory2Enabled, bool isItemSerialNoEnabled, bool isItemSerialNo2Enabled, int categoryCounter, int categoryLength) {
		...
		/// <summary>
		/// Selects all records from the tbl_zItemCategory table by a foreign key.
		/// </summary>
		public static void DeleteAllByItemType_ID(string itemType_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_zItemCategoryDeleteAllByItemType_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		private static tbl_zItemCategory Maketbl_zItemCategory(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(4) == false) {
				tbl_zItemCategory.IsItemSubCategoryEnabled = dataReader.GetBoolean(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_zItemCategory.IsItemSubCategory2Enabled = dataReader.GetBoolean(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_zItemCategory.IsItemSerialNoEnabled = dataReader.GetBoolean(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_zItemCategory.IsItemSerialNo2Enabled = dataReader.GetBoolean(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_zItemCategory.CategoryCounter = dataReader.GetInt32(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_zItemCategory.CategoryLength = dataReader.GetInt32(9);
			}
		...
		dt.Columns.AddRange(new DataColumn[] { col_itemCategory_ID,col_categoryName,col_itemType_ID,col_prefrix,col_isItemSubCategoryEnabled,col_isItemSubCategory2Enabled,col_isItemSerialNoEnabled,col_isItemSerialNo2Enabled,col_categoryCounter,col_categoryLength,});		return dt;
		}
		/// <summary>
