...
namespace DataTire {
	public sealed class tbl_hrMasEmployeeCategory1 {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_hrMasEmployeeCategory1 table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_hrMasEmployeeCategory1Insert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_hrMasEmployeeCategory1 table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_hrMasEmployeeCategory1Update", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_hrMasEmployeeCategory1 table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_hrMasEmployeeCategory1Delete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects a single record from the tbl_hrMasEmployeeCategory1 table.
		/// </summary>
		public static tbl_hrMasEmployeeCategory1 Select(string empCatagory1_ID_Incoming){

			tbl_hrMasEmployeeCategory1 tbl_hrMasEmployeeCategory1ins = new tbl_hrMasEmployeeCategory1();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_hrMasEmployeeCategory1Select", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
			scom.Parameters.Add("@empCatagory1_ID", SqlDbType.VarChar,8);
			scom.Parameters["@empCatagory1_ID"].Value = empCatagory1_ID_Incoming;
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_hrMasEmployeeCategory1ins = Maketbl_hrMasEmployeeCategory1(dataReader);
				} else {
					tbl_hrMasEmployeeCategory1ins = null;
				}
			}
			scon.Close();
			return tbl_hrMasEmployeeCategory1ins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_hrMasEmployeeCategory1 table.
		/// </summary>
		public static List<tbl_hrMasEmployeeCategory1> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_hrMasEmployeeCategory1SelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_hrMasEmployeeCategory1> tbl_hrMasEmployeeCategory1List = new List<tbl_hrMasEmployeeCategory1>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_hrMasEmployeeCategory1 tbl_hrMasEmployeeCategory1 = Maketbl_hrMasEmployeeCategory1(dataReader);
					tbl_hrMasEmployeeCategory1List.Add(tbl_hrMasEmployeeCategory1);
				}
			}
			scon.Close();
			return tbl_hrMasEmployeeCategory1List;
		}
		
		/// <summary>
		/// Creates a new instance of the tbl_hrMasEmployeeCategory1 class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_hrMasEmployeeCategory1 Maketbl_hrMasEmployeeCategory1(SqlDataReader dataReader) {
			tbl_hrMasEmployeeCategory1 tbl_hrMasEmployeeCategory1 = new tbl_hrMasEmployeeCategory1();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_hrMasEmployeeCategory1.EmpCatagory1_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_hrMasEmployeeCategory1.EmpCatagory1_Name = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_hrMasEmployeeCategory1.Remarks = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_hrMasEmployeeCategory1.IsCanceled = dataReader.GetBoolean(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_hrMasEmployeeCategory1.UserID_Created = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_hrMasEmployeeCategory1.UserID_Modified = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_hrMasEmployeeCategory1.UserID_Canceled = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_hrMasEmployeeCategory1.TerminalID_Created = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_hrMasEmployeeCategory1.TerminalID_Modified = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_hrMasEmployeeCategory1.TerminalID_Canceled = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_hrMasEmployeeCategory1.Date_Created = dataReader.GetDateTime(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_hrMasEmployeeCategory1.Date_Modified = dataReader.GetDateTime(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_hrMasEmployeeCategory1.Date_Canceled = dataReader.GetDateTime(12);
			}

			return tbl_hrMasEmployeeCategory1;
		}
		/// <summary>
		/// This makes tbl_hrMasEmployeeCategory1 datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_hrMasEmployeeCategory1 object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_hrMasEmployeeCategory1  tbl_hrMasEmployeeCategory1   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_empCatagory1_ID,col_empCatagory1_Name,col_remarks,col_isCanceled,col_userID_Created,col_userID_Modified,col_userID_Canceled,col_terminalID_Created,col_terminalID_Modified,col_terminalID_Canceled,col_date_Created,col_date_Modified,col_date_Canceled,});		return dt;
		}
		/// <summary>
		/// This fills tbl_hrMasEmployeeCategory1 datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_hrMasEmployeeCategory1 object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_hrMasEmployeeCategory1 user) {
