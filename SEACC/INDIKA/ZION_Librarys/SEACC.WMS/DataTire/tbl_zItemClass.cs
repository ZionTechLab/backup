...
namespace DataTire {
	public sealed class tbl_zItemClass {
		...
		/// Initializes a new instance of the tbl_zItemClass class.
		/// </summary>
		public tbl_zItemClass(string itemClass_ID, string className, string prefrix) {
		...
		dt.Columns.AddRange(new DataColumn[] { col_itemClass_ID,col_className,col_prefrix,});		return dt;
		}
		/// <summary>
