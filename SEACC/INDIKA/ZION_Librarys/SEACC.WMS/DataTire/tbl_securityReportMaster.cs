...
namespace DataTire {
	public sealed class tbl_securityReportMaster {
		...
		/// Initializes a new instance of the tbl_securityReportMaster class.
		/// </summary>
		public tbl_securityReportMaster(int report_ID, int sortOrder, string reportName, string reportCategory_ID, string displayName, string displayName2, string reportPath, bool isEnable, bool isSetPaper, bool isSetPrinter, bool isSetTerminal, bool isSetUser, bool isDefaultPrinter, int printCount) {
		...
		public void Insert() {
			...
			scom.Parameters.Add("@report_ID", SqlDbType.Int,4);
		...
		/// </summary>
		public static tbl_securityReportMaster Select(int report_ID_Incoming){
		...
		private static tbl_securityReportMaster Maketbl_securityReportMaster(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(0) == false) {
				tbl_securityReportMaster.Report_ID = dataReader.GetInt32(0);
			}
		...
		DataTable dt = new DataTable();
			...
			DataColumn col_report_ID = new DataColumn("report_ID" , typeof(int));
