...
namespace DataTire {
	public sealed class tbl_hrMasEmployeeStatus {
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_hrMasEmployeeStatus class.
		/// </summary>
		public tbl_hrMasEmployeeStatus() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_hrMasEmployeeStatus class.
		/// </summary>
		public tbl_hrMasEmployeeStatus(string emp_statusID, string emp_status_Name, bool isCanceled, string userID_Created, string userID_Modified, string userID_Canceled, string terminalID_Created, string terminalID_Modified, string terminalID_Canceled, DateTime date_Created, DateTime date_Modified, DateTime date_Canceled) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_hrMasEmployeeStatus table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_hrMasEmployeeStatusInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_hrMasEmployeeStatus table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_hrMasEmployeeStatusUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_hrMasEmployeeStatus table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_hrMasEmployeeStatusDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects a single record from the tbl_hrMasEmployeeStatus table.
		/// </summary>
		public static tbl_hrMasEmployeeStatus Select(string emp_statusID_Incoming){

			tbl_hrMasEmployeeStatus tbl_hrMasEmployeeStatusins = new tbl_hrMasEmployeeStatus();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_hrMasEmployeeStatusSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
			scom.Parameters.Add("@emp_statusID", SqlDbType.VarChar,8);
			scom.Parameters["@emp_statusID"].Value = emp_statusID_Incoming;
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_hrMasEmployeeStatusins = Maketbl_hrMasEmployeeStatus(dataReader);
				} else {
					tbl_hrMasEmployeeStatusins = null;
				}
			}
			scon.Close();
			return tbl_hrMasEmployeeStatusins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_hrMasEmployeeStatus table.
		/// </summary>
		public static List<tbl_hrMasEmployeeStatus> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_hrMasEmployeeStatusSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_hrMasEmployeeStatus> tbl_hrMasEmployeeStatusList = new List<tbl_hrMasEmployeeStatus>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_hrMasEmployeeStatus tbl_hrMasEmployeeStatus = Maketbl_hrMasEmployeeStatus(dataReader);
					tbl_hrMasEmployeeStatusList.Add(tbl_hrMasEmployeeStatus);
				}
			}
			scon.Close();
			return tbl_hrMasEmployeeStatusList;
		}
		
		/// <summary>
		/// Creates a new instance of the tbl_hrMasEmployeeStatus class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_hrMasEmployeeStatus Maketbl_hrMasEmployeeStatus(SqlDataReader dataReader) {
			tbl_hrMasEmployeeStatus tbl_hrMasEmployeeStatus = new tbl_hrMasEmployeeStatus();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_hrMasEmployeeStatus.Emp_statusID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_hrMasEmployeeStatus.Emp_status_Name = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_hrMasEmployeeStatus.IsCanceled = dataReader.GetBoolean(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_hrMasEmployeeStatus.UserID_Created = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_hrMasEmployeeStatus.UserID_Modified = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_hrMasEmployeeStatus.UserID_Canceled = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_hrMasEmployeeStatus.TerminalID_Created = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_hrMasEmployeeStatus.TerminalID_Modified = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_hrMasEmployeeStatus.TerminalID_Canceled = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_hrMasEmployeeStatus.Date_Created = dataReader.GetDateTime(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_hrMasEmployeeStatus.Date_Modified = dataReader.GetDateTime(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_hrMasEmployeeStatus.Date_Canceled = dataReader.GetDateTime(11);
			}

			return tbl_hrMasEmployeeStatus;
		}
		/// <summary>
		/// This makes tbl_hrMasEmployeeStatus datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_hrMasEmployeeStatus object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_hrMasEmployeeStatus  tbl_hrMasEmployeeStatus   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_emp_statusID,col_emp_status_Name,col_isCanceled,col_userID_Created,col_userID_Modified,col_userID_Canceled,col_terminalID_Created,col_terminalID_Modified,col_terminalID_Canceled,col_date_Created,col_date_Modified,col_date_Canceled,});		return dt;
		}
		/// <summary>
		/// This fills tbl_hrMasEmployeeStatus datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_hrMasEmployeeStatus object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_hrMasEmployeeStatus user) {
