...
namespace DataTire {
	public sealed class tbl_zCustomerCategory {
		...
		/// <summary>
		/// This makes tbl_zCustomerCategory datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_zCustomerCategory object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_zCustomerCategory  tbl_zCustomerCategory   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_customerCategory_ID,col_categoryName,});		return dt;
		}
		/// <summary>
