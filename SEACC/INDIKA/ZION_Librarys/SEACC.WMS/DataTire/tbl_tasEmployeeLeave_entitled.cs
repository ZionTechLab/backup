...
namespace DataTire {
	public sealed class tbl_tasEmployeeLeave_entitled {
		...
		/// Initializes a new instance of the tbl_tasEmployeeLeave_entitled class.
		/// </summary>
		public tbl_tasEmployeeLeave_entitled(string company_ID, string companyBranch_ID, string employee_ID, string hrYear_ID, string leaveType_ID, decimal leaves_Entitled, decimal leaves_Utilized, bool isCanceled, string userID_Created, string userID_Modified, string userID_Canceled, string terminalID_Created, string terminalID_Modified, string terminalID_Canceled, DateTime date_Created, DateTime date_Modified, DateTime date_Canceled) {
		...
		public static void DeleteAllByCompany_ID(string company_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_tasEmployeeLeave_entitledDeleteAllByCompany_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCompany_ID_CompanyBranch_ID(string company_ID, string companyBranch_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_tasEmployeeLeave_entitledDeleteAllByCompany_ID_CompanyBranch_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// </summary>
		public static tbl_tasEmployeeLeave_entitled Select(string company_ID_Incoming, string companyBranch_ID_Incoming, string employee_ID_Incoming, string hrYear_ID_Incoming, string leaveType_ID_Incoming)
        {
		...
		/// Selects all records from the tbl_tasEmployeeLeave_entitled table by a foreign key.
		/// </summary>
		public static List<tbl_tasEmployeeLeave_entitled> SelectAllByCompany_ID(string company_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_tasEmployeeLeave_entitledSelectAllByCompany_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_tasEmployeeLeave_entitled table by a foreign key.
		/// </summary>
		public static List<tbl_tasEmployeeLeave_entitled> SelectAllByCompany_ID_CompanyBranch_ID(string company_ID, string companyBranch_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_tasEmployeeLeave_entitledSelectAllByCompany_ID_CompanyBranch_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
        ...
        /// Selects all records from the tbl_tasEmployeeLeave_entitled table by a foreign key.
        /// </summary>
        public static List<tbl_tasEmployeeLeave_entitled> SelectAllByHrYear_ID(string hrYear_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_tasEmployeeLeave_entitledSelectAllByHrYear_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
		...
		private static tbl_tasEmployeeLeave_entitled Maketbl_tasEmployeeLeave_entitled(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(3) == false) {
				tbl_tasEmployeeLeave_entitled.HrYear_ID = dataReader.GetString(3);
			}
