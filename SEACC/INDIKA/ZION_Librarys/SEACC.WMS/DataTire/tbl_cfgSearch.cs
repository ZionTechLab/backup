...
namespace DataTire {
	public sealed class tbl_cfgSearch {
		...
		/// Initializes a new instance of the tbl_cfgSearch class.
		/// </summary>
		public tbl_cfgSearch(int searchId, string searchName, string displayName, string searchTable, string selection1, string selection2, int width) {
		...
		dt.Columns.AddRange(new DataColumn[] { col_searchId,col_searchName,col_displayName,col_searchTable,col_selection1,col_selection2,col_width,});		return dt;
		}
		/// <summary>
