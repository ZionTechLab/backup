...
namespace DataTire {
	public sealed class tbl_genMasDivision {
		...
		public static void DeleteAllByCompany_ID(string company_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasDivisionDeleteAllByCompany_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCompany_ID_CompanyBranch_ID(string company_ID, string companyBranch_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasDivisionDeleteAllByCompany_ID_CompanyBranch_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// </summary>
		public static tbl_genMasDivision Select(string division_ID_Incoming, string company_ID_Incoming, string companyBranch_ID_Incoming){
		...
		/// Selects all records from the tbl_genMasDivision table by a foreign key.
		/// </summary>
		public static List<tbl_genMasDivision> SelectAllByCompany_ID(string company_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasDivisionSelectAllByCompany_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genMasDivision table by a foreign key.
		/// </summary>
		public static List<tbl_genMasDivision> SelectAllByCompany_ID_CompanyBranch_ID(string company_ID, string companyBranch_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasDivisionSelectAllByCompany_ID_CompanyBranch_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		private static tbl_genMasDivision Maketbl_genMasDivision(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(11) == false) {
				tbl_genMasDivision.IsCanceled = dataReader.GetBoolean(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_genMasDivision.UserID_Created = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_genMasDivision.UserID_Modified = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_genMasDivision.UserID_Canceled = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_genMasDivision.TerminalID_Created = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_genMasDivision.TerminalID_Modified = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_genMasDivision.TerminalID_Canceled = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_genMasDivision.Date_Created = dataReader.GetDateTime(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_genMasDivision.Date_Modified = dataReader.GetDateTime(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_genMasDivision.Date_Canceled = dataReader.GetDateTime(20);
			}
