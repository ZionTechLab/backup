...
namespace DataTire {
	public sealed class sp_genMasEmployee {
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the sp_genMasEmployee class.
		/// </summary>
		public sp_genMasEmployee() {
		}
		
		/// <summary>
		/// Initializes a new instance of the sp_genMasEmployee class.
		/// </summary>
		public sp_genMasEmployee(string employee_ID, string employee_ID2, string titleID, string title, string fullName, string initails, string surName, string aliasName, string nicNo, string drivingLic_No, string passportNo, string nationality_ID, string nationality, string religion_ID, string religion, DateTime dateOfBirth, DateTime dateOfMerrage, string addressLine1, string addressLine2, string addressLine3, string town_ID, string townName, string city_ID, string cityName, string district_ID, string districtName, string country_ID, string countryName, string postalCode_ID, string gs_DivisionCode, string province_ID, string provinceName, string telephone_Home, string telephone_Office, string telephone_Ext, int gender, int civilState, string mobile1, string mobile2, string mobile_Office, string emrg_Contact1, string emrg_ContactPerson1, string emrg_Contact2, string emrg_ContactPerson2, string email, string email_office, string epfNo, string designation_ID, string designation_name, string empCatagory1_ID, string empCatagory1_Name, string empCatagory2_ID, string empCatagory2_Name, string empCatagory3_ID, string empCatagory3_Name, string department_ID, string departmentName, string division_ID, string divisionName, string sectionID, string section_Name, string subSectionID, string subSectionName, string recuirtmentType, string employee_RecuirtmentType, DateTime dateJoin, DateTime dateConfirm, DateTime dateTerminate, DateTime lastWorkingDate, DateTime payrollEndDate, DateTime visaEndDate, string managerID, string supevisorID, string shift_ID, string shift_Name, bool isTime_Attendance, bool isPayrall_Process, bool isPayslip_Print, bool isEPF_ETF_Process, bool is_PayeeProcess, string paymentMethod_ID, string paymentMethodName, string employee_AccountName, string employee_AccountNo, string bank_ID, string bankName, string bankBranch_ID,string bankBranch_Code ,string branchName, string payroll_Level, string payrollLavel, string emp_statusID, string emp_status_Name, byte[] employee_Image, bool isSportman, bool isSalesManager, bool isAreaManager, bool isSelesRep, bool isSalesExecutive, bool isDriver, bool isAssistant, bool isOperator, decimal salesTarget, decimal minimumSalesTarget, decimal commisionPersentage_Normal, decimal commisionPersentage_Bones, bool isCanceled, string userID_Created, string userID_Modified, string userID_Canceled, string terminalID_Created, string terminalID_Modified, string terminalID_Canceled, DateTime date_Created, DateTime date_Modified, DateTime date_Canceled) {
		...
		/// <summary>
		/// Gets or sets the EmpCatagory1_Name value.
		/// </summary>
		public string EmpCatagory1_Name {
			get { return empCatagory1_Name; }
			set { empCatagory1_Name = value; }
		}
		...
		/// <summary>
		/// Gets or sets the EmpCatagory3_Name value.
		/// </summary>
		public string EmpCatagory3_Name {
			get { return empCatagory3_Name; }
			set { empCatagory3_Name = value; }
		}
		...
		/// <summary>
		/// Gets or sets the Emp_status_Name value.
		/// </summary>
		...
		#region Methods
		/// <summary>
		/// Saves a record to the sp_genMasEmployee table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("sp_genMasEmployeeInsert", scon);
			...
			scom.Parameters.Add("@title", SqlDbType.VarChar,50);
			...
			scom.Parameters.Add("@religion", SqlDbType.VarChar,50);
			...
			scom.Parameters.Add("@empCatagory1_Name", SqlDbType.VarChar,50);
			...
			scom.Parameters.Add("@empCatagory3_Name", SqlDbType.VarChar,50);
			...
			scom.Parameters.Add("@emp_status_Name", SqlDbType.VarChar,100);
			...
			scom.Parameters["@religion"].Value = religion;
			...
			scom.Parameters["@empCatagory1_Name"].Value = empCatagory1_Name;
			...
			scom.Parameters["@empCatagory3_Name"].Value = empCatagory3_Name;
			...
			scom.Parameters["@emp_status_Name"].Value = emp_status_Name;
		...
		/// <summary>
		/// Updates a record in the sp_genMasEmployee table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("sp_genMasEmployeeUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the sp_genMasEmployee table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("sp_genMasEmployeeDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects a single record from the sp_genMasEmployee table.
		/// </summary>
		public static sp_genMasEmployee Select(string employee_ID_Incoming){

			sp_genMasEmployee sp_genMasEmployeeins = new sp_genMasEmployee();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("sp_genMasEmployeeSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					sp_genMasEmployeeins = Makesp_genMasEmployee(dataReader);
				} else {
					sp_genMasEmployeeins = null;
				}
			}
			scon.Close();
			return sp_genMasEmployeeins;
		}
		
		/// <summary>
		/// Selects all records from the sp_genMasEmployee table.
		/// </summary>
		public static List<sp_genMasEmployee> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("sp_genMasEmployeeSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<sp_genMasEmployee> sp_genMasEmployeeList = new List<sp_genMasEmployee>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					sp_genMasEmployee sp_genMasEmployee = Makesp_genMasEmployee(dataReader);
					sp_genMasEmployeeList.Add(sp_genMasEmployee);
				}
			}
			scon.Close();
			return sp_genMasEmployeeList;
		}
		
		/// <summary>
		/// Creates a new instance of the sp_genMasEmployee class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static sp_genMasEmployee Makesp_genMasEmployee(SqlDataReader dataReader) {
			sp_genMasEmployee sp_genMasEmployee = new sp_genMasEmployee();
			
			if (dataReader.IsDBNull(0) == false) {
				sp_genMasEmployee.Employee_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				sp_genMasEmployee.Employee_ID2 = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				sp_genMasEmployee.TitleID = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				sp_genMasEmployee.Title = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				sp_genMasEmployee.FullName = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				sp_genMasEmployee.Initails = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				sp_genMasEmployee.SurName = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				sp_genMasEmployee.AliasName = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				sp_genMasEmployee.NicNo = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				sp_genMasEmployee.DrivingLic_No = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				sp_genMasEmployee.PassportNo = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				sp_genMasEmployee.Nationality_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				sp_genMasEmployee.Nationality = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				sp_genMasEmployee.Religion_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				sp_genMasEmployee.Religion = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				sp_genMasEmployee.DateOfBirth = dataReader.GetDateTime(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				sp_genMasEmployee.DateOfMerrage = dataReader.GetDateTime(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				sp_genMasEmployee.AddressLine1 = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				sp_genMasEmployee.AddressLine2 = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				sp_genMasEmployee.AddressLine3 = dataReader.GetString(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				sp_genMasEmployee.Town_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				sp_genMasEmployee.TownName = dataReader.GetString(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				sp_genMasEmployee.City_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				sp_genMasEmployee.CityName = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				sp_genMasEmployee.District_ID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				sp_genMasEmployee.DistrictName = dataReader.GetString(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				sp_genMasEmployee.Country_ID = dataReader.GetString(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				sp_genMasEmployee.CountryName = dataReader.GetString(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				sp_genMasEmployee.PostalCode_ID = dataReader.GetString(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				sp_genMasEmployee.Gs_DivisionCode = dataReader.GetString(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				sp_genMasEmployee.Province_ID = dataReader.GetString(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				sp_genMasEmployee.ProvinceName = dataReader.GetString(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				sp_genMasEmployee.Telephone_Home = dataReader.GetString(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				sp_genMasEmployee.Telephone_Office = dataReader.GetString(33);
			}
			if (dataReader.IsDBNull(34) == false) {
				sp_genMasEmployee.Telephone_Ext = dataReader.GetString(34);
			}
			if (dataReader.IsDBNull(35) == false) {
				sp_genMasEmployee.Gender = dataReader.GetInt32(35);
			}
			if (dataReader.IsDBNull(36) == false) {
				sp_genMasEmployee.CivilState = dataReader.GetInt32(36);
			}
			if (dataReader.IsDBNull(37) == false) {
				sp_genMasEmployee.Mobile1 = dataReader.GetString(37);
			}
			if (dataReader.IsDBNull(38) == false) {
				sp_genMasEmployee.Mobile2 = dataReader.GetString(38);
			}
			if (dataReader.IsDBNull(39) == false) {
				sp_genMasEmployee.Mobile_Office = dataReader.GetString(39);
			}
			if (dataReader.IsDBNull(40) == false) {
				sp_genMasEmployee.Emrg_Contact1 = dataReader.GetString(40);
			}
			if (dataReader.IsDBNull(41) == false) {
				sp_genMasEmployee.Emrg_ContactPerson1 = dataReader.GetString(41);
			}
			if (dataReader.IsDBNull(42) == false) {
				sp_genMasEmployee.Emrg_Contact2 = dataReader.GetString(42);
			}
			if (dataReader.IsDBNull(43) == false) {
				sp_genMasEmployee.Emrg_ContactPerson2 = dataReader.GetString(43);
			}
			if (dataReader.IsDBNull(44) == false) {
				sp_genMasEmployee.Email = dataReader.GetString(44);
			}
			if (dataReader.IsDBNull(45) == false) {
				sp_genMasEmployee.Email_office = dataReader.GetString(45);
			}
			if (dataReader.IsDBNull(46) == false) {
				sp_genMasEmployee.EpfNo = dataReader.GetString(46);
			}
			if (dataReader.IsDBNull(47) == false) {
				sp_genMasEmployee.Designation_ID = dataReader.GetString(47);
			}
			if (dataReader.IsDBNull(48) == false) {
				sp_genMasEmployee.Designation_name = dataReader.GetString(48);
			}
			if (dataReader.IsDBNull(49) == false) {
				sp_genMasEmployee.EmpCatagory1_ID = dataReader.GetString(49);
			}
			if (dataReader.IsDBNull(50) == false) {
				sp_genMasEmployee.EmpCatagory1_Name = dataReader.GetString(50);
			}
			if (dataReader.IsDBNull(51) == false) {
				sp_genMasEmployee.EmpCatagory2_ID = dataReader.GetString(51);
			}
			if (dataReader.IsDBNull(52) == false) {
				sp_genMasEmployee.EmpCatagory2_Name = dataReader.GetString(52);
			}
			if (dataReader.IsDBNull(53) == false) {
				sp_genMasEmployee.EmpCatagory3_ID = dataReader.GetString(53);
			}
			if (dataReader.IsDBNull(54) == false) {
				sp_genMasEmployee.EmpCatagory3_Name = dataReader.GetString(54);
			}
			if (dataReader.IsDBNull(55) == false) {
				sp_genMasEmployee.Department_ID = dataReader.GetString(55);
			}
			if (dataReader.IsDBNull(56) == false) {
				sp_genMasEmployee.DepartmentName = dataReader.GetString(56);
			}
			if (dataReader.IsDBNull(57) == false) {
				sp_genMasEmployee.Division_ID = dataReader.GetString(57);
			}
			if (dataReader.IsDBNull(58) == false) {
				sp_genMasEmployee.DivisionName = dataReader.GetString(58);
			}
			if (dataReader.IsDBNull(59) == false) {
				sp_genMasEmployee.SectionID = dataReader.GetString(59);
			}
			if (dataReader.IsDBNull(60) == false) {
				sp_genMasEmployee.Section_Name = dataReader.GetString(60);
			}
			if (dataReader.IsDBNull(61) == false) {
				sp_genMasEmployee.SubSectionID = dataReader.GetString(61);
			}
			if (dataReader.IsDBNull(62) == false) {
				sp_genMasEmployee.SubSectionName = dataReader.GetString(62);
			}
			if (dataReader.IsDBNull(63) == false) {
				sp_genMasEmployee.RecuirtmentType = dataReader.GetString(63);
			}
			if (dataReader.IsDBNull(64) == false) {
				sp_genMasEmployee.Employee_RecuirtmentType = dataReader.GetString(64);
			}
			if (dataReader.IsDBNull(65) == false) {
				sp_genMasEmployee.DateJoin = dataReader.GetDateTime(65);
			}
			if (dataReader.IsDBNull(66) == false) {
				sp_genMasEmployee.DateConfirm = dataReader.GetDateTime(66);
			}
			if (dataReader.IsDBNull(67) == false) {
				sp_genMasEmployee.DateTerminate = dataReader.GetDateTime(67);
			}
			if (dataReader.IsDBNull(68) == false) {
				sp_genMasEmployee.LastWorkingDate = dataReader.GetDateTime(68);
			}
			if (dataReader.IsDBNull(69) == false) {
				sp_genMasEmployee.PayrollEndDate = dataReader.GetDateTime(69);
			}
			if (dataReader.IsDBNull(70) == false) {
				sp_genMasEmployee.VisaEndDate = dataReader.GetDateTime(70);
			}
			if (dataReader.IsDBNull(71) == false) {
				sp_genMasEmployee.ManagerID = dataReader.GetString(71);
			}
			if (dataReader.IsDBNull(72) == false) {
				sp_genMasEmployee.SupevisorID = dataReader.GetString(72);
			}
			if (dataReader.IsDBNull(73) == false) {
				sp_genMasEmployee.Shift_ID = dataReader.GetString(73);
			}
			if (dataReader.IsDBNull(74) == false) {
				sp_genMasEmployee.Shift_Name = dataReader.GetString(74);
			}
			if (dataReader.IsDBNull(75) == false) {
				sp_genMasEmployee.IsTime_Attendance = dataReader.GetBoolean(75);
			}
			if (dataReader.IsDBNull(76) == false) {
				sp_genMasEmployee.IsPayrall_Process = dataReader.GetBoolean(76);
			}
			if (dataReader.IsDBNull(77) == false) {
				sp_genMasEmployee.IsPayslip_Print = dataReader.GetBoolean(77);
			}
			if (dataReader.IsDBNull(78) == false) {
				sp_genMasEmployee.IsEPF_ETF_Process = dataReader.GetBoolean(78);
			}
			if (dataReader.IsDBNull(79) == false) {
				sp_genMasEmployee.Is_PayeeProcess = dataReader.GetBoolean(79);
			}
			if (dataReader.IsDBNull(80) == false) {
				sp_genMasEmployee.PaymentMethod_ID = dataReader.GetString(80);
			}
			if (dataReader.IsDBNull(81) == false) {
				sp_genMasEmployee.PaymentMethodName = dataReader.GetString(81);
			}
			if (dataReader.IsDBNull(82) == false) {
				sp_genMasEmployee.Employee_AccountName = dataReader.GetString(82);
			}
			if (dataReader.IsDBNull(83) == false) {
				sp_genMasEmployee.Employee_AccountNo = dataReader.GetString(83);
			}
			if (dataReader.IsDBNull(84) == false) {
				sp_genMasEmployee.Bank_ID = dataReader.GetString(84);
			}
			if (dataReader.IsDBNull(85) == false) {
				sp_genMasEmployee.BankName = dataReader.GetString(85);
			}
			if (dataReader.IsDBNull(86) == false) {
				sp_genMasEmployee.BankBranch_ID = dataReader.GetString(86);
			}
            if (dataReader.IsDBNull(87) == false)
            {
                sp_genMasEmployee.BankBranch_Code = dataReader.GetString(87);
            }
			if (dataReader.IsDBNull(88) == false) {
				sp_genMasEmployee.BranchName = dataReader.GetString(88);
			}
			if (dataReader.IsDBNull(89) == false) {
				sp_genMasEmployee.Payroll_Level = dataReader.GetString(89);
			}
			if (dataReader.IsDBNull(90) == false) {
				sp_genMasEmployee.PayrollLavel = dataReader.GetString(90);
			}
			if (dataReader.IsDBNull(91) == false) {
				sp_genMasEmployee.Emp_statusID = dataReader.GetString(91);
			}
			if (dataReader.IsDBNull(92) == false) {
				sp_genMasEmployee.Emp_status_Name = dataReader.GetString(92);
			}
			if (dataReader.IsDBNull(93) == false) {
                sp_genMasEmployee.Employee_Image = (byte[])dataReader[93];
			}
			if (dataReader.IsDBNull(94) == false) {
				sp_genMasEmployee.IsSportman = dataReader.GetBoolean(94);
			}
			if (dataReader.IsDBNull(95) == false) {
				sp_genMasEmployee.IsSalesManager = dataReader.GetBoolean(95);
			}
			if (dataReader.IsDBNull(96) == false) {
				sp_genMasEmployee.IsAreaManager = dataReader.GetBoolean(96);
			}
			if (dataReader.IsDBNull(97) == false) {
				sp_genMasEmployee.IsSelesRep = dataReader.GetBoolean(97);
			}
			if (dataReader.IsDBNull(98) == false) {
				sp_genMasEmployee.IsSalesExecutive = dataReader.GetBoolean(98);
			}
			if (dataReader.IsDBNull(99) == false) {
				sp_genMasEmployee.IsDriver = dataReader.GetBoolean(99);
			}
			if (dataReader.IsDBNull(100) == false) {
				sp_genMasEmployee.IsAssistant = dataReader.GetBoolean(100);
			}
			if (dataReader.IsDBNull(101) == false) {
				sp_genMasEmployee.IsOperator = dataReader.GetBoolean(101);
			}
			if (dataReader.IsDBNull(102) == false) {
				sp_genMasEmployee.SalesTarget = dataReader.GetDecimal(102);
			}
			if (dataReader.IsDBNull(103) == false) {
				sp_genMasEmployee.MinimumSalesTarget = dataReader.GetDecimal(103);
			}
			if (dataReader.IsDBNull(104) == false) {
				sp_genMasEmployee.CommisionPersentage_Normal = dataReader.GetDecimal(104);
			}
			if (dataReader.IsDBNull(105) == false) {
				sp_genMasEmployee.CommisionPersentage_Bones = dataReader.GetDecimal(105);
			}
			if (dataReader.IsDBNull(106) == false) {
				sp_genMasEmployee.IsCanceled = dataReader.GetBoolean(106);
			}
			if (dataReader.IsDBNull(107) == false) {
				sp_genMasEmployee.UserID_Created = dataReader.GetString(107);
			}
			if (dataReader.IsDBNull(108) == false) {
				sp_genMasEmployee.UserID_Modified = dataReader.GetString(108);
			}
			if (dataReader.IsDBNull(109) == false) {
				sp_genMasEmployee.UserID_Canceled = dataReader.GetString(109);
			}
			if (dataReader.IsDBNull(110) == false) {
				sp_genMasEmployee.TerminalID_Created = dataReader.GetString(110);
			}
			if (dataReader.IsDBNull(111) == false) {
				sp_genMasEmployee.TerminalID_Modified = dataReader.GetString(111);
			}
			if (dataReader.IsDBNull(112) == false) {
				sp_genMasEmployee.TerminalID_Canceled = dataReader.GetString(112);
			}
			if (dataReader.IsDBNull(113) == false) {
				sp_genMasEmployee.Date_Created = dataReader.GetDateTime(113);
			}
			if (dataReader.IsDBNull(114) == false) {
				sp_genMasEmployee.Date_Modified = dataReader.GetDateTime(114);
			}
			if (dataReader.IsDBNull(115) == false) {
				sp_genMasEmployee.Date_Canceled = dataReader.GetDateTime(115);
			}

			return sp_genMasEmployee;
		}
		/// <summary>
		/// This makes sp_genMasEmployee datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new sp_genMasEmployee object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( sp_genMasEmployee  sp_genMasEmployee   )
		{
		DataTable dt = new DataTable();
			...
			DataColumn col_religion = new DataColumn("religion" , typeof(string));
			...
			DataColumn col_empCatagory1_Name = new DataColumn("empCatagory1_Name" , typeof(string));
			...
			DataColumn col_empCatagory3_Name = new DataColumn("empCatagory3_Name" , typeof(string));
            ...
            DataColumn col_bankBranch_Code = new DataColumn("bankBranch_ID", typeof(string));
			...
			DataColumn col_emp_status_Name = new DataColumn("emp_status_Name" , typeof(string));
		...
		dt.Columns.AddRange(new DataColumn[] { col_employee_ID,col_employee_ID2,col_titleID,col_title,col_fullName,col_initails,col_surName,col_aliasName,col_nicNo,col_drivingLic_No,col_passportNo,col_nationality_ID,col_nationality,col_religion_ID,col_religion,col_dateOfBirth,col_dateOfMerrage,col_addressLine1,col_addressLine2,col_addressLine3,col_town_ID,col_townName,col_city_ID,col_cityName,col_district_ID,col_districtName,col_country_ID,col_countryName,col_postalCode_ID,col_gs_DivisionCode,col_province_ID,col_provinceName,col_telephone_Home,col_telephone_Office,col_telephone_Ext,col_gender,col_civilState,col_mobile1,col_mobile2,col_mobile_Office,col_emrg_Contact1,col_emrg_ContactPerson1,col_emrg_Contact2,col_emrg_ContactPerson2,col_email,col_email_office,col_epfNo,col_designation_ID,col_designation_name,col_empCatagory1_ID,col_empCatagory1_Name,col_empCatagory2_ID,col_empCatagory2_Name,col_empCatagory3_ID,col_empCatagory3_Name,col_department_ID,col_departmentName,col_division_ID,col_divisionName,col_sectionID,col_section_Name,col_subSectionID,col_subSectionName,col_recuirtmentType,col_employee_RecuirtmentType,col_dateJoin,col_dateConfirm,col_dateTerminate,col_lastWorkingDate,col_payrollEndDate,col_visaEndDate,col_managerID,col_supevisorID,col_shift_ID,col_shift_Name,col_isTime_Attendance,col_isPayrall_Process,col_isPayslip_Print,col_isEPF_ETF_Process,col_is_PayeeProcess,col_paymentMethod_ID,col_paymentMethodName,col_employee_AccountName,col_employee_AccountNo,col_bank_ID,col_bankName,col_bankBranch_ID,col_branchName,col_payroll_Level,col_PayrollLavel,col_emp_statusID,col_emp_status_Name,col_employee_Image,col_isSportman,col_isSalesManager,col_isAreaManager,col_isSelesRep,col_isSalesExecutive,col_isDriver,col_isAssistant,col_isOperator,col_salesTarget,col_minimumSalesTarget,col_commisionPersentage_Normal,col_commisionPersentage_Bones,col_isCanceled,col_userID_Created,col_userID_Modified,col_userID_Canceled,col_terminalID_Created,col_terminalID_Modified,col_terminalID_Canceled,col_date_Created,col_date_Modified,col_date_Canceled,});		return dt;
		}
		/// <summary>
		/// This fills sp_genMasEmployee datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new sp_genMasEmployee object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, sp_genMasEmployee user) {
		DataRow drow = dt.NewRow();
			...
			drow["empCatagory1_Name"] = user.empCatagory1_Name;
			...
			drow["empCatagory3_Name"] = user.empCatagory3_Name;
			...
			drow["emp_status_Name"] = user.emp_status_Name;
