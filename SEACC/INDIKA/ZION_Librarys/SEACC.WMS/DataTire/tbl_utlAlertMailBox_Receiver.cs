...
namespace DataTire {
	public sealed class tbl_utlAlertMailBox_Receiver {
		...
		/// <summary>
		/// Selects all records from the tbl_utlAlertMailBox_Receiver table by a foreign key.
		/// </summary>
		public static void DeleteAllByEMail_ID(int eMail_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_utlAlertMailBox_ReceiverDeleteAllByEMail_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_utlAlertMailBox_Receiver table by a foreign key.
		/// </summary>
		public static List<tbl_utlAlertMailBox_Receiver> SelectAllByEMail_ID(int eMail_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_utlAlertMailBox_ReceiverSelectAllByEMail_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
