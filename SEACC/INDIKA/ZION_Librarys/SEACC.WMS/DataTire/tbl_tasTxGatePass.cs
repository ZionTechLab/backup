...
namespace DataTire {
	public sealed class tbl_tasTxGatePass {
		...
		public void Insert() {
			...
			scom.Parameters.Add("@terminalID_bataApproved", SqlDbType.VarChar,30);
		...
		private static tbl_tasTxGatePass Maketbl_tasTxGatePass(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(8) == false) {
				tbl_tasTxGatePass.GatePass_DateTime = dataReader.GetDateTime(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_tasTxGatePass.Leave_Hours = dataReader.GetDecimal(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_tasTxGatePass.Reason = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_tasTxGatePass.IsBataPayable = dataReader.GetBoolean(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_tasTxGatePass.BataAmount = dataReader.GetDecimal(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_tasTxGatePass.IsCanceled = dataReader.GetBoolean(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_tasTxGatePass.ApprovalStatus_Supevosior = dataReader.GetInt32(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_tasTxGatePass.ApprovalStatus_Manager = dataReader.GetInt32(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_tasTxGatePass.UserID_Created = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_tasTxGatePass.UserID_Modified = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_tasTxGatePass.UserID_Canceled = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_tasTxGatePass.UserID_Supevisor = dataReader.GetString(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_tasTxGatePass.UserID_Manager = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_tasTxGatePass.UserIDbataApproved = dataReader.GetString(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_tasTxGatePass.TerminalID_Created = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_tasTxGatePass.TerminalID_Modified = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_tasTxGatePass.TerminalID_Canceled = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_tasTxGatePass.TerminalID_Supevisor = dataReader.GetString(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_tasTxGatePass.TerminalID_Manager = dataReader.GetString(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_tasTxGatePass.TerminalID_bataApproved = dataReader.GetString(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_tasTxGatePass.Date_Created = dataReader.GetDateTime(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_tasTxGatePass.Date_Modified = dataReader.GetDateTime(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_tasTxGatePass.Date_Canceled = dataReader.GetDateTime(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_tasTxGatePass.Date_Checked_Supevisor = dataReader.GetDateTime(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_tasTxGatePass.Date_Checked_Manager = dataReader.GetDateTime(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_tasTxGatePass.Date_bataApproved = dataReader.GetDateTime(33);
			}
