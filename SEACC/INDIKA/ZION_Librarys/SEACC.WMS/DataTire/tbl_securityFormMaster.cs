...
namespace DataTire
{
    public sealed class tbl_securityFormMaster
    {
        ...
        /// Initializes a new instance of the tbl_securityFormMaster class.
        /// </summary>
        public tbl_securityFormMaster(int form_ID, int sortOrder, string formName, byte[] image, string formCategory_ID, string displayName, bool isEnable, bool isVisible, bool isViewer, int counter, int length, string prefix1, bool isAutoGenerate)
        {
        ...
        private static tbl_securityFormMaster Maketbl_securityFormMaster(SqlDataReader dataReader)
        {
            ...
            {
                tbl_securityFormMaster.Counter = dataReader.GetInt32(9);
            }
            if (dataReader.IsDBNull(10) == false)
            {
                tbl_securityFormMaster.Length = dataReader.GetInt32(10);
            }
            if (dataReader.IsDBNull(11) == false)
            {
                tbl_securityFormMaster.Prefix1 = dataReader.GetString(11);
            }
            if (dataReader.IsDBNull(12) == false)
            {
                tbl_securityFormMaster.IsAutoGenerate = dataReader.GetBoolean(12);
            }
		...
		dt.Columns.AddRange(new DataColumn[] { col_form_ID,col_sortOrder,col_formName,col_image,col_formCategory_ID,col_displayName,col_isEnable,col_isVisible,col_isViewer,col_counter,col_length,col_prefix1,col_isAutoGenerate,});		return dt;
		}
        /// <summary>
