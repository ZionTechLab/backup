...
namespace DataTire {
	public sealed class tbl_utlAlert_Shedule {
		...
		/// Initializes a new instance of the tbl_utlAlert_Shedule class.
		/// </summary>
		public tbl_utlAlert_Shedule(int alert_ID, bool isActive, bool isDaily, bool isWeekly, bool isMonthly, bool isYearly, DateTime sheduledTime, DateTime lastAlert_SentTime, bool isLocked) {
		...
		private static tbl_utlAlert_Shedule Maketbl_utlAlert_Shedule(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(8) == false) {
				tbl_utlAlert_Shedule.IsLocked = dataReader.GetBoolean(8);
			}
		...
		dt.Columns.AddRange(new DataColumn[] { col_alert_ID,col_isActive,col_isDaily,col_isWeekly,col_isMonthly,col_isYearly,col_sheduledTime,col_lastAlert_SentTime,col_isLocked,});		return dt;
		}
		/// <summary>
