...
namespace DataTire {
	public sealed class tbl_zCustomerClass {
		...
		/// <summary>
		/// This makes tbl_zCustomerClass datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_zCustomerClass object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_zCustomerClass  tbl_zCustomerClass   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_customerClass_ID,col_className,});		return dt;
		}
		/// <summary>
