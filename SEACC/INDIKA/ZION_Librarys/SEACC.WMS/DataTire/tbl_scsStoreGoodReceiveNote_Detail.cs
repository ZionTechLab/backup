...
namespace DataTire {
	public sealed class tbl_scsStoreGoodReceiveNote_Detail {
		...
		/// Initializes a new instance of the tbl_scsStoreGoodReceiveNote_Detail class.
		/// </summary>
		public tbl_scsStoreGoodReceiveNote_Detail(int line_No, string storeGoodReceiveNote_ID, string item_ID, string itemSubCategory_ID, string itemSubCategory2_ID, string itemSerialNo, string itemSerialNo2, string job_ID, string fromSelectArea_ID, string fromDepartment_ID, string fromSection_ID, string fromStore_ID, string toStore_ID, string departmentGoodIssueNote_ID, string sectionGoodIssueNote_ID, string storeGoodIssueNote_ID, string uom_ID, decimal qty, decimal qtySettle, decimal weight, decimal weightSettle, decimal tatalCost_FIFO, decimal tatalCost_WA, string remark, bool isLocked) {
		...
		/// </summary>
		public static tbl_scsStoreGoodReceiveNote_Detail Select(string storeGoodReceiveNote_ID_Incoming, string item_ID_Incoming, string itemSubCategory_ID_Incoming, string itemSubCategory2_ID_Incoming, string itemSerialNo_Incoming, string itemSerialNo2_Incoming){
