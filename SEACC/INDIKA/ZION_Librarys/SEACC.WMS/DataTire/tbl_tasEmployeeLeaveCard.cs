...
namespace DataTire {
	public sealed class tbl_tasEmployeeLeaveCard {
        ...
        public static tbl_tasEmployeeLeaveCard Select(string leave_ID_Incoming)
        {
        ...
        /// </summary>
        public static List<tbl_tasEmployeeLeaveCard> SelectAllByCompany_ID_CompanyBranch_ID(string company_ID, string companyBranch_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_tasEmployeeLeaveCardSelectAllByCompany_ID_CompanyBranch_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
        ...
        public static List<tbl_tasEmployeeLeaveCard> SelectAllByEmployee_ID(string employee_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_tasEmployeeLeaveCardSelectAllByEmployee_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
        ...
        /// Selects all records from the tbl_tasEmployeeLeaveCard table by a foreign key.
        /// </summary>
        public static List<tbl_tasEmployeeLeaveCard> SelectAllByCompany_ID(string company_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_tasEmployeeLeaveCardSelectAllByCompany_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
		...
		private static tbl_tasEmployeeLeaveCard Maketbl_tasEmployeeLeaveCard(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(4) == false) {
				tbl_tasEmployeeLeaveCard.Leave_Start = dataReader.GetDateTime(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_tasEmployeeLeaveCard.Leave_End = dataReader.GetDateTime(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_tasEmployeeLeaveCard.LeaveType_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_tasEmployeeLeaveCard.Leaves_Utilized = dataReader.GetDecimal(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_tasEmployeeLeaveCard.Reason = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_tasEmployeeLeaveCard.ApprovalStatus_CP1 = dataReader.GetInt32(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_tasEmployeeLeaveCard.ApprovalStatus_CP2 = dataReader.GetInt32(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_tasEmployeeLeaveCard.ApprovalStatus_Supevosior = dataReader.GetInt32(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_tasEmployeeLeaveCard.ApprovalStatus_Manager = dataReader.GetInt32(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_tasEmployeeLeaveCard.Comments_CP1 = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_tasEmployeeLeaveCard.Comments_CP2 = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_tasEmployeeLeaveCard.Comments_Supevisor = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_tasEmployeeLeaveCard.Comments_Manager = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_tasEmployeeLeaveCard.IsCancled = dataReader.GetBoolean(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_tasEmployeeLeaveCard.UserID_Created = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_tasEmployeeLeaveCard.UserID_Modified = dataReader.GetString(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_tasEmployeeLeaveCard.UserID_Canceled = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_tasEmployeeLeaveCard.UserID_CP1 = dataReader.GetString(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_tasEmployeeLeaveCard.UserID_CP2 = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_tasEmployeeLeaveCard.UserID_Supevisor = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_tasEmployeeLeaveCard.UserID_Manager = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_tasEmployeeLeaveCard.TerminalID_Created = dataReader.GetString(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_tasEmployeeLeaveCard.TerminalID_Modified = dataReader.GetString(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_tasEmployeeLeaveCard.TerminalID_Canceled = dataReader.GetString(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_tasEmployeeLeaveCard.TerminalID_CP1 = dataReader.GetString(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_tasEmployeeLeaveCard.TerminalID_CP2 = dataReader.GetString(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_tasEmployeeLeaveCard.TerminalID_Supevisor = dataReader.GetString(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_tasEmployeeLeaveCard.TerminalID_Manager = dataReader.GetString(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_tasEmployeeLeaveCard.Date_Created = dataReader.GetDateTime(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_tasEmployeeLeaveCard.Date_Modified = dataReader.GetDateTime(33);
			}
			if (dataReader.IsDBNull(34) == false) {
				tbl_tasEmployeeLeaveCard.Date_Canceled = dataReader.GetDateTime(34);
			}
			if (dataReader.IsDBNull(35) == false) {
				tbl_tasEmployeeLeaveCard.Date_Checked_CP1 = dataReader.GetDateTime(35);
			}
			if (dataReader.IsDBNull(36) == false) {
				tbl_tasEmployeeLeaveCard.Date_Checked_CP2 = dataReader.GetDateTime(36);
			}
			if (dataReader.IsDBNull(37) == false) {
				tbl_tasEmployeeLeaveCard.Date_Checked_Supevisor = dataReader.GetDateTime(37);
			}
			if (dataReader.IsDBNull(38) == false) {
				tbl_tasEmployeeLeaveCard.Date_Checked_Manager = dataReader.GetDateTime(38);
			}
