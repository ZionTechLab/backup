...
namespace DataTire {
	public sealed class tbl_genMasEmployee {
		...
		public static void DeleteAllByCompany_ID(string company_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasEmployeeDeleteAllByCompany_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genMasEmployee table by a foreign key.
		/// </summary>
		public static void DeleteAllByEmp_statusID(string emp_statusID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasEmployeeDeleteAllByEmp_statusID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCompany_ID_CompanyBranch_ID(string company_ID, string companyBranch_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasEmployeeDeleteAllByCompany_ID_CompanyBranch_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genMasEmployee table by a foreign key.
		/// </summary>
		public static List<tbl_genMasEmployee> SelectAllByCompany_ID(string company_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasEmployeeSelectAllByCompany_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genMasEmployee table by a foreign key.
		/// </summary>
		public static List<tbl_genMasEmployee> SelectAllByEmp_statusID(string emp_statusID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasEmployeeSelectAllByEmp_statusID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_genMasEmployee table by a foreign key.
		/// </summary>
		public static List<tbl_genMasEmployee> SelectAllByCompany_ID_CompanyBranch_ID(string company_ID, string companyBranch_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasEmployeeSelectAllByCompany_ID_CompanyBranch_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		private static tbl_genMasEmployee Maketbl_genMasEmployee(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(60) == false) {
				tbl_genMasEmployee.IsPayrall_Process = dataReader.GetBoolean(60);
			}
			if (dataReader.IsDBNull(61) == false) {
				tbl_genMasEmployee.IsPayslip_Print = dataReader.GetBoolean(61);
			}
			if (dataReader.IsDBNull(62) == false) {
				tbl_genMasEmployee.IsEPF_ETF_Process = dataReader.GetBoolean(62);
			}
			if (dataReader.IsDBNull(63) == false) {
				tbl_genMasEmployee.Is_PayeeProcess = dataReader.GetBoolean(63);
			}
			if (dataReader.IsDBNull(64) == false) {
				tbl_genMasEmployee.PaymentMethod_ID = dataReader.GetString(64);
			}
			if (dataReader.IsDBNull(65) == false) {
				tbl_genMasEmployee.Employee_AccountName = dataReader.GetString(65);
			}
			if (dataReader.IsDBNull(66) == false) {
				tbl_genMasEmployee.Employee_AccountNo = dataReader.GetString(66);
			}
			if (dataReader.IsDBNull(67) == false) {
				tbl_genMasEmployee.Bank_ID = dataReader.GetString(67);
			}
			if (dataReader.IsDBNull(68) == false) {
				tbl_genMasEmployee.BankBranch_ID = dataReader.GetString(68);
			}
			if (dataReader.IsDBNull(69) == false) {
				tbl_genMasEmployee.Payroll_Level = dataReader.GetString(69);
			}
			if (dataReader.IsDBNull(70) == false) {
				tbl_genMasEmployee.Emp_statusID = dataReader.GetString(70);
			}
			if (dataReader.IsDBNull(71) == false) {
                tbl_genMasEmployee.Employee_Image = (byte[])dataReader[71];
			}
			if (dataReader.IsDBNull(72) == false) {
				tbl_genMasEmployee.IsSportman = dataReader.GetBoolean(72);
			}
			if (dataReader.IsDBNull(73) == false) {
				tbl_genMasEmployee.IsSalesManager = dataReader.GetBoolean(73);
			}
			if (dataReader.IsDBNull(74) == false) {
				tbl_genMasEmployee.IsAreaManager = dataReader.GetBoolean(74);
			}
			if (dataReader.IsDBNull(75) == false) {
				tbl_genMasEmployee.IsSelesRep = dataReader.GetBoolean(75);
			}
			if (dataReader.IsDBNull(76) == false) {
				tbl_genMasEmployee.IsSalesExecutive = dataReader.GetBoolean(76);
			}
			if (dataReader.IsDBNull(77) == false) {
				tbl_genMasEmployee.IsDriver = dataReader.GetBoolean(77);
			}
			if (dataReader.IsDBNull(78) == false) {
				tbl_genMasEmployee.IsAssistant = dataReader.GetBoolean(78);
			}
			if (dataReader.IsDBNull(79) == false) {
				tbl_genMasEmployee.IsOperator = dataReader.GetBoolean(79);
			}
			if (dataReader.IsDBNull(80) == false) {
				tbl_genMasEmployee.SalesTarget = dataReader.GetDecimal(80);
			}
			if (dataReader.IsDBNull(81) == false) {
				tbl_genMasEmployee.MinimumSalesTarget = dataReader.GetDecimal(81);
			}
			if (dataReader.IsDBNull(82) == false) {
				tbl_genMasEmployee.CommisionPersentage_Normal = dataReader.GetDecimal(82);
			}
			if (dataReader.IsDBNull(83) == false) {
				tbl_genMasEmployee.CommisionPersentage_Bones = dataReader.GetDecimal(83);
			}
			if (dataReader.IsDBNull(84) == false) {
				tbl_genMasEmployee.IsCanceled = dataReader.GetBoolean(84);
			}
			if (dataReader.IsDBNull(85) == false) {
				tbl_genMasEmployee.UserID_Created = dataReader.GetString(85);
			}
			if (dataReader.IsDBNull(86) == false) {
				tbl_genMasEmployee.UserID_Modified = dataReader.GetString(86);
			}
			if (dataReader.IsDBNull(87) == false) {
				tbl_genMasEmployee.UserID_Canceled = dataReader.GetString(87);
			}
			if (dataReader.IsDBNull(88) == false) {
				tbl_genMasEmployee.TerminalID_Created = dataReader.GetString(88);
			}
			if (dataReader.IsDBNull(89) == false) {
				tbl_genMasEmployee.TerminalID_Modified = dataReader.GetString(89);
			}
			if (dataReader.IsDBNull(90) == false) {
				tbl_genMasEmployee.TerminalID_Canceled = dataReader.GetString(90);
			}
			if (dataReader.IsDBNull(91) == false) {
				tbl_genMasEmployee.Date_Created = dataReader.GetDateTime(91);
			}
			if (dataReader.IsDBNull(92) == false) {
				tbl_genMasEmployee.Date_Modified = dataReader.GetDateTime(92);
			}
			if (dataReader.IsDBNull(93) == false) {
				tbl_genMasEmployee.Date_Canceled = dataReader.GetDateTime(93);
			}
