	...
	public sealed class tbl_tasShiftMaster {
		...
		private static tbl_tasShiftMaster Maketbl_tasShiftMaster(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(74) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMin = dataReader.GetInt32(74);
			}
			if (dataReader.IsDBNull(75) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMax = dataReader.GetInt32(75);
			}
			if (dataReader.IsDBNull(76) == false) {
				tbl_tasShiftMaster.IsWeekdaySpecialOT = dataReader.GetBoolean(76);
			}
			if (dataReader.IsDBNull(77) == false) {
				tbl_tasShiftMaster.Shift_OTRate_Weekday = dataReader.GetDecimal(77);
			}
			if (dataReader.IsDBNull(78) == false) {
				tbl_tasShiftMaster.Shift_OTGracePeroiod_Weekday = dataReader.GetInt32(78);
			}
			if (dataReader.IsDBNull(79) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMin_Weekday = dataReader.GetInt32(79);
			}
			if (dataReader.IsDBNull(80) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMax_Weekday = dataReader.GetInt32(80);
			}
			if (dataReader.IsDBNull(81) == false) {
				tbl_tasShiftMaster.IsSaturdaySpecialOT = dataReader.GetBoolean(81);
			}
			if (dataReader.IsDBNull(82) == false) {
				tbl_tasShiftMaster.Shift_OTRate_Saturday = dataReader.GetDecimal(82);
			}
			if (dataReader.IsDBNull(83) == false) {
				tbl_tasShiftMaster.Shift_OTGracePeroiod_Saturday = dataReader.GetInt32(83);
			}
			if (dataReader.IsDBNull(84) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMin_Saturday = dataReader.GetInt32(84);
			}
			if (dataReader.IsDBNull(85) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMax_Saturday = dataReader.GetInt32(85);
			}
			if (dataReader.IsDBNull(86) == false) {
				tbl_tasShiftMaster.IsSundaySpecialOT = dataReader.GetBoolean(86);
			}
			if (dataReader.IsDBNull(87) == false) {
				tbl_tasShiftMaster.Shift_OTRate_Sunday = dataReader.GetDecimal(87);
			}
			if (dataReader.IsDBNull(88) == false) {
				tbl_tasShiftMaster.Shift_OTGracePeroiod_Sunday = dataReader.GetInt32(88);
			}
			if (dataReader.IsDBNull(89) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMin_Sunday = dataReader.GetInt32(89);
			}
			if (dataReader.IsDBNull(90) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMax_Sunday = dataReader.GetInt32(90);
			}
			if (dataReader.IsDBNull(91) == false) {
				tbl_tasShiftMaster.IsPoyadaySpecialOT = dataReader.GetBoolean(91);
			}
			if (dataReader.IsDBNull(92) == false) {
				tbl_tasShiftMaster.Shift_OTRate_Poyaday = dataReader.GetDecimal(92);
			}
			if (dataReader.IsDBNull(93) == false) {
				tbl_tasShiftMaster.Shift_OTGracePeroiod_Poyaday = dataReader.GetInt32(93);
			}
			if (dataReader.IsDBNull(94) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMin_Poyaday = dataReader.GetInt32(94);
			}
			if (dataReader.IsDBNull(95) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMax_Poyaday = dataReader.GetInt32(95);
			}
			if (dataReader.IsDBNull(96) == false) {
				tbl_tasShiftMaster.IsCompanyHolidaySpecialOT = dataReader.GetBoolean(96);
			}
			if (dataReader.IsDBNull(97) == false) {
				tbl_tasShiftMaster.Shift_OTRate_CompanyHoliday = dataReader.GetDecimal(97);
			}
			if (dataReader.IsDBNull(98) == false) {
				tbl_tasShiftMaster.Shift_OTGracePeroiod_CompanyHoliday = dataReader.GetInt32(98);
			}
			if (dataReader.IsDBNull(99) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMin_CompanyHoliday = dataReader.GetInt32(99);
			}
			if (dataReader.IsDBNull(100) == false) {
				tbl_tasShiftMaster.Shift_OTMinuteMax_CompanyHoliday = dataReader.GetInt32(100);
			}
			if (dataReader.IsDBNull(101) == false) {
				tbl_tasShiftMaster.Shift_Status_Effective_Date = dataReader.GetDateTime(101);
			}
			if (dataReader.IsDBNull(102) == false) {
				tbl_tasShiftMaster.Shift_Status_ExpireDate = dataReader.GetDateTime(102);
			}
			if (dataReader.IsDBNull(103) == false) {
				tbl_tasShiftMaster.Shift_Status = dataReader.GetBoolean(103);
			}
			if (dataReader.IsDBNull(104) == false) {
				tbl_tasShiftMaster.IsCanceled = dataReader.GetBoolean(104);
			}
			if (dataReader.IsDBNull(105) == false) {
				tbl_tasShiftMaster.UserID_Created = dataReader.GetString(105);
			}
			if (dataReader.IsDBNull(106) == false) {
				tbl_tasShiftMaster.UserID_Modified = dataReader.GetString(106);
			}
			if (dataReader.IsDBNull(107) == false) {
				tbl_tasShiftMaster.UserID_Canceled = dataReader.GetString(107);
			}
			if (dataReader.IsDBNull(108) == false) {
				tbl_tasShiftMaster.TerminalID_Created = dataReader.GetString(108);
			}
			if (dataReader.IsDBNull(109) == false) {
				tbl_tasShiftMaster.TerminalID_Modified = dataReader.GetString(109);
			}
			if (dataReader.IsDBNull(110) == false) {
				tbl_tasShiftMaster.TerminalID_Canceled = dataReader.GetString(110);
			}
			if (dataReader.IsDBNull(111) == false) {
				tbl_tasShiftMaster.Date_Created = dataReader.GetDateTime(111);
			}
			if (dataReader.IsDBNull(112) == false) {
				tbl_tasShiftMaster.Date_Modified = dataReader.GetDateTime(112);
			}
			if (dataReader.IsDBNull(113) == false) {
				tbl_tasShiftMaster.Date_Canceled = dataReader.GetDateTime(113);
			}
