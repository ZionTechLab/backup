	...
	public sealed class tbl_genCompanyInfo {
		...
		private static tbl_genCompanyInfo Maketbl_genCompanyInfo(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(14) == false) {
				tbl_genCompanyInfo.Edition = dataReader.GetInt32(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_genCompanyInfo.SerialNo1 = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_genCompanyInfo.SerialNo2 = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_genCompanyInfo.SerialNo3 = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_genCompanyInfo.SerialNo4 = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_genCompanyInfo.FinancialYear_ID = dataReader.GetString(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_genCompanyInfo.Month_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_genCompanyInfo.StartDate = dataReader.GetDateTime(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_genCompanyInfo.Theme_ID = dataReader.GetInt32(22);
			}
