...
namespace DataTire {
	public sealed class tbl_zBrand {
		...
		/// <summary>
		/// This makes tbl_zBrand datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_zBrand object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_zBrand  tbl_zBrand   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_brand_ID,col_brandName,});		return dt;
		}
		/// <summary>
