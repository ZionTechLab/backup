...
namespace DataTire {
	public sealed class tbl_genMasPostalCode {
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_genMasPostalCode class.
		/// </summary>
		public tbl_genMasPostalCode() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_genMasPostalCode class.
		/// </summary>
		public tbl_genMasPostalCode(string postalCode_ID, string postalCode, string town, string district, bool isCanceled, string userID_Created, string userID_Modified, string userID_Canceled, string terminalID_Created, string terminalID_Modified, string terminalID_Canceled, DateTime date_Created, DateTime date_Modified, DateTime date_Canceled) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_genMasPostalCode table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasPostalCodeInsert", scon);
			scom.CommandType = CommandType.StoredProcedure;
 
 
			scom.Parameters.Add("@postalCode_ID", SqlDbType.VarChar,8);
			scom.Parameters.Add("@postalCode", SqlDbType.VarChar,8);
			scom.Parameters.Add("@town", SqlDbType.VarChar,50);
			scom.Parameters.Add("@district", SqlDbType.VarChar,50);
			...
			scom.Parameters["@postalCode"].Value = postalCode;
			scom.Parameters["@town"].Value = town;
			scom.Parameters["@district"].Value = district;
		...
		/// <summary>
		/// Updates a record in the tbl_genMasPostalCode table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasPostalCodeUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_genMasPostalCode table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasPostalCodeDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects a single record from the tbl_genMasPostalCode table.
		/// </summary>
		public static tbl_genMasPostalCode Select(string postalCode_ID_Incoming){

			tbl_genMasPostalCode tbl_genMasPostalCodeins = new tbl_genMasPostalCode();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasPostalCodeSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
			scom.Parameters.Add("@postalCode_ID", SqlDbType.VarChar,8);
			scom.Parameters["@postalCode_ID"].Value = postalCode_ID_Incoming;
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_genMasPostalCodeins = Maketbl_genMasPostalCode(dataReader);
				} else {
					tbl_genMasPostalCodeins = null;
				}
			}
			scon.Close();
			return tbl_genMasPostalCodeins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_genMasPostalCode table.
		/// </summary>
		public static List<tbl_genMasPostalCode> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasPostalCodeSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_genMasPostalCode> tbl_genMasPostalCodeList = new List<tbl_genMasPostalCode>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_genMasPostalCode tbl_genMasPostalCode = Maketbl_genMasPostalCode(dataReader);
					tbl_genMasPostalCodeList.Add(tbl_genMasPostalCode);
				}
			}
			scon.Close();
			return tbl_genMasPostalCodeList;
		}
		
		/// <summary>
		/// Creates a new instance of the tbl_genMasPostalCode class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_genMasPostalCode Maketbl_genMasPostalCode(SqlDataReader dataReader) {
			tbl_genMasPostalCode tbl_genMasPostalCode = new tbl_genMasPostalCode();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_genMasPostalCode.PostalCode_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_genMasPostalCode.PostalCode = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_genMasPostalCode.Town = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_genMasPostalCode.District = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_genMasPostalCode.IsCanceled = dataReader.GetBoolean(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_genMasPostalCode.UserID_Created = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_genMasPostalCode.UserID_Modified = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_genMasPostalCode.UserID_Canceled = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_genMasPostalCode.TerminalID_Created = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_genMasPostalCode.TerminalID_Modified = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_genMasPostalCode.TerminalID_Canceled = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_genMasPostalCode.Date_Created = dataReader.GetDateTime(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_genMasPostalCode.Date_Modified = dataReader.GetDateTime(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_genMasPostalCode.Date_Canceled = dataReader.GetDateTime(13);
			}

			return tbl_genMasPostalCode;
		}
		/// <summary>
		/// This makes tbl_genMasPostalCode datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_genMasPostalCode object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_genMasPostalCode  tbl_genMasPostalCode   )
		{
		DataTable dt = new DataTable();
		
			DataColumn col_postalCode_ID = new DataColumn("postalCode_ID" , typeof(string));
			DataColumn col_postalCode = new DataColumn("postalCode" , typeof(string));
			DataColumn col_town = new DataColumn("town" , typeof(string));
			DataColumn col_district = new DataColumn("district" , typeof(string));
		...
		dt.Columns.AddRange(new DataColumn[] { col_postalCode_ID,col_postalCode,col_town,col_district,col_isCanceled,col_userID_Created,col_userID_Modified,col_userID_Canceled,col_terminalID_Created,col_terminalID_Modified,col_terminalID_Canceled,col_date_Created,col_date_Modified,col_date_Canceled,});		return dt;
		}
		/// <summary>
		/// This fills tbl_genMasPostalCode datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_genMasPostalCode object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_genMasPostalCode user) {
		DataRow drow = dt.NewRow();
		
			drow["postalCode_ID"] = user.postalCode_ID;
			drow["postalCode"] = user.postalCode;
			drow["town"] = user.town;
			drow["district"] = user.district;
