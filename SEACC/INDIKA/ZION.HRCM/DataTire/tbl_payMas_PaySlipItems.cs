...
namespace DataTire {
	public sealed class tbl_payMas_PaySlipItems {
		...
		public static List<tbl_payMas_PaySlipItems> SelectAll_DefinetionItems()
		{

			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_payMas_PaySlipItemsSelectAll_DefenetionItems", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
