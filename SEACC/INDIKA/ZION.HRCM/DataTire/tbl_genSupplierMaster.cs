...
namespace DataTire {
	public sealed class tbl_genSupplierMaster {
		...
		/// Initializes a new instance of the tbl_genSupplierMaster class.
		/// </summary>
		public tbl_genSupplierMaster(string supplier_ID, string supplierName, string addressRegister, string addressDelivery, string telephone, string fax, string email, string url, string businessRegistraionNo, string vatRegistrationNo, string nbtRegistrationNo, string svatRegistrationNo, string remark, decimal creditLimit, decimal creditPeriod, decimal outstandingAmount, decimal chequeInHandAmount, decimal outstandingBalance, bool isBlacklisted, bool isLocked, bool isDeleted, string country_ID, string province_ID, string district_ID, string city_ID, string town_ID, string area_ID, string route_ID, string supplierType_ID, string supplierCategory_ID, string supplierClass_ID, string currency_ID, string salesManager_ID, string gl_ID, byte[] image, decimal depositAmount, bool isVATenable, bool isSVATenable, bool isNBTenable) {
		...
		private static tbl_genSupplierMaster Maketbl_genSupplierMaster(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(12) == false) {
				tbl_genSupplierMaster.Remark = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_genSupplierMaster.CreditLimit = dataReader.GetDecimal(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_genSupplierMaster.CreditPeriod = dataReader.GetDecimal(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_genSupplierMaster.OutstandingAmount = dataReader.GetDecimal(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_genSupplierMaster.ChequeInHandAmount = dataReader.GetDecimal(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_genSupplierMaster.OutstandingBalance = dataReader.GetDecimal(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_genSupplierMaster.IsBlacklisted = dataReader.GetBoolean(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_genSupplierMaster.IsLocked = dataReader.GetBoolean(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_genSupplierMaster.IsDeleted = dataReader.GetBoolean(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_genSupplierMaster.Country_ID = dataReader.GetString(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_genSupplierMaster.Province_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_genSupplierMaster.District_ID = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_genSupplierMaster.City_ID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_genSupplierMaster.Town_ID = dataReader.GetString(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_genSupplierMaster.Area_ID = dataReader.GetString(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_genSupplierMaster.Route_ID = dataReader.GetString(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_genSupplierMaster.SupplierType_ID = dataReader.GetString(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_genSupplierMaster.SupplierCategory_ID = dataReader.GetString(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_genSupplierMaster.SupplierClass_ID = dataReader.GetString(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_genSupplierMaster.Currency_ID = dataReader.GetString(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_genSupplierMaster.SalesManager_ID = dataReader.GetString(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_genSupplierMaster.Gl_ID = dataReader.GetString(33);
			}
