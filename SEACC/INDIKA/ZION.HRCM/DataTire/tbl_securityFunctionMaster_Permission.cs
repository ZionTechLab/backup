...
namespace DataTire {
	public sealed class tbl_securityFunctionMaster_Permission {
		...
		/// Initializes a new instance of the tbl_securityFunctionMaster_Permission class.
		/// </summary>
		public tbl_securityFunctionMaster_Permission(string user_ID, int function_ID, bool allowRead, bool allowWrite, bool allowDelete, bool allowApprovable, bool allowCheckable, bool allowUpdate, bool allowPrint, bool allowRePrint, bool allowExport, bool allowView) {
		...
		/// </summary>
		public static tbl_securityFunctionMaster_Permission Select(string user_ID_Incoming, int function_ID_Incoming){
		...
		private static tbl_securityFunctionMaster_Permission Maketbl_securityFunctionMaster_Permission(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(0) == false) {
				tbl_securityFunctionMaster_Permission.User_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_securityFunctionMaster_Permission.Function_ID = dataReader.GetInt32(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_securityFunctionMaster_Permission.AllowRead = dataReader.GetBoolean(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_securityFunctionMaster_Permission.AllowWrite = dataReader.GetBoolean(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_securityFunctionMaster_Permission.AllowDelete = dataReader.GetBoolean(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_securityFunctionMaster_Permission.AllowApprovable = dataReader.GetBoolean(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_securityFunctionMaster_Permission.AllowCheckable = dataReader.GetBoolean(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_securityFunctionMaster_Permission.AllowUpdate = dataReader.GetBoolean(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_securityFunctionMaster_Permission.AllowPrint = dataReader.GetBoolean(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_securityFunctionMaster_Permission.AllowRePrint = dataReader.GetBoolean(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_securityFunctionMaster_Permission.AllowExport = dataReader.GetBoolean(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_securityFunctionMaster_Permission.AllowView = dataReader.GetBoolean(11);
			}
		...
		dt.Columns.AddRange(new DataColumn[] { col_user_ID,col_function_ID,col_allowRead,col_allowWrite,col_allowDelete,col_allowApprovable,col_allowCheckable,col_allowUpdate,col_allowPrint,col_allowRePrint,col_allowExport,col_allowView,});		return dt;
		}
		/// <summary>
