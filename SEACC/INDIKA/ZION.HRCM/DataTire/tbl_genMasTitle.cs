...
namespace DataTire {
	public sealed class tbl_genMasTitle {
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_genMasTitle class.
		/// </summary>
		public tbl_genMasTitle() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_genMasTitle class.
		/// </summary>
		public tbl_genMasTitle(string titleID, string title, bool isCanceled, string userID_Created, string userID_Modified, string userID_Canceled, string terminalID_Created, string terminalID_Modified, string terminalID_Canceled, DateTime date_Created, DateTime date_Modified, DateTime date_Canceled) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_genMasTitle table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasTitleInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_genMasTitle table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasTitleUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_genMasTitle table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasTitleDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects a single record from the tbl_genMasTitle table.
		/// </summary>
		public static tbl_genMasTitle Select(string titleID_Incoming){

			tbl_genMasTitle tbl_genMasTitleins = new tbl_genMasTitle();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasTitleSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
			scom.Parameters.Add("@titleID", SqlDbType.VarChar,8);
			scom.Parameters["@titleID"].Value = titleID_Incoming;
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_genMasTitleins = Maketbl_genMasTitle(dataReader);
				} else {
					tbl_genMasTitleins = null;
				}
			}
			scon.Close();
			return tbl_genMasTitleins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_genMasTitle table.
		/// </summary>
		public static List<tbl_genMasTitle> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genMasTitleSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_genMasTitle> tbl_genMasTitleList = new List<tbl_genMasTitle>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_genMasTitle tbl_genMasTitle = Maketbl_genMasTitle(dataReader);
					tbl_genMasTitleList.Add(tbl_genMasTitle);
				}
			}
			scon.Close();
			return tbl_genMasTitleList;
		}
		
		/// <summary>
		/// Creates a new instance of the tbl_genMasTitle class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_genMasTitle Maketbl_genMasTitle(SqlDataReader dataReader) {
			tbl_genMasTitle tbl_genMasTitle = new tbl_genMasTitle();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_genMasTitle.TitleID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_genMasTitle.Title = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_genMasTitle.IsCanceled = dataReader.GetBoolean(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_genMasTitle.UserID_Created = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_genMasTitle.UserID_Modified = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_genMasTitle.UserID_Canceled = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_genMasTitle.TerminalID_Created = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_genMasTitle.TerminalID_Modified = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_genMasTitle.TerminalID_Canceled = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_genMasTitle.Date_Created = dataReader.GetDateTime(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_genMasTitle.Date_Modified = dataReader.GetDateTime(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_genMasTitle.Date_Canceled = dataReader.GetDateTime(11);
			}

			return tbl_genMasTitle;
		}
		/// <summary>
		/// This makes tbl_genMasTitle datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_genMasTitle object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_genMasTitle  tbl_genMasTitle   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_titleID,col_title,col_isCanceled,col_userID_Created,col_userID_Modified,col_userID_Canceled,col_terminalID_Created,col_terminalID_Modified,col_terminalID_Canceled,col_date_Created,col_date_Modified,col_date_Canceled,});		return dt;
		}
		/// <summary>
		/// This fills tbl_genMasTitle datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_genMasTitle object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_genMasTitle user) {
