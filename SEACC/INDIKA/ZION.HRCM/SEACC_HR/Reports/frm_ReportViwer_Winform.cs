...
{
    public partial class frm_ReportViwer_Winform : Metro_From
    {
        public frm_ReportViwer_Winform()
        {
            InitializeComponent();
        }

        private void frm_ReportViwer_Winform_Load(object sender, EventArgs e)
        {
        ...
        {
            //cls_Formater.setFormatForm(this, "Report Viewer", 2, 0);
        }
        ...
        private void PrintNormal(ReportDocument objRpt, tbl_securityFunctionMaster_Permission oPermission)
        {
            ...
            this.TheamColor = ColorTranslator.FromHtml("#FF2D3E4F");
            Cursor = Cursors.Default;
            ShowDialog();
