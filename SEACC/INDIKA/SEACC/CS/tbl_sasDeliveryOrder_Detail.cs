...
namespace DataTire
{
	...
	public class tbl_sasDeliveryOrder_Detail_Ex : tbl_sasDeliveryOrder_Detail
	{
		public string store_ID;

		private static tbl_sasDeliveryOrder_Detail_Ex Maketbl_sasDeliveryOrder_Detail2(SqlDataReader dataReader)
		{
			tbl_sasDeliveryOrder_Detail_Ex tbl_sasDeliveryOrder_Detail = new tbl_sasDeliveryOrder_Detail_Ex();
			...
			{
				tbl_sasDeliveryOrder_Detail.store_ID = dataReader.GetString(37);
			}
			return tbl_sasDeliveryOrder_Detail;
		}

		public static List<tbl_sasDeliveryOrder_Detail_Ex> SelectAllByDeliveryOrder_ID2(string deliveryOrder_ID)
		{

			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_sasDeliveryOrder_DetailSelectAllByDeliveryOrder_ID2", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();

			scom.Parameters.Add("@deliveryOrder_ID", SqlDbType.VarChar, 20);
			scom.Parameters["@deliveryOrder_ID"].Value = deliveryOrder_ID;
		var tbl_sasDeliveryOrder_DetailList = new List<tbl_sasDeliveryOrder_Detail_Ex>();
			using (SqlDataReader dataReader = scom.ExecuteReader())
			{
				while (dataReader.Read())
				{
					var tbl_sasDeliveryOrder_Detail = Maketbl_sasDeliveryOrder_Detail2(dataReader);
					tbl_sasDeliveryOrder_DetailList.Add(tbl_sasDeliveryOrder_Detail);
				}
			}
			scon.Close();
