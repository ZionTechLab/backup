...
namespace DataTire {
	public sealed class tbl_accPaymentVoucher {
		#region Fields
		private string paymentVoucher_ID;
		private DateTime paymentVoucherDate;
		...
		private string projectCostCenter1_ID;
		private string projectCostCenter2_ID;
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_accPaymentVoucher class.
		/// </summary>
		public tbl_accPaymentVoucher() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_accPaymentVoucher class.
		/// </summary>
		public tbl_accPaymentVoucher(string paymentVoucher_ID, DateTime paymentVoucherDate, string remark, string narration, string payee, string accountPayableNote_ID, string chequeRegister_ID, string customer_ID, string supplier_ID, string employee_ID, string bankAcc_No, string costCenter1_ID, string costCenter2_ID, string projectCostCenter1_ID, string projectCostCenter2_ID, string glPosting_ID, string postingStatus_ID, string financialYear_ID, string currency_ID, decimal currencyRate, decimal cashAmount, decimal chequeAmount, decimal totalAmount, string createUser_ID, string modifiedUser_ID, string checkedUser_ID, string approvedUser_ID, string deletedUser_ID, string printedUser_ID, string createTerminal_ID, string modifiedTerminal_ID, string deletedTerminal_ID, string printedTerminal_ID, DateTime dateCreate, DateTime dateModified, DateTime dateChecked, DateTime dateApproved, DateTime dateDeleted, DateTime datePrinted, bool isChecked, bool isApproved, bool isFinished, bool isDeleted, bool isLocked, bool isSeattled, bool isAdvancePayment, int printCount, decimal settledAmount, string companyID, string companyBranch_ID, string apnType_ID) {
			...
			this.projectCostCenter1_ID = projectCostCenter1_ID;
			this.projectCostCenter2_ID = projectCostCenter2_ID;
		...
		/// <summary>
		/// Gets or sets the PaymentVoucherDate value.
		/// </summary>
		public DateTime PaymentVoucherDate {
			get { return paymentVoucherDate; }
			set { paymentVoucherDate = value; }
		}
		...
		/// <summary>
		/// Gets or sets the ProjectCostCenter1_ID value.
		/// </summary>
		public string ProjectCostCenter1_ID {
			get { return projectCostCenter1_ID; }
			set { projectCostCenter1_ID = value; }
		}
		
		/// <summary>
		/// Gets or sets the ProjectCostCenter2_ID value.
		/// </summary>
		public string ProjectCostCenter2_ID {
			get { return projectCostCenter2_ID; }
			set { projectCostCenter2_ID = value; }
		}
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_accPaymentVoucher table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accPaymentVoucherInsert", scon);
			scom.CommandType = CommandType.StoredProcedure;
 
 
			scom.Parameters.Add("@paymentVoucher_ID", SqlDbType.VarChar,20);
			scom.Parameters.Add("@paymentVoucherDate", SqlDbType.DateTime,8);
			...
			scom.Parameters.Add("@projectCostCenter1_ID", SqlDbType.VarChar,10);
			scom.Parameters.Add("@projectCostCenter2_ID", SqlDbType.VarChar,10);
			...
			scom.Parameters["@paymentVoucherDate"].Value = paymentVoucherDate;
			...
			scom.Parameters["@projectCostCenter1_ID"].Value = projectCostCenter1_ID;
			scom.Parameters["@projectCostCenter2_ID"].Value = projectCostCenter2_ID;
		...
		/// <summary>
		/// Updates a record in the tbl_accPaymentVoucher table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accPaymentVoucherUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_accPaymentVoucher table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accPaymentVoucherDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_accPaymentVoucher table by a foreign key.
		/// </summary>
		public static void DeleteAllBySupplier_ID(string supplier_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accPaymentVoucherDeleteAllBySupplier_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByEmployee_ID(string employee_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accPaymentVoucherDeleteAllByEmployee_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_accPaymentVoucher table.
		/// </summary>
		public static tbl_accPaymentVoucher Select(string paymentVoucher_ID_Incoming){

			tbl_accPaymentVoucher tbl_accPaymentVoucherins = new tbl_accPaymentVoucher();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accPaymentVoucherSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_accPaymentVoucherins = Maketbl_accPaymentVoucher(dataReader);
				} else {
					tbl_accPaymentVoucherins = null;
				}
			}
			scon.Close();
			return tbl_accPaymentVoucherins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_accPaymentVoucher table.
		/// </summary>
		public static List<tbl_accPaymentVoucher> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accPaymentVoucherSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_accPaymentVoucher> tbl_accPaymentVoucherList = new List<tbl_accPaymentVoucher>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_accPaymentVoucher tbl_accPaymentVoucher = Maketbl_accPaymentVoucher(dataReader);
					tbl_accPaymentVoucherList.Add(tbl_accPaymentVoucher);
				}
			}
			scon.Close();
			return tbl_accPaymentVoucherList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_accPaymentVoucher table by a foreign key.
		/// </summary>
		public static List<tbl_accPaymentVoucher> SelectAllBySupplier_ID(string supplier_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accPaymentVoucherSelectAllBySupplier_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_accPaymentVoucher table by a foreign key.
		/// </summary>
		public static List<tbl_accPaymentVoucher> SelectAllByEmployee_ID(string employee_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accPaymentVoucherSelectAllByEmployee_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_accPaymentVoucher class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_accPaymentVoucher Maketbl_accPaymentVoucher(SqlDataReader dataReader) {
			tbl_accPaymentVoucher tbl_accPaymentVoucher = new tbl_accPaymentVoucher();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_accPaymentVoucher.PaymentVoucher_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_accPaymentVoucher.PaymentVoucherDate = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_accPaymentVoucher.Remark = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_accPaymentVoucher.Narration = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_accPaymentVoucher.Payee = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_accPaymentVoucher.AccountPayableNote_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_accPaymentVoucher.ChequeRegister_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_accPaymentVoucher.Customer_ID = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_accPaymentVoucher.Supplier_ID = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_accPaymentVoucher.Employee_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_accPaymentVoucher.BankAcc_No = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_accPaymentVoucher.CostCenter1_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_accPaymentVoucher.CostCenter2_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_accPaymentVoucher.ProjectCostCenter1_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_accPaymentVoucher.ProjectCostCenter2_ID = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_accPaymentVoucher.GlPosting_ID = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_accPaymentVoucher.PostingStatus_ID = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_accPaymentVoucher.FinancialYear_ID = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_accPaymentVoucher.Currency_ID = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_accPaymentVoucher.CurrencyRate = dataReader.GetDecimal(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_accPaymentVoucher.CashAmount = dataReader.GetDecimal(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_accPaymentVoucher.ChequeAmount = dataReader.GetDecimal(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_accPaymentVoucher.TotalAmount = dataReader.GetDecimal(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_accPaymentVoucher.CreateUser_ID = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_accPaymentVoucher.ModifiedUser_ID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_accPaymentVoucher.CheckedUser_ID = dataReader.GetString(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_accPaymentVoucher.ApprovedUser_ID = dataReader.GetString(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_accPaymentVoucher.DeletedUser_ID = dataReader.GetString(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_accPaymentVoucher.PrintedUser_ID = dataReader.GetString(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_accPaymentVoucher.CreateTerminal_ID = dataReader.GetString(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_accPaymentVoucher.ModifiedTerminal_ID = dataReader.GetString(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_accPaymentVoucher.DeletedTerminal_ID = dataReader.GetString(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_accPaymentVoucher.PrintedTerminal_ID = dataReader.GetString(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_accPaymentVoucher.DateCreate = dataReader.GetDateTime(33);
			}
			if (dataReader.IsDBNull(34) == false) {
				tbl_accPaymentVoucher.DateModified = dataReader.GetDateTime(34);
			}
			if (dataReader.IsDBNull(35) == false) {
				tbl_accPaymentVoucher.DateChecked = dataReader.GetDateTime(35);
			}
			if (dataReader.IsDBNull(36) == false) {
				tbl_accPaymentVoucher.DateApproved = dataReader.GetDateTime(36);
			}
			if (dataReader.IsDBNull(37) == false) {
				tbl_accPaymentVoucher.DateDeleted = dataReader.GetDateTime(37);
			}
			if (dataReader.IsDBNull(38) == false) {
				tbl_accPaymentVoucher.DatePrinted = dataReader.GetDateTime(38);
			}
			if (dataReader.IsDBNull(39) == false) {
				tbl_accPaymentVoucher.IsChecked = dataReader.GetBoolean(39);
			}
			if (dataReader.IsDBNull(40) == false) {
				tbl_accPaymentVoucher.IsApproved = dataReader.GetBoolean(40);
			}
			if (dataReader.IsDBNull(41) == false) {
				tbl_accPaymentVoucher.IsFinished = dataReader.GetBoolean(41);
			}
			if (dataReader.IsDBNull(42) == false) {
				tbl_accPaymentVoucher.IsDeleted = dataReader.GetBoolean(42);
			}
			if (dataReader.IsDBNull(43) == false) {
				tbl_accPaymentVoucher.IsLocked = dataReader.GetBoolean(43);
			}
			if (dataReader.IsDBNull(44) == false) {
				tbl_accPaymentVoucher.IsSeattled = dataReader.GetBoolean(44);
			}
			if (dataReader.IsDBNull(45) == false) {
				tbl_accPaymentVoucher.IsAdvancePayment = dataReader.GetBoolean(45);
			}
			if (dataReader.IsDBNull(46) == false) {
				tbl_accPaymentVoucher.PrintCount = dataReader.GetInt32(46);
			}
			if (dataReader.IsDBNull(47) == false) {
				tbl_accPaymentVoucher.SettledAmount = dataReader.GetDecimal(47);
			}
			if (dataReader.IsDBNull(48) == false) {
				tbl_accPaymentVoucher.CompanyID = dataReader.GetString(48);
			}
			if (dataReader.IsDBNull(49) == false) {
				tbl_accPaymentVoucher.CompanyBranch_ID = dataReader.GetString(49);
			}
			if (dataReader.IsDBNull(50) == false) {
				tbl_accPaymentVoucher.ApnType_ID = dataReader.GetString(50);
			}

			return tbl_accPaymentVoucher;
		}
		/// <summary>
		/// This makes tbl_accPaymentVoucher datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_accPaymentVoucher object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_accPaymentVoucher  tbl_accPaymentVoucher   )
		{
		DataTable dt = new DataTable();
		
			DataColumn col_paymentVoucher_ID = new DataColumn("paymentVoucher_ID" , typeof(string));
			DataColumn col_paymentVoucherDate = new DataColumn("paymentVoucherDate" , typeof(DateTime));
			...
			DataColumn col_projectCostCenter1_ID = new DataColumn("projectCostCenter1_ID" , typeof(string));
			DataColumn col_projectCostCenter2_ID = new DataColumn("projectCostCenter2_ID" , typeof(string));
		...
		dt.Columns.AddRange(new DataColumn[] { col_paymentVoucher_ID,col_paymentVoucherDate,col_remark,col_narration,col_payee,col_accountPayableNote_ID,col_chequeRegister_ID,col_customer_ID,col_supplier_ID,col_employee_ID,col_bankAcc_No,col_costCenter1_ID,col_costCenter2_ID,col_projectCostCenter1_ID,col_projectCostCenter2_ID,col_glPosting_ID,col_postingStatus_ID,col_financialYear_ID,col_currency_ID,col_currencyRate,col_cashAmount,col_chequeAmount,col_totalAmount,col_createUser_ID,col_modifiedUser_ID,col_checkedUser_ID,col_approvedUser_ID,col_deletedUser_ID,col_printedUser_ID,col_createTerminal_ID,col_modifiedTerminal_ID,col_deletedTerminal_ID,col_printedTerminal_ID,col_dateCreate,col_dateModified,col_dateChecked,col_dateApproved,col_dateDeleted,col_datePrinted,col_isChecked,col_isApproved,col_isFinished,col_isDeleted,col_isLocked,col_isSeattled,col_isAdvancePayment,col_printCount,col_settledAmount,col_companyID,col_companyBranch_ID,col_apnType_ID,});		return dt;
		}
		/// <summary>
		/// This fills tbl_accPaymentVoucher datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_accPaymentVoucher object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_accPaymentVoucher user) {
		DataRow drow = dt.NewRow();
		
			drow["paymentVoucher_ID"] = user.paymentVoucher_ID;
			drow["paymentVoucherDate"] = user.paymentVoucherDate;
			...
			drow["projectCostCenter1_ID"] = user.projectCostCenter1_ID;
			drow["projectCostCenter2_ID"] = user.projectCostCenter2_ID;
