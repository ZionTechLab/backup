...
namespace DataTire {
	public sealed class tbl_scsSectionGoodIssueNote_Detail {
		#region Fields
		private int line_No;
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_scsSectionGoodIssueNote_Detail class.
		/// </summary>
		public tbl_scsSectionGoodIssueNote_Detail() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_scsSectionGoodIssueNote_Detail class.
		/// </summary>
		public tbl_scsSectionGoodIssueNote_Detail(int line_No, string sectionGoodIssueNote_ID, string item_ID, string itemSubCategory_ID, string itemSubCategory2_ID, string itemSerialNo, string itemSerialNo2, string job_ID, string fromSection_ID, string toSelectArea_ID, string toDepartment_ID, string toSection_ID, string toStore_ID, string departmentReqositionNote_ID, string sectionRequisitionNote_ID, string storeRequisitionNote_ID, string uom_ID, decimal qty, decimal qtySettle, decimal weight, decimal weightSettle, decimal tatalCost_FIFO, decimal tatalCost_WA, string remark, bool isLocked) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_scsSectionGoodIssueNote_Detail table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_scsSectionGoodIssueNote_Detail table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_scsSectionGoodIssueNote_Detail table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_scsSectionGoodIssueNote_Detail table by a foreign key.
		/// </summary>
		public static void DeleteAllByItem_ID(string item_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailDeleteAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByItemSubCategory_ID(string itemSubCategory_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailDeleteAllByItemSubCategory_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllBySectionGoodIssueNote_ID(string sectionGoodIssueNote_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailDeleteAllBySectionGoodIssueNote_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByItemSubCategory2_ID(string itemSubCategory2_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailDeleteAllByItemSubCategory2_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByFromSection_ID(string fromSection_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailDeleteAllByFromSection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByJob_ID(string job_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailDeleteAllByJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByToSelectArea_ID(string toSelectArea_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailDeleteAllByToSelectArea_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_scsSectionGoodIssueNote_Detail table.
		/// </summary>
		public static tbl_scsSectionGoodIssueNote_Detail Select(string sectionGoodIssueNote_ID_Incoming, string item_ID_Incoming, string itemSubCategory_ID_Incoming, string itemSubCategory2_ID_Incoming, string itemSerialNo_Incoming, string itemSerialNo2_Incoming){

			tbl_scsSectionGoodIssueNote_Detail tbl_scsSectionGoodIssueNote_Detailins = new tbl_scsSectionGoodIssueNote_Detail();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_scsSectionGoodIssueNote_Detailins = Maketbl_scsSectionGoodIssueNote_Detail(dataReader);
				} else {
					tbl_scsSectionGoodIssueNote_Detailins = null;
				}
			}
			scon.Close();
			return tbl_scsSectionGoodIssueNote_Detailins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsSectionGoodIssueNote_Detail table.
		/// </summary>
		public static List<tbl_scsSectionGoodIssueNote_Detail> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_scsSectionGoodIssueNote_Detail> tbl_scsSectionGoodIssueNote_DetailList = new List<tbl_scsSectionGoodIssueNote_Detail>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_scsSectionGoodIssueNote_Detail tbl_scsSectionGoodIssueNote_Detail = Maketbl_scsSectionGoodIssueNote_Detail(dataReader);
					tbl_scsSectionGoodIssueNote_DetailList.Add(tbl_scsSectionGoodIssueNote_Detail);
				}
			}
			scon.Close();
			return tbl_scsSectionGoodIssueNote_DetailList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsSectionGoodIssueNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsSectionGoodIssueNote_Detail> SelectAllByItem_ID(string item_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailSelectAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsSectionGoodIssueNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsSectionGoodIssueNote_Detail> SelectAllByItemSubCategory_ID(string itemSubCategory_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailSelectAllByItemSubCategory_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsSectionGoodIssueNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsSectionGoodIssueNote_Detail> SelectAllBySectionGoodIssueNote_ID(string sectionGoodIssueNote_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailSelectAllBySectionGoodIssueNote_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsSectionGoodIssueNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsSectionGoodIssueNote_Detail> SelectAllByItemSubCategory2_ID(string itemSubCategory2_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailSelectAllByItemSubCategory2_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsSectionGoodIssueNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsSectionGoodIssueNote_Detail> SelectAllByFromSection_ID(string fromSection_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailSelectAllByFromSection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsSectionGoodIssueNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsSectionGoodIssueNote_Detail> SelectAllByJob_ID(string job_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailSelectAllByJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsSectionGoodIssueNote_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsSectionGoodIssueNote_Detail> SelectAllByToSelectArea_ID(string toSelectArea_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsSectionGoodIssueNote_DetailSelectAllByToSelectArea_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_scsSectionGoodIssueNote_Detail class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_scsSectionGoodIssueNote_Detail Maketbl_scsSectionGoodIssueNote_Detail(SqlDataReader dataReader) {
			tbl_scsSectionGoodIssueNote_Detail tbl_scsSectionGoodIssueNote_Detail = new tbl_scsSectionGoodIssueNote_Detail();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_scsSectionGoodIssueNote_Detail.Line_No = dataReader.GetInt32(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_scsSectionGoodIssueNote_Detail.SectionGoodIssueNote_ID = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_scsSectionGoodIssueNote_Detail.Item_ID = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_scsSectionGoodIssueNote_Detail.ItemSubCategory_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_scsSectionGoodIssueNote_Detail.ItemSubCategory2_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_scsSectionGoodIssueNote_Detail.ItemSerialNo = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_scsSectionGoodIssueNote_Detail.ItemSerialNo2 = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_scsSectionGoodIssueNote_Detail.Job_ID = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_scsSectionGoodIssueNote_Detail.FromSection_ID = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_scsSectionGoodIssueNote_Detail.ToSelectArea_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_scsSectionGoodIssueNote_Detail.ToDepartment_ID = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_scsSectionGoodIssueNote_Detail.ToSection_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_scsSectionGoodIssueNote_Detail.ToStore_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_scsSectionGoodIssueNote_Detail.DepartmentReqositionNote_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_scsSectionGoodIssueNote_Detail.SectionRequisitionNote_ID = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_scsSectionGoodIssueNote_Detail.StoreRequisitionNote_ID = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_scsSectionGoodIssueNote_Detail.Uom_ID = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_scsSectionGoodIssueNote_Detail.Qty = dataReader.GetDecimal(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_scsSectionGoodIssueNote_Detail.QtySettle = dataReader.GetDecimal(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_scsSectionGoodIssueNote_Detail.Weight = dataReader.GetDecimal(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_scsSectionGoodIssueNote_Detail.WeightSettle = dataReader.GetDecimal(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_scsSectionGoodIssueNote_Detail.TatalCost_FIFO = dataReader.GetDecimal(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_scsSectionGoodIssueNote_Detail.TatalCost_WA = dataReader.GetDecimal(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_scsSectionGoodIssueNote_Detail.Remark = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_scsSectionGoodIssueNote_Detail.IsLocked = dataReader.GetBoolean(24);
			}

			return tbl_scsSectionGoodIssueNote_Detail;
		}
		/// <summary>
		/// This makes tbl_scsSectionGoodIssueNote_Detail datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_scsSectionGoodIssueNote_Detail object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_scsSectionGoodIssueNote_Detail  tbl_scsSectionGoodIssueNote_Detail   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_line_No,col_sectionGoodIssueNote_ID,col_item_ID,col_itemSubCategory_ID,col_itemSubCategory2_ID,col_itemSerialNo,col_itemSerialNo2,col_job_ID,col_fromSection_ID,col_toSelectArea_ID,col_toDepartment_ID,col_toSection_ID,col_toStore_ID,col_departmentReqositionNote_ID,col_sectionRequisitionNote_ID,col_storeRequisitionNote_ID,col_uom_ID,col_qty,col_qtySettle,col_weight,col_weightSettle,col_tatalCost_FIFO,col_tatalCost_WA,col_remark,col_isLocked,});		return dt;
		}
		/// <summary>
		/// This fills tbl_scsSectionGoodIssueNote_Detail datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_scsSectionGoodIssueNote_Detail object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_scsSectionGoodIssueNote_Detail user) {
