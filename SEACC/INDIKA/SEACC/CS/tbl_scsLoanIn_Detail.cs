...
namespace DataTire {
	public sealed class tbl_scsLoanIn_Detail {
		#region Fields
		private int line_No;
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_scsLoanIn_Detail table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanIn_DetailInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_scsLoanIn_Detail table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanIn_DetailUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_scsLoanIn_Detail table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanIn_DetailDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_scsLoanIn_Detail table by a foreign key.
		/// </summary>
		public static void DeleteAllByLoanIn_ID(string loanIn_ID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanIn_DetailDeleteAllByLoanIn_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_scsLoanIn_Detail table.
		/// </summary>
		public static tbl_scsLoanIn_Detail Select(string loanIn_ID_Incoming, string item_ID_Incoming, string itemSubCategory_ID_Incoming, string itemSubCategory2_ID_Incoming, string itemSerialNo_Incoming, string itemSerialNo2_Incoming){

			tbl_scsLoanIn_Detail tbl_scsLoanIn_Detailins = new tbl_scsLoanIn_Detail();
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanIn_DetailSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_scsLoanIn_Detailins = Maketbl_scsLoanIn_Detail(dataReader);
				} else {
					tbl_scsLoanIn_Detailins = null;
				}
			}
			scon.Close();
			return tbl_scsLoanIn_Detailins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsLoanIn_Detail table.
		/// </summary>
		public static List<tbl_scsLoanIn_Detail> SelectAll() {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanIn_DetailSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_scsLoanIn_Detail> tbl_scsLoanIn_DetailList = new List<tbl_scsLoanIn_Detail>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_scsLoanIn_Detail tbl_scsLoanIn_Detail = Maketbl_scsLoanIn_Detail(dataReader);
					tbl_scsLoanIn_DetailList.Add(tbl_scsLoanIn_Detail);
				}
			}
			scon.Close();
			return tbl_scsLoanIn_DetailList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsLoanIn_Detail table by a foreign key.
		/// </summary>
		public static List<tbl_scsLoanIn_Detail> SelectAllByLoanIn_ID(string loanIn_ID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsLoanIn_DetailSelectAllByLoanIn_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_scsLoanIn_Detail class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_scsLoanIn_Detail Maketbl_scsLoanIn_Detail(SqlDataReader dataReader) {
			tbl_scsLoanIn_Detail tbl_scsLoanIn_Detail = new tbl_scsLoanIn_Detail();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_scsLoanIn_Detail.Line_No = dataReader.GetInt32(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_scsLoanIn_Detail.LoanIn_ID = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_scsLoanIn_Detail.Item_ID = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_scsLoanIn_Detail.ItemSubCategory_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_scsLoanIn_Detail.ItemSubCategory2_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_scsLoanIn_Detail.ItemSerialNo = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_scsLoanIn_Detail.ItemSerialNo2 = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_scsLoanIn_Detail.Qty = dataReader.GetDecimal(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_scsLoanIn_Detail.QtySettle = dataReader.GetDecimal(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_scsLoanIn_Detail.Weight = dataReader.GetDecimal(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_scsLoanIn_Detail.WeightSettle = dataReader.GetDecimal(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_scsLoanIn_Detail.UnitPrice = dataReader.GetDecimal(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_scsLoanIn_Detail.UnitPriceSettle = dataReader.GetDecimal(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_scsLoanIn_Detail.WeightPrice = dataReader.GetDecimal(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_scsLoanIn_Detail.WeightPriceSettle = dataReader.GetDecimal(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_scsLoanIn_Detail.TotalAmount = dataReader.GetDecimal(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_scsLoanIn_Detail.Remark = dataReader.GetString(16);
			}

			return tbl_scsLoanIn_Detail;
		}
		/// <summary>
		/// This makes tbl_scsLoanIn_Detail datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_scsLoanIn_Detail object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_scsLoanIn_Detail  tbl_scsLoanIn_Detail   )
		{
