...
namespace DataTire {
	public sealed class tbl_accJournalEntry {
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_accJournalEntry class.
		/// </summary>
		public tbl_accJournalEntry() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_accJournalEntry class.
		/// </summary>
		public tbl_accJournalEntry(string journalEntry_ID, string journalEntryType_ID, DateTime journalEntryDate, string remark, string narration, string glPosting_ID, string postingStatus_ID, string financialYear_ID, string companyID, string companyBranch_ID, decimal grandTotal, string createUser_ID, string modifiedUser_ID, string checkedUser_ID, string approvedUser_ID, string deletedUser_ID, string printedUser_ID, string createTerminal_ID, string modifiedTerminal_ID, string deletedTerminal_ID, string printedTerminal_ID, DateTime dateCreate, DateTime dateModified, DateTime dateChecked, DateTime dateApproved, DateTime dateDeleted, DateTime datePrinted, bool isChecked, bool isApproved, bool isFinished, bool isDeleted, bool isLocked, bool isSeattled, int printCount) {
		...
		/// <summary>
		/// Gets or sets the JournalEntryDate value.
		/// </summary>
		public DateTime JournalEntryDate {
			get { return journalEntryDate; }
			set { journalEntryDate = value; }
		}
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_accJournalEntry table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accJournalEntryInsert", scon);
			...
			scom.Parameters.Add("@journalEntryDate", SqlDbType.DateTime,8);
			scom.Parameters.Add("@remark", SqlDbType.VarChar,1000);
			scom.Parameters.Add("@narration", SqlDbType.VarChar,1000);
			...
			scom.Parameters["@journalEntryDate"].Value = journalEntryDate;
		...
		/// <summary>
		/// Updates a record in the tbl_accJournalEntry table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accJournalEntryUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_accJournalEntry table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accJournalEntryDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
        ...
        /// <summary>
        /// Selects all records from the tbl_accJournalEntry table by a foreign key.
        /// </summary>
        public static void DeleteAllByJournalEntryType_ID(string journalEntryType_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_accJournalEntryDeleteAllByJournalEntryType_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_accJournalEntry table.
		/// </summary>
		public static tbl_accJournalEntry Select(string journalEntry_ID_Incoming){

			tbl_accJournalEntry tbl_accJournalEntryins = new tbl_accJournalEntry();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accJournalEntrySelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_accJournalEntryins = Maketbl_accJournalEntry(dataReader);
				} else {
					tbl_accJournalEntryins = null;
				}
			}
			scon.Close();
			return tbl_accJournalEntryins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_accJournalEntry table.
		/// </summary>
		public static List<tbl_accJournalEntry> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accJournalEntrySelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_accJournalEntry> tbl_accJournalEntryList = new List<tbl_accJournalEntry>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_accJournalEntry tbl_accJournalEntry = Maketbl_accJournalEntry(dataReader);
					tbl_accJournalEntryList.Add(tbl_accJournalEntry);
				}
			}
			scon.Close();
			return tbl_accJournalEntryList;
		}
		
		/// <summary>
        ///   /// Selects all records from the tbl_accJournalEntry table by a foreign key.
        /// </summary>
        public static List<tbl_accJournalEntry> SelectAllByJournalEntryType_ID(string journalEntryType_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_accJournalEntrySelectAllByJournalEntryType_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
        ...
        /// <summary>
		/// Creates a new instance of the tbl_accJournalEntry class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_accJournalEntry Maketbl_accJournalEntry(SqlDataReader dataReader) {
			tbl_accJournalEntry tbl_accJournalEntry = new tbl_accJournalEntry();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_accJournalEntry.JournalEntry_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_accJournalEntry.JournalEntryType_ID = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_accJournalEntry.JournalEntryDate = dataReader.GetDateTime(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_accJournalEntry.Remark = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_accJournalEntry.Narration = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_accJournalEntry.GlPosting_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_accJournalEntry.PostingStatus_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_accJournalEntry.FinancialYear_ID = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_accJournalEntry.CompanyID = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_accJournalEntry.CompanyBranch_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_accJournalEntry.GrandTotal = dataReader.GetDecimal(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_accJournalEntry.CreateUser_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_accJournalEntry.ModifiedUser_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_accJournalEntry.CheckedUser_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_accJournalEntry.ApprovedUser_ID = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_accJournalEntry.DeletedUser_ID = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_accJournalEntry.PrintedUser_ID = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_accJournalEntry.CreateTerminal_ID = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_accJournalEntry.ModifiedTerminal_ID = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_accJournalEntry.DeletedTerminal_ID = dataReader.GetString(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_accJournalEntry.PrintedTerminal_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_accJournalEntry.DateCreate = dataReader.GetDateTime(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_accJournalEntry.DateModified = dataReader.GetDateTime(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_accJournalEntry.DateChecked = dataReader.GetDateTime(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_accJournalEntry.DateApproved = dataReader.GetDateTime(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_accJournalEntry.DateDeleted = dataReader.GetDateTime(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_accJournalEntry.DatePrinted = dataReader.GetDateTime(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_accJournalEntry.IsChecked = dataReader.GetBoolean(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_accJournalEntry.IsApproved = dataReader.GetBoolean(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_accJournalEntry.IsFinished = dataReader.GetBoolean(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_accJournalEntry.IsDeleted = dataReader.GetBoolean(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_accJournalEntry.IsLocked = dataReader.GetBoolean(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_accJournalEntry.IsSeattled = dataReader.GetBoolean(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_accJournalEntry.PrintCount = dataReader.GetInt32(33);
			}

			return tbl_accJournalEntry;
		}
		/// <summary>
		/// This makes tbl_accJournalEntry datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_accJournalEntry object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_accJournalEntry  tbl_accJournalEntry   )
		{
		DataTable dt = new DataTable();
			...
			DataColumn col_journalEntryDate = new DataColumn("journalEntryDate" , typeof(DateTime));
