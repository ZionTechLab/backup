...
namespace DataTire {
	public sealed class tbl_genItemMaster_Gem {
		#region Fields
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_genItemMaster_Gem table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMaster_GemInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_genItemMaster_Gem table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMaster_GemUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_genItemMaster_Gem table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMaster_GemDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects a single record from the tbl_genItemMaster_Gem table.
		/// </summary>
		public static tbl_genItemMaster_Gem Select(string item_ID_Incoming){

			tbl_genItemMaster_Gem tbl_genItemMaster_Gemins = new tbl_genItemMaster_Gem();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMaster_GemSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_genItemMaster_Gemins = Maketbl_genItemMaster_Gem(dataReader);
				} else {
					tbl_genItemMaster_Gemins = null;
				}
			}
			scon.Close();
			return tbl_genItemMaster_Gemins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_genItemMaster_Gem table.
		/// </summary>
		public static List<tbl_genItemMaster_Gem> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_genItemMaster_GemSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_genItemMaster_Gem> tbl_genItemMaster_GemList = new List<tbl_genItemMaster_Gem>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_genItemMaster_Gem tbl_genItemMaster_Gem = Maketbl_genItemMaster_Gem(dataReader);
					tbl_genItemMaster_GemList.Add(tbl_genItemMaster_Gem);
				}
			}
			scon.Close();
			return tbl_genItemMaster_GemList;
		}
		
		/// <summary>
		/// Creates a new instance of the tbl_genItemMaster_Gem class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_genItemMaster_Gem Maketbl_genItemMaster_Gem(SqlDataReader dataReader) {
			tbl_genItemMaster_Gem tbl_genItemMaster_Gem = new tbl_genItemMaster_Gem();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_genItemMaster_Gem.Item_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_genItemMaster_Gem.ItemDate = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_genItemMaster_Gem.Description = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_genItemMaster_Gem.RefNo = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_genItemMaster_Gem.ItemLength = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_genItemMaster_Gem.ItemSize = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_genItemMaster_Gem.ImagePath1 = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_genItemMaster_Gem.ImagePath2 = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_genItemMaster_Gem.ImagePath3 = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_genItemMaster_Gem.GemDetail = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_genItemMaster_Gem.MetalDetail = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_genItemMaster_Gem.ItemCategory_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_genItemMaster_Gem.ItemClass_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_genItemMaster_Gem.ItemType_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_genItemMaster_Gem.Weight = dataReader.GetDecimal(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_genItemMaster_Gem.SellingPrice = dataReader.GetDecimal(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_genItemMaster_Gem.CostPrice = dataReader.GetDecimal(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_genItemMaster_Gem.AverageWeightFrom = dataReader.GetDecimal(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_genItemMaster_Gem.AverageWeightTo = dataReader.GetDecimal(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_genItemMaster_Gem.IsManufacture = dataReader.GetBoolean(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_genItemMaster_Gem.IsBuyingAndSelling = dataReader.GetBoolean(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_genItemMaster_Gem.IsOrdered = dataReader.GetBoolean(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_genItemMaster_Gem.CreateUser_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_genItemMaster_Gem.ModifiedUser_ID = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_genItemMaster_Gem.DeletedUser_ID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_genItemMaster_Gem.CreateTerminal_ID = dataReader.GetString(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_genItemMaster_Gem.ModifiedTerminal_ID = dataReader.GetString(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_genItemMaster_Gem.DeletedTerminal_ID = dataReader.GetString(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_genItemMaster_Gem.DateCreate = dataReader.GetDateTime(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_genItemMaster_Gem.DateModified = dataReader.GetDateTime(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_genItemMaster_Gem.DateDeleted = dataReader.GetDateTime(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_genItemMaster_Gem.IsDeleted = dataReader.GetBoolean(31);
			}

			return tbl_genItemMaster_Gem;
		}
		/// <summary>
		/// This makes tbl_genItemMaster_Gem datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_genItemMaster_Gem object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_genItemMaster_Gem  tbl_genItemMaster_Gem   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_item_ID,col_itemDate,col_description,col_refNo,col_itemLength,col_itemSize,col_imagePath1,col_imagePath2,col_imagePath3,col_gemDetail,col_metalDetail,col_itemCategory_ID,col_itemClass_ID,col_itemType_ID,col_weight,col_sellingPrice,col_costPrice,col_averageWeightFrom,col_averageWeightTo,col_isManufacture,col_isBuyingAndSelling,col_isOrdered,col_createUser_ID,col_modifiedUser_ID,col_deletedUser_ID,col_createTerminal_ID,col_modifiedTerminal_ID,col_deletedTerminal_ID,col_dateCreate,col_dateModified,col_dateDeleted,col_isDeleted,});		return dt;
		}
		/// <summary>
		/// This fills tbl_genItemMaster_Gem datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_genItemMaster_Gem object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_genItemMaster_Gem user) {
