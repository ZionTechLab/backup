...
namespace DataTire {
	public sealed class tbl_ZEmpSalesRep {
		...
		/// Initializes a new instance of the tbl_ZEmpSalesRep class.
		/// </summary>
		public tbl_ZEmpSalesRep(string selesRep_ID, string selesRepName, string areaManager_ID, string store_ID, bool isCollector, bool isSalesRep) {
		...
		dt.Columns.AddRange(new DataColumn[] { col_selesRep_ID,col_selesRepName,col_areaManager_ID,col_store_ID,col_isCollector,col_isSalesRep,});		return dt;
		}
		/// <summary>
