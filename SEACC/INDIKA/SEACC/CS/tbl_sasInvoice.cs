...
namespace DataTire
{
    public sealed class tbl_sasInvoice
    {
        ...
        //Area Manager
        public static List<tbl_sasInvoice> SelectAllByAreaManager_ID(string sAreaManager_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_sasInvoiceSelectAllByAreaManager_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
        ...
        //Sales Manager
        public static List<tbl_sasInvoice> SelectAllBySalesManager_ID(string sSalesManager_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_sasInvoiceSelectAllBySalesManager_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();

            scom.Parameters.Add("@SalesManager_ID", SqlDbType.VarChar, 20);
            scom.Parameters["@SalesManager_ID"].Value = sSalesManager_ID;
            List<tbl_sasInvoice> tbl_sasInvoiceList = new List<tbl_sasInvoice>();
            using (SqlDataReader dataReader = scom.ExecuteReader())
            {
                while (dataReader.Read())
        ...
        //Collector
        public static List<tbl_sasInvoice> SelectAllByCollector_ID(string sCollector_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_sasInvoiceSelectAllByCollector_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
        ...
        public static List<tbl_sasInvoice> SelectAllByCustomer_ID_Unsettled(string customer_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_sasInvoiceSelectAllByCustomer_ID_Unsettled", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
