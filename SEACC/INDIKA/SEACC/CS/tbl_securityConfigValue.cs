...
namespace DataTire
{
	public sealed class tbl_securityConfigValue {
		...
		/// Initializes a new instance of the tbl_securityConfigValue class.
		/// </summary>
		public tbl_securityConfigValue(int valueID, string valueName, string configValue, string configTypeValue_ID, int form_ID) {
		...
		public static void DeleteAllByForm_ID(int form_ID) {
			...
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_securityConfigValueDeleteAllByForm_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_securityConfigValue table by a foreign key.
		/// </summary>
		public static List<tbl_securityConfigValue> SelectAllByForm_ID(int form_ID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_securityConfigValueSelectAllByForm_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		private static tbl_securityConfigValue Maketbl_securityConfigValue(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(4) == false) {
				tbl_securityConfigValue.Form_ID = dataReader.GetInt32(4);
			}
		...
		dt.Columns.AddRange(new DataColumn[] { col_valueID,col_valueName,col_configValue,col_configTypeValue_ID,col_form_ID,});		return dt;
		}
		/// <summary>
