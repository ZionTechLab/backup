...
namespace DataTire {
	public sealed class tbl_scsDiscardedGoodNote {
		#region Fields
		private string discardedGoodNote_ID;
		private DateTime discardedGoodNoteDate;
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_scsDiscardedGoodNote class.
		/// </summary>
		public tbl_scsDiscardedGoodNote() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_scsDiscardedGoodNote class.
		/// </summary>
		public tbl_scsDiscardedGoodNote(string discardedGoodNote_ID, DateTime discardedGoodNoteDate, string remark, string store_ID, decimal discountPercentage, decimal nbtPercentage, decimal vatPercentage, decimal otherTaxPercentage, decimal subTotal, decimal discountTotal, decimal nbtTotal, decimal vatTotal, decimal otherTaxTotal, decimal grandTotal, string createUser_ID, string modifiedUser_ID, string checkedUser_ID, string approvedUser_ID, DateTime dateCreate, DateTime dateModified, DateTime dateChecked, DateTime dateApproved, bool isChecked, bool isApproved, bool isFinished, bool isDeleted, bool isLocked, decimal seattleAmount, bool isSeattled, int printCount, bool isWeightCalculation, string companyID, string companyBranch_ID) {
			this.discardedGoodNote_ID = discardedGoodNote_ID;
			this.discardedGoodNoteDate = discardedGoodNoteDate;
			this.remark = remark;
		...
		/// <summary>
		/// Gets or sets the DiscardedGoodNoteDate value.
		/// </summary>
		public DateTime DiscardedGoodNoteDate {
			get { return discardedGoodNoteDate; }
			set { discardedGoodNoteDate = value; }
		}
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_scsDiscardedGoodNote table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsDiscardedGoodNoteInsert", scon);
			scom.CommandType = CommandType.StoredProcedure;
 
 
			scom.Parameters.Add("@discardedGoodNote_ID", SqlDbType.VarChar,20);
			scom.Parameters.Add("@discardedGoodNoteDate", SqlDbType.DateTime,8);
			...
			scom.Parameters["@discardedGoodNoteDate"].Value = discardedGoodNoteDate;
		...
		/// <summary>
		/// Updates a record in the tbl_scsDiscardedGoodNote table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsDiscardedGoodNoteUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_scsDiscardedGoodNote table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsDiscardedGoodNoteDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_scsDiscardedGoodNote table by a foreign key.
		/// </summary>
		public static void DeleteAllByStore_ID(string store_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsDiscardedGoodNoteDeleteAllByStore_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_scsDiscardedGoodNote table.
		/// </summary>
		public static tbl_scsDiscardedGoodNote Select(string discardedGoodNote_ID_Incoming){

			tbl_scsDiscardedGoodNote tbl_scsDiscardedGoodNoteins = new tbl_scsDiscardedGoodNote();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsDiscardedGoodNoteSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_scsDiscardedGoodNoteins = Maketbl_scsDiscardedGoodNote(dataReader);
				} else {
					tbl_scsDiscardedGoodNoteins = null;
				}
			}
			scon.Close();
			return tbl_scsDiscardedGoodNoteins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsDiscardedGoodNote table.
		/// </summary>
		public static List<tbl_scsDiscardedGoodNote> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsDiscardedGoodNoteSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_scsDiscardedGoodNote> tbl_scsDiscardedGoodNoteList = new List<tbl_scsDiscardedGoodNote>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_scsDiscardedGoodNote tbl_scsDiscardedGoodNote = Maketbl_scsDiscardedGoodNote(dataReader);
					tbl_scsDiscardedGoodNoteList.Add(tbl_scsDiscardedGoodNote);
				}
			}
			scon.Close();
			return tbl_scsDiscardedGoodNoteList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsDiscardedGoodNote table by a foreign key.
		/// </summary>
		public static List<tbl_scsDiscardedGoodNote> SelectAllByStore_ID(string store_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsDiscardedGoodNoteSelectAllByStore_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_scsDiscardedGoodNote class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_scsDiscardedGoodNote Maketbl_scsDiscardedGoodNote(SqlDataReader dataReader) {
			tbl_scsDiscardedGoodNote tbl_scsDiscardedGoodNote = new tbl_scsDiscardedGoodNote();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_scsDiscardedGoodNote.DiscardedGoodNote_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_scsDiscardedGoodNote.DiscardedGoodNoteDate = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_scsDiscardedGoodNote.Remark = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_scsDiscardedGoodNote.Store_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_scsDiscardedGoodNote.DiscountPercentage = dataReader.GetDecimal(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_scsDiscardedGoodNote.NbtPercentage = dataReader.GetDecimal(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_scsDiscardedGoodNote.VatPercentage = dataReader.GetDecimal(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_scsDiscardedGoodNote.OtherTaxPercentage = dataReader.GetDecimal(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_scsDiscardedGoodNote.SubTotal = dataReader.GetDecimal(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_scsDiscardedGoodNote.DiscountTotal = dataReader.GetDecimal(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_scsDiscardedGoodNote.NbtTotal = dataReader.GetDecimal(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_scsDiscardedGoodNote.VatTotal = dataReader.GetDecimal(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_scsDiscardedGoodNote.OtherTaxTotal = dataReader.GetDecimal(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_scsDiscardedGoodNote.GrandTotal = dataReader.GetDecimal(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_scsDiscardedGoodNote.CreateUser_ID = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_scsDiscardedGoodNote.ModifiedUser_ID = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_scsDiscardedGoodNote.CheckedUser_ID = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_scsDiscardedGoodNote.ApprovedUser_ID = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_scsDiscardedGoodNote.DateCreate = dataReader.GetDateTime(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_scsDiscardedGoodNote.DateModified = dataReader.GetDateTime(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_scsDiscardedGoodNote.DateChecked = dataReader.GetDateTime(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_scsDiscardedGoodNote.DateApproved = dataReader.GetDateTime(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_scsDiscardedGoodNote.IsChecked = dataReader.GetBoolean(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_scsDiscardedGoodNote.IsApproved = dataReader.GetBoolean(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_scsDiscardedGoodNote.IsFinished = dataReader.GetBoolean(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_scsDiscardedGoodNote.IsDeleted = dataReader.GetBoolean(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_scsDiscardedGoodNote.IsLocked = dataReader.GetBoolean(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_scsDiscardedGoodNote.SeattleAmount = dataReader.GetDecimal(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_scsDiscardedGoodNote.IsSeattled = dataReader.GetBoolean(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_scsDiscardedGoodNote.PrintCount = dataReader.GetInt32(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_scsDiscardedGoodNote.IsWeightCalculation = dataReader.GetBoolean(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_scsDiscardedGoodNote.CompanyID = dataReader.GetString(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_scsDiscardedGoodNote.CompanyBranch_ID = dataReader.GetString(32);
			}

			return tbl_scsDiscardedGoodNote;
		}
		/// <summary>
		/// This makes tbl_scsDiscardedGoodNote datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_scsDiscardedGoodNote object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_scsDiscardedGoodNote  tbl_scsDiscardedGoodNote   )
		{
		DataTable dt = new DataTable();
		
			DataColumn col_discardedGoodNote_ID = new DataColumn("discardedGoodNote_ID" , typeof(string));
			DataColumn col_discardedGoodNoteDate = new DataColumn("discardedGoodNoteDate" , typeof(DateTime));
		...
		dt.Columns.AddRange(new DataColumn[] { col_discardedGoodNote_ID,col_discardedGoodNoteDate,col_remark,col_store_ID,col_discountPercentage,col_nbtPercentage,col_vatPercentage,col_otherTaxPercentage,col_subTotal,col_discountTotal,col_nbtTotal,col_vatTotal,col_otherTaxTotal,col_grandTotal,col_createUser_ID,col_modifiedUser_ID,col_checkedUser_ID,col_approvedUser_ID,col_dateCreate,col_dateModified,col_dateChecked,col_dateApproved,col_isChecked,col_isApproved,col_isFinished,col_isDeleted,col_isLocked,col_seattleAmount,col_isSeattled,col_printCount,col_isWeightCalculation,col_companyID,col_companyBranch_ID,});		return dt;
		}
		/// <summary>
		/// This fills tbl_scsDiscardedGoodNote datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_scsDiscardedGoodNote object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_scsDiscardedGoodNote user) {
		DataRow drow = dt.NewRow();
		
			drow["discardedGoodNote_ID"] = user.discardedGoodNote_ID;
			drow["discardedGoodNoteDate"] = user.discardedGoodNoteDate;
