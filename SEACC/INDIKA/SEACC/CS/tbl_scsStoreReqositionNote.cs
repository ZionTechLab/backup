...
namespace DataTire {
	public sealed class tbl_scsStoreReqositionNote {
		#region Fields
		private string storeRecositionNote_ID;
		private DateTime storeRecositionNoteDate;
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_scsStoreReqositionNote class.
		/// </summary>
		public tbl_scsStoreReqositionNote() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_scsStoreReqositionNote class.
		/// </summary>
		public tbl_scsStoreReqositionNote(string storeRecositionNote_ID, DateTime storeRecositionNoteDate, string remark, string job_ID, string fromStore_ID, string toSelectArea_ID, string toDepartment_ID, string toSection_ID, string toStore_ID, string issuedRefNo_ID, string purchaseRequisitionNote_ID, string createUser_ID, string modifiedUser_ID, string checkedUser_ID, string approvedUser_ID, string deletedUser_ID, string printedUser_ID, string createTerminal_ID, string modifiedTerminal_ID, string deletedTerminal_ID, string printedTerminal_ID, DateTime dateCreate, DateTime dateModified, DateTime dateChecked, DateTime dateApproved, DateTime dateDeleted, DateTime datePrinted, bool isChecked, bool isApproved, bool isFinished, bool isDeleted, bool isLocked, int printCount, bool isSeattled, bool isPRdone, string itemPriceCategory, string companyID, string companyBranch_ID) {
			this.storeRecositionNote_ID = storeRecositionNote_ID;
			this.storeRecositionNoteDate = storeRecositionNoteDate;
			this.remark = remark;
			this.job_ID = job_ID;
		...
		/// <summary>
		/// Gets or sets the StoreRecositionNoteDate value.
		/// </summary>
		public DateTime StoreRecositionNoteDate {
			get { return storeRecositionNoteDate; }
			set { storeRecositionNoteDate = value; }
		}
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_scsStoreReqositionNote table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteInsert", scon);
			scom.CommandType = CommandType.StoredProcedure;
 
 
			scom.Parameters.Add("@storeRecositionNote_ID", SqlDbType.VarChar,20);
			scom.Parameters.Add("@storeRecositionNoteDate", SqlDbType.DateTime,8);
			...
			scom.Parameters["@storeRecositionNoteDate"].Value = storeRecositionNoteDate;
		...
		/// <summary>
		/// Updates a record in the tbl_scsStoreReqositionNote table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_scsStoreReqositionNote table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_scsStoreReqositionNote table by a foreign key.
		/// </summary>
		public static void DeleteAllByFromStore_ID(string fromStore_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteDeleteAllByFromStore_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByToSelectArea_ID(string toSelectArea_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteDeleteAllByToSelectArea_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByIssuedRefNo_ID(string issuedRefNo_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteDeleteAllByIssuedRefNo_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByJob_ID(string job_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteDeleteAllByJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_scsStoreReqositionNote table.
		/// </summary>
		public static tbl_scsStoreReqositionNote Select(string storeRecositionNote_ID_Incoming){

			tbl_scsStoreReqositionNote tbl_scsStoreReqositionNoteins = new tbl_scsStoreReqositionNote();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_scsStoreReqositionNoteins = Maketbl_scsStoreReqositionNote(dataReader);
				} else {
					tbl_scsStoreReqositionNoteins = null;
				}
			}
			scon.Close();
			return tbl_scsStoreReqositionNoteins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsStoreReqositionNote table.
		/// </summary>
		public static List<tbl_scsStoreReqositionNote> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_scsStoreReqositionNote> tbl_scsStoreReqositionNoteList = new List<tbl_scsStoreReqositionNote>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_scsStoreReqositionNote tbl_scsStoreReqositionNote = Maketbl_scsStoreReqositionNote(dataReader);
					tbl_scsStoreReqositionNoteList.Add(tbl_scsStoreReqositionNote);
				}
			}
			scon.Close();
			return tbl_scsStoreReqositionNoteList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_scsStoreReqositionNote table by a foreign key.
		/// </summary>
		public static List<tbl_scsStoreReqositionNote> SelectAllByFromStore_ID(string fromStore_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteSelectAllByFromStore_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsStoreReqositionNote table by a foreign key.
		/// </summary>
		public static List<tbl_scsStoreReqositionNote> SelectAllByToSelectArea_ID(string toSelectArea_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteSelectAllByToSelectArea_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsStoreReqositionNote table by a foreign key.
		/// </summary>
		public static List<tbl_scsStoreReqositionNote> SelectAllByIssuedRefNo_ID(string issuedRefNo_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteSelectAllByIssuedRefNo_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_scsStoreReqositionNote table by a foreign key.
		/// </summary>
		public static List<tbl_scsStoreReqositionNote> SelectAllByJob_ID(string job_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_scsStoreReqositionNoteSelectAllByJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_scsStoreReqositionNote class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_scsStoreReqositionNote Maketbl_scsStoreReqositionNote(SqlDataReader dataReader) {
			tbl_scsStoreReqositionNote tbl_scsStoreReqositionNote = new tbl_scsStoreReqositionNote();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_scsStoreReqositionNote.StoreRecositionNote_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_scsStoreReqositionNote.StoreRecositionNoteDate = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_scsStoreReqositionNote.Remark = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_scsStoreReqositionNote.Job_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_scsStoreReqositionNote.FromStore_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_scsStoreReqositionNote.ToSelectArea_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_scsStoreReqositionNote.ToDepartment_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_scsStoreReqositionNote.ToSection_ID = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_scsStoreReqositionNote.ToStore_ID = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_scsStoreReqositionNote.IssuedRefNo_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_scsStoreReqositionNote.PurchaseRequisitionNote_ID = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_scsStoreReqositionNote.CreateUser_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_scsStoreReqositionNote.ModifiedUser_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_scsStoreReqositionNote.CheckedUser_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_scsStoreReqositionNote.ApprovedUser_ID = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_scsStoreReqositionNote.DeletedUser_ID = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_scsStoreReqositionNote.PrintedUser_ID = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_scsStoreReqositionNote.CreateTerminal_ID = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_scsStoreReqositionNote.ModifiedTerminal_ID = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_scsStoreReqositionNote.DeletedTerminal_ID = dataReader.GetString(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_scsStoreReqositionNote.PrintedTerminal_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_scsStoreReqositionNote.DateCreate = dataReader.GetDateTime(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_scsStoreReqositionNote.DateModified = dataReader.GetDateTime(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_scsStoreReqositionNote.DateChecked = dataReader.GetDateTime(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_scsStoreReqositionNote.DateApproved = dataReader.GetDateTime(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_scsStoreReqositionNote.DateDeleted = dataReader.GetDateTime(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_scsStoreReqositionNote.DatePrinted = dataReader.GetDateTime(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_scsStoreReqositionNote.IsChecked = dataReader.GetBoolean(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_scsStoreReqositionNote.IsApproved = dataReader.GetBoolean(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_scsStoreReqositionNote.IsFinished = dataReader.GetBoolean(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_scsStoreReqositionNote.IsDeleted = dataReader.GetBoolean(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_scsStoreReqositionNote.IsLocked = dataReader.GetBoolean(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_scsStoreReqositionNote.PrintCount = dataReader.GetInt32(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_scsStoreReqositionNote.IsSeattled = dataReader.GetBoolean(33);
			}
			if (dataReader.IsDBNull(34) == false) {
				tbl_scsStoreReqositionNote.IsPRdone = dataReader.GetBoolean(34);
			}
			if (dataReader.IsDBNull(35) == false) {
				tbl_scsStoreReqositionNote.ItemPriceCategory = dataReader.GetString(35);
			}
			if (dataReader.IsDBNull(36) == false) {
				tbl_scsStoreReqositionNote.CompanyID = dataReader.GetString(36);
			}
			if (dataReader.IsDBNull(37) == false) {
				tbl_scsStoreReqositionNote.CompanyBranch_ID = dataReader.GetString(37);
			}

			return tbl_scsStoreReqositionNote;
		}
		/// <summary>
		/// This makes tbl_scsStoreReqositionNote datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_scsStoreReqositionNote object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_scsStoreReqositionNote  tbl_scsStoreReqositionNote   )
		{
		DataTable dt = new DataTable();
		
			DataColumn col_storeRecositionNote_ID = new DataColumn("storeRecositionNote_ID" , typeof(string));
			DataColumn col_storeRecositionNoteDate = new DataColumn("storeRecositionNoteDate" , typeof(DateTime));
		...
		dt.Columns.AddRange(new DataColumn[] { col_storeRecositionNote_ID,col_storeRecositionNoteDate,col_remark,col_job_ID,col_fromStore_ID,col_toSelectArea_ID,col_toDepartment_ID,col_toSection_ID,col_toStore_ID,col_IssuedRefNo_ID,col_purchaseRequisitionNote_ID,col_createUser_ID,col_modifiedUser_ID,col_checkedUser_ID,col_approvedUser_ID,col_deletedUser_ID,col_printedUser_ID,col_createTerminal_ID,col_modifiedTerminal_ID,col_deletedTerminal_ID,col_printedTerminal_ID,col_dateCreate,col_dateModified,col_dateChecked,col_dateApproved,col_dateDeleted,col_datePrinted,col_isChecked,col_isApproved,col_isFinished,col_isDeleted,col_isLocked,col_printCount,col_isSeattled,col_isPRdone,col_itemPriceCategory,col_companyID,col_companyBranch_ID,});		return dt;
		}
		/// <summary>
		/// This fills tbl_scsStoreReqositionNote datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_scsStoreReqositionNote object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_scsStoreReqositionNote user) {
		DataRow drow = dt.NewRow();
		
			drow["storeRecositionNote_ID"] = user.storeRecositionNote_ID;
			drow["storeRecositionNoteDate"] = user.storeRecositionNoteDate;
