...
namespace DataTire {
	public sealed class tbl_ZEmpSalesExecutive {
		...
		/// Initializes a new instance of the tbl_ZEmpSalesExecutive class.
		/// </summary>
		public tbl_ZEmpSalesExecutive(string salesExecutive_ID, string salesExecutiveName, string areaManager_ID) {
		...
		dt.Columns.AddRange(new DataColumn[] { col_salesExecutive_ID,col_salesExecutiveName,col_areaManager_ID,});		return dt;
		}
		/// <summary>
