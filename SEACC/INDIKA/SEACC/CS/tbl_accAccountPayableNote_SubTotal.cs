...
namespace DataTire {
	public  class tbl_accAccountPayableNote_SubTotal {
		#region Fields
		protected int line_No;
		protected string accountPayableNote_ID;
		protected string tc_ID;
		protected string gl_ID;
		protected string customer_ID;
		protected string supplier_ID;
		protected string employee_ID;
		protected string bankAcc_No;
		protected string costCenter1_ID;
		protected string costCenter2_ID;
		protected decimal amount;
		protected bool isCredit;
		#endregion
	...
	public class tbl_accAccountPayableNote_SubTotal_EX : tbl_accAccountPayableNote_SubTotal
	{
		public string remarks;
		public tbl_accAccountPayableNote_SubTotal_EX()
		{ }
		public tbl_accAccountPayableNote_SubTotal_EX(int line_No, string accountPayableNote_ID, string tc_ID, string gl_ID, string customer_ID, string supplier_ID, string employee_ID, string bankAcc_No, string costCenter1_ID, string costCenter2_ID, decimal amount, bool isCredit,string remarks)
		{
			this.line_No = line_No;
			this.accountPayableNote_ID = accountPayableNote_ID;
			this.tc_ID = tc_ID;
		...
		public void InsertEX()
		{
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accAccountPayableNote_SubTotalInsertEX", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		public static List<tbl_accAccountPayableNote_SubTotal> SelectAllByAccountPayableNote_IDEX(string accountPayableNote_ID)
		{

			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_accAccountPayableNote_SubTotalSelectAllByAccountPayableNote_IDEX", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader())
			{
				while (dataReader.Read())
				{
					tbl_accAccountPayableNote_SubTotal tbl_accAccountPayableNote_SubTotal = Maketbl_accAccountPayableNote_SubTotalEX(dataReader);
					tbl_accAccountPayableNote_SubTotalList.Add(tbl_accAccountPayableNote_SubTotal);
				}
			}
			scon.Close();
		...
		private static tbl_accAccountPayableNote_SubTotal Maketbl_accAccountPayableNote_SubTotalEX(SqlDataReader dataReader)
		{
			tbl_accAccountPayableNote_SubTotal_EX tbl_accAccountPayableNote_SubTotal = new tbl_accAccountPayableNote_SubTotal_EX();
			...
			{
				tbl_accAccountPayableNote_SubTotal.remarks = dataReader.GetString(12);
			}
			return tbl_accAccountPayableNote_SubTotal;
		}
	}
