...
namespace DataTire {
	public sealed class tbl_ZEmpAreaManager {
		...
		/// Initializes a new instance of the tbl_ZEmpAreaManager class.
		/// </summary>
		public tbl_ZEmpAreaManager(string areaManager_ID, string areaManagerName, string salesManager_ID) {
		...
		dt.Columns.AddRange(new DataColumn[] { col_areaManager_ID,col_areaManagerName,col_salesManager_ID,});		return dt;
		}
		/// <summary>
