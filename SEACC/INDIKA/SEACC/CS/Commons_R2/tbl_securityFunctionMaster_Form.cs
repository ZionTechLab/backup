...
namespace DataTire {
	public sealed class tbl_securityFunctionMaster_Form {
		...
		/// Initializes a new instance of the tbl_securityFunctionMaster_Form class.
		/// </summary>
		public tbl_securityFunctionMaster_Form(int function_ID, string displayName, int counter, int length, string prefix1, bool isAutoGenerate, int serialType) {
		...
		private static tbl_securityFunctionMaster_Form Maketbl_securityFunctionMaster_Form(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(6) == false) {
				tbl_securityFunctionMaster_Form.SerialType = dataReader.GetInt32(6);
			}
		...
		dt.Columns.AddRange(new DataColumn[] { col_function_ID,col_displayName,col_counter,col_length,col_prefix1,col_isAutoGenerate,col_serialType,});		return dt;
		}
		/// <summary>
