...
namespace DataTire {
	public sealed class tbl_securityFunctionMaster {
		...
		/// Initializes a new instance of the tbl_securityFunctionMaster class.
		/// </summary>
		public tbl_securityFunctionMaster(int function_ID, int function_Code, string functionName, byte[] image, string functionCategory_ID, bool isEnable, bool isReport, bool isVisible) {
		...
		private static tbl_securityFunctionMaster Maketbl_securityFunctionMaster(SqlDataReader dataReader) {
			...
			if (dataReader.IsDBNull(7) == false) {
				tbl_securityFunctionMaster.IsVisible = dataReader.GetBoolean(7);
			}
		...
		dt.Columns.AddRange(new DataColumn[] { col_function_ID,col_function_Code,col_functionName,col_image,col_functionCategory_ID,col_isEnable,col_isReport,col_isVisible,});		return dt;
		}
		/// <summary>
