...
namespace DataTire {
	public sealed class tbl_prod_polyTxJobCard {
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_prod_polyTxJobCard class.
		/// </summary>
		public tbl_prod_polyTxJobCard() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_prod_polyTxJobCard class.
		/// </summary>
		public tbl_prod_polyTxJobCard(string prodJob_ID, DateTime prodJobDate, int prodJobStatus, string salesman_ID, string customer_ID, string customerInquiry_ID, string customerOrder_ID, string remarks, string remarks2, string jobType_ID, string prodRange_ID, string prodCategory_ID, string prodSize_ID, string colour_ID, string item_ID_Previous, string item_ID_FG, string uom_ID, decimal item_Length, string item_Length_UoM_ID, decimal item_Width, string item_Width_UoM_ID, decimal item_Height, string item_Height_UoM_ID, decimal item_Diameter, string item_Diameter_UoM_ID, decimal item_Radius, string item_Radius_UoM_ID, decimal item_Thickness, string item_Thickness_UoM_ID, decimal item_Weight, string item_Weight_UoM_ID, decimal orderedQty, decimal orderedWeight, decimal fGoodQty, decimal fGoodWeight, decimal wastePercent, decimal wasteQty, decimal wasteWeight, DateTime exfactoryDate, DateTime prodStartDate, decimal estProdHrs, bool isChecked1, bool isChecked2, bool isChecked3, bool isApproved1, bool isApproved2, bool isApproved3, bool isCanceled, bool isLocked, string createUser_ID, string modifiedUser_ID, string checked1User_ID, string checked2User_ID, string checked3User_ID, string approved1User_ID, string approved2User_ID, string approved3User_ID, string canceldUser_ID, string lockedUser_ID, DateTime dateCreate, DateTime dateModified, DateTime dateChecked1, DateTime dateChecked2, DateTime dateChecked3, DateTime dateApproved1, DateTime dateApproved2, DateTime dateApproved3, DateTime dateCanceled, DateTime dateLocked, string createUserTerminal_ID, string modifiedUserTerminal_ID, string checked1UserTerminal_ID, string checked2UserTerminal_ID, string checked3UserTerminal_ID, string approved1UserTerminal_ID, string approved2UserTerminal_ID, string approved3UserTerminal_ID, string canceledUserTerminal_ID, string lockedUserTerminal_ID, string companyID, string companyBranchID) {
		...
		/// <summary>
		/// Gets or sets the OrderedWeight value.
		/// </summary>
		public decimal OrderedWeight {
			get { return orderedWeight; }
			set { orderedWeight = value; }
		}
		...
		/// <summary>
		/// Gets or sets the WasteWeight value.
		/// </summary>
		public decimal WasteWeight {
			get { return wasteWeight; }
			set { wasteWeight = value; }
		}
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_prod_polyTxJobCard table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardInsert", scon);
			...
			scom.Parameters.Add("@orderedWeight", SqlDbType.Decimal,9);
			...
			scom.Parameters.Add("@wasteWeight", SqlDbType.Decimal,9);
			...
			scom.Parameters["@orderedWeight"].Value = orderedWeight;
			...
			scom.Parameters["@wasteWeight"].Value = wasteWeight;
		...
		/// <summary>
		/// Updates a record in the tbl_prod_polyTxJobCard table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_prod_polyTxJobCard table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static void DeleteAllByCustomerInquiry_ID(string customerInquiry_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByCustomerInquiry_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_Height_UoM_ID(string item_Height_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByItem_Height_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //scon.Open();
		...
		public static void DeleteAllByCustomer_ID(string customer_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByCustomer_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //scon.Open();
		...
		public static void DeleteAllByChecked1User_ID(string checked1User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByChecked1User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByItem_Weight_UoM_ID(string item_Weight_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByItem_Weight_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByCompanyBranchID(string companyBranchID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByProdJob_ID(string prodJob_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByUom_ID(string uom_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByUom_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByProdSize_ID(string prodSize_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByProdSize_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByItem_Thickness_UoM_ID(string item_Thickness_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByItem_Thickness_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByCanceldUser_ID(string canceldUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByProdRange_ID(string prodRange_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByProdRange_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByApproved1User_ID(string approved1User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByApproved1User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByApproved3User_ID(string approved3User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByApproved3User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByModifiedUser_ID(string modifiedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByItem_Length_UoM_ID(string item_Length_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByItem_Length_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByItem_Width_UoM_ID(string item_Width_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByItem_Width_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByColour_ID(string colour_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByColour_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByProdCategory_ID(string prodCategory_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByProdCategory_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByChecked2User_ID(string checked2User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByChecked2User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByItem_Radius_UoM_ID(string item_Radius_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByItem_Radius_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByApproved2User_ID(string approved2User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByApproved2User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByCompanyID(string companyID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByCreateUser_ID(string createUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllBySalesman_ID(string salesman_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllBySalesman_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByLockedUser_ID(string lockedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByLockedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByItem_Diameter_UoM_ID(string item_Diameter_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByItem_Diameter_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByJobType_ID(string jobType_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByJobType_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByItem_ID_FG(string item_ID_FG) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByItem_ID_FG", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByCustomerOrder_ID(string customerOrder_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByCustomerOrder_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //	scon.Open();
		...
		public static void DeleteAllByChecked3User_ID(string checked3User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardDeleteAllByChecked3User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
            //scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_prod_polyTxJobCard table.
		/// </summary>
		public static tbl_prod_polyTxJobCard Select(string prodJob_ID_Incoming){

			tbl_prod_polyTxJobCard tbl_prod_polyTxJobCardins = new tbl_prod_polyTxJobCard();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
            	scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_prod_polyTxJobCardins = Maketbl_prod_polyTxJobCard(dataReader);
				} else {
					tbl_prod_polyTxJobCardins = null;
				}
			}
			scon.Close();
			return tbl_prod_polyTxJobCardins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_polyTxJobCard table.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_prod_polyTxJobCard> tbl_prod_polyTxJobCardList = new List<tbl_prod_polyTxJobCard>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_prod_polyTxJobCard tbl_prod_polyTxJobCard = Maketbl_prod_polyTxJobCard(dataReader);
					tbl_prod_polyTxJobCardList.Add(tbl_prod_polyTxJobCard);
				}
			}
			scon.Close();
			return tbl_prod_polyTxJobCardList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByCustomerInquiry_ID(string customerInquiry_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByCustomerInquiry_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByItem_Height_UoM_ID(string item_Height_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByItem_Height_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByCustomer_ID(string customer_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByCustomer_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByChecked1User_ID(string checked1User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByChecked1User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByItem_Weight_UoM_ID(string item_Weight_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByItem_Weight_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByCompanyBranchID(string companyBranchID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByProdJob_ID(string prodJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByUom_ID(string uom_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByUom_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByProdSize_ID(string prodSize_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByProdSize_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByItem_Thickness_UoM_ID(string item_Thickness_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByItem_Thickness_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByCanceldUser_ID(string canceldUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByProdRange_ID(string prodRange_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByProdRange_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByApproved1User_ID(string approved1User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByApproved1User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByApproved3User_ID(string approved3User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByApproved3User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByModifiedUser_ID(string modifiedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByItem_Length_UoM_ID(string item_Length_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByItem_Length_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByItem_Width_UoM_ID(string item_Width_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByItem_Width_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByColour_ID(string colour_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByColour_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByProdCategory_ID(string prodCategory_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByProdCategory_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByChecked2User_ID(string checked2User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByChecked2User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByItem_Radius_UoM_ID(string item_Radius_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByItem_Radius_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByApproved2User_ID(string approved2User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByApproved2User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByCompanyID(string companyID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByCreateUser_ID(string createUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllBySalesman_ID(string salesman_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllBySalesman_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByLockedUser_ID(string lockedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByLockedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByItem_Diameter_UoM_ID(string item_Diameter_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByItem_Diameter_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByJobType_ID(string jobType_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByJobType_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByItem_ID_FG(string item_ID_FG) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByItem_ID_FG", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByCustomerOrder_ID(string customerOrder_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByCustomerOrder_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_polyTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prod_polyTxJobCard> SelectAllByChecked3User_ID(string checked3User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_polyTxJobCardSelectAllByChecked3User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_prod_polyTxJobCard class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_prod_polyTxJobCard Maketbl_prod_polyTxJobCard(SqlDataReader dataReader) {
			tbl_prod_polyTxJobCard tbl_prod_polyTxJobCard = new tbl_prod_polyTxJobCard();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_prod_polyTxJobCard.ProdJob_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_prod_polyTxJobCard.ProdJobDate = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_prod_polyTxJobCard.ProdJobStatus = dataReader.GetInt32(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_prod_polyTxJobCard.Salesman_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_prod_polyTxJobCard.Customer_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_prod_polyTxJobCard.CustomerInquiry_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_prod_polyTxJobCard.CustomerOrder_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_prod_polyTxJobCard.Remarks = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_prod_polyTxJobCard.Remarks2 = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_prod_polyTxJobCard.JobType_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_prod_polyTxJobCard.ProdRange_ID = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_prod_polyTxJobCard.ProdCategory_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_prod_polyTxJobCard.ProdSize_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_prod_polyTxJobCard.Colour_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_prod_polyTxJobCard.Item_ID_Previous = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_prod_polyTxJobCard.Item_ID_FG = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_prod_polyTxJobCard.Uom_ID = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_prod_polyTxJobCard.Item_Length = dataReader.GetDecimal(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_prod_polyTxJobCard.Item_Length_UoM_ID = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_prod_polyTxJobCard.Item_Width = dataReader.GetDecimal(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_prod_polyTxJobCard.Item_Width_UoM_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_prod_polyTxJobCard.Item_Height = dataReader.GetDecimal(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_prod_polyTxJobCard.Item_Height_UoM_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_prod_polyTxJobCard.Item_Diameter = dataReader.GetDecimal(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_prod_polyTxJobCard.Item_Diameter_UoM_ID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_prod_polyTxJobCard.Item_Radius = dataReader.GetDecimal(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_prod_polyTxJobCard.Item_Radius_UoM_ID = dataReader.GetString(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_prod_polyTxJobCard.Item_Thickness = dataReader.GetDecimal(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_prod_polyTxJobCard.Item_Thickness_UoM_ID = dataReader.GetString(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_prod_polyTxJobCard.Item_Weight = dataReader.GetDecimal(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_prod_polyTxJobCard.Item_Weight_UoM_ID = dataReader.GetString(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_prod_polyTxJobCard.OrderedQty = dataReader.GetDecimal(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_prod_polyTxJobCard.OrderedWeight = dataReader.GetDecimal(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_prod_polyTxJobCard.FGoodQty = dataReader.GetDecimal(33);
			}
			if (dataReader.IsDBNull(34) == false) {
				tbl_prod_polyTxJobCard.FGoodWeight = dataReader.GetDecimal(34);
			}
			if (dataReader.IsDBNull(35) == false) {
				tbl_prod_polyTxJobCard.WastePercent = dataReader.GetDecimal(35);
			}
			if (dataReader.IsDBNull(36) == false) {
				tbl_prod_polyTxJobCard.WasteQty = dataReader.GetDecimal(36);
			}
			if (dataReader.IsDBNull(37) == false) {
				tbl_prod_polyTxJobCard.WasteWeight = dataReader.GetDecimal(37);
			}
			if (dataReader.IsDBNull(38) == false) {
				tbl_prod_polyTxJobCard.ExfactoryDate = dataReader.GetDateTime(38);
			}
			if (dataReader.IsDBNull(39) == false) {
				tbl_prod_polyTxJobCard.ProdStartDate = dataReader.GetDateTime(39);
			}
			if (dataReader.IsDBNull(40) == false) {
				tbl_prod_polyTxJobCard.EstProdHrs = dataReader.GetDecimal(40);
			}
			if (dataReader.IsDBNull(41) == false) {
				tbl_prod_polyTxJobCard.IsChecked1 = dataReader.GetBoolean(41);
			}
			if (dataReader.IsDBNull(42) == false) {
				tbl_prod_polyTxJobCard.IsChecked2 = dataReader.GetBoolean(42);
			}
			if (dataReader.IsDBNull(43) == false) {
				tbl_prod_polyTxJobCard.IsChecked3 = dataReader.GetBoolean(43);
			}
			if (dataReader.IsDBNull(44) == false) {
				tbl_prod_polyTxJobCard.IsApproved1 = dataReader.GetBoolean(44);
			}
			if (dataReader.IsDBNull(45) == false) {
				tbl_prod_polyTxJobCard.IsApproved2 = dataReader.GetBoolean(45);
			}
			if (dataReader.IsDBNull(46) == false) {
				tbl_prod_polyTxJobCard.IsApproved3 = dataReader.GetBoolean(46);
			}
			if (dataReader.IsDBNull(47) == false) {
				tbl_prod_polyTxJobCard.IsCanceled = dataReader.GetBoolean(47);
			}
			if (dataReader.IsDBNull(48) == false) {
				tbl_prod_polyTxJobCard.IsLocked = dataReader.GetBoolean(48);
			}
			if (dataReader.IsDBNull(49) == false) {
				tbl_prod_polyTxJobCard.CreateUser_ID = dataReader.GetString(49);
			}
			if (dataReader.IsDBNull(50) == false) {
				tbl_prod_polyTxJobCard.ModifiedUser_ID = dataReader.GetString(50);
			}
			if (dataReader.IsDBNull(51) == false) {
				tbl_prod_polyTxJobCard.Checked1User_ID = dataReader.GetString(51);
			}
			if (dataReader.IsDBNull(52) == false) {
				tbl_prod_polyTxJobCard.Checked2User_ID = dataReader.GetString(52);
			}
			if (dataReader.IsDBNull(53) == false) {
				tbl_prod_polyTxJobCard.Checked3User_ID = dataReader.GetString(53);
			}
			if (dataReader.IsDBNull(54) == false) {
				tbl_prod_polyTxJobCard.Approved1User_ID = dataReader.GetString(54);
			}
			if (dataReader.IsDBNull(55) == false) {
				tbl_prod_polyTxJobCard.Approved2User_ID = dataReader.GetString(55);
			}
			if (dataReader.IsDBNull(56) == false) {
				tbl_prod_polyTxJobCard.Approved3User_ID = dataReader.GetString(56);
			}
			if (dataReader.IsDBNull(57) == false) {
				tbl_prod_polyTxJobCard.CanceldUser_ID = dataReader.GetString(57);
			}
			if (dataReader.IsDBNull(58) == false) {
				tbl_prod_polyTxJobCard.LockedUser_ID = dataReader.GetString(58);
			}
			if (dataReader.IsDBNull(59) == false) {
				tbl_prod_polyTxJobCard.DateCreate = dataReader.GetDateTime(59);
			}
			if (dataReader.IsDBNull(60) == false) {
				tbl_prod_polyTxJobCard.DateModified = dataReader.GetDateTime(60);
			}
			if (dataReader.IsDBNull(61) == false) {
				tbl_prod_polyTxJobCard.DateChecked1 = dataReader.GetDateTime(61);
			}
			if (dataReader.IsDBNull(62) == false) {
				tbl_prod_polyTxJobCard.DateChecked2 = dataReader.GetDateTime(62);
			}
			if (dataReader.IsDBNull(63) == false) {
				tbl_prod_polyTxJobCard.DateChecked3 = dataReader.GetDateTime(63);
			}
			if (dataReader.IsDBNull(64) == false) {
				tbl_prod_polyTxJobCard.DateApproved1 = dataReader.GetDateTime(64);
			}
			if (dataReader.IsDBNull(65) == false) {
				tbl_prod_polyTxJobCard.DateApproved2 = dataReader.GetDateTime(65);
			}
			if (dataReader.IsDBNull(66) == false) {
				tbl_prod_polyTxJobCard.DateApproved3 = dataReader.GetDateTime(66);
			}
			if (dataReader.IsDBNull(67) == false) {
				tbl_prod_polyTxJobCard.DateCanceled = dataReader.GetDateTime(67);
			}
			if (dataReader.IsDBNull(68) == false) {
				tbl_prod_polyTxJobCard.DateLocked = dataReader.GetDateTime(68);
			}
			if (dataReader.IsDBNull(69) == false) {
				tbl_prod_polyTxJobCard.CreateUserTerminal_ID = dataReader.GetString(69);
			}
			if (dataReader.IsDBNull(70) == false) {
				tbl_prod_polyTxJobCard.ModifiedUserTerminal_ID = dataReader.GetString(70);
			}
			if (dataReader.IsDBNull(71) == false) {
				tbl_prod_polyTxJobCard.Checked1UserTerminal_ID = dataReader.GetString(71);
			}
			if (dataReader.IsDBNull(72) == false) {
				tbl_prod_polyTxJobCard.Checked2UserTerminal_ID = dataReader.GetString(72);
			}
			if (dataReader.IsDBNull(73) == false) {
				tbl_prod_polyTxJobCard.Checked3UserTerminal_ID = dataReader.GetString(73);
			}
			if (dataReader.IsDBNull(74) == false) {
				tbl_prod_polyTxJobCard.Approved1UserTerminal_ID = dataReader.GetString(74);
			}
			if (dataReader.IsDBNull(75) == false) {
				tbl_prod_polyTxJobCard.Approved2UserTerminal_ID = dataReader.GetString(75);
			}
			if (dataReader.IsDBNull(76) == false) {
				tbl_prod_polyTxJobCard.Approved3UserTerminal_ID = dataReader.GetString(76);
			}
			if (dataReader.IsDBNull(77) == false) {
				tbl_prod_polyTxJobCard.CanceledUserTerminal_ID = dataReader.GetString(77);
			}
			if (dataReader.IsDBNull(78) == false) {
				tbl_prod_polyTxJobCard.LockedUserTerminal_ID = dataReader.GetString(78);
			}
			if (dataReader.IsDBNull(79) == false) {
				tbl_prod_polyTxJobCard.CompanyID = dataReader.GetString(79);
			}
			if (dataReader.IsDBNull(80) == false) {
				tbl_prod_polyTxJobCard.CompanyBranchID = dataReader.GetString(80);
			}

			return tbl_prod_polyTxJobCard;
		}
		/// <summary>
		/// This makes tbl_prod_polyTxJobCard datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_prod_polyTxJobCard object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_prod_polyTxJobCard  tbl_prod_polyTxJobCard   )
		{
		DataTable dt = new DataTable();
			...
			DataColumn col_orderedWeight = new DataColumn("orderedWeight" , typeof(decimal));
			...
			DataColumn col_wasteWeight = new DataColumn("wasteWeight" , typeof(decimal));
		...
		DataRow drow = dt.NewRow();
			...
			drow["orderedWeight"] = user.orderedWeight;
			...
			drow["wasteWeight"] = user.wasteWeight;
