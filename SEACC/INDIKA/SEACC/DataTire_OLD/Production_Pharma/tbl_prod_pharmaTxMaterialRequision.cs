...
namespace DataTire {
	public sealed class tbl_prod_pharmaTxMaterialRequision {
		#region Fields
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_prod_pharmaTxMaterialRequision table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_prod_pharmaTxMaterialRequision table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_prod_pharmaTxMaterialRequision table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_prod_pharmaTxMaterialRequision table by a foreign key.
		/// </summary>
		public static void DeleteAllByCheckedUser_ID(string checkedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionDeleteAllByCheckedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByApprovedUser_ID(string approvedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionDeleteAllByApprovedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByModifiedUser_ID(string modifiedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionDeleteAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCanceldUser_ID(string canceldUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionDeleteAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCompanyID(string companyID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionDeleteAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCompanyBranchID(string companyBranchID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionDeleteAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCreateUser_ID(string createUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionDeleteAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllBySection_ID(string section_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionDeleteAllBySection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_prod_pharmaTxMaterialRequision table.
		/// </summary>
		public static tbl_prod_pharmaTxMaterialRequision Select(string mr_No_Incoming){

			tbl_prod_pharmaTxMaterialRequision tbl_prod_pharmaTxMaterialRequisionins = new tbl_prod_pharmaTxMaterialRequision();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_prod_pharmaTxMaterialRequisionins = Maketbl_prod_pharmaTxMaterialRequision(dataReader);
				} else {
					tbl_prod_pharmaTxMaterialRequisionins = null;
				}
			}
			scon.Close();
			return tbl_prod_pharmaTxMaterialRequisionins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_pharmaTxMaterialRequision table.
		/// </summary>
		public static List<tbl_prod_pharmaTxMaterialRequision> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_prod_pharmaTxMaterialRequision> tbl_prod_pharmaTxMaterialRequisionList = new List<tbl_prod_pharmaTxMaterialRequision>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_prod_pharmaTxMaterialRequision tbl_prod_pharmaTxMaterialRequision = Maketbl_prod_pharmaTxMaterialRequision(dataReader);
					tbl_prod_pharmaTxMaterialRequisionList.Add(tbl_prod_pharmaTxMaterialRequision);
				}
			}
			scon.Close();
			return tbl_prod_pharmaTxMaterialRequisionList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_pharmaTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxMaterialRequision> SelectAllByCheckedUser_ID(string checkedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionSelectAllByCheckedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxMaterialRequision> SelectAllByApprovedUser_ID(string approvedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionSelectAllByApprovedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxMaterialRequision> SelectAllByModifiedUser_ID(string modifiedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionSelectAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxMaterialRequision> SelectAllByCanceldUser_ID(string canceldUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionSelectAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxMaterialRequision> SelectAllByCompanyID(string companyID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionSelectAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxMaterialRequision> SelectAllByCompanyBranchID(string companyBranchID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionSelectAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxMaterialRequision> SelectAllByCreateUser_ID(string createUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionSelectAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxMaterialRequision> SelectAllBySection_ID(string section_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxMaterialRequisionSelectAllBySection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_prod_pharmaTxMaterialRequision class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_prod_pharmaTxMaterialRequision Maketbl_prod_pharmaTxMaterialRequision(SqlDataReader dataReader) {
			tbl_prod_pharmaTxMaterialRequision tbl_prod_pharmaTxMaterialRequision = new tbl_prod_pharmaTxMaterialRequision();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_prod_pharmaTxMaterialRequision.Mr_No = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_prod_pharmaTxMaterialRequision.Mr_Date = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_prod_pharmaTxMaterialRequision.Section_ID = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_prod_pharmaTxMaterialRequision.PlanDate_from = dataReader.GetDateTime(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_prod_pharmaTxMaterialRequision.PlanDate_to = dataReader.GetDateTime(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_prod_pharmaTxMaterialRequision.IsChecked = dataReader.GetBoolean(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_prod_pharmaTxMaterialRequision.IsApproved = dataReader.GetBoolean(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_prod_pharmaTxMaterialRequision.IsCanceled = dataReader.GetBoolean(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_prod_pharmaTxMaterialRequision.CreateUser_ID = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_prod_pharmaTxMaterialRequision.ModifiedUser_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_prod_pharmaTxMaterialRequision.CheckedUser_ID = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_prod_pharmaTxMaterialRequision.ApprovedUser_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_prod_pharmaTxMaterialRequision.CanceldUser_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_prod_pharmaTxMaterialRequision.DateCreate = dataReader.GetDateTime(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_prod_pharmaTxMaterialRequision.DateModified = dataReader.GetDateTime(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_prod_pharmaTxMaterialRequision.DateChecked = dataReader.GetDateTime(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_prod_pharmaTxMaterialRequision.DateApproved = dataReader.GetDateTime(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_prod_pharmaTxMaterialRequision.DateCanceled = dataReader.GetDateTime(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_prod_pharmaTxMaterialRequision.CreateUserTerminal_ID = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_prod_pharmaTxMaterialRequision.ModifiedUserTerminal_ID = dataReader.GetString(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_prod_pharmaTxMaterialRequision.CheckedUserTerminal_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_prod_pharmaTxMaterialRequision.ApprovedUserTerminal_ID = dataReader.GetString(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_prod_pharmaTxMaterialRequision.CanceledUserTerminal_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_prod_pharmaTxMaterialRequision.CompanyID = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_prod_pharmaTxMaterialRequision.CompanyBranchID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_prod_pharmaTxMaterialRequision.Remarks = dataReader.GetString(25);
			}

			return tbl_prod_pharmaTxMaterialRequision;
		}
		/// <summary>
		/// This makes tbl_prod_pharmaTxMaterialRequision datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_prod_pharmaTxMaterialRequision object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_prod_pharmaTxMaterialRequision  tbl_prod_pharmaTxMaterialRequision   )
		{
		...
		/// <summary>
		/// This fills tbl_prod_pharmaTxMaterialRequision datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_prod_pharmaTxMaterialRequision object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_prod_pharmaTxMaterialRequision user) {
