...
namespace DataTire {
	public sealed class tbl_prod_pharmaTxBatch_Material {
		#region Fields
		private int line_No;
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_prod_pharmaTxBatch_Material class.
		/// </summary>
		public tbl_prod_pharmaTxBatch_Material() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_prod_pharmaTxBatch_Material class.
		/// </summary>
		public tbl_prod_pharmaTxBatch_Material(int line_No, int line_No_Sub1, int line_No_Sub2, string prodJob_ID, string prodBatch_ID, string item_ID, string uom_ID, bool isSemiFinishItem, decimal inputQty, bool isWastagePercent, decimal wastagePercent, decimal wastageQty, decimal totalInputQty, string section_ID, string activity_ID, decimal smv_TimeMinutes, decimal totalLabour, decimal lowestCost, decimal highestCost, decimal weightedAvgCost, int costTypeSelection, decimal cost, bool allowCostEdit, decimal editedCost, bool isSelected) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_prod_pharmaTxBatch_Material table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_prod_pharmaTxBatch_Material table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_prod_pharmaTxBatch_Material table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_prod_pharmaTxBatch_Material table by a foreign key.
		/// </summary>
		public static void DeleteAllByProdJob_ID(string prodJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialDeleteAllByProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByLine_No_Line_No_Sub1_Line_No_Sub2_ProdJob_ID(int line_No, int line_No_Sub1, int line_No_Sub2, string prodJob_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialDeleteAllByLine_No_Line_No_Sub1_Line_No_Sub2_ProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_ID(string item_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialDeleteAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByActivity_ID(string activity_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialDeleteAllByActivity_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByUom_ID(string uom_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialDeleteAllByUom_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllBySection_ID(string section_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialDeleteAllBySection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByProdBatch_ID(string prodBatch_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialDeleteAllByProdBatch_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_prod_pharmaTxBatch_Material table.
		/// </summary>
		public static tbl_prod_pharmaTxBatch_Material Select(int line_No_Incoming, int line_No_Sub1_Incoming, int line_No_Sub2_Incoming, string prodJob_ID_Incoming, string prodBatch_ID_Incoming){

			tbl_prod_pharmaTxBatch_Material tbl_prod_pharmaTxBatch_Materialins = new tbl_prod_pharmaTxBatch_Material();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_prod_pharmaTxBatch_Materialins = Maketbl_prod_pharmaTxBatch_Material(dataReader);
				} else {
					tbl_prod_pharmaTxBatch_Materialins = null;
				}
			}
			scon.Close();
			return tbl_prod_pharmaTxBatch_Materialins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_pharmaTxBatch_Material table.
		/// </summary>
		public static List<tbl_prod_pharmaTxBatch_Material> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_prod_pharmaTxBatch_Material> tbl_prod_pharmaTxBatch_MaterialList = new List<tbl_prod_pharmaTxBatch_Material>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_prod_pharmaTxBatch_Material tbl_prod_pharmaTxBatch_Material = Maketbl_prod_pharmaTxBatch_Material(dataReader);
					tbl_prod_pharmaTxBatch_MaterialList.Add(tbl_prod_pharmaTxBatch_Material);
				}
			}
			scon.Close();
			return tbl_prod_pharmaTxBatch_MaterialList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_pharmaTxBatch_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxBatch_Material> SelectAllByProdJob_ID(string prodJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialSelectAllByProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxBatch_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxBatch_Material> SelectAllByLine_No_Line_No_Sub1_Line_No_Sub2_ProdJob_ID(int line_No, int line_No_Sub1, int line_No_Sub2, string prodJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialSelectAllByLine_No_Line_No_Sub1_Line_No_Sub2_ProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxBatch_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxBatch_Material> SelectAllByItem_ID(string item_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialSelectAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxBatch_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxBatch_Material> SelectAllByActivity_ID(string activity_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialSelectAllByActivity_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxBatch_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxBatch_Material> SelectAllByUom_ID(string uom_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialSelectAllByUom_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxBatch_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxBatch_Material> SelectAllBySection_ID(string section_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialSelectAllBySection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxBatch_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxBatch_Material> SelectAllByProdBatch_ID(string prodBatch_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxBatch_MaterialSelectAllByProdBatch_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_prod_pharmaTxBatch_Material class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_prod_pharmaTxBatch_Material Maketbl_prod_pharmaTxBatch_Material(SqlDataReader dataReader) {
			tbl_prod_pharmaTxBatch_Material tbl_prod_pharmaTxBatch_Material = new tbl_prod_pharmaTxBatch_Material();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_prod_pharmaTxBatch_Material.Line_No = dataReader.GetInt32(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_prod_pharmaTxBatch_Material.Line_No_Sub1 = dataReader.GetInt32(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_prod_pharmaTxBatch_Material.Line_No_Sub2 = dataReader.GetInt32(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_prod_pharmaTxBatch_Material.ProdJob_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_prod_pharmaTxBatch_Material.ProdBatch_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_prod_pharmaTxBatch_Material.Item_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_prod_pharmaTxBatch_Material.Uom_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_prod_pharmaTxBatch_Material.IsSemiFinishItem = dataReader.GetBoolean(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_prod_pharmaTxBatch_Material.InputQty = dataReader.GetDecimal(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_prod_pharmaTxBatch_Material.IsWastagePercent = dataReader.GetBoolean(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_prod_pharmaTxBatch_Material.WastagePercent = dataReader.GetDecimal(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_prod_pharmaTxBatch_Material.WastageQty = dataReader.GetDecimal(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_prod_pharmaTxBatch_Material.TotalInputQty = dataReader.GetDecimal(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_prod_pharmaTxBatch_Material.Section_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_prod_pharmaTxBatch_Material.Activity_ID = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_prod_pharmaTxBatch_Material.Smv_TimeMinutes = dataReader.GetDecimal(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_prod_pharmaTxBatch_Material.TotalLabour = dataReader.GetDecimal(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_prod_pharmaTxBatch_Material.LowestCost = dataReader.GetDecimal(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_prod_pharmaTxBatch_Material.HighestCost = dataReader.GetDecimal(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_prod_pharmaTxBatch_Material.WeightedAvgCost = dataReader.GetDecimal(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_prod_pharmaTxBatch_Material.CostTypeSelection = dataReader.GetInt32(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_prod_pharmaTxBatch_Material.Cost = dataReader.GetDecimal(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_prod_pharmaTxBatch_Material.AllowCostEdit = dataReader.GetBoolean(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_prod_pharmaTxBatch_Material.EditedCost = dataReader.GetDecimal(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_prod_pharmaTxBatch_Material.IsSelected = dataReader.GetBoolean(24);
			}

			return tbl_prod_pharmaTxBatch_Material;
		}
		/// <summary>
		/// This makes tbl_prod_pharmaTxBatch_Material datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_prod_pharmaTxBatch_Material object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_prod_pharmaTxBatch_Material  tbl_prod_pharmaTxBatch_Material   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_line_No,col_line_No_Sub1,col_line_No_Sub2,col_prodJob_ID,col_prodBatch_ID,col_item_ID,col_uom_ID,col_isSemiFinishItem,col_inputQty,col_isWastagePercent,col_wastagePercent,col_wastageQty,col_totalInputQty,col_section_ID,col_activity_ID,col_smv_TimeMinutes,col_totalLabour,col_lowestCost,col_highestCost,col_weightedAvgCost,col_costTypeSelection,col_cost,col_allowCostEdit,col_editedCost,col_isSelected,});		return dt;
		}
		/// <summary>
		/// This fills tbl_prod_pharmaTxBatch_Material datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_prod_pharmaTxBatch_Material object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_prod_pharmaTxBatch_Material user) {
