...
namespace DataTire {
	public sealed class tbl_prod_pharmaTxFinishedGoodSpecsSheet {
		#region Fields
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_prod_pharmaTxFinishedGoodSpecsSheet table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_prod_pharmaTxFinishedGoodSpecsSheet table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static void DeleteAllByCustomer_ID(string customer_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByCustomer_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		//	SqlConnection scon = DBHandling.GetConnection();
		//	SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByItem_ID_FG", scon);
		//	scom.CommandType = CommandType.StoredProcedure;
		//	//scon.Open();
		...
		public static void DeleteAllByModifiedUser_ID(string modifiedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCreateUser_ID(string createUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByTag4_ID(string tag4_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByTag4_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCompanyID(string companyID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCanceldUser_ID(string canceldUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCompanyBranchID(string companyBranchID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCheckedUser_ID(string checkedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByCheckedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByTag3_ID(string tag3_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByTag3_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByApprovedUser_ID(string approvedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByApprovedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_ID_Template(string item_ID_Template) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByItem_ID_Template", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByColour_ID(string colour_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetDeleteAllByColour_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table.
		/// </summary>
		public static tbl_prod_pharmaTxFinishedGoodSpecsSheet Select(string item_ID_FG_Incoming){

			tbl_prod_pharmaTxFinishedGoodSpecsSheet tbl_prod_pharmaTxFinishedGoodSpecsSheetins = new tbl_prod_pharmaTxFinishedGoodSpecsSheet();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_prod_pharmaTxFinishedGoodSpecsSheetins = Maketbl_prod_pharmaTxFinishedGoodSpecsSheet(dataReader);
				} else {
					tbl_prod_pharmaTxFinishedGoodSpecsSheetins = null;
				}
			}
			scon.Close();
			return tbl_prod_pharmaTxFinishedGoodSpecsSheetins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> tbl_prod_pharmaTxFinishedGoodSpecsSheetList = new List<tbl_prod_pharmaTxFinishedGoodSpecsSheet>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_prod_pharmaTxFinishedGoodSpecsSheet tbl_prod_pharmaTxFinishedGoodSpecsSheet = Maketbl_prod_pharmaTxFinishedGoodSpecsSheet(dataReader);
					tbl_prod_pharmaTxFinishedGoodSpecsSheetList.Add(tbl_prod_pharmaTxFinishedGoodSpecsSheet);
				}
			}
			scon.Close();
			return tbl_prod_pharmaTxFinishedGoodSpecsSheetList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByCustomer_ID(string customer_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByCustomer_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByItem_ID_FG(string item_ID_FG) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByItem_ID_FG", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByModifiedUser_ID(string modifiedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByCreateUser_ID(string createUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByTag4_ID(string tag4_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByTag4_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByCompanyID(string companyID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByCanceldUser_ID(string canceldUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByCompanyBranchID(string companyBranchID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByCheckedUser_ID(string checkedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByCheckedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByTag3_ID(string tag3_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByTag3_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByApprovedUser_ID(string approvedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByApprovedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByItem_ID_Template(string item_ID_Template) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByItem_ID_Template", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prod_pharmaTxFinishedGoodSpecsSheet table by a foreign key.
		/// </summary>
		public static List<tbl_prod_pharmaTxFinishedGoodSpecsSheet> SelectAllByColour_ID(string colour_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prod_pharmaTxFinishedGoodSpecsSheetSelectAllByColour_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_prod_pharmaTxFinishedGoodSpecsSheet class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_prod_pharmaTxFinishedGoodSpecsSheet Maketbl_prod_pharmaTxFinishedGoodSpecsSheet(SqlDataReader dataReader) {
			tbl_prod_pharmaTxFinishedGoodSpecsSheet tbl_prod_pharmaTxFinishedGoodSpecsSheet = new tbl_prod_pharmaTxFinishedGoodSpecsSheet();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Item_ID_FG = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Item_ID_Template = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Industry_ID = dataReader.GetInt32(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Customer_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Instruction_Sales = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Instruction_Prod = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Instruction_Accounts = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Instruction_Stores = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Instruction_Supplier = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Uom_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Uom_ID_Weight = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Tag3_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Tag4_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Colour_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.MeltingPoint = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.ChemFormula = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Density = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.IsChecked = dataReader.GetBoolean(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.IsApproved = dataReader.GetBoolean(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.IsCanceled = dataReader.GetBoolean(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.CreateUser_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.ModifiedUser_ID = dataReader.GetString(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.CheckedUser_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.ApprovedUser_ID = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.CanceldUser_ID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.DateCreate = dataReader.GetDateTime(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.DateModified = dataReader.GetDateTime(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.DateChecked = dataReader.GetDateTime(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.DateApproved = dataReader.GetDateTime(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.DateCanceled = dataReader.GetDateTime(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.CreateUserTerminal_ID = dataReader.GetString(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.ModifiedUserTerminal_ID = dataReader.GetString(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.CheckedUserTerminal_ID = dataReader.GetString(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.ApprovedUserTerminal_ID = dataReader.GetString(33);
			}
			if (dataReader.IsDBNull(34) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.CanceledUserTerminal_ID = dataReader.GetString(34);
			}
			if (dataReader.IsDBNull(35) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.CompanyID = dataReader.GetString(35);
			}
			if (dataReader.IsDBNull(36) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.CompanyBranchID = dataReader.GetString(36);
			}
			if (dataReader.IsDBNull(37) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Prefix = dataReader.GetString(37);
			}
			if (dataReader.IsDBNull(38) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Suffix = dataReader.GetString(38);
			}
			if (dataReader.IsDBNull(39) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Layer1 = dataReader.GetString(39);
			}
			if (dataReader.IsDBNull(40) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Layer2 = dataReader.GetString(40);
			}
			if (dataReader.IsDBNull(41) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Layer3 = dataReader.GetString(41);
			}
			if (dataReader.IsDBNull(42) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Layer4 = dataReader.GetString(42);
			}
			if (dataReader.IsDBNull(43) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Layer5 = dataReader.GetString(43);
			}
			if (dataReader.IsDBNull(44) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Layer6 = dataReader.GetString(44);
			}
			if (dataReader.IsDBNull(45) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Filling1 = dataReader.GetString(45);
			}
			if (dataReader.IsDBNull(46) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Filling2 = dataReader.GetString(46);
			}
			if (dataReader.IsDBNull(47) == false) {
				tbl_prod_pharmaTxFinishedGoodSpecsSheet.Filling3 = dataReader.GetString(47);
			}

			return tbl_prod_pharmaTxFinishedGoodSpecsSheet;
		}
		/// <summary>
		/// This makes tbl_prod_pharmaTxFinishedGoodSpecsSheet datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_prod_pharmaTxFinishedGoodSpecsSheet object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_prod_pharmaTxFinishedGoodSpecsSheet  tbl_prod_pharmaTxFinishedGoodSpecsSheet   )
		{
		...
		/// <summary>
		/// This fills tbl_prod_pharmaTxFinishedGoodSpecsSheet datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_prod_pharmaTxFinishedGoodSpecsSheet object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_prod_pharmaTxFinishedGoodSpecsSheet user) {
