...
namespace DataTire {
	public sealed class tbl_pmsWorkInProgress_Machine_Shedule {
		#region Fields
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_pmsWorkInProgress_Machine_Shedule table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgress_Machine_SheduleInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_pmsWorkInProgress_Machine_Shedule table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgress_Machine_SheduleUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_pmsWorkInProgress_Machine_Shedule table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgress_Machine_SheduleDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_pmsWorkInProgress_Machine_Shedule table by a foreign key.
		/// </summary>
		public static void DeleteAllByWorkInProgress_ID_Line_No_PrePlan_ID_Section_ID_Machine_ID(string workInProgress_ID, int line_No, string prePlan_ID, string section_ID, string machine_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgress_Machine_SheduleDeleteAllByWorkInProgress_ID_Line_No_PrePlan_ID_Section_ID_Machine_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_pmsWorkInProgress_Machine_Shedule table.
		/// </summary>
		public static tbl_pmsWorkInProgress_Machine_Shedule Select(int line_NoShedule_Incoming, string workInProgress_ID_Incoming, int line_No_Incoming, string prePlan_ID_Incoming, string section_ID_Incoming, string machine_ID_Incoming){

			tbl_pmsWorkInProgress_Machine_Shedule tbl_pmsWorkInProgress_Machine_Sheduleins = new tbl_pmsWorkInProgress_Machine_Shedule();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgress_Machine_SheduleSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_pmsWorkInProgress_Machine_Sheduleins = Maketbl_pmsWorkInProgress_Machine_Shedule(dataReader);
				} else {
					tbl_pmsWorkInProgress_Machine_Sheduleins = null;
				}
			}
			scon.Close();
			return tbl_pmsWorkInProgress_Machine_Sheduleins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_pmsWorkInProgress_Machine_Shedule table.
		/// </summary>
		public static List<tbl_pmsWorkInProgress_Machine_Shedule> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgress_Machine_SheduleSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_pmsWorkInProgress_Machine_Shedule> tbl_pmsWorkInProgress_Machine_SheduleList = new List<tbl_pmsWorkInProgress_Machine_Shedule>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_pmsWorkInProgress_Machine_Shedule tbl_pmsWorkInProgress_Machine_Shedule = Maketbl_pmsWorkInProgress_Machine_Shedule(dataReader);
					tbl_pmsWorkInProgress_Machine_SheduleList.Add(tbl_pmsWorkInProgress_Machine_Shedule);
				}
			}
			scon.Close();
			return tbl_pmsWorkInProgress_Machine_SheduleList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_pmsWorkInProgress_Machine_Shedule table by a foreign key.
		/// </summary>
		public static List<tbl_pmsWorkInProgress_Machine_Shedule> SelectAllByWorkInProgress_ID_Line_No_PrePlan_ID_Section_ID_Machine_ID(string workInProgress_ID, int line_No, string prePlan_ID, string section_ID, string machine_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgress_Machine_SheduleSelectAllByWorkInProgress_ID_Line_No_PrePlan_ID_Section_ID_Machine_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_pmsWorkInProgress_Machine_Shedule class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_pmsWorkInProgress_Machine_Shedule Maketbl_pmsWorkInProgress_Machine_Shedule(SqlDataReader dataReader) {
			tbl_pmsWorkInProgress_Machine_Shedule tbl_pmsWorkInProgress_Machine_Shedule = new tbl_pmsWorkInProgress_Machine_Shedule();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.Line_NoShedule = dataReader.GetInt32(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.WorkInProgress_ID = dataReader.GetString(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.Line_No = dataReader.GetInt32(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.PrePlan_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.Section_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.Machine_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.DateStart = dataReader.GetDateTime(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.DateEnd = dataReader.GetDateTime(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.CreateUser_ID = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ModifiedUser_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.CheckedUser_ID = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ApprovedUser_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.DeletedUser_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.PrintedUser_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.CreateTerminal_ID = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ModifiedTerminal_ID = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.DeletedTerminal_ID = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.PrintedTerminal_ID = dataReader.GetString(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.DateCreate = dataReader.GetDateTime(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.DateModified = dataReader.GetDateTime(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.DateChecked = dataReader.GetDateTime(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.DateApproved = dataReader.GetDateTime(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.DateDeleted = dataReader.GetDateTime(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.DatePrinted = dataReader.GetDateTime(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.Employee_ID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ExtraHours_iddle = dataReader.GetDecimal(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ExtraHours_Maintenance = dataReader.GetDecimal(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ExtraHours_Labours = dataReader.GetDecimal(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ExtraHours_Cleaning = dataReader.GetDecimal(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ExtraHours_Approval = dataReader.GetDecimal(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ExtraHours_Powe_Air_etc = dataReader.GetDecimal(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ExtraHours_JobSetting = dataReader.GetDecimal(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.ExtraHours_JobRunning = dataReader.GetDecimal(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_pmsWorkInProgress_Machine_Shedule.CutbackSize = dataReader.GetDecimal(33);
			}

			return tbl_pmsWorkInProgress_Machine_Shedule;
		}
		/// <summary>
		/// This makes tbl_pmsWorkInProgress_Machine_Shedule datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_pmsWorkInProgress_Machine_Shedule object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_pmsWorkInProgress_Machine_Shedule  tbl_pmsWorkInProgress_Machine_Shedule   )
		{
		...
		/// <summary>
		/// This fills tbl_pmsWorkInProgress_Machine_Shedule datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_pmsWorkInProgress_Machine_Shedule object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_pmsWorkInProgress_Machine_Shedule user) {
        ...
        public static List<tbl_pmsWorkInProgress_Machine_Shedule> SelectAllByWorkInProgress_ID(string workInProgress_ID)
        {

            SqlConnection scon = DBHandling.GetConnection();
            SqlCommand scom = new SqlCommand("tbl_pmsWorkInProgress_Machine_SheduleSelectAllByWorkInProgress_ID", scon);
            scom.CommandType = CommandType.StoredProcedure;
            scon.Open();
