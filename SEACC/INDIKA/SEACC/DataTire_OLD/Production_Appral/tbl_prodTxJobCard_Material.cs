...
namespace DataTire {
	public sealed class tbl_prodTxJobCard_Material {
		#region Fields
		private int line_No;
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the tbl_prodTxJobCard_Material class.
		/// </summary>
		public tbl_prodTxJobCard_Material() {
		}
		
		/// <summary>
		/// Initializes a new instance of the tbl_prodTxJobCard_Material class.
		/// </summary>
		public tbl_prodTxJobCard_Material(int line_No, int line_No_Sub1, int line_No_Sub2, string prodJob_ID, string item_ID, string uom_ID, bool isSemiFinishItem, decimal inputQty, decimal consumption, bool isWastagePercent, decimal wastagePercent, decimal wastageQty, decimal totalInputQty, string section_ID, decimal smv_TimeMinutes, decimal totalLabour, decimal lowestCost, decimal highestCost, decimal weightedAvgCost, decimal bomCost, int costTypeSelection, decimal cost, bool allowCostEdit, decimal editedCost, Int64 wipout_sf_Index) {
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_prodTxJobCard_Material table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_prodTxJobCard_Material table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_prodTxJobCard_Material table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_prodTxJobCard_Material table by a foreign key.
		/// </summary>
		public static void DeleteAllByWipout_sf_Index(Int64 wipout_sf_Index) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialDeleteAllByWipout_sf_Index", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByProdJob_ID(string prodJob_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialDeleteAllByProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByUom_ID(string uom_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialDeleteAllByUom_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_ID(string item_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialDeleteAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_prodTxJobCard_Material table.
		/// </summary>
		public static tbl_prodTxJobCard_Material Select(int line_No_Incoming, int line_No_Sub1_Incoming, int line_No_Sub2_Incoming, string prodJob_ID_Incoming){

			tbl_prodTxJobCard_Material tbl_prodTxJobCard_Materialins = new tbl_prodTxJobCard_Material();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_prodTxJobCard_Materialins = Maketbl_prodTxJobCard_Material(dataReader);
				} else {
					tbl_prodTxJobCard_Materialins = null;
				}
			}
			scon.Close();
			return tbl_prodTxJobCard_Materialins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prodTxJobCard_Material table.
		/// </summary>
		public static List<tbl_prodTxJobCard_Material> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_prodTxJobCard_Material> tbl_prodTxJobCard_MaterialList = new List<tbl_prodTxJobCard_Material>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_prodTxJobCard_Material tbl_prodTxJobCard_Material = Maketbl_prodTxJobCard_Material(dataReader);
					tbl_prodTxJobCard_MaterialList.Add(tbl_prodTxJobCard_Material);
				}
			}
			scon.Close();
			return tbl_prodTxJobCard_MaterialList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prodTxJobCard_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard_Material> SelectAllByWipout_sf_Index(Int64 wipout_sf_Index) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialSelectAllByWipout_sf_Index", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard_Material> SelectAllByProdJob_ID(string prodJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialSelectAllByProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard_Material> SelectAllByUom_ID(string uom_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialSelectAllByUom_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard_Material table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard_Material> SelectAllByItem_ID(string item_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCard_MaterialSelectAllByItem_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_prodTxJobCard_Material class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_prodTxJobCard_Material Maketbl_prodTxJobCard_Material(SqlDataReader dataReader) {
			tbl_prodTxJobCard_Material tbl_prodTxJobCard_Material = new tbl_prodTxJobCard_Material();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_prodTxJobCard_Material.Line_No = dataReader.GetInt32(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_prodTxJobCard_Material.Line_No_Sub1 = dataReader.GetInt32(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_prodTxJobCard_Material.Line_No_Sub2 = dataReader.GetInt32(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_prodTxJobCard_Material.ProdJob_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_prodTxJobCard_Material.Item_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_prodTxJobCard_Material.Uom_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_prodTxJobCard_Material.IsSemiFinishItem = dataReader.GetBoolean(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_prodTxJobCard_Material.InputQty = dataReader.GetDecimal(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_prodTxJobCard_Material.Consumption = dataReader.GetDecimal(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_prodTxJobCard_Material.IsWastagePercent = dataReader.GetBoolean(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_prodTxJobCard_Material.WastagePercent = dataReader.GetDecimal(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_prodTxJobCard_Material.WastageQty = dataReader.GetDecimal(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_prodTxJobCard_Material.TotalInputQty = dataReader.GetDecimal(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_prodTxJobCard_Material.Section_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_prodTxJobCard_Material.Smv_TimeMinutes = dataReader.GetDecimal(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_prodTxJobCard_Material.TotalLabour = dataReader.GetDecimal(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_prodTxJobCard_Material.LowestCost = dataReader.GetDecimal(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_prodTxJobCard_Material.HighestCost = dataReader.GetDecimal(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_prodTxJobCard_Material.WeightedAvgCost = dataReader.GetDecimal(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_prodTxJobCard_Material.BomCost = dataReader.GetDecimal(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_prodTxJobCard_Material.CostTypeSelection = dataReader.GetInt32(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_prodTxJobCard_Material.Cost = dataReader.GetDecimal(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_prodTxJobCard_Material.AllowCostEdit = dataReader.GetBoolean(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_prodTxJobCard_Material.EditedCost = dataReader.GetDecimal(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_prodTxJobCard_Material.Wipout_sf_Index = dataReader.GetInt64(24);
			}

			return tbl_prodTxJobCard_Material;
		}
		/// <summary>
		/// This makes tbl_prodTxJobCard_Material datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_prodTxJobCard_Material object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_prodTxJobCard_Material  tbl_prodTxJobCard_Material   )
		{
		...
		dt.Columns.AddRange(new DataColumn[] { col_line_No,col_line_No_Sub1,col_line_No_Sub2,col_prodJob_ID,col_item_ID,col_uom_ID,col_isSemiFinishItem,col_inputQty,col_consumption,col_isWastagePercent,col_wastagePercent,col_wastageQty,col_totalInputQty,col_section_ID,col_smv_TimeMinutes,col_totalLabour,col_lowestCost,col_highestCost,col_weightedAvgCost,col_bomCost,col_costTypeSelection,col_cost,col_allowCostEdit,col_editedCost,col_wipout_sf_Index,});		return dt;
		}
		/// <summary>
		/// This fills tbl_prodTxJobCard_Material datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_prodTxJobCard_Material object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_prodTxJobCard_Material user) {
