...
namespace DataTire {
	public sealed class tbl_prodTxJobCard {
		#region Fields
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_prodTxJobCard table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_prodTxJobCard table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_prodTxJobCard table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static void DeleteAllByCustomerInquiry_ID(string customerInquiry_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByCustomerInquiry_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_Height_UoM_ID(string item_Height_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByItem_Height_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCustomer_ID(string customer_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByCustomer_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByChecked1User_ID(string checked1User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByChecked1User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_Weight_UoM_ID(string item_Weight_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByItem_Weight_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCompanyBranchID(string companyBranchID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByProdJob_ID(string prodJob_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByUom_ID(string uom_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByUom_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByProdSize_ID(string prodSize_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByProdSize_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_Thickness_UoM_ID(string item_Thickness_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByItem_Thickness_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCanceldUser_ID(string canceldUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByProdRange_ID(string prodRange_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByProdRange_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByApproved1User_ID(string approved1User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByApproved1User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByApproved3User_ID(string approved3User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByApproved3User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByModifiedUser_ID(string modifiedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_Length_UoM_ID(string item_Length_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByItem_Length_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_Width_UoM_ID(string item_Width_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByItem_Width_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByColour_ID(string colour_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByColour_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByProdCategory_ID(string prodCategory_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByProdCategory_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByChecked2User_ID(string checked2User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByChecked2User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_Radius_UoM_ID(string item_Radius_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByItem_Radius_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByApproved2User_ID(string approved2User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByApproved2User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCompanyID(string companyID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCreateUser_ID(string createUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllBySalesman_ID(string salesman_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllBySalesman_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByLockedUser_ID(string lockedUser_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByLockedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_Diameter_UoM_ID(string item_Diameter_UoM_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByItem_Diameter_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByJobType_ID(string jobType_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByJobType_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByItem_ID_FG(string item_ID_FG) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByItem_ID_FG", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByCustomerOrder_ID(string customerOrder_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByCustomerOrder_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		public static void DeleteAllByChecked3User_ID(string checked3User_ID) {
			...
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardDeleteAllByChecked3User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			//scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_prodTxJobCard table.
		/// </summary>
		public static tbl_prodTxJobCard Select(string prodJob_ID_Incoming){

			tbl_prodTxJobCard tbl_prodTxJobCardins = new tbl_prodTxJobCard();
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_prodTxJobCardins = Maketbl_prodTxJobCard(dataReader);
				} else {
					tbl_prodTxJobCardins = null;
				}
			}
			scon.Close();
			return tbl_prodTxJobCardins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prodTxJobCard table.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAll() {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_prodTxJobCard> tbl_prodTxJobCardList = new List<tbl_prodTxJobCard>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_prodTxJobCard tbl_prodTxJobCard = Maketbl_prodTxJobCard(dataReader);
					tbl_prodTxJobCardList.Add(tbl_prodTxJobCard);
				}
			}
			scon.Close();
			return tbl_prodTxJobCardList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByCustomerInquiry_ID(string customerInquiry_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByCustomerInquiry_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByItem_Height_UoM_ID(string item_Height_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByItem_Height_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByCustomer_ID(string customer_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByCustomer_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByChecked1User_ID(string checked1User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByChecked1User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByItem_Weight_UoM_ID(string item_Weight_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByItem_Weight_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByCompanyBranchID(string companyBranchID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByProdJob_ID(string prodJob_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByProdJob_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByUom_ID(string uom_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByUom_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByProdSize_ID(string prodSize_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByProdSize_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByItem_Thickness_UoM_ID(string item_Thickness_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByItem_Thickness_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByCanceldUser_ID(string canceldUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByProdRange_ID(string prodRange_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByProdRange_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByApproved1User_ID(string approved1User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByApproved1User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByApproved3User_ID(string approved3User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByApproved3User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByModifiedUser_ID(string modifiedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByItem_Length_UoM_ID(string item_Length_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByItem_Length_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByItem_Width_UoM_ID(string item_Width_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByItem_Width_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByColour_ID(string colour_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByColour_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByProdCategory_ID(string prodCategory_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByProdCategory_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByChecked2User_ID(string checked2User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByChecked2User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByItem_Radius_UoM_ID(string item_Radius_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByItem_Radius_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByApproved2User_ID(string approved2User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByApproved2User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByCompanyID(string companyID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByCreateUser_ID(string createUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllBySalesman_ID(string salesman_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllBySalesman_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByLockedUser_ID(string lockedUser_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByLockedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByItem_Diameter_UoM_ID(string item_Diameter_UoM_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByItem_Diameter_UoM_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByJobType_ID(string jobType_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByJobType_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByItem_ID_FG(string item_ID_FG) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByItem_ID_FG", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByCustomerOrder_ID(string customerOrder_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByCustomerOrder_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxJobCard table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxJobCard> SelectAllByChecked3User_ID(string checked3User_ID) {
 
			SqlConnection scon = DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxJobCardSelectAllByChecked3User_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_prodTxJobCard class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_prodTxJobCard Maketbl_prodTxJobCard(SqlDataReader dataReader) {
			tbl_prodTxJobCard tbl_prodTxJobCard = new tbl_prodTxJobCard();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_prodTxJobCard.ProdJob_ID = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_prodTxJobCard.ProdJobDate = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_prodTxJobCard.ProdJobStatus = dataReader.GetInt32(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_prodTxJobCard.Salesman_ID = dataReader.GetString(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_prodTxJobCard.Customer_ID = dataReader.GetString(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_prodTxJobCard.CustomerInquiry_ID = dataReader.GetString(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_prodTxJobCard.CustomerOrder_ID = dataReader.GetString(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_prodTxJobCard.Remarks = dataReader.GetString(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_prodTxJobCard.Remarks2 = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_prodTxJobCard.JobType_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_prodTxJobCard.ProdRange_ID = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_prodTxJobCard.ProdCategory_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_prodTxJobCard.ProdSize_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_prodTxJobCard.Colour_ID = dataReader.GetString(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_prodTxJobCard.Item_ID_Previous = dataReader.GetString(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_prodTxJobCard.Item_ID_FG = dataReader.GetString(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_prodTxJobCard.Uom_ID = dataReader.GetString(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_prodTxJobCard.Item_Length = dataReader.GetDecimal(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_prodTxJobCard.Item_Length_UoM_ID = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_prodTxJobCard.Item_Width = dataReader.GetDecimal(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_prodTxJobCard.Item_Width_UoM_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_prodTxJobCard.Item_Height = dataReader.GetDecimal(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_prodTxJobCard.Item_Height_UoM_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_prodTxJobCard.Item_Diameter = dataReader.GetDecimal(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_prodTxJobCard.Item_Diameter_UoM_ID = dataReader.GetString(24);
			}
			if (dataReader.IsDBNull(25) == false) {
				tbl_prodTxJobCard.Item_Radius = dataReader.GetDecimal(25);
			}
			if (dataReader.IsDBNull(26) == false) {
				tbl_prodTxJobCard.Item_Radius_UoM_ID = dataReader.GetString(26);
			}
			if (dataReader.IsDBNull(27) == false) {
				tbl_prodTxJobCard.Item_Thickness = dataReader.GetDecimal(27);
			}
			if (dataReader.IsDBNull(28) == false) {
				tbl_prodTxJobCard.Item_Thickness_UoM_ID = dataReader.GetString(28);
			}
			if (dataReader.IsDBNull(29) == false) {
				tbl_prodTxJobCard.Item_Weight = dataReader.GetDecimal(29);
			}
			if (dataReader.IsDBNull(30) == false) {
				tbl_prodTxJobCard.Item_Weight_UoM_ID = dataReader.GetString(30);
			}
			if (dataReader.IsDBNull(31) == false) {
				tbl_prodTxJobCard.OrderedQty = dataReader.GetDecimal(31);
			}
			if (dataReader.IsDBNull(32) == false) {
				tbl_prodTxJobCard.FGoodQty = dataReader.GetDecimal(32);
			}
			if (dataReader.IsDBNull(33) == false) {
				tbl_prodTxJobCard.WastePercent = dataReader.GetDecimal(33);
			}
			if (dataReader.IsDBNull(34) == false) {
				tbl_prodTxJobCard.WasteQty = dataReader.GetDecimal(34);
			}
			if (dataReader.IsDBNull(35) == false) {
				tbl_prodTxJobCard.ExfactoryDate = dataReader.GetDateTime(35);
			}
			if (dataReader.IsDBNull(36) == false) {
				tbl_prodTxJobCard.ProdStartDate = dataReader.GetDateTime(36);
			}
			if (dataReader.IsDBNull(37) == false) {
				tbl_prodTxJobCard.EstProdHrs = dataReader.GetDecimal(37);
			}
			if (dataReader.IsDBNull(38) == false) {
				tbl_prodTxJobCard.IsChecked1 = dataReader.GetBoolean(38);
			}
			if (dataReader.IsDBNull(39) == false) {
				tbl_prodTxJobCard.IsChecked2 = dataReader.GetBoolean(39);
			}
			if (dataReader.IsDBNull(40) == false) {
				tbl_prodTxJobCard.IsChecked3 = dataReader.GetBoolean(40);
			}
			if (dataReader.IsDBNull(41) == false) {
				tbl_prodTxJobCard.IsApproved1 = dataReader.GetBoolean(41);
			}
			if (dataReader.IsDBNull(42) == false) {
				tbl_prodTxJobCard.IsApproved2 = dataReader.GetBoolean(42);
			}
			if (dataReader.IsDBNull(43) == false) {
				tbl_prodTxJobCard.IsApproved3 = dataReader.GetBoolean(43);
			}
			if (dataReader.IsDBNull(44) == false) {
				tbl_prodTxJobCard.IsCanceled = dataReader.GetBoolean(44);
			}
			if (dataReader.IsDBNull(45) == false) {
				tbl_prodTxJobCard.IsLocked = dataReader.GetBoolean(45);
			}
			if (dataReader.IsDBNull(46) == false) {
				tbl_prodTxJobCard.CreateUser_ID = dataReader.GetString(46);
			}
			if (dataReader.IsDBNull(47) == false) {
				tbl_prodTxJobCard.ModifiedUser_ID = dataReader.GetString(47);
			}
			if (dataReader.IsDBNull(48) == false) {
				tbl_prodTxJobCard.Checked1User_ID = dataReader.GetString(48);
			}
			if (dataReader.IsDBNull(49) == false) {
				tbl_prodTxJobCard.Checked2User_ID = dataReader.GetString(49);
			}
			if (dataReader.IsDBNull(50) == false) {
				tbl_prodTxJobCard.Checked3User_ID = dataReader.GetString(50);
			}
			if (dataReader.IsDBNull(51) == false) {
				tbl_prodTxJobCard.Approved1User_ID = dataReader.GetString(51);
			}
			if (dataReader.IsDBNull(52) == false) {
				tbl_prodTxJobCard.Approved2User_ID = dataReader.GetString(52);
			}
			if (dataReader.IsDBNull(53) == false) {
				tbl_prodTxJobCard.Approved3User_ID = dataReader.GetString(53);
			}
			if (dataReader.IsDBNull(54) == false) {
				tbl_prodTxJobCard.CanceldUser_ID = dataReader.GetString(54);
			}
			if (dataReader.IsDBNull(55) == false) {
				tbl_prodTxJobCard.LockedUser_ID = dataReader.GetString(55);
			}
			if (dataReader.IsDBNull(56) == false) {
				tbl_prodTxJobCard.DateCreate = dataReader.GetDateTime(56);
			}
			if (dataReader.IsDBNull(57) == false) {
				tbl_prodTxJobCard.DateModified = dataReader.GetDateTime(57);
			}
			if (dataReader.IsDBNull(58) == false) {
				tbl_prodTxJobCard.DateChecked1 = dataReader.GetDateTime(58);
			}
			if (dataReader.IsDBNull(59) == false) {
				tbl_prodTxJobCard.DateChecked2 = dataReader.GetDateTime(59);
			}
			if (dataReader.IsDBNull(60) == false) {
				tbl_prodTxJobCard.DateChecked3 = dataReader.GetDateTime(60);
			}
			if (dataReader.IsDBNull(61) == false) {
				tbl_prodTxJobCard.DateApproved1 = dataReader.GetDateTime(61);
			}
			if (dataReader.IsDBNull(62) == false) {
				tbl_prodTxJobCard.DateApproved2 = dataReader.GetDateTime(62);
			}
			if (dataReader.IsDBNull(63) == false) {
				tbl_prodTxJobCard.DateApproved3 = dataReader.GetDateTime(63);
			}
			if (dataReader.IsDBNull(64) == false) {
				tbl_prodTxJobCard.DateCanceled = dataReader.GetDateTime(64);
			}
			if (dataReader.IsDBNull(65) == false) {
				tbl_prodTxJobCard.DateLocked = dataReader.GetDateTime(65);
			}
			if (dataReader.IsDBNull(66) == false) {
				tbl_prodTxJobCard.CreateUserTerminal_ID = dataReader.GetString(66);
			}
			if (dataReader.IsDBNull(67) == false) {
				tbl_prodTxJobCard.ModifiedUserTerminal_ID = dataReader.GetString(67);
			}
			if (dataReader.IsDBNull(68) == false) {
				tbl_prodTxJobCard.Checked1UserTerminal_ID = dataReader.GetString(68);
			}
			if (dataReader.IsDBNull(69) == false) {
				tbl_prodTxJobCard.Checked2UserTerminal_ID = dataReader.GetString(69);
			}
			if (dataReader.IsDBNull(70) == false) {
				tbl_prodTxJobCard.Checked3UserTerminal_ID = dataReader.GetString(70);
			}
			if (dataReader.IsDBNull(71) == false) {
				tbl_prodTxJobCard.Approved1UserTerminal_ID = dataReader.GetString(71);
			}
			if (dataReader.IsDBNull(72) == false) {
				tbl_prodTxJobCard.Approved2UserTerminal_ID = dataReader.GetString(72);
			}
			if (dataReader.IsDBNull(73) == false) {
				tbl_prodTxJobCard.Approved3UserTerminal_ID = dataReader.GetString(73);
			}
			if (dataReader.IsDBNull(74) == false) {
				tbl_prodTxJobCard.CanceledUserTerminal_ID = dataReader.GetString(74);
			}
			if (dataReader.IsDBNull(75) == false) {
				tbl_prodTxJobCard.LockedUserTerminal_ID = dataReader.GetString(75);
			}
			if (dataReader.IsDBNull(76) == false) {
				tbl_prodTxJobCard.CompanyID = dataReader.GetString(76);
			}
			if (dataReader.IsDBNull(77) == false) {
				tbl_prodTxJobCard.CompanyBranchID = dataReader.GetString(77);
			}
			if (dataReader.IsDBNull(78) == false) {
				tbl_prodTxJobCard.CustomerOrder_Qty = dataReader.GetDecimal(78);
			}

			return tbl_prodTxJobCard;
		}
		/// <summary>
		/// This makes tbl_prodTxJobCard datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_prodTxJobCard object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_prodTxJobCard  tbl_prodTxJobCard   )
		{
		...
		/// <summary>
		/// This fills tbl_prodTxJobCard datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_prodTxJobCard object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_prodTxJobCard user) {
