...
namespace DataTire {
	public sealed class tbl_prodTxMaterialRequision {
		#region Fields
		...
		#region Methods
		/// <summary>
		/// Saves a record to the tbl_prodTxMaterialRequision table.
		/// </summary>
		public void Insert() {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionInsert", scon);
		...
		/// <summary>
		/// Updates a record in the tbl_prodTxMaterialRequision table.
		/// </summary>
		public void Update() {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionUpdate", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Deletes a record from the tbl_prodTxMaterialRequision table by its primary key.
		/// </summary>
		public void Delete() {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionDelete", scon);
			scom.CommandType = CommandType.StoredProcedure;
		...
		/// <summary>
		/// Selects all records from the tbl_prodTxMaterialRequision table by a foreign key.
		/// </summary>
		public static void DeleteAllByCompanyID(string companyID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionDeleteAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCheckedUser_ID(string checkedUser_ID) {
			...
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionDeleteAllByCheckedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByApprovedUser_ID(string approvedUser_ID) {
			...
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionDeleteAllByApprovedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCompanyBranchID(string companyBranchID) {
			...
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionDeleteAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByModifiedUser_ID(string modifiedUser_ID) {
			...
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionDeleteAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCreateUser_ID(string createUser_ID) {
			...
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionDeleteAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllByCanceldUser_ID(string canceldUser_ID) {
			...
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionDeleteAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		public static void DeleteAllBySection_ID(string section_ID) {
			...
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionDeleteAllBySection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Selects a single record from the tbl_prodTxMaterialRequision table.
		/// </summary>
		public static tbl_prodTxMaterialRequision Select(string mr_No_Incoming){

			tbl_prodTxMaterialRequision tbl_prodTxMaterialRequisionins = new tbl_prodTxMaterialRequision();
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionSelect", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
			...
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				if (dataReader.Read()) {
					tbl_prodTxMaterialRequisionins = Maketbl_prodTxMaterialRequision(dataReader);
				} else {
					tbl_prodTxMaterialRequisionins = null;
				}
			}
			scon.Close();
			return tbl_prodTxMaterialRequisionins;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prodTxMaterialRequision table.
		/// </summary>
		public static List<tbl_prodTxMaterialRequision> SelectAll() {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionSelectAll", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
 
				List<tbl_prodTxMaterialRequision> tbl_prodTxMaterialRequisionList = new List<tbl_prodTxMaterialRequision>();
			using (SqlDataReader dataReader = scom.ExecuteReader()){
				while (dataReader.Read()) {
					tbl_prodTxMaterialRequision tbl_prodTxMaterialRequision = Maketbl_prodTxMaterialRequision(dataReader);
					tbl_prodTxMaterialRequisionList.Add(tbl_prodTxMaterialRequision);
				}
			}
			scon.Close();
			return tbl_prodTxMaterialRequisionList;
		}
		
		/// <summary>
		/// Selects all records from the tbl_prodTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxMaterialRequision> SelectAllByCompanyID(string companyID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionSelectAllByCompanyID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxMaterialRequision> SelectAllByCheckedUser_ID(string checkedUser_ID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionSelectAllByCheckedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxMaterialRequision> SelectAllByApprovedUser_ID(string approvedUser_ID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionSelectAllByApprovedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxMaterialRequision> SelectAllByCompanyBranchID(string companyBranchID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionSelectAllByCompanyBranchID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxMaterialRequision> SelectAllByModifiedUser_ID(string modifiedUser_ID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionSelectAllByModifiedUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxMaterialRequision> SelectAllByCreateUser_ID(string createUser_ID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionSelectAllByCreateUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxMaterialRequision> SelectAllByCanceldUser_ID(string canceldUser_ID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionSelectAllByCanceldUser_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// Selects all records from the tbl_prodTxMaterialRequision table by a foreign key.
		/// </summary>
		public static List<tbl_prodTxMaterialRequision> SelectAllBySection_ID(string section_ID) {
 
			SqlConnection scon =DBHandling.GetConnection();
			SqlCommand scom = new SqlCommand("tbl_prodTxMaterialRequisionSelectAllBySection_ID", scon);
			scom.CommandType = CommandType.StoredProcedure;
			scon.Open();
		...
		/// <summary>
		/// Creates a new instance of the tbl_prodTxMaterialRequision class and populates it with data from the specified SqlDataReader.
		/// </summary>
		private static tbl_prodTxMaterialRequision Maketbl_prodTxMaterialRequision(SqlDataReader dataReader) {
			tbl_prodTxMaterialRequision tbl_prodTxMaterialRequision = new tbl_prodTxMaterialRequision();
			
			if (dataReader.IsDBNull(0) == false) {
				tbl_prodTxMaterialRequision.Mr_No = dataReader.GetString(0);
			}
			if (dataReader.IsDBNull(1) == false) {
				tbl_prodTxMaterialRequision.Mr_Date = dataReader.GetDateTime(1);
			}
			if (dataReader.IsDBNull(2) == false) {
				tbl_prodTxMaterialRequision.Section_ID = dataReader.GetString(2);
			}
			if (dataReader.IsDBNull(3) == false) {
				tbl_prodTxMaterialRequision.PlanDate_from = dataReader.GetDateTime(3);
			}
			if (dataReader.IsDBNull(4) == false) {
				tbl_prodTxMaterialRequision.PlanDate_to = dataReader.GetDateTime(4);
			}
			if (dataReader.IsDBNull(5) == false) {
				tbl_prodTxMaterialRequision.IsChecked = dataReader.GetBoolean(5);
			}
			if (dataReader.IsDBNull(6) == false) {
				tbl_prodTxMaterialRequision.IsApproved = dataReader.GetBoolean(6);
			}
			if (dataReader.IsDBNull(7) == false) {
				tbl_prodTxMaterialRequision.IsCanceled = dataReader.GetBoolean(7);
			}
			if (dataReader.IsDBNull(8) == false) {
				tbl_prodTxMaterialRequision.CreateUser_ID = dataReader.GetString(8);
			}
			if (dataReader.IsDBNull(9) == false) {
				tbl_prodTxMaterialRequision.ModifiedUser_ID = dataReader.GetString(9);
			}
			if (dataReader.IsDBNull(10) == false) {
				tbl_prodTxMaterialRequision.CheckedUser_ID = dataReader.GetString(10);
			}
			if (dataReader.IsDBNull(11) == false) {
				tbl_prodTxMaterialRequision.ApprovedUser_ID = dataReader.GetString(11);
			}
			if (dataReader.IsDBNull(12) == false) {
				tbl_prodTxMaterialRequision.CanceldUser_ID = dataReader.GetString(12);
			}
			if (dataReader.IsDBNull(13) == false) {
				tbl_prodTxMaterialRequision.DateCreate = dataReader.GetDateTime(13);
			}
			if (dataReader.IsDBNull(14) == false) {
				tbl_prodTxMaterialRequision.DateModified = dataReader.GetDateTime(14);
			}
			if (dataReader.IsDBNull(15) == false) {
				tbl_prodTxMaterialRequision.DateChecked = dataReader.GetDateTime(15);
			}
			if (dataReader.IsDBNull(16) == false) {
				tbl_prodTxMaterialRequision.DateApproved = dataReader.GetDateTime(16);
			}
			if (dataReader.IsDBNull(17) == false) {
				tbl_prodTxMaterialRequision.DateCanceled = dataReader.GetDateTime(17);
			}
			if (dataReader.IsDBNull(18) == false) {
				tbl_prodTxMaterialRequision.CreateUserTerminal_ID = dataReader.GetString(18);
			}
			if (dataReader.IsDBNull(19) == false) {
				tbl_prodTxMaterialRequision.ModifiedUserTerminal_ID = dataReader.GetString(19);
			}
			if (dataReader.IsDBNull(20) == false) {
				tbl_prodTxMaterialRequision.CheckedUserTerminal_ID = dataReader.GetString(20);
			}
			if (dataReader.IsDBNull(21) == false) {
				tbl_prodTxMaterialRequision.ApprovedUserTerminal_ID = dataReader.GetString(21);
			}
			if (dataReader.IsDBNull(22) == false) {
				tbl_prodTxMaterialRequision.CanceledUserTerminal_ID = dataReader.GetString(22);
			}
			if (dataReader.IsDBNull(23) == false) {
				tbl_prodTxMaterialRequision.CompanyID = dataReader.GetString(23);
			}
			if (dataReader.IsDBNull(24) == false) {
				tbl_prodTxMaterialRequision.CompanyBranchID = dataReader.GetString(24);
			}

			return tbl_prodTxMaterialRequision;
		}
		/// <summary>
		/// This makes tbl_prodTxMaterialRequision datatable according to the datatable.
		/// IMPORTANT: you have to change the Column names according to your disire. becouse we cannot change it to your fit
		///            We are still humans
		/// </summary>
		/// <param name="user">new tbl_prodTxMaterialRequision object</param>
		/// <returns></returns>
		public static DataTable CreateDataTable( tbl_prodTxMaterialRequision  tbl_prodTxMaterialRequision   )
		{
		...
		/// <summary>
		/// This fills tbl_prodTxMaterialRequision datatable according to the Given user list.
		/// </summary>
		/// <param name="user">new tbl_prodTxMaterialRequision object</param>
		/// <returns></returns>
		public static void FillData(DataTable dt, tbl_prodTxMaterialRequision user) {
