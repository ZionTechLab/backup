...
namespace Digiteq_Logic
{
    public  class clsAlerts_Email
    {
        ...
        #region Invoice
        public  bool createEmail_Invoice(string sInvoiceID, enum_Alerts alertType)
        {
         ...
         SEACC.WinFormControls.Forms.SEACCException       .Show(ex);
            }

            return bEmailStatus;
        }

        public  bool createEmail_Warning_Alert_Exceeded_Credit_Days(string sInvoiceID, int iCreaditPeriod, enum_Alerts alertType)
        {
            bool bEmailStatus = false;
            try
            {
        ...
        public  void Email_DO(string sDoID, enum_Alerts alertType)
        {
            try
            {
            bool bEmailStatus = false;
            ...
            if (oAlert != null && oAlert.Alert_ID != "default" && oAlert.IsActive)
            {
                ...
                if (detail != null && detail.DeliveryOrder_ID != "default")
                {
                    ...
                    foreach (tbl_sasDeliveryOrder_Detail oItems in tbl_sasDeliveryOrder_Detail.SelectAllByDeliveryOrder_ID(detail.DeliveryOrder_ID))
                    {
                        ...
                        sLifoCost = clsFormatter.FormatDecimalPlaces_Price(clsProcessMethods.GetCostPrice_ByCostType(oItems.Item_ID, enum_CostPriceType.LIFO)).ToString();
                        sWAVG = clsFormatter.FormatDecimalPlaces_Price(clsProcessMethods.GetCostPrice_ByCostType(oItems.Item_ID,  enum_CostPriceType.WeightedAverage)).ToString();
                        sHPP = clsFormatter.FormatDecimalPlaces_Price(clsProcessMethods.GetCostPrice_ByCostType(oItems.Item_ID,  enum_CostPriceType.HighestPurchaseCost)).ToString();
        ...
        public  void Email_CO(string sCoID, enum_Alerts alertType)
        {
            try
            {
            bool bEmailStatus = false;
        ...
        public  void Email_CO_DiscountedItem(string sCoID, enum_Alerts alertType)
        {
            try
            {
            bool bEmailStatus = false;
        ...
        #region Credit Note
        public  bool createEmail_CreditNote(string sCRNID, enum_Alerts alertType)
        {
            bool bEmailStatus = false;
            try
            {
        ...
        #region Debit Note
        public  bool createEmail_DebitNote(string sDBNID, enum_Alerts alertType)
        {
            bool bEmailStatus = false;
            try
            {
        ...
        #region Sales Return
        public  bool createEmail_SalesReturn(string sSRNID, enum_Alerts alertType)
        {
            bool bEmailStatus = false;
            try
            {
        ...
        #region Receipt
        public  bool createEmail_Receipt(string sReceiptID, enum_Alerts alertType)
        {
            bool bEmailStatus = false;
        ...
        public  bool createEmail_SAN(string sSANID, enum_Alerts alertType)
        {
            bool bEmailStatus = false;
            try
            {
        ...
        #region Item Spred
        public  bool createEmail_IS(string sISID, enum_Alerts alertType)
        {
            bool bEmailStatus = false;
            try
            {
        ...
        #region  GRN Aleart 
        public  bool createEmail_GRN(string GrnID, enum_Alerts alertType)
        {
            bool bEmailStatus = false;
            try
            {
        ...
        #region APN Aleart
        public  bool createEmail_APN(string apnID, enum_Alerts alertType)
        {
            bool bEmailStatus = false;
            try
            {
        ...
        #region PV Alert
        public  bool createEmail_PV(string pvID, enum_Alerts alertType)
        {
            bool bEmailStatus = false;
            try
            {
        ...
        //public  bool createEmail_ProductionJobConfirmed(String sProductionJobID)
        //{
        //    bool bEmailStatus = false;
        ...
        public  bool createEmail_ChequePendingBankDeposit(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_ChequePendingBankDeposit1(enum_Alerts alertType)
        {
            string sAlertID = "";
            bool bEmailStatus = false;
            try
        ...
        public  bool createEmail_CashSalesNotDeposited(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_CashSalesNotDeposited1(enum_Alerts alertType)
        {
        ...
        public  bool createEmail_DONotInvoiced(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_CustomerExceededCredit(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
            {
                ...
                if (oAlert != null && oAlert.Alert_ID != "default" && oAlert.IsActive)
                {
                    ...
                    foreach (tbl_genCustomerMaster oCustomer in tbl_genCustomerMaster.SelectAll().Where(p => !p.IsDeleted && p.Customer_ID != "default"))
                    {
                        ...
                        if (oFin != null)
                        {
                            decimal dOutstandingAmount = GetCustomerTotalDues_All(oCustomer.Customer_ID);
                            decimal dChequeInHandAmu = GetCustomerChequesInHand(oCustomer.Customer_ID);
        ...
        public  decimal GetCustomerTotal_UnsettledPayements(string sCustomerID)
        {
        ...
        public  decimal GetCustomerTotalDues_All(string sCustomerID)
        {
        ...
        public  decimal GetCustomerChequesInHand(string sCustomerID)
        {
            decimal dAmount = 0;
        ...
        public  bool createEmail_DepositedChequesNotRealized(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_UnsettleReturnedCheques(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_InvoicesExceededCreditPeriod(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_DailyStatusAlert_Genaral(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
            {
                ...
                if (oAlert != null && oAlert.Alert_ID != "default" && oAlert.IsActive)
                {
                    ...
                    assingValues_NetSalesAndDebitValue(ref dNetSales_ForTheDay, ref dNetSales_ForTheMonth, ref dDebitValue_ForTheDay, ref dDebitValue_ForTheMonth, dtNow, "default");
                    assingValues_CreditNote_WithoutTaxes(ref dCreditNote_Value_ForTheMonth, ref dCreditNote_Value_ForTheDay, dtNow, "default");
                    ...
                    assingValues_Collection(ref dReceipt_Cash_ForTheDay, ref dReceipt_Cash_ForTheMonth, ref dReceipt_Cheque_ForTheDay, ref dReceipt_Cheque_ForTheMonth, dtNow, "default");
                    ...
                    assingValues_ChequeReconcile(ref dReturned_Cheque_ForTheDay, ref dReturned_Cheque_ForTheMonth, ref dRealized_Cheque_ForTheDay, ref dRealized_Cheque_ForTheMonth, dtNow, "default");
                    assingValues_ChequeDeposit(ref dDeposit_Cheque_ForTheDay, ref dDeposit_Cheque_ForTheMonth, dtNow, "default");
                    assingValues_CashDeposit(ref dDeposit_Cash_ForTheDay, ref dDeposit_Cash_ForTheMonth, dtNow);
                    ...
                    assingValues_Outstanding(ref dChequeInHand, ref dTotalOutstanding, ref dTotalOutstandingOver90, ref dDepositedButUnrealized, ref dHoldingCheques, "default");
        ...
        public  bool createEmail_DailyStatusAlert_BranchWise(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            ...
            try
            {
                ...
                if (oAlert != null && oAlert.Alert_ID != "default" && oAlert.IsActive)
                {
                    ...
                    assingValues_NetSalesAndDebitValue(ref dNetSales_ForTheDay, ref dNetSales_ForTheMonth, ref dDebitValue_ForTheDay, ref dDebitValue_ForTheMonth, dtNow, sBranch_ID);
                    assingValues_CreditNote_WithoutTaxes(ref dCreditNote_Value_ForTheMonth, ref dCreditNote_Value_ForTheDay, dtNow, sBranch_ID);
                    tblEmailDetail1.Rows.Add("Net Sales Value (Without Taxes)", clsFormatter.FormatDecimalPlaces_Price(dNetSales_ForTheDay), clsFormatter.FormatDecimalPlaces_Price(dNetSales_ForTheMonth));
                    tblEmailDetail1.Rows.Add("Debit Note Value (Without Taxes)", clsFormatter.FormatDecimalPlaces_Price(dDebitValue_ForTheDay), clsFormatter.FormatDecimalPlaces_Price(dDebitValue_ForTheMonth));
                    tblEmailDetail1.Rows.Add("Credit Note Value (Without Taxes)", clsFormatter.FormatDecimalPlaces_Price(dCreditNote_Value_ForTheDay), clsFormatter.FormatDecimalPlaces_Price(dCreditNote_Value_ForTheMonth));
                    decimal dSales_ForTheDay = (dNetSales_ForTheDay + dDebitValue_ForTheDay) - dCreditNote_Value_ForTheDay;
                    ...
                    assingValues_Collection(ref dReceipt_Cash_ForTheDay, ref dReceipt_Cash_ForTheMonth, ref dReceipt_Cheque_ForTheDay, ref dReceipt_Cheque_ForTheMonth, dtNow, sBranch_ID);
                    tblEmailDetail2.Rows.Add("Cash Collection", clsFormatter.FormatDecimalPlaces_Price(dReceipt_Cash_ForTheDay), clsFormatter.FormatDecimalPlaces_Price(dReceipt_Cash_ForTheMonth));
                    tblEmailDetail2.Rows.Add("Cheque Collection", clsFormatter.FormatDecimalPlaces_Price(dReceipt_Cheque_ForTheDay), clsFormatter.FormatDecimalPlaces_Price(dReceipt_Cheque_ForTheMonth));
                    decimal dCollection_ForTheDay = dReceipt_Cash_ForTheDay + dReceipt_Cheque_ForTheDay;
                    decimal dCollection_ForTheMonth = dReceipt_Cash_ForTheMonth + dReceipt_Cheque_ForTheMonth;
                    ...
                    assingValues_ChequeReconcile(ref dReturned_Cheque_ForTheDay, ref dReturned_Cheque_ForTheMonth, ref dRealized_Cheque_ForTheDay, ref dRealized_Cheque_ForTheMonth, dtNow, sBranch_ID);
                    assingValues_ChequeDeposit(ref dDeposit_Cheque_ForTheDay, ref dDeposit_Cheque_ForTheMonth, dtNow, sBranch_ID);
                    assingValues_CashDeposit(ref dDeposit_Cash_ForTheDay, ref dDeposit_Cash_ForTheMonth, dtNow, sBranch_ID);
                    tblEmailDetail3.Rows.Add("Cheque(s) Deposited in Bank(s)", clsFormatter.FormatDecimalPlaces_Price(dDeposit_Cheque_ForTheDay), clsFormatter.FormatDecimalPlaces_Price(dDeposit_Cheque_ForTheMonth));
                    tblEmailDetail3.Rows.Add("Cheque(s) Returns", clsFormatter.FormatDecimalPlaces_Price(dReturned_Cheque_ForTheDay), clsFormatter.FormatDecimalPlaces_Price(dReturned_Cheque_ForTheMonth));
                    tblEmailDetail3.Rows.Add("Cash Deposited in Bank(s)", clsFormatter.FormatDecimalPlaces_Price(dDeposit_Cash_ForTheDay), clsFormatter.FormatDecimalPlaces_Price(dDeposit_Cash_ForTheMonth));
                    tblEmailDetail3.Rows.Add("Cheque Realized in Bank(s)", clsFormatter.FormatDecimalPlaces_Price(dRealized_Cheque_ForTheDay), clsFormatter.FormatDecimalPlaces_Price(dRealized_Cheque_ForTheMonth));
                    ...
                    assingValues_Outstanding(ref dChequeInHand, ref dTotalOutstanding, ref dTotalOutstandingOver90, ref dDepositedButUnrealized, ref dHoldingCheques, sBranch_ID);
                    tblEmailDetail4.Rows.Add("Notes Receivables (Invoice + DebitNote)", clsFormatter.FormatDecimalPlaces_Price(dTotalOutstanding));
                    tblEmailDetail4.Rows.Add("Cheque In Hand (PD Cheques)", clsFormatter.FormatDecimalPlaces_Price(dChequeInHand));
                    tblEmailDetail4.Rows.Add("", clsFormatter.FormatDecimalPlaces_Price(dChequeInHand + dTotalOutstanding));
        ...
        public  bool createEmail_InvoiceSummary(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_InvoiceSummary1(enum_Alerts alertType)
        {
        ...
        public  bool createEmail_ReceiptSummary(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_TurnOverDetails_SalesmanWise(enum_Alerts alertType, string sSalesmanID, string sEmailAddress, DateTime dtmToday, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_TurnOverDetails_SalesmanWiseSummary(enum_Alerts alertType, DateTime dtmToday, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_UnAllocatedReceipt(enum_Alerts alertType, DateTime dtmToday, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_OutstandingJobsAlert_SalesmanWise(enum_Alerts alertType, string sSalesmanID, string sEmailAddress, DateTime dtmToday, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_JobCloseSummary(enum_Alerts alertType, DateTime dtmToday, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_SalesReturnSummary(enum_Alerts alertType, DateTime dtmToday, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_SalesReturn_SalesmanWise(enum_Alerts alertType, string sSalesmanID, string sEmailAddress, DateTime dtmToday, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_DailySectionPlan(enum_Alerts alertType, DateTime dtmToday, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  void assingValues_NetSalesAndDebitValue(ref decimal dNetSales_ForTheDay, ref decimal dNetSales_ForTheMonth, ref decimal dDebitValue_ForTheDay, ref decimal dDebitValue_ForTheMonth, DateTime dtNow, string sCompanyBranchID)
        {
        ...
        public  void assingValues_NetSalesAndDebitValue_UptoDate(ref decimal dNetSales_ForTheDay, ref decimal dNetSales_ForTheMonth, ref decimal dDebitValue_ForTheDay, ref decimal dDebitValue_ForTheMonth, DateTime dtFromDate, DateTime dtToDate, string sCompanyBranchID)
        {
        ...
        #region Credit Note
        public  void assingValues_CreditNote_WithoutTaxes(ref decimal dCreditNote_Value_ForTheMonth, ref decimal dCreditNote_Value_ForTheDay, DateTime dtNow, string sBranchID)
        {
            DateTime dtFirstDayOfThisMonth = new DateTime(dtNow.Year, dtNow.Month, 1);
        ...
        #region Collection
        public  void assingValues_Collection(ref decimal dReceipt_Cash_ForTheDay, ref decimal dReceipt_Cash_ForTheMonth, ref decimal dReceipt_Cheque_ForTheDay, ref decimal dReceipt_Cheque_ForTheMonth, DateTime dtNow, string sBranchID)
        {
            DateTime dtFirstDayOfThisMonth = new DateTime(dtNow.Year, dtNow.Month, 1);
        ...
        public  void assingValues_Collection_ForDateRange(ref decimal dReceipt_Cash_ForTheDay, ref decimal dReceipt_Cash_ForTheMonth, ref decimal dReceipt_Cheque_ForTheDay, ref decimal dReceipt_Cheque_ForTheMonth, DateTime dtFromDate, DateTime dtToDate, string sBranchID)
        {
        ...
        #region Cash Deposit
        public  void assingValues_CashDeposit(ref decimal dDeposit_Cash_ForTheDay, ref decimal dDeposit_Cash_ForTheMonth, DateTime dtNow)
        {
            DateTime dtFirstDayOfThisMonth = new DateTime(dtNow.Year, dtNow.Month, 1);
        ...
        public  void assingValues_CashDeposit(ref decimal dDeposit_Cash_ForTheDay, ref decimal dDeposit_Cash_ForTheMonth, DateTime dtNow, string sBranchID)
        {
            DateTime dtFirstDayOfThisMonth = new DateTime(dtNow.Year, dtNow.Month, 1);
            foreach (tbl_bpsCashDeposit oDeposit in tbl_bpsCashDeposit.SelectAll().Where(p => p.CashDeposit_ID != "default" && p.DateDeposit >= dtFirstDayOfThisMonth))
            {
        ...
        public  void assingValues_ChequeDeposit(ref decimal dDeposit_Cheque_ForTheDay, ref decimal dDeposit_Cheque_ForTheMonth, DateTime dtNow, string sBranchID)
        {
            DateTime dtFirstDayOfThisMonth = new DateTime(dtNow.Year, dtNow.Month, 1);
        ...
        public  void assingValues_ChequeReconcile(ref decimal dReturned_Cheque_ForTheDay, ref decimal dReturned_Cheque_ForTheMonth, ref decimal dRealized_Cheque_ForTheDay, ref decimal dRealized_Cheque_ForTheMonth, DateTime dtNow, string sBranchID)
        {
            DateTime dtFirstDayOfThisMonth = new DateTime(dtNow.Year, dtNow.Month, 1);
        ...
        #region Outstanding
        public  void assingValues_Outstanding(ref decimal dChequeInHand, ref decimal dTotalOutstanding, ref decimal dTotalOutstandingOver90, ref decimal dDepositedButUnrealized, ref decimal dHoldingCheques, string sBranchID)
        {
        ...
        public  void assingValues_Outstanding_ForDateRange(ref decimal dChequeInHand, ref decimal dTotalOutstanding, ref decimal dTotalOutstandingOver90, ref decimal dDepositedButUnrealized, ref decimal dHoldingCheques, DateTime dtFromDate, DateTime dtToDate, string sBranchID)
        {
        ...
        public  bool createEmail_ChequeInHand(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
                ...
                if (oAlert != null && oAlert.Alert_ID != "default" && oAlert.IsActive)
                {
                    ...
                    foreach (tbl_bpsChequeRegister oCheque in tbl_bpsChequeRegister.SelectAll().Where(p => !p.IsDeleted && p.ChequeRegister_ID != "default" && !p.IsDepositted && !p.IsReturned).OrderBy(p => p.DateCheque))
                    {
                        if (oCheque.PaymentMethod_ID == (int)PaymentMethod.Cheque)
                        {
                            ...
                            tbl_genCustomerFinance finance = tbl_genCustomerFinance.Select(oCheque.Customer_ID);
                            if (finance != null && finance.Customer_ID != "default")
                                dCreditPeriod = finance.CreditPeriod;

                            string CreditPeriod = clsFormatter.FormatToNumberNoDecimal(dCreditPeriod);
        ...
        public  bool createEmail_CustomerOutstandingStatement(enum_Alerts alertType, string sCustomerID, string sEmailAddress, DateTime dtmToday, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_CustomerOutstandingStatement_ToCustomer(enum_Alerts alertType, string sCustomerID, string sEmailAddress, DateTime dtmToday, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  bool createEmail_POSDetail(int iSchedule_ID, enum_Alerts alertType, string sCompanyBranchID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
        ...
        public  bool createEmail_FlowStock(int iSchedule_ID, enum_Alerts alertType, string sCompanyBranchID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            ...
            try
            {
                ...
                if (oAlert != null && oAlert.Alert_ID != "default" && oAlert.IsActive)
                {
                    ...
                    //    #region Attachment Generate
                        ...
                        string sQuary = "exec [dbo].[sp_GetRpt_FloreStock]";

                        var tbl = DBHandling.ExecQuery(sQuary).Tables[0];

                        PdfExport pdf = new PdfExport();
                        string sReportGenerationPath = pdf.PDF_Export(@"Report\RPT_floreStock.rpt", tbl, clsSecurity.getServerDateTime(), clsConfig.sPOSAttachmentPath_Server);
                        clsValidate.WriteErrorLog(sAlertID + " - " + alertType.ToString() + " - Report Export Successfully -" + clsSecurity.getServerDateTime(), -1, null);
                        #endregion
                        ...
                        string sBodyHTML = "";
                        string sSubject = "Floor Stock Balance -  " + clsSecurity.getServerDateTime().Date.ToString("yyyy-MMM-dd");
                        string sEmail_ID = clsFormatter.FormatDate_FullString(clsSecurity.getServerDateTime());
                        sBodyHTML = clsEmailConfig.CreateEmailBody(lstEData);
        ...
        private  string PDF_Export(string sRptFilePath, DataSet ReportDataSet)
        {
            string returnPath = "";
        ...
        public  byte[] getCompanyImage(string sCopmayID)
        {
        ...
        public  string CreateEmailBody(string EmailId, string Title, string sHeading, DataTable tHeader, DataTable tDetail, DataTable tFooter)
        {
        ...
        public  string CreateEmailBody_GenearlStatus(string EmailId, string Title, string sHeading, DataTable tHeader, DataTable tDetail1, DataTable tDetail2, DataTable tDetail3, DataTable tDetail4, DataTable tDetail5, DataTable tFooter)
        {
        ...
        public  string CreateDailyStatusEmailBody(string EmailId, string Title, string sHeading, DataTable tTitle, DataTable tDetail1, DataTable tDetail2, DataTable tDetail3, DataTable tDetail4, DataTable tDetail5, DataTable tDetail6, DataTable tDetail7, DataTable tHeader, DataTable tDetail, DataTable tFooter)
        {
            // string sBodyHTML;
            StringBuilder sb = new StringBuilder();
        ...
        public  bool createEmail_EventLog(enum_Alerts alertType, string sBranch_ID)
        {
            bool bEmailStatus = false;
            string sAlertID = "";
            try
        ...
        public  void Checking_SheduledAlerts()
        {
            foreach (tbl_utlAlert_Shedule oShedule in tbl_utlAlert_Shedule.SelectAll().Where(p => p.IsActive))
            {
                ...
                if (value)
                {
                    if (enAlert == enum_Alerts.SheduleAlert_ChequePendingDeposit)
                        ...
                        createEmail_UnsettleReturnedCheques(enum_Alerts.SheduleAlert_UnsettleReturnedCheques, oShedule.CompanyBranch_ID);
                    ...
                    else if (enAlert == enum_Alerts.FloorStock)
                    {
                        createEmail_FlowStock(oShedule.Schedule_ID, enAlert, oShedule.CompanyBranch_ID);
                    }
                }
            }
        ...
        public  bool SaveMailHTML(string sAlertID, string sSubject, string sBodyHTML)
        {
            bool status = false;
            try
            {
        ...
        public  bool SaveMailHTML_Attachment(string sAlertID, string sSubject, string sBodyHTML, string sPath)
        {
            bool status = false;
            try
            {
        ...
        public  bool SaveMailHTML_ToCustomer(string sAlertID, string sSubject, string sBodyHTML, string sEmailAddress, string sReceiverName)
        {
            bool status = false;
            try
            {
