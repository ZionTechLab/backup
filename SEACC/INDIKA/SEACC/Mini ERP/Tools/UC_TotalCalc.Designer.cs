namespace Digiteq
{
    partial class UC_TotalCalc
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtPercentageNBT.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtPercentageNBT_KeyDown);
            ...
            this.txtPercentageVat.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtPercentageVat_KeyDown);
            ...
            this.txtSubTotal.TextboxValuechanged += new Digiteq.UC_FinanceTextBox.ValueChange(this.txtSubTotal_TextboxValuechanged);
            this.txtSubTotal.LedgerUpdated += new Digiteq.UC_FinanceTextBox.ValueChange(this.txt_LedgerUpdated);
            // 
            // panel2
            // 
            ...
            this.txtGrandTotal.TextboxValuechanged += new Digiteq.UC_FinanceTextBox.ValueChange(this.txtGrandTotal_TextboxValuechanged);
            this.txtGrandTotal.LedgerUpdated += new Digiteq.UC_FinanceTextBox.ValueChange(this.txt_LedgerUpdated);
            // 
            // txtNBT
            // 
            ...
            this.txtNBT.TextboxValuechanged += new Digiteq.UC_FinanceTextBox.ValueChange(this.txtNBT_TextboxValuechanged);
            this.txtNBT.LedgerUpdated += new Digiteq.UC_FinanceTextBox.ValueChange(this.txt_LedgerUpdated);
            // 
            // txtVat
            // 
            ...
            this.txtVat.TextboxValuechanged += new Digiteq.UC_FinanceTextBox.ValueChange(this.txtVat_TextboxValuechanged);
            this.txtVat.LedgerUpdated += new Digiteq.UC_FinanceTextBox.ValueChange(this.txt_LedgerUpdated);
            // 
            // txtOtherTax
            // 
            ...
            this.txtOtherTax.TextboxValuechanged += new Digiteq.UC_FinanceTextBox.ValueChange(this.txtOtherTax_TextboxValuechanged);
            this.txtOtherTax.LedgerUpdated += new Digiteq.UC_FinanceTextBox.ValueChange(this.txt_LedgerUpdated);
            // 
            // flowLayoutPanel1
            // 
            ...
            this.txtDesc.TextboxValuechanged += new Digiteq.UC_FinanceTextBox.ValueChange(this.txtDesc_TextboxValuechanged);
            this.txtDesc.LedgerUpdated += new Digiteq.UC_FinanceTextBox.ValueChange(this.txt_LedgerUpdated);
            // 
            // UC_TotalCalc
            // 
