            ...
            try
            {
                if (txtJournalID.Text.Trim().Length > 0 && txtJournalID.Text.Trim() != "<Auto Generate>")
                {
                    ...
                    if (JV != null)
                    {
                        ...
                        string sGetRptPath = clsHelpMethods_Local.GetReportPath(clsAutocode.getReportID(enum_ReportName.NP_JournalVoucher));
                        ...
                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CreateUserName", clsGenaralName.getName_User(JV.CreateUser_ID), true);
                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("CheckUserName", clsGenaralName.getName_User(JV.CheckedUser_ID), true);
                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("ApproveUserName", clsGenaralName.getName_User(JV.ApprovedUser_ID), true);


                        #region Report Feald Names Gen
                        // if (JournalEntryType.StandardJournalEntry == glb_JournalEntryType)
                        {
                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("NoColoumn", "Txn ID", true);
                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("DateColoumn", "Txn Date", true);
                        }
                        //else if (JournalEntryType.BankAdjustmentEntry == glb_JournalEntryType)
                        //{
                        //    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("NoColoumn", "BE No", true);
                        //    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("DateColoumn", "BE Date", true);
                        //}
                        //else
                        //{
                        //    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("NoColoumn", "JV No", true);
                        //    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("DateColoumn", "JV Date", true);

                        //}
                        #endregion

                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("DuplicateCopy", sDuplicateCopy, true);
                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("isDel", sCancel, true);
                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("Cancel", JV.IsDeleted ? "CANCELLED" : "", true);
