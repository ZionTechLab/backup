...
namespace Digiteq
{
    public partial class frm_AccPostingConfigaration : MettroForm
    {
        ...
        private void frm_AccPostingConfigaration_Load(object sender, EventArgs e)
        {
            ...
            Ex_Inventry_Refresh_Click(null, null);
        ...
        private void Ex_Invoice_Update_Click(object sender, EventArgs e)
        {
            if (clsSecurity.PermissionToSave(clsSecurity.UserIDLoged, iFormID, IsUpdate))
            {
                try
                {
                    ...
                    {
                        if (txtCostOfSales.Tag == null)
                        {
                            MessageBox.Show("Please select the Cost Of Sales Account Code..", clsFormatter.GetMessageCaption(), System.Windows.Forms.MessageBoxButtons.OK);
                            bIsUpdateValidationOk = false;
                        }
                    }
                    ...
                    if (bIsUpdateValidationOk)
                    {
                        ...
                        clsSecurity.SetCofigValue(242, txtCostOfSales.Tag.ToString());
                        clsConfig.sAccountCode_CostOfSales = txtCostOfSales.Tag.ToString();
        ...
        {
            //if (clsConfig.sAccountCode_Inventry == "default")
            //{
            //    txtRMInventry.Tag = "default";
            //    txtRMInventry.Text = "<<All Account>>";
            //}
            //else
            //{
            //    txtRMInventry.Tag = clsConfig.sAccountCode_Inventry;
            //    txtRMInventry.Text = clsGenaralName.getName_AccountName(clsConfig.sAccountCode_Inventry);
            //}
        ...
        private void Ex_Inventry_Update_Click(object sender, EventArgs e)
        {
            if (clsSecurity.PermissionToSave(clsSecurity.UserIDLoged, iFormID, IsUpdate))
            {
                try
                {
                    bool bIsUpdateValidationOk = true;

                    if (txtRMInventry.Tag == null)
                    {
                        MessageBox.Show("Please select the Inventry Account Code..", clsFormatter.GetMessageCaption(), System.Windows.Forms.MessageBoxButtons.OK);
                        bIsUpdateValidationOk = false;
                    }
                    ...
                    if (bIsUpdateValidationOk)
                    {
                        ...
                        clsSecurity.SetCofigValue(243, txtRMInventry.Tag.ToString());
                       // clsConfig.sAccountCode_Inventry = txtRMInventry.Tag.ToString();
        ...
        private void Ex_Invoice_Refresh_Click(object sender, EventArgs e)
        {
            ...
            if (clsConfig.sAccountCode_CostOfSales == "default")
            {
                txtCostOfSales.Tag = "default";
                txtCostOfSales.Text = "<<All Account>>";
            }
            else
            {
                txtCostOfSales.Tag = clsConfig.sAccountCode_CostOfSales;
                txtCostOfSales.Text = clsGenaralName.getName_AccountName(clsConfig.sAccountCode_CostOfSales);
            }
        }
        ...
        private void txtCostOfSales_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                List<string> lstParameeters = new List<string>();
        ...
        private void txtInventry_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                List<string> lstParameeters = new List<string>();
