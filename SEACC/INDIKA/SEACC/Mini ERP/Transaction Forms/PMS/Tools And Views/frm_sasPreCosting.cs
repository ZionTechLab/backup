...
namespace Digiteq
{
    public partial class frm_sasPreCosting : Form
    {
        ...
        private void CalculateMaterialWeight(decimal dGauge, decimal dQuantity, string sUomID)
        {
            ...
            txtmatCalculatedWeight.Text = clsFormatter.FormatToNumberWithFourDecimalPlaces(clsHelpMethods_Local.GetWeight(dWidth, dLength, dGauge, dGussest, dQuantity, sUomID));
