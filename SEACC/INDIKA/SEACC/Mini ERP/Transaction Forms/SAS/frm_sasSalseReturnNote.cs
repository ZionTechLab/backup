...
namespace Digiteq
{
    public partial class frm_sasSalseReturnNote : SEACC_Form
    {
                                            ...
                                            if (msgResult == DialogResult.Yes)
                                            {
                                                ...
                                                foreach (tbl_sasSalesReturnedNote_Detail SRNdetail in tbl_sasSalesReturnedNote_Detail.SelectAllBySalesReturnedNote_ID(txtSRNID.Text.Trim()))
                                                {
                                                    if (SRNdetail.Item_ID != null)
                                                    {
                                                        ...
                                                        //clsHelpMethods_Local.UpdateStoreStock(iFormID, SRNdetail.SalesReturnedNote_ID, detail.SalesReturnedNoteDate, SRNdetail.Item_ID, "0", txtStoreID.Tag.ToString(), SRNdetail.Qty, SRNdetail.Weight, SRNdetail.TatalAmount, true, true, false, ref dWeightedAverageCostPrice);
                                                ...
                                                {
                                                    clsHelpMethods_Local.RemoveSattlementsFrom_CreditNoteID(oldCNote.CreditNote_ID);
                                                ...
                                                var responce = oData.Delete_InventoryTxn(iFormID, txtSRNID.Text.Trim());
                                                if (!responce.IsSuccess)
                                                {
                                                    clsValidate.WriteErrorLog(txtSRNID.Text.Trim() + " - " + responce.OutMsg, iFormID, null);
                                                }
                                       
                                                email.createEmail_SalesReturn(txtSRNID.Text.Trim(), enum_Alerts.SalesReternCancel);
                    ...
                    if (IsUpdate)
                    {
                        ...
                        if (oldRecord != null && CheckPrintingValidity(oldRecord.PrintCount))
                        {
                            if (ValidateForDependancies(oldRecord.SalesReturnedNote_ID))
                            {
                                ...
                                {
                                    if (!oldRecord.IsChecked || (oldRecord.IsChecked &&
                                         clsSecurity.PermissionToApproved(clsSecurity.UserIDLoged, iFormID)))
                                    {
                                        if (clsValidate.CheckValidity_TransactionCodeLength(txtSRNID.Text))
                                        {
                                            ...
                                            foreach (tbl_sasSalesReturnedNote_Detail oUpdatedRecord in tbl_sasSalesReturnedNote_Detail.SelectAllBySalesReturnedNote_ID(
                                                    txtSRNID.Text.Trim()))
                                            {
                                                decimal dWeightedAverageCostPrice = 0;
                                                //clsHelpMethods_Local.UpdateStoreStock(iFormID, oUpdatedRecord.SalesReturnedNote_ID,
                                                //    oldRecord.SalesReturnedNoteDate, oUpdatedRecord.Item_ID, "0", txtStoreID.Tag.ToString(), oUpdatedRecord.Qty,
                                                //    oUpdatedRecord.Weight, oUpdatedRecord.TatalAmount, true, true, false, ref dWeightedAverageCostPrice);
                                            ...
                                            List<tbl_sasSalesReturnedNote_Detail> oldSRNDetails = tbl_sasSalesReturnedNote_Detail.SelectAllBySalesReturnedNote_ID(
                                                    txtSRNID.Text.Trim());
                                                    ...
                                                    if (oDO != null && oDO.DeliveryOrder_ID != "default")
                                                    {
                                                        ...
                                                        if (DoItem != null)
                                                        {
                                                            ...
                                                            if (CoItem != null && rdoReturnable.Checked)
                                                            {
                                                                ...
                                                                CoItem.WeightSettle_DeliveryOrder = CoItem.WeightSettle_DeliveryOrder +
                                                                    oldSRNDetail.Weight;
                                                                CoItem.Update();
                                            ...
                                            foreach (DataGridViewRow row in dgvDetail.Rows)
                                            {
                                                try
                                                {
                                                    ...
                                                    string sItemCode = "", sUom = "default", sDeliveryOrderCode = "", sInvoiceCode = "",
                                                        sJobCode = "", sRemarks = "", sItemSubCategoryID = "", sItemSubCategoryID2 = "",
                                                        sItemSerialNo = "", sItemSerialNo2 = "", sLineNo = "", Store_ID = "";
                                                    decimal dWeightPrice = 0, dUnitPrice = 0, dQuantity = 0, dWeight = 0,
                                                        dAmount = 0, dunitCost = 0, dTatalCost_FIFO = 0, dDiscountPresentage = 0,
                                                        dDiscountValue = 0;
                                                    ...
                                                    bIsFreeIssue = clsValidate.ValidateGridValue(dgvDetail, "Free", row.Index, "") == "True" ? true
                                                            : false;
                                                    ...
                                                    Store_ID = clsValidate.ValidateGridTag(dgvDetail, "store_ID", row.Index, "");
                                                    #endregion
                                                    ...
                                                    if (sItemCode.Length > 0)
                                                    {
                                                        ...
                                                        tbl_sasSalesReturnedNote_Detail items =
                                                            new tbl_sasSalesReturnedNote_Detail(int.Parse(sLineNo),
                                                                ...
                                                                dTatalCost_FIFO, sRemarks, clsProcessMethods.GetItemWeightedAvarageCostPrice(sItemCode), Store_ID);
                                                        items.Insert();
                                                        ...
                                                        if (bDeliveryOrderOK)
                                                        {
                                                            ...
                                                            if (oDO != null && oDO.DeliveryOrder_ID != "default")
                                                            {
                                                                tbl_sasDeliveryOrder_Detail DoItem = tbl_sasDeliveryOrder_Detail.Select(
                                                                        int.Parse(sLineNo), sDeliveryOrderCode, sItemCode, sItemSubCategoryID,
                                                                        sItemSubCategoryID2, sItemSerialNo, sItemSerialNo2);
                                            ...
                                            var responce = oData.Update_InventoryTxn(iFormID, txtSRNID.Text.Trim(), IsUpdate);
                                            if (!responce.IsSuccess)
                                            {
                                                clsValidate.WriteErrorLog(txtSRNID.Text.Trim() + " - " + responce.OutMsg, iFormID, null);
                                            }
                    ...
                    else
                    {
                        ...
                        if (clsValidate.CheckValidity_TransactionCodeLength(txtSRNID.Text)) //if (txtSRNID.TextLength > 0)
                        {
                            ...
                            tbl_sasSalesReturnedNote detail = new tbl_sasSalesReturnedNote(txtSRNID.Text.Trim(), dtpSRNDate.Value, txtRemark.Text.Trim(),
                                ...
                                "default", clsAutocode.getGLPostingStatusID(GLPostingStatus.NewTransaction), clsSecurity.FinancialYearID, txtCurrencyID.Tag.ToString(), 
                                txtSalesNoteType.Tag.ToString(), decimal.Parse(txtCurrencyRate.Text.Trim()), 0, decimal.Parse(txtPercentageDiscount.Text.Trim()), 
                                decimal.Parse(txtPercentageNBT.Text.Trim()),decimal.Parse(txtPercentageVat.Text.Trim()), decimal.Parse(txtPercentageOtherTax.Text.Trim()),
                                clsHelpMethods_Local.getSavePrice(decimal.Parse(txtSubTotal.Text.Trim()), txtCurrencyRate),clsHelpMethods_Local.getSavePrice(decimal.Parse(txtDiscount.Text.Trim()),
                                txtCurrencyRate), clsHelpMethods_Local.getSavePrice(decimal.Parse(txtNBT.Text.Trim()), txtCurrencyRate),
                                ...
                                clsHelpMethods_Local.getSavePrice(decimal.Parse(txtGrandTotal.Text.Trim()), txtCurrencyRate), clsSecurity.UserIDLoged, clsSecurity.UserIDLoged, "default", "default", clsSecurity.UserIDLoged, clsSecurity.UserIDLoged, clsSecurity.TerminalID, clsSecurity.TerminalID, clsSecurity.TerminalID, clsSecurity.TerminalID,
                                ...
                                0, !chkUnitPricing.Checked, chkReverseCalculation.Checked, rdoReturnable.Checked, rdoRefundable.Checked, rdoExcess.Checked, txtCustomerBranchID.Tag.ToString(), chkEnteranceError.Checked, clsSecurity.CompanyID, clsSecurity.BranchID, ((ComboBoxItem)cmbItemPrice.SelectedItem).Value, int.Parse(lblRoute.Tag.ToString()), rdbNew.Checked);
                            detail.Insert();
                            #endregion
                            ...
                            if (true)
                            {
                                foreach (DataGridViewRow row in dgvDetail.Rows)
                                {
                                    try
                                    {
                                        string Store_ID = "", sItemCode = "", sUom = "default", sDeliveryOrderCode = "", sInvoiceCode = "", sJobCode = "", sRemarks = "",
                                        ...
                                        if (sItemCode.Length > 0)
                                        {
                                            ...
                                            tbl_sasSalesReturnedNote_Detail items = new tbl_sasSalesReturnedNote_Detail(int.Parse(sLineNo), txtSRNID.Text.Trim(), sItemCode, sItemSubCategoryID, sItemSubCategoryID2, sItemSerialNo, sItemSerialNo2,
                                                sInvoiceCode, sDeliveryOrderCode, dQuantity, dWeight, 0, dWeightPrice, dUnitPrice, bIsFreeIssue, dDiscountPresentage, dDiscountValue, dAmount, dunitCost, dTatalCost_FIFO, sRemarks, clsProcessMethods.GetItemWeightedAvarageCostPrice(sItemCode), Store_ID);
                                            items.Insert();
                                            ...
                                            #region Update Store Stock
                                            decimal dWeightedAverageCostPrice = 0;
                                       //     clsHelpMethods_Local.UpdateStoreStock(iFormID, detail.SalesReturnedNote_ID, detail.SalesReturnedNoteDate, sItemCode, "0", txtStoreID.Tag.ToString(), dQuantity, dWeight, items.TatalAmount, false, true, false, ref dWeightedAverageCostPrice);
                                            #endregion
                                        }
                                    }
                                    catch (Exception ex)
                            ...
                            email.createEmail_SalesReturn(txtSRNID.Text.Trim(), enum_Alerts.SalesReternCreated);
                ...
                if (txtItemID.Tag != null && txtItemID.Tag.ToString().Trim().Length > 0)
                {
                    ...
                    if (detail != null)
                    {
                            ...
                            if (frm.lstclsTmpSelectedItems.Count > 0)
                            {
                                foreach (clsTmpSelectedItems oDO in frm.lstclsTmpSelectedItems)
                                {
                                    ...
                                    Fill_Datagrid(true, iRow, oDO.iLineNo, detail.Item_ID, oDO.sDONo, oDO.sInvoiceNo, oDO.sJobNo, detail.Uom_ID, oDO.dUnitPrice, 0, false, 0, 0, dTotalAmount, detail.Width, detail.Height, detail.Thickness, detail.Gusset, oDO.dWeight, oDO.dQty, oDO.dUnitPrice, dTotalAmount,
                                       txtItemSubCategory.Tag.ToString(), txtItemSubCategory.Text.Trim(), txtItemSerialNo.Tag.ToString(), txtItemSerialNo.Text.Trim(), oDO.sRemarks, decimal.Parse(txtCurrencyRate.Text.Trim()), detail.store_ID);
                        ...
                        else
                        {
                            ...
                            int iRow = dgvDetail.Rows.Count - 1;
                            var maxLineNo = dgvDetail.Rows.Cast<DataGridViewRow>().Max(r => Convert.ToInt32(r.Cells["LineNo"].Value));
                            Fill_Datagrid(false, iRow, maxLineNo + 1, txtItemID.Tag.ToString(), "default", "default", "default", detail.Uom_ID, 0, 0, false, 0, 0, 0, detail.Width, detail.Height, detail.Thickness, detail.Gusset, 0, 1, 0, 0,
                                txtItemSubCategory.Tag.ToString(), txtItemSubCategory.Text.Trim(), txtItemSerialNo.Tag.ToString(), txtItemSerialNo.Text.Trim(), "", decimal.Parse(txtCurrencyRate.Text.Trim()), detail.store_ID);
        ...
        private void CusDataGridViewFormat()
        {
            ...
            dgvDetail.Columns["Store_ID"].Visible = true;
            dgvDetail.Columns["Free"].ReadOnly = true;
            dgvDetail.Columns["Store_ID"].ReadOnly = true;
        }
        ...
        private void ClearFields()
        {
            ...
            dtpSRNDate.Enabled = clsSecurity.PermissionToRead(clsSecurity.UserIDLoged, 1760);
                    ...
                    foreach (tbl_sasSalesReturnedNote_Detail detail in details)
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            Fill_Datagrid(true, iRow, detail.Line_No, detail.Item_ID, detail.DeliveryOrder_ID, detail.Invoice_ID, "default", item.Uom_ID, detail.UnitPrice, detail.KiloPrice, detail.BIsFreeItem, detail.DiscountPresentage, detail.DiscountAmount,
                                detail.TatalAmount, item.Width, item.Height, item.Thickness, item.Gusset, detail.Weight, detail.Qty, detail.UnitCost, detail.TatalCost_FIFO, detail.ItemSubCategory_ID, detail.ItemSubCategory2_ID, detail.ItemSerialNo, detail.ItemSerialNo2, detail.Remark, oSRN.CurrencyRate, detail.store_ID);
                        }
                    }
                }
            }
        ...
        private void RefreshGridByInvoiceID(string sInvoiceID)
        {
            try
            {
                ...
                {
                   var details = tbl_sasInvoice_Detail_Ex.SelectAllByInvoice_ID_WithStore(sInvoiceID);
                    foreach (tbl_sasInvoice_Detail_Ex detail in details)
                    {
                        tbl_genItemMaster item = tbl_genItemMaster.Select(detail.Item_ID);
                        if (item != null)
                        {
                            ...
                            Fill_Datagrid(true, iRow, detail.Line_No, detail.Item_ID, detail.DeliveryOrder_ID, detail.Invoice_ID, clsHelpMethods_Local.GetProductionJobIDByCustomerOrderID(detail.CustomerOrder_ID),
                                ...
                                detail.ItemSubCategory_ID, detail.ItemSubCategory2_ID, detail.ItemSerialNo, detail.ItemSerialNo2, detail.Remark, oInvoice.CurrencyRate, detail.store_ID);
                        }
                    }
                    CalcualteSubTotal();
                    CalculateTaxesAndGrandTotal();
        ...
        private bool CheckValidity_Item()
        {
            ...
            try
            {
                string Store_ID = "", sItemCode = "", sDoCode = "", sInvoiceCode = "", strMessage = "", sItemSubCategoryID = "", sItemSubCategoryID2 = "", sItemSerialNo = "", sItemSerialNo2 = "", sLineNo = "";
                ...
                foreach (DataGridViewRow row in dgvDetail.Rows)
                {
                    try
                    {
                        ...
                        {
                            strMessage += "Invalied Store found ,Iyem<" + sItemCode + ">";
                            rtn = false;
                            break;

                        }
                        if (!clsSecurity.permissionToSave_Store(clsSecurity.UserIDLoged, Store_ID, IsUpdate))
                        {
                            rtn = false;
                            break;
                        }
        ...
        private bool CheckValidity_Posting1()
        {
            bool bStatus = false;
            try
            {
            ...
            try
            {
                if (e.RowIndex >= 0)
                {
                    ...
                    if (sColName == "store_ID")
                    {
                        ...
                        {
                            dgvDetail["store_ID", e.RowIndex].Tag = lstResult[0];
                            dgvDetail["store_ID", e.RowIndex].Value = lstResult[1];
                        ...
                        //{
                        //    dgvDetail["store_ID", e.RowIndex].Tag = txtStoreID.Tag.ToString();
                        //    dgvDetail["store_ID", e.RowIndex].Value = txtStoreID.Text;
                        //}
                    }

                    else if (sColName != "UOM" && sColName != "Quantity" && sColName != "Weight" && sColName != "UnitPrice" && sColName != "WeightPrice" && sColName != "Remarks"
        ...
        decimal Width, decimal Height, decimal Gauge, decimal Gusset, decimal Weight, decimal Qty, decimal dUnitCost, decimal dTatalCost_FIFO, string ItemSubCategoryID, string ItemSubCategoryID2, string SerialNo, string SerialNo2, string Remark, decimal dExRate, string Store)
        {
            try
            {
                bool isNewItem = true;
                ...
                if (bValidItem)
                {
                    ...
                    dgvDetail["store_ID", iRow].Tag = Store;
                    dgvDetail["store_ID", iRow].Value = clsGenaralName.getName_Store(Store);
        ...
        {
            #region Akt Dataset Sales Return Note / RHW / TW Dataset Sales Return Note
            if (clsConfig.sSoftwareModel.Trim() == SoftwareModel_Sales.akt.ToString() || clsConfig.bisDatasetActive_SalesReturnNotePrinting)
            {
                if (txtSRNID.TextLength > 0 && txtSRNID.Text != "<Auto Generate>")
                {
                    try
                    {
                        ...
                        Cursor = Cursors.WaitCursor;
                        string sCreateUser = "", sCheckedUser = "", sApprovedUser = "", sJobNo = "", sPONo = "", sCustomerAddress = "";// string sInvoiceID = "";
                        string sDuplicate = "";
                        ...
                        if (bPermissinOkToPrint)
                        {
                                ...
                                if (bApprovalDone && bCheckingDone)
                                {
                                    ...
                                    foreach (tbl_sasSalesReturnedNote_Detail oOderes in tbl_sasSalesReturnedNote_Detail.SelectAllBySalesReturnedNote_ID(order.SalesReturnedNote_ID).Where(p => p.SalesReturnedNote_ID != "default"))
                                    {
                                        ...
                                        if (item != null && item.Item_ID != "default")
                                            sItemSizeRemark = clsHelpMethods_Local.GetItemSizeByItemID(item.Item_ID);
                                    ...
                                    string sGetRptPath = clsHelpMethods_Local.GetReportPath(clsAutocode.getReportID(enum_ReportName.NP_SalesReturnNote));
                                    ...
                                    {
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("JobNo", sJobNo, true);
                                        glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("PONo", sPONo, true);
                                    }
                                    ...
                                    if (bisDraft)
                                    {
                                        if (!clsConfig.isVisibleCompanyInfoInDraftPrint)
                                        {
                                            ...
                                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("DigiteqName", "", true);
                                            glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("DigiteqEmail", "", true);
                            ...
                            email.createEmail_SalesReturn(txtSRNID.Text.Trim(), enum_Alerts.SalesReturnNotePrint);
                        }
                    }
                    catch (Exception ex)
                    {
