    ...
    public partial class frm_scsSectionRequisitionNote : SEACC_Form
    {
                                        ...
                                        else  //insert records
                                        {
                                            ...
                                            if (clsValidate.CheckValidity_TransactionCodeLength(txtSectionRequisitionNoteID.Text)) //if (txtSectionRequisitionNoteID.Text.Trim().Length > 0)
                                            {
                                                ...
                                                tbl_scsSectionReqositionNote detail = new tbl_scsSectionReqositionNote(txtSectionRequisitionNoteID.Text.Trim(), dtpSRNDate.Value, txtRemark.Text.Trim(),
                                                    txtjobID.Tag.ToString(), txtLocationID.Tag.ToString(), clsHelpMethods_Local.getSelectAreaID(txtDepartmentID, txtSectionID, txtStoreID),
        ...
        private void RefreshGridByJob_ID(string sJob_ID)
        {
            try
            {
                ...
                //            if (item != null)
                //            {
                //                clsHelpMethods_Local.Fill_StockDatagrid(dgvDetail, iRow, input.Line_No, item.Item_ID, item.Uom_ID, sJob_ID, clsHelpMethods_Local.getSelectAreaID(txtDepartmentID, txtSectionID, txtStoreID),
        ...
        private void RefreshGridByItem_ID(string sItem_ID)
        {
            try
            {
                ...
                if (detail != null)
                {
                    ...
                    clsHelpMethods_Local.Fill_StockDatagrid(dgvDetail, iRow, dgvDetail.Rows.Count, detail.Item_ID, detail.Uom_ID, sJobID, clsHelpMethods_Local.getSelectAreaID(txtDepartmentID, txtSectionID, txtStoreID),
