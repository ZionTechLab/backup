...
namespace Digiteq
{
    public partial class frm_scsLoan : Form
    {
                                    ...
                                    if (!detail.IsLocked && !detail.IsApproved && !detail.IsFinished && !detail.IsDeleted)
                                    {
                                        if (CheckSupplierSaveValidity())
                                        {
                                            ...
                                            if (msgResult == DialogResult.Yes)
                                            {
                                                ...
                                                // {
                                                ////     clsHelpMethods_Local.UpdateOrInsertStoreStock(true, true, oItem.Item_ID, oItem.ItemSubCategory_ID, oItem.ItemSubCategory2_ID, oItem.ItemSerialNo, oItem.ItemSerialNo2, "default", txtStoreID.Tag.ToString(), oItem.Qty, oItem.Weight, 0, 0, false, false, true);
                                                // }
                                            }
                                    ...
                                    if (!detail.IsLocked && !detail.IsApproved && !detail.IsFinished && !detail.IsDeleted)
                                    {
                                        if (CheckSupplierSaveValidity())
                                        {
                                            ...
                                            if (msgResult == DialogResult.Yes)
                                            {
                                                ...
                                                //{
                                                //    clsHelpMethods_Local.UpdateOrInsertStoreStock(true, true, oItem.Item_ID, oItem.ItemSubCategory_ID, oItem.ItemSubCategory2_ID, oItem.ItemSerialNo, oItem.ItemSerialNo2, "default", txtStoreID.Tag.ToString(), oItem.Qty, oItem.Weight, 0, 0, false, true, true);
                                                //}
                                            }
                                        }
                                    }
                                                                ...
                                                                !oldRecord.IsFinished && !oldRecord.IsDeleted)
                                                            {
                                                                ...
                                                                foreach (tbl_scsLoanIn_Detail oldDetail in oldDetails)
                                                                {
                                                                    ...
                                                                    if (bHasItemInDB)
                                                                    {
                                                                        ...
                                                                        //    clsHelpMethods_Local.UpdateOrInsertStoreStock(true, true, sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2, sJobCode, txtStoreID.Tag.ToString(), dQty, dWeight, oldDetail.Qty, oldDetail.Weight, true, true, true);
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        //   clsHelpMethods_Local.UpdateOrInsertStoreStock(true, true, oldDetail.Item_ID, oldDetail.ItemSubCategory_ID, oldDetail.ItemSubCategory2_ID, oldDetail.ItemSerialNo, oldDetail.ItemSerialNo2, "default", txtStoreID.Tag.ToString(), oldDetail.Qty, oldDetail.Weight, 0, 0, false, false, true);
                                                                ...
                                                                foreach (DataGridViewRow row in dgvDetail.Rows)
                                                                {
                                                                    ...
                                                                    //    clsHelpMethods_Local.UpdateOrInsertStoreStock(true, true, sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2, sJobCode, txtStoreID.Tag.ToString(), dQty, dWeight, 0, 0, false, true, true);
                                                            ...
                                                            clsValidate.CheckPrintingValidity(oldRecord.PrintCount))
                                                        {
                                                                ...
                                                                !oldRecord.IsFinished && !oldRecord.IsDeleted)
                                                            {
                                                                ...
                                                                foreach (DataGridViewRow row in dgvDetail.Rows)
                                                                {
                                                                    ...
                                                                    tbl_scsLoanOut_Detail detail =                                                                        new tbl_scsLoanOut_Detail(                                                                            clsHelpMethods_Local                                                                                .GetMaxzimumLineNoLoanOut(                                                                                    txtLoanID.Text.Trim()),                                                                            txtLoanID.Text.Trim(),                                                                            sItemCode, sItemSubCategoryID1,                                                                            sItemSubCategoryID2, sItemSerialNo1,                                                                            sItemSerialNo2, dQty, 0, dWeight, 0,                                                                            dUnitPrice, 0, dWeidhtPrice, 0, dAmount,                                                                            sRemarks);
                                                                    detail.Insert();
                                            ...
                                            else //insert recode
                                            {
                                                ...
                                                if (clsValidate.CheckValidity_TransactionCodeLength(txtLoanID.Text)) //if (txtLoanID.Text.Trim().Length > 0)
                                                {
                                                    ...
                                                    foreach (DataGridViewRow row in dgvDetail.Rows)
                                                    {
                                                        ...
                                                        if (rdoLoanIn.Checked)
                                                        {
                                                            tbl_scsLoanIn_Detail detail = new tbl_scsLoanIn_Detail(clsHelpMethods_Local.GetMaxzimumLineNoLoanIN(txtLoanID.Text.Trim()), txtLoanID.Text.Trim(),
                                                        ...
                                                        {
                                                            tbl_scsLoanOut_Detail detail = new tbl_scsLoanOut_Detail(clsHelpMethods_Local.GetMaxzimumLineNoLoanOut(txtLoanID.Text.Trim()), txtLoanID.Text.Trim(),
                                                                sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2, dQty, 0, dWeight, 0, dUnitPrice, 0, dWeidhtPrice, 0, dAmount, sRemarks);
                                                            detail.Insert();
                                                        }
                                                        #endregion
                                                        ...
                                                        //    clsHelpMethods_Local.UpdateOrInsertStoreStock(true, true, sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2, sJobCode, txtStoreID.Tag.ToString(), dQty, dWeight, 0, 0, false, true, true);
                                                        //else
                                                        //    clsHelpMethods_Local.UpdateOrInsertStoreStock(true, true, sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2, sJobCode, txtStoreID.Tag.ToString(), dQty, dWeight, 0, 0, false, false, true);
                                                        #endregion
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            if (rdoLoanIn.Checked)
            {
                sGetRptPath = clsHelpMethods_Local.GetReportPath(clsAutocode.getReportID(enum_ReportName.ST_LoanIN));
            }
            else
            {
                sGetRptPath = clsHelpMethods_Local.GetReportPath(clsAutocode.getReportID(enum_ReportName.ST_LoanOut));
            }
            #endregion
                        ...
                        if (order != null)
                        {
                           ...
                           */
                            ...
                            try
                            {
                                ...
                                if (bIsDuplicate)
                                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("DuplicateCopy", "Duplicate Copy", true);
