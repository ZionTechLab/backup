...
namespace Digiteq
{
    public partial class frm_scsItemViewer_SemiFinishedGood : Form
    {
        ...
        #region Form Load
        public frm_scsItemViewer_SemiFinishedGood()
        {
            iFormID = clsSecurity.getFormID(FormName.ViewerSemiFinishedGood);
        ...
        {
            clsFormatter.setFormatForm(this, "Item Viewer Semi Finished", 2, iFormID);
            ClearFields();
        ...
        {
            List<tbl_genItemMaster_SemiFinishedGood> MaterailDetails = tbl_genItemMaster_SemiFinishedGood.SelectAllByItem_ID(sItemID);
            foreach (tbl_genItemMaster_SemiFinishedGood detail in MaterailDetails)
            {
