...
namespace Digiteq
{
    public partial class frm_masAccChartOfAccount1 : MettroForm
    {
        ...
        #region Form Load
        public frm_masAccChartOfAccount1()
        {
                                    ...
                                    if (oldRecord != null)
                                    {
                                        ...
                                        if (bStatus)
                                        {
                                            ...
                                            tbl_accGLMaster detail = new tbl_accGLMaster(iRowno, txtAcctCode.Text.Trim(), txtAcctCodeName.Text.ToString(),
                                               txtAcctCodeType2Code.Text, txtGLNoteID.Tag.ToString().Trim(), clsSecurity.UserIDLoged, clsSecurity.TerminalID,
            ...
            try
            {
                if (sAcct.Length > 0)
                {
                    ...
                    if (detail != null)
                    {
                        ...
                        clsCommon.SetEnableDisable_NormalLabel(lblAcctCodeGlCode, true);
                        clsCommon.SetEnableDisable_NormalLabel(lblAcctCodeSubGlCode, true);
                        clsCommon.SetEnableDisable_NormalLabel(lblAcctCodeTypeCode, true);
                        clsCommon.SetEnableDisable_NormalLabel(lblAcctCodeType2Code, true);
                        clsCommon.SetEnableDisable_NormalLabel(lblAcctCode, true);
                        ...
                        clsCommon.SetEnableDisable_ForeignKeyTextboxMust(txtAcctCode, true);
        ...
        private void dgvAcct_CellBorderStyleChanged(object sender, EventArgs e)
        {
