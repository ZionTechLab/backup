    ...
    public partial class frm_rpt_AdminStandardReport : Form
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            else if (rdoCancelledTransactions.Checked)
            {
                ...
                if (clsHelpMethods_Local.GetReportPath(clsAutocode.getReportID(enum_ReportName.ADM_Cancel_Transactions), ref sReportTitle_Main, ref sReportTitle_Sub, ref sReportPath))
                {
