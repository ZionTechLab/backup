    ...
    public partial class frm_scsSectionGoodIssueNote : Form
    {
                                                    ...
                                                    foreach (DataGridViewRow row in dgvDetail.Rows)
                                                    {
                                                        try
                                                        {
                                                            ...
                                                            if (sItemCode.Length > 0)
                                                            {
                                                                ...
                                                                ////Update Store Stock                                                           
                                                                //clsHelpMethods_Local.UpdateOrInsertSectionStock(clsConfig.bStockValidateQty_iGIN, clsConfig.bStockValidateWeight_iGIN, sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2,
        ...
        private void RefreshGrid(string sGINID)
        {
            ...
            foreach (tbl_scsSectionGoodIssueNote_Detail detail in details)
            {
                ...
                string sToNoteID = clsHelpMethods_Local.GetSelectAreaNoteID(detail.ToSelectArea_ID, detail.DepartmentReqositionNote_ID, detail.SectionRequisitionNote_ID, detail.StoreRequisitionNote_ID);
        ...
        //                if (item != null)
        //                {
        //                    clsHelpMethods_Local.Fill_StockDatagrid(dgvDetail, iRow, input.Line_No, item.Item_ID, item.Uom_ID, sJob_ID, getSelectAriaID(), txtDepartmentID.Tag.ToString(), txtSectionID.Tag.ToString(),
        ...
        //                if (item != null)
        //                {
        //                    clsHelpMethods_Local.Fill_StockDatagrid(dgvDetail, iRow, output.Line_No, item.Item_ID, item.Uom_ID, sJob_ID, getSelectAriaID(), txtDepartmentID.Tag.ToString(), txtSectionID.Tag.ToString(),
        ...
        private void RefreshGridByItem_ID(string sItem_ID)
        {
            ...
            if (detail != null)
            {
                ...
                clsHelpMethods_Local.Fill_StockDatagrid(dgvDetail, iRow, dgvDetail.Rows.Count, detail.Item_ID, detail.Uom_ID, sJobID, getSelectAriaID(), txtDepartmentID.Tag.ToString(), txtSectionID.Tag.ToString(),
                                ...
                                if (!detail.IsDeleted)
                                {
                                    if (!detail.IsSeattled)
                                    {
                                        ...
                                        if (msgResult == DialogResult.Yes)
                                        {
                                            ...
                                            {
                                                ///Update Stock
                                                //clsHelpMethods_Local.UpdateOrInsertSectionStock(true, true, GINdetail.Item_ID, GINdetail.ItemSubCategory_ID, GINdetail.ItemSubCategory2_ID, GINdetail.ItemSerialNo, GINdetail.ItemSerialNo2,
