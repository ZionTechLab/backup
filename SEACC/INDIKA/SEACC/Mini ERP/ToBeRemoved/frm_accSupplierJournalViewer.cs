...
namespace Digiteq
{
    public partial class frm_accSupplierJournalViewer : MettroForm
    {
        ...
        #region Form Load
        public frm_accSupplierJournalViewer()
        {
            InitializeComponent();
        ...
        private void RefreshGrid()
        {
            ...
            try
            {
                ...
                List<tbl_accPaymentVoucher> oPVList;
                List<tbl_accDebitNote> oSDBNList;
