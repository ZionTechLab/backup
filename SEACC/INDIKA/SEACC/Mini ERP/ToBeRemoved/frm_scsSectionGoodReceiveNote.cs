                                            ...
                                            if (clsValidate.CheckValidity_TransactionCodeLength(txtGoodreceivedNoteID.Text)) // if (txtGoodreceivedNoteID.TextLength > 0)
                                            {
                                                ...
                                                foreach (DataGridViewRow row in dgvDetail.Rows)
                                                {
                                                    try
                                                    {
                                                        ...
                                                        {
                                                            tbl_scsSectionGoodReceiveNote_Detail items = new tbl_scsSectionGoodReceiveNote_Detail(clsHelpMethods_Local.GetMaxzimumLineNoSectionGoodReceiveNote(txtGoodreceivedNoteID.Text.Trim()), txtGoodreceivedNoteID.Text.Trim(),
                                                            ...
                                                            ////Update Store Stock                                                           
                                                            //clsHelpMethods_Local.UpdateOrInsertSectionStock(clsConfig.bStockValidateQty_iGRN, clsConfig.bStockValidateWeight_iGRN, sItemCode, sItemSubCategoryID1, sItemSubCategoryID2, sItemSerialNo1, sItemSerialNo2,
                                ...
                                if (!detail.IsDeleted)
                                {
                                    ...
                                    if (msgResult == DialogResult.Yes)
                                    {
                                        ...
                                        if (CheckStockValidityWhenRemove(detail.SectionGoodReceiveNote_ID))
                                        {
                                            ...
                                            {
                                                ///Update Stock
                                                //clsHelpMethods_Local.UpdateOrInsertSectionStock(true, true, GRNdetail.Item_ID, GRNdetail.ItemSubCategory_ID, GRNdetail.ItemSubCategory2_ID, GRNdetail.ItemSerialNo, GRNdetail.ItemSerialNo2,
