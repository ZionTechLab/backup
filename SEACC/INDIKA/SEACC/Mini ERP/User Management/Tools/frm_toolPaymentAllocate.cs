       ...
       public int iFormID;
            ...
            if (rdoAdvancePayment.Checked || rdoOverPayment.Checked || rdoPartPayment.Checked)
            {
                ...
                try
                {
                 ...
                 // decimal dReceiptTotal = receipt.TotalAmount;
                    ...
                    string sGetRptPath = clsHelpMethods_Local.GetReportPath(clsAutocode.getReportID(enum_ReportName.NP_SalesReceipt));
        ...
        {            
            ...
            if (rdoAdvancePayment.Checked || rdoOverPayment.Checked)
                glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("AllocationCode", clsCommon.fncsetstring(sAllocationID), true);
            ...
            if (clsConfig.sSoftwareModel.Trim() == SoftwareModel_Sales.akt.ToString())
            {
                ...
                {
                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("ChequeNo", clsCommon.fncsetstring(oCheque.ChequeNumber), true);
                    glb_dtsReportExport.dt_rptParameter.Adddt_rptParameterRow("ChequeDate", clsCommon.fncsetstring(clsFormatter.FormatDate_Short(oCheque.DateCheque)), true);
                }
            }
            string sinvoiceno = "";
