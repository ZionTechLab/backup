...
namespace Digiteq
{
    public partial class UC_mtrCompanyStore_New : SEACC_Form
    {
        #region Form Load
        public UC_mtrCompanyStore_New(FormName _enmForm)
        {
            enmForm = _enmForm;
            InitializeComponent();
            Initialize();
        }        
        private void UC_mtrCompanyStore_New_Load(object sender, EventArgs e)
        {
            RefreshGrid();
        ...
        #region Btn New
        private void UC_mtrCompanyStore_New_SF_newButton_Click(object sender, EventArgs e)
        {
            ClearFields();
        }
        #endregion
        ...
        #region Btn Delete
        private void UC_mtrCompanyStore_New_SF_cancelButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtCompanyStoreID.TextLength > 0)
                {
                    if (clsSecurity.PermissionToDelete(clsSecurity.UserIDLoged, iFormID))
                    {
                        ...
                        {
                            detail.Delete();
                            clsHelpMethods.InsertTransactionHistory(iFormID, txtCompanyStoreID.Text, TxnActivity.Cancel);
                        }
        ...
        #region Btn Save
        private void UC_mtrCompanyStore_New_SF_saveButton_Click(object sender, EventArgs e)
        {
            if (CheckValidity())
            {
                                ...
                                if (txtCompanyStoreID.TextLength > 0)
                                {
                                    if (IsUpdate)  //update records
                                    {
                                        ...
                                        if (oldRecord != null)
                                        {
                                            ...
                                            detail.Update();
                                            clsHelpMethods.InsertTransactionHistory(iFormID, txtCompanyStoreID.Text, TxnActivity.Update);
                                    ...
                                    else  //insert records
                                    {
                                        ...
                                        detail.Insert();
                                        clsHelpMethods.InsertTransactionHistory(iFormID, txtCompanyStoreID.Text, TxnActivity.Insert);
        ...
        private void ClearFields()
        {
            ...
            chkSubContractotStore.Enabled = false;

            chkSubContractotStore.Checked = false;
            ...
            try
            {
                if (sID.Length > 0)
                {
                    ...
                    if (detail != null)
                    {
                        ...
                        chkSubContractotStore.Checked = detail.IsSubContractorStore;
        ...
        private void UC_mtrCompanyStore_New_KeyDown(object sender, KeyEventArgs e)
        {
