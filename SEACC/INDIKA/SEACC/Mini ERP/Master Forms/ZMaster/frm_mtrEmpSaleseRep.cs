    ...
    public partial class frm_mtrEmpSaleseRep : MettroForm
    {
            ...
            try
            {
                if (txtSalesRepID.TextLength > 0)
                {
                    if (clsSecurity.PermissionToDelete(clsSecurity.UserIDLoged, iFormID))
                    {
                        ...
                        if (detail != null && EmpMasterdetail != null && StrMasterdetail != null)
                        {
                            StrMasterdetail.Delete();
                            detail.Delete();
                            ...
                            if (txtSalesRepID.TextLength > 0)
                            {
                                if (IsUpdate)  //update records
                                {
                                    ...
                                    if (oldRecord != null)
                                    {
                                        ...
                                        tbl_ZEmpSalesRep detail = new tbl_ZEmpSalesRep(txtSalesRepID.Text.Trim(), txtSalesRepName.Text.Trim(), txtAreaManagerName.Tag.ToString(), oldRecord.Store_ID, chkIsCollector.Checked, chkIsSalesRep.Checked);
                                        detail.Update();
                                ...
                                else  //insert records
                                {
                                    ...
                                    tbl_ZEmpSalesRep detail = new tbl_ZEmpSalesRep(txtSalesRepID.Text.Trim(), txtSalesRepName.Text.Trim(), txtAreaManagerName.Tag.ToString(), txtSalesRepID.Text.Trim(), chkIsCollector.Checked, chkIsSalesRep.Checked);
                                    detail.Insert();
        ...
        private void Search_SalesRepID()
        {
            try
            {
                ...
                if (txtSalesRepID.Tag.ToString() != null)
                {
