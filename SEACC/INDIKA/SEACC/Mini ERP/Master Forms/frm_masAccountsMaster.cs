...

{
    public partial class frm_masAccountsMaster : MettroForm
    {
        ...
        {
            var detail = new frm_masAccChartOfAccount1();
            detail.MdiParent = this.MdiParent;
            detail.Show();
        }
        #endregion
        ...
        private void btnAccSloatMasterer_Click(object sender, EventArgs e)
        {
            frm_AccountType_Customer detail = new frm_AccountType_Customer();
            detail.MdiParent = this.MdiParent;
            detail.Show();
        }
        ...
        {
            //frm_masReciptGlAccountTaging detail = new frm_masReciptGlAccountTaging();
            //detail.MdiParent = this.MdiParent;
            //detail.Show();
        }

        private void btnAccountType_Supplier_Click(object sender, EventArgs e)
        {
            frm_AccountType_Supplier detail = new frm_AccountType_Supplier();
            detail.MdiParent = this.MdiParent;
            detail.Show();
        }
