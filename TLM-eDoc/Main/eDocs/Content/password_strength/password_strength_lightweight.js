...
function btn_savePass() {

    var Password = $('.strength_input').val();
    var ConformPassword = $('#ConformPassword').val();

    $('span[data-valmsg-for="ConformPassword"]').text('');
    ...
    if(Password == ConformPassword)
    {
        ...
        $("[data-dismiss=modal]").trigger({ type: "click" });
            ...
            $('span[data-valmsg-for="ConformPassword"]').text('Password did not match.');
