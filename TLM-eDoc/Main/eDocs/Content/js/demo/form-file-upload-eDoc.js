...
$(document).on('nifty.ready', function () {
    ...
    var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
        url: $("#SaveFile").val(), // Set the url
        thumbnailWidth: 50,
        thumbnailHeight: 50,
        parallelUploads: 20,
        maxFilesize: 500000000000,
        //acceptedFiles: ".jpg,.pdf,.png,.jpeg",
