    ...
    public partial class AWBManual : Form
    {
        ...
        private string Save(int MpsNo,string MpsAgnNo,bool deleted,string ExpressID)
        {
            ...
            else
            {
                ...
                var sType = _extProvider.GetShipTypeList(agencyView.CompID, agencyView.AgncyCode, txtOrigCountry.Text, txtDestCountry.Text);
                ...
                if (sType.FirstOrDefault().ShipType == "O")
                {

                    if (lis.Count == 0 && AWBDomainView.ExpressMpsNo == 0)
                    {
                        dr = MessageBox.Show("You have entered invalid origin.", "Origin", MessageBoxButtons.OK,
                        MessageBoxIcon.Information);
                ...
                if (sType.FirstOrDefault().ShipType == "I")
                {

                    if (lisd.Count == 0 && AWBDomainView.ExpressMpsNo == 0)
                    {
                        drd = MessageBox.Show("You have entered invalid destination.", "Destination", MessageBoxButtons.OK,
                        MessageBoxIcon.Information);
        ...
        private void ConsLeave()
        {
            ...
            else if (ConsList.Count > 0)
            {
                ...
                txtExpConsNo.Text = consView.ExpressCons;
        ...
        private void AWBLeave()
        {
            ...
            if (AWBList.Count > 0)
            {
                ...
                txtExpConsNo.Text = consView == null ? "" : consView.ExpressCons;
