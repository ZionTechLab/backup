   ...
   public sealed  class DelInvoiceLocator
    {
        ...
        public static T GetService<T>()
        {
            ...
            if(servicecontainer ==null)
            {
                ...
                servicecontainer.Add(typeof(IDelInvoicePreview), typeof(DelInvoicePreview));
                servicecontainer.Add(typeof(IDelInvProcess), typeof(DelInvoiceProcess));
            }
            #endregion
            try
            {             
