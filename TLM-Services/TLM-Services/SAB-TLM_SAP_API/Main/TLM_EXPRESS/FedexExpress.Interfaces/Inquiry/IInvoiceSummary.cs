...
{
    public interface IInvoiceSummary<T> : IDataAccess<InvoiceSummaryDomainView> where T : class
    {
        ...
        IList<InvoiceSummaryDomainView> GetInvoiceList(string fDate,string frominvNo,string ToInvNo,string todate,int CMPY,int agency,int groupID,string Gate,string Station,string InvoiceType,bool isInvoiceRange );
