...
{
    public interface IClearanceAnalysis<T> : IDataAccess<ClearanceAnalysisDomainView> where T : class
    {
        ...
        IList<ClearanceAnalysisDomainView> GetInvoiceList(string fDate,string frominvNo,string ToInvNo,string todate,int CMPY,int agency,int groupID,string Gate,string Station,string InvoiceType,bool isInvoiceRange );
