    ...
    public sealed class InvoiceUIFactory
    {
        ...
        public static T GetService<T>()
        {
            ...
            //{
                ...
                servicecontainer.Add(typeof(IInvFrtProcessPrint), new InvFrtInvPorcessPrintBusiness(new InvFrtInvPorcessPrintData()));
            servicecontainer.Add(typeof(IInvDelInvoiceProcess), new InvDelProcessBusiness(new InvDelProcessData()));
            servicecontainer.Add(typeof(IInvPickProcessRepo), new InvPickProcessBusiness(new InvPickProcessData()));
