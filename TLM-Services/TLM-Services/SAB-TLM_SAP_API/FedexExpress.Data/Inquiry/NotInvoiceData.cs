...
{
    public class NotInvoiceData : INotInvoice<NotInvoiceReportDomainView>
    {
        ...
        public IList<NotInvoiceReportDomainView> GetInvoiceList(string todate, int CMPY, int agency, int groupID, string Gate, string Station, string InvoiceType)
        {
            try
            {
                using (IExpressUnitOfWork<NewNotInvoiceSummaryResult> uof = new ExpressUnitOfWork<NewNotInvoiceSummaryResult>())
                {
                    SqlParameter[] paraList = new SqlParameter[]
                          {
                    ...
                    var OrgRegistryList = (from Ag in uof.Reposotery.GetDataBySp("[Express].[TLM_GetNotInvoiceSummaryData]", paraList)
                                           select new NotInvoiceReportDomainView
                                           {
                                               CMPY = Ag.CMPY.Value,
