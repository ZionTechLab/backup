...
namespace Express.Report.Operation.ReportProxy
{
    public class OperationReports : IOperationReportProvider
    {
        ...
        public void GetPodScanReport(IList<PodScanRptDomainView> para)
        {
            try
            {
                PodScanReport  invRpt = new PodScanReport();
                ...
                Report_Para.Add("reportPara", _searchPara);
                Report_Data.Add("PodScanRptDomainView", ReportContext.ToDataTable<PodScanRptDomainView>(para.ToList()));
                ReportContext.ShowReport("POD Scan", invRpt, Report_Data, Report_Para);
        ...
        public void GetPrincipleAccountsReport(IList<PrincipleAccountsView> _para)
        {
            try
            {
                RptPrincipalAccount invRpt = new RptPrincipalAccount();

                Dictionary<string, DataTable> Report_Data = new Dictionary<string, DataTable>();
                Report_Data.Add("PrincipleAccountsView", ReportContext.ToDataTable<PrincipleAccountsView>(_para.ToList()));
                ReportContext.ShowReport("Principle Account Report", invRpt, Report_Data, null);
