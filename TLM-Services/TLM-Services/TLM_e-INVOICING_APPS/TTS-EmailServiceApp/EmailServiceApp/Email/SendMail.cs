...
namespace EmailServiceApp.Email
{
    public class SendMail
    {
        ...
        // public static readonly string SMTP_CLIENT = "smtp.office365.com"; // as we are using outlook so we have provided smtp-mail.outlook.com   
        ...
        public static readonly string SMTP_CLIENT = EmailSettings.Settings.SmtpServerN;
        ...
        public ResponseMessage SendEMail(string recipient, string subject, string message, byte[] attachment, string path, string ReferenceNo, string CC, string EmailSender, string EmailSenderPassword)
        {
            ...
            try
            {
                MailAddress mailFrom = new MailAddress(EmailSender.Trim(), "TTS GROUP - Invoices");
