...
namespace EmailServiceApp.Report
{
    public class ReportContext
    {
        ...
        public static void PrintReport(string rptTitle, ReportDocument rptDocument, Dictionary<string, DataTable> Report_Data, Dictionary<string, string> Report_Para, string _printSource = "A")
        {
        ...
        public static void ExportDutyReportb(string rptTitle, ReportDocument rptDocument, Dictionary<string, DataTable> Report_Data, Dictionary<string, string> Report_Para, string invId)
        {
            string DutyPath = Path.Combine(Environment.CurrentDirectory, @"ExportItems\Duty\");
            ExportOptions rptExportOption;
            DiskFileDestinationOptions rptFileDestOption = new DiskFileDestinationOptions();
            PdfRtfWordFormatOptions rptFormatOption = new PdfRtfWordFormatOptions();
            //System.IO.Directory.CreateDirectory(@"C:\TLM\Duty\");
            string filePath = DutyPath + invId + "_backup.pdf";
            rptFileDestOption.DiskFileName = filePath;
            SetReportDataSource(rptDocument, Report_Data);
            SetReportParameter(rptDocument, Report_Para);
            rptDocument.PrintOptions.PaperSize = PaperSize.PaperA4;
        ...
        public static void ExportFrtReportb(string rptTitle, ReportDocument rptDocument, Dictionary<string, DataTable> Report_Data, Dictionary<string, string> Report_Para, string invId)
        {
            string FrtPath = Path.Combine(Environment.CurrentDirectory, @"ExportItems\Freight\");
            ...
            PdfRtfWordFormatOptions rptFormatOption = new PdfRtfWordFormatOptions();
            //System.IO.Directory.CreateDirectory(@"C:\TLM\Freight\");
            string filePath = FrtPath + invId + "_backup.pdf";
            rptFileDestOption.DiskFileName = filePath;
            SetReportDataSource(rptDocument, Report_Data);
            SetReportParameter(rptDocument, Report_Para);
            rptDocument.PrintOptions.PaperSize = PaperSize.PaperA4;
